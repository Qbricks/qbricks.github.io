...
Axiom tail_bits_sum :
  ...
  ((tail_bits i n) =
   (ind_isum
    (fun (l:Z) => (((value (int_to_bv i n)) l) * (power 2%Z (n - l)%Z))%Z)
    2%Z (n + 1%Z)%Z)).
...
Axiom bv_to_int_mod :
  ...
  ((int.EuclideanDivision.mod1 (bv_to_int bv)
   ...
   =
   (ind_isum
    (fun (l:Z) => (((value bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)
...
Axiom set_n_bvs :
  ...
  ~ ((1%Z <= i)%Z /\ (i <= (length bv))%Z) -> (((value bv) i) = 0%Z).
...
Axiom fc_def6 :
  ...
  ((l <= (length bv))%Z ->
   (((fc6 bv) l) = (((value bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc6 bv) l) = 0%Z)).

Axiom fc_def7 :
  forall (bv:bitvec) (l:Z),
  ((l <= (length bv))%Z ->
   (((fc7 bv) l) = (((value bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc7 bv) l) = 0%Z)).

Axiom kth_decomp :
  forall (bv:bitvec) (k:Z), ((1%Z <= k)%Z /\ (k <= (length bv))%Z) ->
  ((bv_to_int bv) =
   (((ind_isum (fc6 bv) 1%Z k) +
     (((value bv) k) * (power 2%Z ((length bv) - k)%Z))%Z)%Z
    + (ind_isum (fc7 bv) (k + 1%Z)%Z ((length bv) + 1%Z)%Z))%Z).
...
Axiom fc_def8 :
  forall (bv:bitvec) (l:Z),
  ((l <= (length bv))%Z ->
   (((fc8 bv) l) = (((value bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc8 bv) l) = 0%Z)).

Axiom fc_def9 :
  forall (bv:bitvec) (l:Z),
  ((l <= (length bv))%Z ->
   (((fc9 bv) l) = (((value bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc9 bv) l) = 0%Z)).

Axiom kth_decomp_bound_zero :
  forall (bv:bitvec) (k:Z), ((1%Z <= k)%Z /\ (k <= (length bv))%Z) ->
  (((value bv) k) = 0%Z) ->
  ((ind_isum (fc8 bv) 1%Z k) <= (bv_to_int bv))%Z /\
  ((bv_to_int bv) <
   ((ind_isum (fc9 bv) 1%Z k) + (power 2%Z ((length bv) - k)%Z))%Z)%Z.
...
Axiom fc_def10 :
  forall (bv:bitvec) (l:Z),
  ((l <= (length bv))%Z ->
   (((fc10 bv) l) = (((value bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc10 bv) l) = 0%Z)).

Axiom fc_def11 :
  forall (bv:bitvec) (l:Z),
  ((l <= (length bv))%Z ->
   (((fc11 bv) l) = (((value bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc11 bv) l) = 0%Z)).

Axiom kth_decomp_bound_one :
  forall (bv:bitvec) (k:Z), ((1%Z <= k)%Z /\ (k <= (length bv))%Z) ->
  (((value bv) k) = 1%Z) ->
  (((ind_isum (fc10 bv) 1%Z k) + (power 2%Z ((length bv) - k)%Z))%Z <=
   (bv_to_int bv))%Z /\
  ((bv_to_int bv) <
   ((ind_isum (fc11 bv) 1%Z k) + (power 2%Z (((length bv) - k)%Z + 1%Z)%Z))%Z)%Z.
...
Parameter fc12: Z -> Z -> Z -> Z -> (Z* Z)%type -> bool.
...
Axiom ind_basis_mat_spec :
  ...
  (((columns (ind_basis_mat i j r c)) = c) /\
   ((forall (k:Z) (l:Z), (valid_index (ind_basis_mat i j r c) k l) ->
    ...
    ((cardinal (filter (fc12 i j r c) (mat_indices (ind_basis_mat i j r c))))
     = 1%Z))).
...
Parameter result10: Z -> Z -> (Z* Z)%type -> matrix t.
...
Axiom result_def10 :
  ...
  | (i, j) =>
      ((((0%Z <= i)%Z /\ (i < r)%Z) /\ ((0%Z <= j)%Z /\ (j < c)%Z)) ->
       (((result10 r c) o) = (ind_basis_mat i j r c))) /\
      (~ (((0%Z <= i)%Z /\ (i < r)%Z) /\ ((0%Z <= j)%Z /\ (j < c)%Z)) ->
       (((result10 r c) o) = (make r c tzero)))
  end.

Axiom basis_mat_def :
  forall (r:Z) (c:Z), (0%Z < r)%Z -> (0%Z < c)%Z ->
  ((basis_mat r c) =
   (map (result10 r c) (cartesian_product (to_fset 0%Z r) (to_fset 0%Z c)))).

Parameter fc13: (matrix t) -> (Z* Z)%type -> bool.

Axiom fc_def13 :
  forall (m:matrix t) (x:(Z* Z)%type),
  (((fc13 m) x) = true) <-> ((get m (fir x) (sec x)) = tone).
   ...
   ((constant_size (basis_mat r c) (fun (y0:matrix t) => y0)) /\
    (((s_columns (basis_mat r c) (fun (y0:matrix t) => y0)) = c) /\
     (((s_rows (basis_mat r c) (fun (y0:matrix t) => y0)) = r) /\
      ...
      ((cardinal (filter (fc13 m) (mat_indices m))) = 1%Z))))).

Parameter basis_mat_indexes: (matrix t) -> (Z* Z)%type.

Parameter result11: (matrix t) -> (Z* Z)%type -> bool.
...
Axiom basis_mat_indexes_def :
  ...
  ((basis_mat_indexes m) = (element (filter (result11 m) (mat_indices m)))).
...
Parameter result12: (matrix t) -> (Z* Z)%type -> matrix t.

Axiom result_def12 :
  forall (m:matrix t) (o:(Z* Z)%type),
  ((valid_index m (fir o) (sec o)) ->
   (((result12 m) o) = (basis_projection m (fir o) (sec o)))) /\
  (~ (valid_index m (fir o) (sec o)) -> (((result12 m) o) = m)).

(* Why3 assumption *)
Definition basis_projections (m:matrix t) : set (matrix t) :=
  map (result12 m) (to_indexes m).
...
Parameter fc14: (matrix t) -> (Z* Z)%type -> matrix t.

Axiom fc_def14 :
  forall (m:matrix t) (o:(Z* Z)%type),
  ((valid_index m (fir o) (sec o)) ->
   (((fc14 m) o) = (basis_projection m (fir o) (sec o)))) /\
  (~ (valid_index m (fir o) (sec o)) -> (((fc14 m) o) = m)).

Axiom rewrite_basis_projections :
  forall (m:matrix t),
  ((basis_projections m) = (map (fc14 m) (to_indexes m))).

Parameter result13: (matrix t) -> (Z* Z)%type -> matrix t.

Axiom result_def13 :
  forall (m:matrix t) (o:(Z* Z)%type),
  ((mem o (to_indexes m)) ->
   (((result13 m) o) = (basis_projection m (fir o) (sec o)))) /\
  (~ (mem o (to_indexes m)) -> (((result13 m) o) = m)).

(* Why3 assumption *)
Definition indexes_decomp (m:matrix t) : matrix t :=
  mat_sum (to_indexes m) (result13 m).
...
Axiom fc_def15 :
  ...
  ((mem a1 s) -> (((fc15 m s f) a1) = (mat_mult m (f a1)))) /\
  (~ (mem a1 s) -> (((fc15 m s f) a1) = m)).
...
Axiom product_mat_sum_r_pre :
  ...
  (0%Z < (cardinal s'))%Z ->
  ((mat_mult m (mat_sum s' f)) = (mat_sum s' (fc15 m s f))) /\
  ...
  (((ket_length (bin_to_ket n bvx)) = n) /\
   (((ket_to_int (bin_to_ket n bvx)) = (bin_to_int bvx n)) /\
    (((rows (bin_to_ket n bvx)) = (power 2%Z n)) /\
     (((columns (bin_to_ket n bvx)) = 1%Z) /\ (is_a_ket (bin_to_ket n bvx)))))).
...
Parameter result14: (matrix t) -> Z -> matrix t.

Axiom result_def14 :
  forall (m:matrix t) (j:Z),
  ((mem j (to_fset 0%Z (power 2%Z (ket_length m)))) ->
   (((result14 m) j) = (ket_basis_projection m j))) /\
  (~ (mem j (to_fset 0%Z (power 2%Z (ket_length m)))) ->
   (((result14 m) j) = m)).
...
Axiom ket_basis_projections_def :
  ...
  ((ket_basis_projections m) =
   (map (result14 m) (to_fset 0%Z (power 2%Z (ket_length m))))).
...
Parameter fc16: (Z -> Z) -> (set Z) -> (Z -> t) -> Z -> Z -> matrix t.
...
Axiom fc_def16 :
  ...
  (~ (mem j s) -> (((fc16 f s a n) j) = (make n 1%Z tzero))).
...
Axiom fc_def17 :
  ...
  (~ (mem j s') -> (((fc17 f s s' a n) j) = (make n 1%Z tzero))).
...
Axiom fun_inversion_ :
  ...
  ((mat_sum s (fc16 f s a n)) = (mat_sum s' (fc17 f s s' a n))).
...
Axiom H : (pow_2_n = (power 2%Z (ket_length m))).

Axiom H1 : is_a_ket m.

Axiom H2 : (0%Z < pow_2_n)%Z.

Axiom H3 : p_bijective f (to_fset 0%Z pow_2_n) (to_fset 0%Z pow_2_n).
...
Axiom H5 :
  (0%Z < pow_2_n)%Z -> ((cardinal (to_fset 0%Z pow_2_n)) = (pow_2_n - 0%Z)%Z).

Axiom H6 : (pow_2_n <= 0%Z)%Z -> is_empty (to_fset 0%Z pow_2_n).

Axiom H7 :
  forall (k:Z),
  (mem k (to_fset 0%Z pow_2_n)) <-> ((0%Z <= k)%Z /\ (k < pow_2_n)%Z).

Axiom H8 :
  (0%Z < pow_2_n)%Z -> ((cardinal (to_fset 0%Z pow_2_n)) = (pow_2_n - 0%Z)%Z).

Axiom H9 : (pow_2_n <= 0%Z)%Z -> is_empty (to_fset 0%Z pow_2_n).

Axiom H10 :
  forall (k:Z),
  (mem k (to_fset 0%Z pow_2_n)) <-> ((0%Z <= k)%Z /\ (k < pow_2_n)%Z).

Parameter fc18: Z -> matrix t.

Parameter fc19: Z -> matrix t.

Axiom fc_def18 :
  forall (j:Z),
  ((mem j (to_fset 0%Z pow_2_n)) ->
   ((fc18 j) =
    (infix_asdtdt (a j) (set1 (make pow_2_n 1%Z tzero) (f j) 0%Z tone)))) /\
  (~ (mem j (to_fset 0%Z pow_2_n)) -> ((fc18 j) = (make pow_2_n 1%Z tzero))).
...
Axiom fc_def19 :
  ...
  ((mem j (to_fset 0%Z pow_2_n)) ->
   ((fc19 j) =
    (infix_asdtdt
     (a (inv_func f (to_fset 0%Z pow_2_n) (to_fset 0%Z pow_2_n) j))
     (set1 (make pow_2_n 1%Z tzero) j 0%Z tone)))) /\
  (~ (mem j (to_fset 0%Z pow_2_n)) -> ((fc19 j) = (make pow_2_n 1%Z tzero))).

Axiom H11 :
  ((mat_sum (to_fset 0%Z pow_2_n) fc18) =
   (mat_sum (to_fset 0%Z pow_2_n) fc19)).

Parameter a1: Z.

Axiom H12 : mem a1 (to_fset 0%Z pow_2_n).

Axiom H13 : mem a1 (to_fset 0%Z pow_2_n).
...
Axiom H14 :
  valid_index
  (infix_asdtdt (a a1) (set1 (make pow_2_n 1%Z tzero) (f a1) 0%Z tone)) i j.

(* Why3 goal *)
Theorem G :
  ((get (set1 (make pow_2_n 1%Z tzero) (f a1) 0%Z tone) i j) =
   (get (ket (ket_length m) (f a1)) i j)).
Proof.
