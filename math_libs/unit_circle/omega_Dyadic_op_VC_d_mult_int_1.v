...
Parameter result6: d_frac.

Axiom result_def6 : (result6 = (dyadic (i * (num o))%Z (den o))).

Axiom H : ((num result6) = (i * (num o))%Z).

Axiom H1 : ((den result6) = (den o)).

Axiom H2 : ((to_values result6) = ((i * (num o))%Z, den o)).

(* Why3 goal *)
Theorem VC_d_mult_int :
  ((d_omega (dyadic (i * (num o))%Z (den o))) = (cpower (d_omega o) i)).
Proof.
