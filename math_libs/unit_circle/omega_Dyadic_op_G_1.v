...
Axiom exp_two_pi_mul :
  forall (k:Z), (k >= 0%Z)%Z ->
  ((exp (infix_asdt (i_to_t k) two_pi_i)) = tone).
...
Axiom exp_two_pi_mul_den_add :
  forall (k:Z) (l:Z) (m:Z), ((k * m)%Z >= 0%Z)%Z ->
...
Axiom periodic_cos :
  ...
  ((cos (infix_pldt (infix_asdt (infix_asdt (i_to_t k) pi) ttwo) x)) =
   (cos x)).

Axiom anti_sym_cos :
  forall (k:Z), forall (x:t),
  ((cos
    (infix_pldt (infix_pldt (infix_asdt (i_to_t k) pi) (infix_sldt pi ttwo))
     x))
   =
   (prefix_mndt
    (cos
     (infix_mndt (infix_pldt (infix_asdt (i_to_t k) pi) (infix_sldt pi ttwo))
      x)))).
...
Axiom d_to_t_def :
  ...
  ((d_to_t o) =
   (infix_sldt
    (i_to_t (int.EuclideanDivision.mod1 (num o) (power 2%Z (den o))))
    (i_to_t (power 2%Z (den o))))).

Axiom d_to_t_spec : forall (o:d_frac), real_ (d_to_t o).

Axiom num_d_to_t :
  forall (d1:d_frac) (d2:d_frac),
  ((int.EuclideanDivision.mod1 (num d1) (power 2%Z (den d2))) =
   (int.EuclideanDivision.mod1 (num d2) (power 2%Z (den d2)))) ->
  ((den d1) = (den d2)) -> ((d_to_t d1) = (d_to_t d2)).

Parameter d_equiv: d_frac -> d_frac -> Prop.

Axiom d_equiv_def :
  forall (d1:d_frac) (d2:d_frac),
  (d_equiv d1 d2) <-> ((d_to_t d1) = (d_to_t d2)).

Axiom set_d_equiv :
  forall (d1:d_frac) (d2:d_frac), ((d_to_t d1) = (d_to_t d2)) ->
  d_equiv d1 d2.

Axiom get_d_equiv :
  forall (d1:d_frac) (d2:d_frac), (d_equiv d1 d2) ->
  ((d_to_t d1) = (d_to_t d2)).

Parameter d_cos: d_frac -> t.

Axiom d_cos_def : forall (o:d_frac), ((d_cos o) = (cos (d_to_t o))).

Axiom d_cos_spec : forall (o:d_frac), real_ (d_cos o).

Parameter d_sin: d_frac -> t.

Axiom d_sin_def : forall (o:d_frac), ((d_sin o) = (sin (d_to_t o))).
...
Axiom d_omega_int_spec :
  ...
  ((d_omega_int n k) = (exp (infix_asdt two_pi_i (d_to_t (dyadic n k))))).
...
Axiom mult_two_def :
  forall (o:d_frac), ((mult_two o) = (dyadic (2%Z * (num o))%Z (den o))).
...
Axiom div_two_spec :
  forall (o:d_frac), ((d_to_t (div_two o)) = (infix_sldt (d_to_t o) ttwo)).

Parameter o: d_frac.

(* Why3 goal *)
Theorem G : ((exp (infix_asdt im (d_to_t (div_two o)))) = (d_omega o)).
Proof.
