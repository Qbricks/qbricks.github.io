...
Axiom zero_def : (zero = 0%R).

Parameter one: R.

Axiom one_def : (one = 1%R).

Parameter two: R.

Axiom two_def : (two = 2%R).
...
Axiom infix_lsas_def :
  forall (x:R) (y:R), (infix_lsas x y) <-> ((infix_lseqas x y) /\ ~ (x = y)).
...
Axiom two1 : ((infix_plas 1%R 1%R) = 2%R).

Axiom Assoc :
  forall (x:R) (y:R) (z:R),
  ((infix_plas (infix_plas x y) z) = (infix_plas x (infix_plas y z))).

Axiom Unit_def_l : forall (x:R), ((infix_plas zero x) = x).

Axiom Unit_def_r : forall (x:R), ((infix_plas x zero) = x).

Axiom Inv_def_l : forall (x:R), ((infix_plas (prefix_mnas x) x) = zero).

Axiom Inv_def_r : forall (x:R), ((infix_plas x (prefix_mnas x)) = zero).
...
Axiom Unitary : forall (x:R), ((infix_asas one x) = x).

Axiom NonTrivialRing : ~ (zero = one).

Parameter inv: R -> R.

Axiom Inverse : forall (x:R), ~ (x = zero) -> ((infix_asas x (inv x)) = one).

Axiom sub_def :
  forall (x:R) (y:R), ((infix_mnas x y) = (infix_plas x (prefix_mnas y))).

Axiom div_def :
  forall (x:R) (y:R), ~ (y = zero) ->
  ((infix_slas x y) = (infix_asas x (inv y))).

Axiom absorbinf_zero : forall (x:R), ((infix_asas x zero) = zero).

Axiom add_div :
  forall (x:R) (y:R) (z:R), ~ (z = zero) ->
...
Axiom assoc_div_mul :
  forall (x:R) (y:R) (z:R), (~ (y = zero) /\ ~ (z = zero)) ->
...
Axiom ZeroLessOne : infix_lseqas zero one.
...
Axiom CompatOrderMult :
  forall (x:R) (y:R) (z:R), (infix_lseqas x y) -> (infix_lseqas zero z) ->
...
Parameter antisym:
  forall {a:Type} {a_WT:WhyType a}, (a -> a -> bool) -> Prop.
...
Axiom reflexive_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (rel:a -> a -> bool),
  (reflexive rel) <-> forall (a1:a), (((rel a1) a1) = true).
...
Axiom pre_order_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (rel:a -> a -> bool),
  (pre_order rel) <-> ((transitive rel) /\ (reflexive rel)).

Parameter partial_order:
  forall {a:Type} {a_WT:WhyType a}, (a -> a -> bool) -> Prop.

Axiom partial_order_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (rel:a -> a -> bool),
  (partial_order rel) <-> ((antisym rel) /\ (pre_order rel)).

Parameter recip:
  forall {a:Type} {a_WT:WhyType a}, (a -> a -> bool) -> (a -> a -> bool) ->
  Prop.

Axiom recip_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (rrel:a -> a -> bool) (rel:a -> a -> bool),
  (recip rrel rel) <->
...
Parameter compat_order_mult1:
  forall {a:Type} {a_WT:WhyType a}, (a -> a -> bool) -> (a -> a -> a) -> a ->
  Prop.

Axiom compat_order_mult_def :
  forall {a:Type} {a_WT:WhyType a},
...
Axiom opposite_def :
  ...
  (opposite op1 po1) <-> forall (a:im1) (b:im1), (((op1 ((po1 a) b)) b) = a).
...
Axiom set_cardone_elt :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (a1:a), ((cardinal s) > 0%Z)%Z ->
...
Axiom Exp_quarter_pi :
  ((exp (infix_sldt (infix_asdt im pi) (i_to_t 4%Z))) =
   (infix_pldt squarert_two (infix_asdt im squarert_two))).
...
Axiom cos_half_pi : ((cos (infix_sldt pi ttwo)) = tzero).
...
Axiom sin_def :
  forall (x:t), (real_ x) ->
  ((sin x) = (cos (infix_mndt x (infix_sldt pi ttwo)))).
...
Axiom result_def4 :
  forall {a:Type} {a_WT:WhyType a} {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (t1:a -> im1) (e1:a),
  (((result4 op1 t1) e1) = true) <-> ~ (neutral op1 (t1 e1)).
...
Axiom nonn_part_spec1 :
  forall {a:Type} {a_WT:WhyType a} {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (s:set a) (t1:a -> im1), forall (e1:a),
  (mem e1 (nonn_part1 op1 s t1)) <-> ((mem e1 s) /\ ~ (neutral op1 (t1 e1))).
...
Axiom result_def5 :
  forall {a:Type} {a_WT:WhyType a} {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (t1:a -> im1) (e1:a),
  (((result5 op1 t1) e1) = true) <-> (neutral op1 (t1 e1)).
...
Axiom n_part_spec1 :
  forall {a:Type} {a_WT:WhyType a} {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (s:set a) (t1:a -> im1), forall (e1:a),
  (mem e1 (n_part1 op1 s t1)) <-> ((mem e1 s) /\ (neutral op1 (t1 e1))).
...
Axiom sum_indic_def :
  ...
  ((sum_indic s t1 i) =
   (sum s (fun (e1:a) => (infix_asdt (t1 e1) (indic i e1))))).
...
Axiom ind_sum_indic_def :
  ...
  ((ind_sum_indic t1 l h i) =
   (ind_sum (fun (e1:Z) => (infix_asdt (t1 e1) (indic i e1))) l h)).
...
Axiom sum_indic_ts :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (t1:a -> t) (i:a), (mem i s) ->
  ((sum s (fun (e1:a) => (infix_asdt (t1 e1) (indic i e1)))) = (t1 i)).

Axiom ind_sum_indic_t :
  forall (t1:Z -> t) (l:Z) (h:Z) (i:Z), ((l <= i)%Z /\ (i < h)%Z) ->
  ((ind_sum_indic t1 l h i) = (t1 i)) /\
  ((ind_sum (fun (e1:Z) => (infix_asdt (t1 e1) (indic i e1))) l h) = (t1 i)).
...
Axiom comp_exp_cpower :
  forall (i:Z) (j:Z), (0%Z <= i)%Z -> (0%Z <= j)%Z ->
  ((cpower (exp (i_to_t i)) j) = (cpower e (i * j)%Z)) /\
...
Axiom unity_rt_def :
  forall (n:Z), (0%Z < n)%Z ->
  ((unity_rt n) = (exp (infix_sldt two_pi_i (i_to_t n)))).
...
Axiom exp_mod :
  ...
  ((exp (infix_sldt (infix_asdt (i_to_t k) two_pi_i) (i_to_t n))) =
   (exp
    (infix_sldt
     (infix_asdt (i_to_t (int.EuclideanDivision.mod1 k n)) two_pi_i)
     (i_to_t n)))).
...
Axiom exp_omega :
  forall (n:Z), (0%Z <= n)%Z ->
  ((omega n) = (exp (infix_sldt two_pi_i (i_to_t (power 2%Z n))))).

Axiom exp_p_omega :
  forall (n:Z) (k:Z), (0%Z <= n)%Z ->
  ((p_omega n k) =
   (exp (infix_sldt (infix_asdt (i_to_t k) two_pi_i) (i_to_t (power 2%Z n))))).
...
Axiom p_omega_add_ord :
  forall (n:Z) (k:Z) (n':Z) (k':Z), ((n' >= n)%Z /\ (n >= 0%Z)%Z) ->
...
Parameter d_inv: d_frac -> d_frac.

Axiom d_inv_def :
  forall (o:d_frac), ((d_inv o) = (dyadic (-(num o))%Z (den o))).

Parameter d_to_t: d_frac -> t.

Axiom d_to_t_def :
  forall (o:d_frac),
  ((d_to_t o) = (infix_sldt (i_to_t (num o)) (i_to_t (power 2%Z (den o))))).

Axiom d_to_t_spec : forall (o:d_frac), real_ (d_to_t o).

Parameter d_cos: d_frac -> t.

Axiom d_cos_def :
  forall (o:d_frac),
  ((d_cos o) = (cos (infix_asdt (infix_asdt ttwo pi) (d_to_t o)))).

Axiom d_cos_spec : forall (o:d_frac), real_ (d_cos o).

Parameter d_sin: d_frac -> t.

Axiom d_sin_def :
  forall (o:d_frac),
  ((d_sin o) = (sin (infix_asdt (infix_asdt ttwo pi) (d_to_t o)))).

Axiom d_sin_spec : forall (o:d_frac), real_ (d_sin o).

Parameter d_sum: d_frac -> d_frac -> d_frac.
...
Axiom d_sum_spec :
  forall (d1:d_frac) (d2:d_frac),
  ((d_to_t (d_sum d1 d2)) = (infix_pldt (d_to_t d1) (d_to_t d2))).

Parameter d_sum_i: Z -> Z -> Z -> Z -> d_frac.

Axiom d_sum_i_def :
  forall (k1:Z) (k2:Z) (n1:Z) (n2:Z),
  ((d_sum_i k1 k2 n1 n2) = (d_sum (dyadic k1 n1) (dyadic k2 n2))).

Axiom d_sum_i_spec :
  forall (k1:Z) (k2:Z) (n1:Z) (n2:Z),
  ((d_to_t (d_sum_i k1 k2 n1 n2)) =
   (infix_pldt (d_to_t (dyadic k1 n1)) (d_to_t (dyadic k2 n2)))).

Axiom d_sum_equal_den :
  forall (k1:Z) (k2:Z) (n:Z),
  ((d_sum (dyadic k1 n) (dyadic k2 n)) = (dyadic (k1 + k2)%Z n)).

Parameter d_omega: d_frac -> t.

Axiom d_omega_def :
  forall (o:d_frac), ((d_omega o) = (p_omega (den o) (num o))).

Axiom d_omega_spec :
  forall (o:d_frac),
  ((d_omega o) = (p_unity (power 2%Z (den o)) (num o))) /\
  ((d_omega o) = (exp (infix_asdt two_pi_i (d_to_t o)))).

Axiom d_omega_sum_d :
  forall (d1:d_frac) (d2:d_frac),
  ((infix_asdt (d_omega d1) (d_omega d2)) = (d_omega (d_sum d1 d2))).

Axiom d_omega_sum :
  forall (k1:Z) (k2:Z) (n1:Z) (n2:Z),
  ((infix_asdt (d_omega (dyadic k1 n1)) (d_omega (dyadic k2 n2))) =
   (d_omega (d_sum (dyadic k1 n1) (dyadic k2 n2)))).

Parameter d_omega_int: Z -> Z -> t.

Axiom d_omega_int_def :
  forall (n:Z) (k:Z), ((d_omega_int n k) = (d_omega (dyadic k n))).

Axiom d_omega_int_spec :
  forall (n:Z) (k:Z),
  ((d_omega_int n k) = (p_unity (power 2%Z n) k)) /\
  ((d_omega_int n k) = (exp (infix_asdt two_pi_i (d_to_t (dyadic k n))))).
...
Axiom d_omega_to_exp :
  forall (o:d_frac), ((d_omega o) = (exp (infix_asdt two_pi_i (d_to_t o)))).
...
Parameter mult_two: d_frac -> d_frac.

Axiom mult_two_def : forall (o:d_frac), ((mult_two o) = (d_mult_int 2%Z o)).

Axiom mult_two_spec :
  forall (o:d_frac), ((d_to_t (mult_two o)) = (infix_asdt ttwo (d_to_t o))).
...
Axiom div_two_def :
  forall (o:d_frac), ((div_two o) = (dyadic (num o) ((den o) + 1%Z)%Z)).
...
Parameter phase_inv: d_frac -> d_frac.

Axiom phase_inv_def :
  forall (o:d_frac), ((phase_inv o) = (dyadic (-(num o))%Z (den o))).
...
Parameter phase_inv_: Z -> d_frac -> d_frac.
...
Axiom d_omega10 : ((d_omega (dyadic 1%Z 0%Z)) = tone).

Axiom cos11 : ((d_cos (dyadic 1%Z 1%Z)) = (prefix_mndt tone)).

Axiom sin11 : ((d_sin (dyadic 1%Z 1%Z)) = tzero).

Axiom d_omega11 : ((d_omega (dyadic 1%Z 1%Z)) = (prefix_mndt tone)).
...
Theorem VC_cos0n :
  ((cos
    (infix_asdt (infix_asdt ttwo pi)
     (infix_sldt (i_to_t 0%Z) (i_to_t (power 2%Z n)))))
   = (prefix_mndt tone)).
Proof.
