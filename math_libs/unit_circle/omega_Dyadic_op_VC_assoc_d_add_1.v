...
Axiom d_add_spec :
  forall (d1:d_frac) (d2:d_frac),
  ((d_to_t (d_add d1 d2)) = (infix_pldt (d_to_t d1) (d_to_t d2))).
...
(* Why3 assumption *)
Definition d_add_i (k1:Z) (k2:Z) (n1:Z) (n2:Z) : d_frac :=
  d_add (dyadic k1 n1) (dyadic k2 n2).

Axiom d_add_i_spec :
  forall (k1:Z) (k2:Z) (n1:Z) (n2:Z),
  ((d_to_t (d_add_i k1 k2 n1 n2)) =
...
Axiom d_omega_zero_eq :
  forall (k1:Z) (k2:Z) (n1:Z) (n2:Z), (k1 = 0%Z) -> (k2 = 0%Z) ->
  ((d_omega (dyadic k1 n1)) = (d_omega (dyadic k2 n2))).
...
Axiom d_frac_simpl :
  ...
  infix_eqeq1 (dyadic (k * (power 2%Z n1))%Z (n2 + n1)%Z) (dyadic k n2).
...
Axiom H1 :
  infix_eqeq1 (d_add d1 d2)
  (dyadic
   (((num d1) *
     (power 2%Z ((max3 (den d1) (den d2) (den d3)) - (den d1))%Z))%Z
    +
    ((num d2) *
     (power 2%Z ((max3 (den d1) (den d2) (den d3)) - (den d2))%Z))%Z)%Z
   (max3 (den d1) (den d2) (den d3))).

Axiom H2 :
  infix_eqeq1 (d_add d2 d3)
  (dyadic
   (((num d2) *
     (power 2%Z ((max3 (den d1) (den d2) (den d3)) - (den d2))%Z))%Z
    +
    ((num d3) *
     (power 2%Z ((max3 (den d1) (den d2) (den d3)) - (den d3))%Z))%Z)%Z
   (max3 (den d1) (den d2) (den d3))).

Axiom H3 :
  infix_eqeq1 (d_add (d_add d1 d2) d3)
  (dyadic
   ((((num d1) *
      (power 2%Z ((max3 (den d1) (den d2) (den d3)) - (den d1))%Z))%Z
     +
...
(* Why3 goal *)
Theorem VC_assoc_d_add :
  infix_eqeq1 (d_add d1 (d_add d2 d3))
  (dyadic
   ((((num d1) *
      (power 2%Z ((max3 (den d1) (den d2) (den d3)) - (den d1))%Z))%Z
     +
