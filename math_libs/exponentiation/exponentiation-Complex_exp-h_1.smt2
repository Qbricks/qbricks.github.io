...
(declare-fun t2tb12 ((Array t Bool)) uni)

;; t2tb_sort
  (assert
  (forall ((x (Array t Bool))) (sort (infix_mngt t1 bool) (t2tb12 x))))

(declare-fun tb2t12 (uni) (Array t Bool))
...
;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (infix_mngt t1 bool) j) (= (t2tb12 (tb2t12 j)) j)) :pattern (
  (t2tb12 (tb2t12 j))) )))

(declare-fun t2tb13 ((Array t (Array t Bool))) uni)

;; t2tb_sort
  (assert
  (forall ((x (Array t (Array t Bool)))) (sort
  (infix_mngt t1 (infix_mngt t1 bool)) (t2tb13 x))))

(declare-fun tb2t13 (uni) (Array t (Array t Bool)))
...
;; infix <=._closure_def
  ...
  (= (tb2t
     (infix_at bool t1
     (infix_at (infix_mngt t1 bool) t1 (t2tb13 infix_lseqdt_closure)
     (t2tb5 y)) (t2tb5 y1))) true)
  (infix_lseqdt y y1))))
...
;; transitive_infeq_t
  ...
  (transitive t1 (t2tb13 infix_lseqdt_closure))))
...
;; infix <._closure_def
  ...
  (= (tb2t
     (infix_at bool t1
     (infix_at (infix_mngt t1 bool) t1 (t2tb13 infix_lsdt_closure) (t2tb5 y))
     (t2tb5 y1))) true)
  (infix_lsdt y y1))))
...
;; Cpower_one
  (assert (forall ((i t)) (= (cpower i 1) i)))
...
;; inv_cpower
  (assert (forall ((e t) (i Int)) (= (inv1 (cpower e i)) (cpower e (- i)))))
...
(declare-fun fc50 () (Array t (Array Int t)))

(declare-fun t2tb14 ((Array t (Array Int t))) uni)

;; t2tb_sort
  (assert
  (forall ((x (Array t (Array Int t)))) (sort
  (infix_mngt t1 (infix_mngt int t1)) (t2tb14 x))))

(declare-fun tb2t14 (uni) (Array t (Array Int t)))
...
;; fc_def
  ...
  (= (tb2t5
     (infix_at t1 int
     (infix_at (infix_mngt int t1) t1 (t2tb14 fc50) (t2tb5 y0)) (t2tb1 y1))) y0)))
...
;; cpower_iterate
  ...
  (=> (<= 0 i)
  (= (cpower e i) (tb2t5
                  (int_iterate t1 (t2tb6 infix_asdt_closure)
                  (infix_at (infix_mngt int t1) t1 (t2tb14 fc50) (t2tb5 e)) 0
                  i))))))
...
;; pre_cond_int
  (assert
  (and (compat_order_mult t1 (t2tb13 infix_lsdt_closure)
  (t2tb6 infix_asdt_closure) (t2tb5 tzero))
  (and (compat_order_mult t1 (t2tb13 infix_lseqdt_closure)
  (t2tb6 infix_asdt_closure) (t2tb5 tzero))
  (and (infix_lsdt tzero tone)
  (and (partial_order t1 (t2tb13 infix_lseqdt_closure))
  (and (neutral t1 (t2tb6 infix_asdt_closure) (t2tb5 tone))
  (and (iterable t1 (t2tb6 infix_asdt_closure)) (strict t1
  (t2tb13 infix_lsdt_closure) (t2tb13 infix_lseqdt_closure)))))))))
...
;; exp_eq
  (assert (forall ((t11 t) (t2 t)) (=> (= t11 t2) (= (exp t11) (exp t2)))))
