...
(declare-fun t2tb3 ((matrix t)) uni)

;; t2tb_sort
  (assert (forall ((x (matrix t))) (sort (matrix1 t1) (t2tb3 x))))

(declare-fun tb2t3 (uni) (matrix t))

;; BridgeL
  (assert
  (forall ((i (matrix t))) (! (= (tb2t3 (t2tb3 i)) i) :pattern ((t2tb3 i)) )))

;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (matrix1 t1) j) (= (t2tb3 (tb2t3 j)) j)) :pattern ((t2tb3
                                                                  (tb2t3 j))) )))
...
(declare-fun t2tb5 ((Array Int (Array Int t))) uni)

;; t2tb_sort
  (assert
  (forall ((x (Array Int (Array Int t)))) (sort
  (infix_mngt int (infix_mngt int t1)) (t2tb5 x))))

(declare-fun tb2t5 (uni) (Array Int (Array Int t)))
...
(declare-fun t2tb6 ((Array Int t)) uni)

;; t2tb_sort
  (assert (forall ((x (Array Int t))) (sort (infix_mngt int t1) (t2tb6 x))))

(declare-fun tb2t6 (uni) (Array Int t))
...
;; BridgeR
  (assert
  (forall ((j uni))
  (! (=> (sort (infix_mngt int t1) j) (= (t2tb6 (tb2t6 j)) j)) :pattern (
  (t2tb6 (tb2t6 j))) )))
...
;; result_def
  ...
  (= (tb2t4
     (infix_at t1 int
     (infix_at (infix_mngt int t1) int (t2tb5 (result s m)) (t2tb2 i))
     (t2tb2 j))) (infix_asdt s (tb2t4 (get t1 (t2tb3 m) i j))))))

;; infix *.._def
  (assert
  (forall ((s t) (m (matrix t)))
  (= (infix_asdtdt s m) (tb2t3
                        (make_f t1 (rows t1 (t2tb3 m)) (columns t1 (t2tb3 m))
                        (t2tb5 (result s m)))))))
...
;; infix *.._spec
  ...
  (= (tb2t4 (get t1 (t2tb3 (infix_asdtdt s m)) i j)) (infix_asdt s
                                                     (tb2t4
                                                     (get t1 (t2tb3 m) i j))))))
  (forall ((i Int) (j Int))
