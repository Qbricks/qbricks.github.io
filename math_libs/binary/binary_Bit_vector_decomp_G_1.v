...
Axiom teq_def1 : forall (x:t) (y:t), (infix_eqeq x y) -> teq x y.
...
Axiom r_to_t_add_rev :
  forall (i:R) (j:R),
  ((r_to_t (infix_plas i j)) = (infix_pldt (r_to_t i) (r_to_t j))).
...
Axiom r_to_t_mult_rev :
  forall (i:R) (j:R),
  ((r_to_t (infix_asas i j)) = (infix_asdt (r_to_t i) (r_to_t j))).
...
Axiom real__def1 : forall (x:t), (infix_eqeq (im_part x) 0%R) -> real_ x.
...
Axiom pure_im__def1 :
  forall (x:t), (infix_eqeq (real_part x) 0%R) -> pure_im_ x.
...
Axiom infix_lseqdt_def :
  forall (x:t) (y:t), (infix_lseqdt x y) -> (real_ x) \/ (infix_eqeq x y).

Axiom infix_lseqdt_def1 :
  forall (x:t) (y:t), (infix_lseqdt x y) -> (real_ y) \/ (infix_eqeq x y).
...
Axiom infix_lseqdt_def4 :
  forall (x:t) (y:t), (infix_eqeq x y) -> infix_lseqdt x y.

Parameter infix_lsdt: t -> t -> Prop.

Axiom infix_lsdt_def :
  forall (x:t) (y:t), (infix_lsdt x y) -> infix_lseqdt x y.

Axiom infix_lsdt_def1 :
  forall (x:t) (y:t), (infix_lsdt x y) -> ~ (infix_eqeq x y).

Axiom infix_lsdt_def2 :
  forall (x:t) (y:t), ((infix_lseqdt x y) /\ ~ (infix_eqeq x y)) ->
  infix_lsdt x y.
...
Axiom infix_gteqdt_def1 :
  forall (x:t) (y:t), (infix_lseqdt y x) -> infix_gteqdt x y.

Parameter infix_gtdt: t -> t -> Prop.

Axiom infix_gtdt_def :
  forall (x:t) (y:t), (infix_gtdt x y) -> infix_gteqdt x y.

Axiom infix_gtdt_def1 :
  forall (x:t) (y:t), (infix_gtdt x y) -> ~ (infix_eqeq x y).

Axiom infix_gtdt_def2 :
  forall (x:t) (y:t), ((infix_gteqdt x y) /\ ~ (infix_eqeq x y)) ->
  infix_gtdt x y.
...
Axiom supeq_elim_left :
  forall (a:t) (b:t), (real_ a) -> (real_ b) -> (infix_gteqdt a b) ->
...
Axiom iproduct_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (t1:a -> Z),
  ((iproduct s t1) = (iterate (fun (y0:Z) (y1:Z) => (y0 * y1)%Z) s t1)).
...
Axiom indic_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:a) (a':a), (infix_eqeq a1 a') -> ((indic a1 a') = tone).

Axiom indic_def1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:a) (a':a), ~ (infix_eqeq a1 a') -> ((indic a1 a') = tzero).
...
Axiom bool_to_t_def : forall (a:bool), (a = true) -> ((bool_to_t a) = tone).

Axiom bool_to_t_def1 :
  forall (a:bool), ~ (a = true) -> ((bool_to_t a) = tzero).
...
Axiom mapz_pre_spec1 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e:bitvec), (mem e (mapz_pre n s)) -> (((getbv e) 0%Z) = 0%Z).
...
Axiom mapz_pre_spec4 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e:bitvec), ((length e) = n) -> (((getbv e) 0%Z) = 0%Z) ->
  mem e (mapz_pre n s).
...
Axiom mapo_pre_spec1 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e:bitvec), (mem e (mapo_pre n s)) -> (((getbv e) 0%Z) = 1%Z).
...
Axiom mapo_pre_spec4 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e:bitvec), ((length e) = n) -> (((getbv e) 0%Z) = 1%Z) ->
  mem e (mapo_pre n s).
...
Parameter empty_bv: unit -> bitvec.

Axiom empty_bv_def :
  forall (us:unit), ((empty_bv us) = (make_bv (fun (us1:Z) => 0%Z) 0%Z)).

Axiom empty_bv_spec : forall (us:unit), ((length (empty_bv us)) = 0%Z).

Axiom empty_bv_spec1 :
...
Axiom n_bvsz_spec2 :
  forall (us:unit), ((n_bvsz us) = (to_set (empty_bv tt))).
...
Parameter f: bitvec -> matrix t.

Axiom H : (0%Z < n)%Z.

Axiom H1 : constant_size (n_bvs n) f.

Axiom H2 : (n = 1%Z).

(* Why3 goal *)
Theorem G :
  mem (choose (to_set (make_bv (fun (us:Z) => 1%Z) 1%Z)))
  (to_set (make_bv (fun (us:Z) => 1%Z) 1%Z)).
Proof.
