...
Axiom instantiate_mat :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (m:Z -> Z -> b) (f:a -> Z) (g:a -> Z) (a1:a),
  (valid_index m (f a1) (g a1)) ->
  (((fun (k:a) => ((m (f k)) (g k))) a1) = ((m (f a1)) (g a1))).
...
Axiom instantiate_k_th_left :
  forall (m:Z -> Z -> t) (i:Z) (j:Z) (l:Z) (a:Z) (f:Z -> Z),
  (((fun (k:Z) => ((m (k_th_left i l k f)) (k_th_left j l k f))) a) =
   ((m (k_th_left i l a f)) (k_th_left j l a f))).

Axiom instantiate_k_th_left_comp :
  forall (m:Z -> Z -> t) (i:Z) (j:Z) (l:Z) (a:Z) (t1:Z -> Z) (f:Z -> Z)
    (g:Z -> Z),
  (((fun (k:Z) => ((m (k_th_left i l (t1 k) f)) (k_th_left j l (t1 k) g))) a)
   = ((m (k_th_left i l (t1 a) f)) (k_th_left j l (t1 a) g))).
