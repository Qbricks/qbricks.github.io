...
Axiom instantiate_mat :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (m:Z -> Z -> b) (f2:a -> Z) (g:a -> Z) (a1:a),
  (valid_index m (f2 a1) (g a1)) ->
  ((((((fun (m1:Z -> Z -> b) (f3:a -> Z) (g1:a -> Z) (k:a) =>
        ((m1 (f3 k)) (g1 k)))
       m)
      f2)
     g)
...
Axiom Hinst :
  (valid_index m
   ...
   ((fun (k1:Z) =>
    ...
    k)) ->
  ((((((fun (m1:Z -> Z -> t) (f2:Z -> Z) (g:Z -> Z) (k1:Z) =>
        ((m1 (f2 k1)) (g k1)))
       m)
      fun (k1:Z) =>
      (k_th_left i 0%Z ((n - k1)%Z + 1%Z)%Z
...
Theorem G :
  (((fun (k1:Z) =>
   ...
   =
   ((m
     (k_th_left i (0%Z + 1%Z)%Z (n - k)%Z
      ((fun (y0:Z -> Z -> Z -> t) (y1:Z) => (frows y0 y1))
       ((fun (y0:Z -> Z -> t) (y1:Z) => y0) m))))
    (k_th_left j (0%Z + 1%Z)%Z (n - k)%Z
     ((fun (y0:Z -> Z -> Z -> t) (y1:Z) => (fcolumns y0 y1))
      ((fun (y0:Z -> Z -> t) (y1:Z) => y0) m))))).
Proof.
