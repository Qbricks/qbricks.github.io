...
(* Why3 assumption *)
Definition o : Z -> Z -> Z -> t := (fun (y0:Z -> Z -> t) (y1:Z) => y0) m.

Axiom H1 :
  ((rows (k_iter o 0%Z n)) =
   (ind_iproduct ((fun (y0:Z -> Z -> Z -> t) (y1:Z) => (frows y0 y1)) o) 0%Z
    n)).

Axiom H2 :
  ((columns (k_iter o 0%Z n)) =
   (ind_iproduct ((fun (y0:Z -> Z -> Z -> t) (y1:Z) => (fcolumns y0 y1)) o)
    0%Z n)).

Axiom H3 : ((rows (k_iter o 0%Z n)) = (power (rows m) n)).
...
(* Why3 goal *)
Theorem G :
  ((((fun (y0:Z -> Z -> Z -> t) (y1:Z) => (fcolumns y0 y1)) o) k) =
   (((fun (y0:Z) (y1:Z) => y0) (columns m)) k)).
Proof.
