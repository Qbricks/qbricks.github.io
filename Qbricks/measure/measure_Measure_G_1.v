...
Axiom compat_order_add_left :
  forall (x:complex) (y:complex) (z:complex), (infix_lseqdt x y) ->
  (real_ x) -> (real_ y) -> (real_ z) ->
  infix_lseqdt (infix_pldt z x) (infix_pldt z y).
...
Axiom compat_order_add_both :
  ...
  (real_ z) -> (real_ t) -> infix_lseqdt (infix_pldt z x) (infix_pldt t y).
...
Axiom modulus_real_minus_bound :
  forall (a:complex) (b:complex) (c:complex), (real_ a) -> (real_ b) ->
  (real_ c) -> (infix_lseqdt c_zero a) -> (infix_lseqdt c_zero b) ->
  (infix_lseqdt c_zero c) -> (infix_lseqdt (modulus (infix_mn a b)) c) ->
  (infix_lseqdt (infix_mndt a c) b) /\ (infix_lseqdt b (infix_pldt a c)).
...
Axiom mult_distr_add_l_rev :
  forall (a:complex) (b:complex) (c:complex),
  ((infix_pldt (infix_asdt b a) (infix_asdt c a)) =
   (infix_asdt (infix_pldt b c) a)).
...
Axiom sum_partition :
  forall {b:Type} {b_WT:WhyType b},
  forall (s:set b) (s':set b) (f:b -> complex),
  (forall (e:b), (mem e s) -> ~ (mem e s')) ->
  ((sum (union s s') f) = (infix_pldt (sum s f) (sum s' f))).
...
Axiom get_mod :
  forall (j:Z) (q:Z) (r:Z), (0%Z < j)%Z -> ((0%Z <= r)%Z /\ (r < j)%Z) ->
  ((int.EuclideanDivision.mod1 ((q * j)%Z + r)%Z j) = r).
...
Axiom i_to_c_sub_rev :
  forall (i:Z) (j:Z),
  ((i_to_c (i - j)%Z) = (infix_mndt (i_to_c i) (i_to_c j))).
...
Axiom compat_i_to_c_inf_rev :
  forall (a:Z) (b:Z), (infix_lsdt (i_to_c a) (i_to_c b)) -> (a < b)%Z.
...
Axiom sum_inf :
  ...
  (forall (e:a), (mem e s) -> real_ (t e)) ->
  (forall (e:a), (mem e s) -> real_ (t' e)) ->
  (forall (e:a), (mem e s) -> infix_lseqdt (t e) (t' e)) ->
  infix_lseqdt (sum s t) (sum s t').
...
Axiom proba_measure_spec :
  forall (x:matrix complex) (i:Z) (n:Z), (is_a_ket_l x n) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  (real_ (proba_measure x i n)) /\
  ((infix_lseqdt c_zero (proba_measure x i n)) /\
   ((proba_measure x i n) = (cpower (modulus (get x i 0%Z)) 2%Z))).

Parameter proba_measure_extension: (matrix complex) -> Z -> Z -> complex.

Axiom proba_measure_extension_def :
  forall (x:matrix complex) (n:Z) (i:Z), (is_a_ket_l x n) ->
  (((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
   ((proba_measure_extension x n i) = (proba_measure x i n))) /\
  (~ ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
   ((proba_measure_extension x n i) = c_one)).

Axiom proba_measure_extension_spec :
  forall (x:matrix complex) (n:Z) (i:Z), (is_a_ket_l x n) ->
  (real_ (proba_measure_extension x n i)) /\
  ((infix_lseqdt c_zero (proba_measure_extension x n i)) /\
   ((((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
     ((proba_measure_extension x n i) = (proba_measure x i n))) /\
    (((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
     ((proba_measure_extension x n i) = (cpower (modulus (get x i 0%Z)) 2%Z))))).

Axiom proba_measure_sum_from_extension :
  forall (x:matrix complex) (s:set Z) (n:Z), (is_a_ket_l x n) ->
  (forall (i:Z), (mem i s) -> (0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((sum s (fun (i:Z) => (proba_measure x i n))) =
   (sum s
    (((fun (y0:matrix complex) (y1:Z) (y2:Z) =>
       (proba_measure_extension y0 y1 y2))
      x)
     n))).

Axiom proba_measure_sum_to_extension :
  forall (x:matrix complex) (s:set Z) (n:Z), (is_a_ket_l x n) ->
  (forall (i:Z), (mem i s) -> (0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((sum s
    (((fun (y0:matrix complex) (y1:Z) (y2:Z) =>
...
Axiom positive_proba_measure :
  forall (x:matrix complex) (i:Z) (n:Z), (is_a_ket_l x n) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  infix_lseqdt c_zero (proba_measure x i n).

Axiom proba_measure_scal :
  forall (x:matrix complex) (i:Z) (n:Z) (scal:complex), (is_a_ket_l x n) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) -> (real_ scal) ->
  ((proba_measure (infix_asdtdt scal x) i n) =
   (infix_asdt (cpower scal 2%Z) (proba_measure x i n))).

Axiom proba_measure_add_ket_l_null_right :
  forall (x:matrix complex) (x':matrix complex) (i:Z) (n:Z),
  (is_a_ket_l x n) -> ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  (is_a_ket_l x' n) -> ((get x' i 0%Z) = c_zero) ->
  ((proba_measure (add_ket_l x x' n) i n) = (proba_measure x i n)).

Axiom proba_measure_add_ket_l_null_left :
  forall (x:matrix complex) (x':matrix complex) (i:Z) (n:Z),
  (is_a_ket_l x n) -> ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  (is_a_ket_l x' n) -> ((get x' i 0%Z) = c_zero) ->
  ((proba_measure (add_ket_l x' x n) i n) = (proba_measure x i n)).
...
Axiom proba_measure_cond_spec :
  forall (x:matrix complex) (n:Z) (p:Z -> bool), (is_a_ket_l x n) ->
  (real_ (proba_measure_cond x n p)) /\
  ((proba_measure_cond x n p) =
   (sum (my_filter (to_fset 0%Z (power_ 2%Z n)) p)
...
Parameter f: Z -> Z -> complex.

Parameter g: Z -> Z.

Parameter g': Z -> Z.

Parameter scal: complex.

Axiom H : is_a_ket_l x n.
...
Axiom H9 : (y < (power_ 2%Z n'))%Z.

Axiom H10 :
  forall (e:Z), ((0%Z <= e)%Z /\ (e < (power_ 2%Z n'))%Z) ->
  (0%Z <= (g' e))%Z /\ ((g' e) < (power_ 2%Z n1))%Z.

Axiom H11 :
  forall (e:Z), ((0%Z <= e)%Z /\ (e < k)%Z) ->
  (0%Z <= (g e))%Z /\ ((g e) < (power_ 2%Z n'))%Z.

Axiom H12 : real_ scal.
      ...
      (ket_sum_l (n_bvs n')
       (fun (j1:bitvec) =>
        (infix_asdtdt ((f (bv_to_int i1)) (bv_to_int j1))
         (kronecker (ket n' (bv_to_int j1)) (ket n1 (g' (bv_to_int i1))))))
       n))
     n))).

Axiom H14 :
  forall (e:Z) (e':Z), ((0%Z <= e)%Z /\ (e < k)%Z) ->
  ((0%Z <= e')%Z /\ (e' < k)%Z) -> ~ (e = e') -> ~ ((g e) = (g e')).

Axiom H15 :
  forall (l:Z), ((0%Z <= l)%Z /\ (l < k)%Z) -> ((g' (g l)) = (g' i)).

Axiom H16 :
  forall (j:Z), ((0%Z <= j)%Z /\ (j < (power_ 2%Z n1))%Z) ->
  ((g' j) = (g' i)) ->
  exists ind:Z, ((0%Z <= ind)%Z /\ (ind < k)%Z) /\ ((g ind) = j).
   ...
   (ket_sum_l (to_fset 0%Z (power_ 2%Z n'))
    (fun (i1:Z) =>
     ((fun (i11:bitvec) =>
       (ket_sum_l (n_bvs n')
        (fun (j1:bitvec) =>
         (infix_asdtdt ((f (bv_to_int i11)) (bv_to_int j1))
          (kronecker (ket n' (bv_to_int j1)) (ket n1 (g' (bv_to_int i11))))))
        n))
      (int_to_bv i1 n')))
    n)).
...
Axiom H18 :
  (0%Z < (power_ 2%Z n'))%Z ->
  ((cardinal (to_fset 0%Z (power_ 2%Z n'))) = ((power_ 2%Z n') - 0%Z)%Z).

Axiom H19 :
  ((power_ 2%Z n') <= 0%Z)%Z -> is_empty (to_fset 0%Z (power_ 2%Z n')).

Axiom H20 :
  forall (k1:Z),
  (mem k1 (to_fset 0%Z (power_ 2%Z n'))) <->
  ((0%Z <= k1)%Z /\ (k1 < (power_ 2%Z n'))%Z).

Parameter o: Z -> bool.

Parameter o1: Z -> bool.

Axiom o_def : forall (j:Z), ((o j) = true) <-> ~ ((g' j) = (g' i)).

Axiom o_def1 : forall (j:Z), ((o1 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H21 :
  forall (e:Z), (mem e (to_fset 0%Z (power_ 2%Z n'))) ->
  ((o e) = true) <-> (mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o1)).

Parameter o2: Z -> bool.

Axiom o_def2 : forall (j:Z), ((o2 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H22 :
  forall (e:Z), (mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o2)) ->
  mem e (to_fset 0%Z (power_ 2%Z n')).

Parameter o3: Z -> bool.

Axiom o_def3 : forall (j:Z), ((o3 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H23 :
  (0%Z <= (cardinal (my_filter (to_fset 0%Z (power_ 2%Z n')) o3)))%Z.

Parameter o4: Z -> bool.

Axiom o_def4 : forall (j:Z), ((o4 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H24 :
  ((cardinal (my_filter (to_fset 0%Z (power_ 2%Z n')) o4)) <=
   (cardinal (to_fset 0%Z (power_ 2%Z n'))))%Z.
...
Axiom o_def5 : forall (j:Z), ((o5 j) = true) <-> ((g' j) = (g' i)).

Axiom o_def6 : forall (j:Z), ((o6 j) = true) <-> ((g' j) = (g' i)).

Axiom H28 :
  forall (e:Z), (mem e (to_fset 0%Z (power_ 2%Z n'))) ->
  ((o5 e) = true) <-> (mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o6)).

Parameter o7: Z -> bool.

Axiom o_def7 : forall (j:Z), ((o7 j) = true) <-> ((g' j) = (g' i)).

Axiom H29 :
  forall (e:Z), (mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o7)) ->
  mem e (to_fset 0%Z (power_ 2%Z n')).

Parameter o8: Z -> bool.

Axiom o_def8 : forall (j:Z), ((o8 j) = true) <-> ((g' j) = (g' i)).

Axiom H30 :
  (0%Z <= (cardinal (my_filter (to_fset 0%Z (power_ 2%Z n')) o8)))%Z.

Parameter o9: Z -> bool.

Axiom o_def9 : forall (j:Z), ((o9 j) = true) <-> ((g' j) = (g' i)).

Axiom H31 :
  ((cardinal (my_filter (to_fset 0%Z (power_ 2%Z n')) o9)) <=
   (cardinal (to_fset 0%Z (power_ 2%Z n'))))%Z.

Parameter o10: Z -> bool.

Parameter o11: Z -> bool.

Axiom o_def10 : forall (j:Z), ((o10 j) = true) <-> ((g' j) = (g' i)).

Axiom o_def11 : forall (j:Z), ((o11 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H32 :
  is_empty
  (inter (my_filter (to_fset 0%Z (power_ 2%Z n')) o10)
   (my_filter (to_fset 0%Z (power_ 2%Z n')) o11)).
...
Parameter o12: Z -> bool.

Parameter o13: Z -> bool.

Axiom o_def12 : forall (j:Z), ((o12 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom o_def13 : forall (j:Z), ((o13 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H36 :
  forall (e:Z), (mem e (to_fset 0%Z (power_ 2%Z n'))) ->
  ((o12 e) = true) <-> (mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o13)).

Parameter o14: Z -> bool.

Axiom o_def14 : forall (j:Z), ((o14 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H37 :
  forall (e:Z), (mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o14)) ->
  mem e (to_fset 0%Z (power_ 2%Z n')).

Parameter o15: Z -> bool.

Axiom o_def15 : forall (j:Z), ((o15 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H38 :
  (0%Z <= (cardinal (my_filter (to_fset 0%Z (power_ 2%Z n')) o15)))%Z.

Parameter o16: Z -> bool.

Axiom o_def16 : forall (j:Z), ((o16 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H39 :
  ((cardinal (my_filter (to_fset 0%Z (power_ 2%Z n')) o16)) <=
   (cardinal (to_fset 0%Z (power_ 2%Z n'))))%Z.
...
Parameter o17: Z -> bool.

Parameter o18: Z -> bool.

Axiom o_def17 : forall (j:Z), ((o17 j) = true) <-> ((g' j) = (g' i)).

Axiom o_def18 : forall (j:Z), ((o18 j) = true) <-> ((g' j) = (g' i)).

Axiom H43 :
  forall (e:Z), (mem e (to_fset 0%Z (power_ 2%Z n'))) ->
  ((o17 e) = true) <-> (mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o18)).

Parameter o19: Z -> bool.

Axiom o_def19 : forall (j:Z), ((o19 j) = true) <-> ((g' j) = (g' i)).

Axiom H44 :
  forall (e:Z), (mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o19)) ->
  mem e (to_fset 0%Z (power_ 2%Z n')).

Parameter o20: Z -> bool.

Axiom o_def20 : forall (j:Z), ((o20 j) = true) <-> ((g' j) = (g' i)).

Axiom H45 :
  (0%Z <= (cardinal (my_filter (to_fset 0%Z (power_ 2%Z n')) o20)))%Z.

Parameter o21: Z -> bool.

Axiom o_def21 : forall (j:Z), ((o21 j) = true) <-> ((g' j) = (g' i)).

Axiom H46 :
  ((cardinal (my_filter (to_fset 0%Z (power_ 2%Z n')) o21)) <=
   (cardinal (to_fset 0%Z (power_ 2%Z n'))))%Z.
...
Parameter o22: Z -> bool.

Parameter o23: Z -> bool.

Axiom o_def22 : forall (j:Z), ((o22 j) = true) <-> ((g' j) = (g' i)).

Axiom o_def23 : forall (j:Z), ((o23 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H50 :
  ((ket_sum_l (to_fset 0%Z (power_ 2%Z n'))
    (fun (x1:Z) =>
     let o24 := int_to_bv x1 n' in
     ket_sum_l (n_bvs n')
     (fun (j1:bitvec) =>
      (infix_asdtdt ((f (bv_to_int o24)) (bv_to_int j1))
       (kronecker (ket n' (bv_to_int j1)) (ket n1 (g' (bv_to_int o24))))))
     n)
    n)
   =
   (add_ket_l
    (ket_sum_l (my_filter (to_fset 0%Z (power_ 2%Z n')) o22)
     (fun (x1:Z) =>
      let o24 := int_to_bv x1 n' in
      ket_sum_l (n_bvs n')
      (fun (j1:bitvec) =>
      ...
      n)
     n)
    (ket_sum_l (my_filter (to_fset 0%Z (power_ 2%Z n')) o23)
     (fun (x1:Z) =>
      let o24 := int_to_bv x1 n' in
      ket_sum_l (n_bvs n')
      (fun (j1:bitvec) =>
...
Parameter o24: Z -> bool.

Parameter o25: Z -> bool.

Axiom o_def24 : forall (j:Z), ((o24 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom o_def25 : forall (j:Z), ((o25 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H54 :
  forall (e:Z), (mem e (to_fset 0%Z (power_ 2%Z n'))) ->
  ((o24 e) = true) <-> (mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o25)).

Parameter o26: Z -> bool.

Axiom o_def26 : forall (j:Z), ((o26 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H55 :
  forall (e:Z), (mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o26)) ->
  mem e (to_fset 0%Z (power_ 2%Z n')).

Parameter o27: Z -> bool.

Axiom o_def27 : forall (j:Z), ((o27 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H56 :
  (0%Z <= (cardinal (my_filter (to_fset 0%Z (power_ 2%Z n')) o27)))%Z.

Parameter o28: Z -> bool.

Axiom o_def28 : forall (j:Z), ((o28 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H57 :
  ((cardinal (my_filter (to_fset 0%Z (power_ 2%Z n')) o28)) <=
   (cardinal (to_fset 0%Z (power_ 2%Z n'))))%Z.

Parameter e: Z.

Parameter o29: Z -> bool.

Axiom o_def29 : forall (j:Z), ((o29 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom H58 : mem e (my_filter (to_fset 0%Z (power_ 2%Z n')) o29).

Parameter e1: bitvec.

Axiom H59 : mem e1 (n_bvs n').

Parameter fc11: Z -> bool.

Axiom fc_def11 : forall (j:Z), ((fc11 j) = true) <-> ~ ((g' j) = (g' i)).

Axiom h : ((fc11 e) = true).

(* Why3 goal *)
Theorem G : (0%Z <= (g' e))%Z /\ ((g' e) < (power_ 2%Z n1))%Z.
Proof.
