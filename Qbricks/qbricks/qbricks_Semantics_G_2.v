...
Axiom makes_bv_def :
  forall (f:Z -> Z) (s:Z), (0%Z <= s)%Z ->
  ((makes_bv f s) = (make_bv (result7 f) s)).
...
Axiom ket_sum_comp_l :
  ...
  (0%Z <= l)%Z -> (forall (e:b), (mem e s) -> is_a_ket_l (f e) l) ->
...
Axiom ket_l_ket_sum_scalar :
  ...
  (0%Z <= l)%Z -> (forall (e:a), (mem e s) -> is_a_ket_l (f e) l) ->
  (l = n) -> is_a_ket_l (infix_asdtdt a1 (ket_sum_l s f l)) n.
...
Axiom scal_ket_sum_scalar_l :
  ...
  (forall (e:a), (mem e s) ->
   exists a1:complex,
   exists k:matrix complex, ((f e) = (infix_asdtdt a1 k)) /\ (is_a_ket_l k l)) ->
...
Axiom ket_sum_bitvec_one :
  ...
  (forall (x:bitvec), ((length x) = 1%Z) -> is_a_ket_l (f x) l) ->
...
Axiom pps_phase_spec3 :
  ...
  (~ (0%Z <= k)%Z ->
   ((((h_angle (pps_phase k)) x) y) = (int_to_ang 1%Z (-k)%Z))).
...
Axiom pps_rz_spec3 :
  ...
  (~ ((x 0%Z) = 0%Z) ->
   ...
   (~ (0%Z <= k)%Z ->
    ((((h_angle (pps_rz k)) x) y) = (int_to_ang 1%Z (-k)%Z)))).
...
Axiom pps_phase_apply_basis :
  ...
  (~ (0%Z <= k)%Z ->
   ((pps_apply_basis (pps_phase k) x) =
    (infix_asdtdt (ang_exp (int_to_ang 1%Z (-k)%Z)) (bv_to_ket x)))).
...
(* Why3 assumption *)
Definition width (c:circuit) : Z := h_width (circ_to_pps c).
...
(* Why3 assumption *)
Definition range (c:circuit) : Z := h_range (circ_to_pps c).

Axiom range_spec : forall (c:circuit), (0%Z <= (range c))%Z.

(* Why3 assumption *)
Definition basis_ket (c:circuit) (x:Z -> Z) (y:Z -> Z) (i:Z) : Z :=
...
(* Why3 assumption *)
Definition ang_ind (c:circuit) (x:Z -> Z) (y:Z -> Z) : angle :=
...
Parameter result22: circuit -> (matrix complex) -> bitvec -> matrix complex.

Axiom result_def22 :
  forall (c:circuit) (x:matrix complex) (y:bitvec),
  (((length y) = (width c)) ->
   (((result22 c x) y) =
    (infix_asdtdt (get x (bv_to_int y) 0%Z) (path_sem_basis c (bv_to_ket y))))) /\
  (~ ((length y) = (width c)) -> (((result22 c x) y) = x)).

Axiom path_sem_def :
  forall (c:circuit) (x:matrix complex), (is_a_ket_l x (width c)) ->
  ((path_sem c x) = (ket_sum_l (n_bvs (width c)) (result22 c x) (width c))).
...
Axiom path_sem_basis_ket_l :
  ...
  (l = (width c)) -> (is_a_ket_basis_elt x) ->
...
Axiom path_sem_to_ket_l :
  ...
  (is_a_ket_l x (width c)) -> ((path_sem c x) = y) -> is_a_ket_l y (width c).
...
Parameter mat_sem: circuit -> matrix complex.

Axiom mat_sem_spec :
  forall (c:circuit), ((columns (mat_sem c)) = (power_ 2%Z (width c))).

Axiom mat_sem_spec1 :
  forall (c:circuit), ((rows (mat_sem c)) = (power_ 2%Z (width c))).
...
Axiom path_sem_comp_basis :
  ...
  ((width d) = (width e)) ->
  ((path_sem_basis (sequence d e) x) = (path_sem e (path_sem_basis d x))).
...
Axiom path_sem_kron_basis :
  ...
  ((path_sem_basis (parallel d e) (kronecker x y)) =
   (kronecker (path_sem_basis d x) (path_sem_basis e y))).
...
Axiom ancilla_g_def :
  ...
  (forall (x:matrix complex), (is_a_ket_l x ((width c) - 1%Z)%Z) ->
   ((path_sem c (kronecker x (ket 1%Z 0%Z))) =
    (kronecker (path_sem_target x) (ket 1%Z 0%Z)))) ->
  ((ancilla_g c path_sem_target) = (ancilla c)).
...
Axiom ancilla_g_spec5 :
  ...
  (forall (x:matrix complex), (is_a_ket_l x ((width c) - 1%Z)%Z) ->
   ((path_sem c (kronecker x (ket 1%Z 0%Z))) =
    (kronecker (path_sem_target x) (ket 1%Z 0%Z)))) ->
  forall (x:Z -> Z) (y:Z -> Z),
  ((ang_ind (ancilla_g c path_sem_target) x y) = (ang_ind c (fc23 c x) y)).
...
Axiom mat_sem_ancilla :
  forall (c:circuit), (1%Z <= (width c))%Z ->
  forall (mat_sem_target:matrix complex),
  (forall (x:matrix complex), (is_a_ket_l x ((width c) - 1%Z)%Z) ->
   ((mat_mult (mat_sem c) (kronecker x (ket 1%Z 0%Z))) =
    (kronecker (mat_mult mat_sem_target x) (ket 1%Z 0%Z)))) ->
  ((mat_sem (ancilla c)) = mat_sem_target).

Parameter sem_id_mat: matrix complex.

Axiom sem_id_mat_def : ((rows sem_id_mat) = (power_ 2%Z 1%Z)).

Axiom sem_id_mat_def1 : ((columns sem_id_mat) = (power_ 2%Z 1%Z)).

Axiom sem_id_mat_def2 :
  forall (x:bitvec), ((length x) = 1%Z) ->
  ((mat_mult sem_id_mat (bv_to_ket x)) = (bv_to_ket x)).

Parameter result23: Z -> Z -> Z -> complex.

Axiom result_def23 :
  forall (k:Z) (i:Z) (j:Z),
  ((i = j) ->
   ((i = 0%Z) -> ((((result23 k) i) j) = c_one)) /\
   (~ (i = 0%Z) ->
    ((0%Z <= k)%Z -> ((((result23 k) i) j) = (ang_exp (int_to_ang 1%Z k)))) /\
    (~ (0%Z <= k)%Z ->
     ((((result23 k) i) j) = (ang_exp (int_to_ang 1%Z (-k)%Z)))))) /\
  (~ (i = j) -> ((((result23 k) i) j) = c_zero)).

(* Why3 assumption *)
Definition sem_rz_mat (k:Z) : matrix complex := make_f 2%Z 2%Z (result23 k).

Axiom sem_rz_mat_spec :
  forall (k:Z), ((rows (sem_rz_mat k)) = (power_ 2%Z 1%Z)).

Axiom sem_rz_mat_spec1 :
  forall (k:Z), ((columns (sem_rz_mat k)) = (power_ 2%Z 1%Z)).

Axiom sem_rz_mat_spec2 :
  forall (k:Z), (0%Z <= k)%Z -> forall (x:bitvec), ((length x) = 1%Z) ->
  (((bv_to_int x) = 0%Z) ->
   ((mat_mult (sem_rz_mat k) (bv_to_ket x)) = (bv_to_ket x))) /\
  (~ ((bv_to_int x) = 0%Z) ->
   ((mat_mult (sem_rz_mat k) (bv_to_ket x)) =
    (infix_asdtdt (ang_exp (int_to_ang 1%Z k)) (bv_to_ket x)))).

Axiom sem_rz_mat_spec3 :
  forall (k:Z), (k <= 0%Z)%Z -> forall (x:bitvec), ((length x) = 1%Z) ->
  (((bv_to_int x) = 0%Z) ->
   ((mat_mult (sem_rz_mat k) (bv_to_ket x)) = (bv_to_ket x))) /\
  (~ ((bv_to_int x) = 0%Z) ->
   ((mat_mult (sem_rz_mat k) (bv_to_ket x)) =
...
Axiom sem_rz_mat_spec4 :
  forall (k:Z), forall (x:bitvec), ((length x) = 1%Z) ->
  ((mat_mult (sem_rz_mat k) (bv_to_ket x)) = (path_sem (rz k) (bv_to_ket x))).

Parameter result24: Z -> Z -> Z -> complex.

Axiom result_def24 :
  forall (k:Z) (i:Z) (j:Z),
  ((i = j) ->
   ((0%Z <= k)%Z -> ((((result24 k) i) j) = (ang_exp (int_to_ang 1%Z k)))) /\
   (~ (0%Z <= k)%Z ->
    ((((result24 k) i) j) = (ang_exp (int_to_ang 1%Z (-k)%Z))))) /\
  (~ (i = j) -> ((((result24 k) i) j) = c_zero)).

(* Why3 assumption *)
Definition sem_phase_mat (k:Z) : matrix complex :=
  make_f 2%Z 2%Z (result24 k).

Axiom sem_phase_mat_spec :
  forall (k:Z), ((rows (sem_phase_mat k)) = (power_ 2%Z 1%Z)).

Axiom sem_phase_mat_spec1 :
  forall (k:Z), ((columns (sem_phase_mat k)) = (power_ 2%Z 1%Z)).

Axiom sem_phase_mat_spec2 :
  forall (k:Z), (0%Z <= k)%Z -> forall (x:bitvec), ((length x) = 1%Z) ->
  ((mat_mult (sem_phase_mat k) (bv_to_ket x)) =
   (infix_asdtdt (ang_exp (int_to_ang 1%Z k)) (bv_to_ket x))).

Axiom sem_phase_mat_spec3 :
  forall (k:Z), (k <= 0%Z)%Z -> forall (x:bitvec), ((length x) = 1%Z) ->
  ((mat_mult (sem_phase_mat k) (bv_to_ket x)) =
   (infix_asdtdt (ang_exp (int_to_ang 1%Z (-k)%Z)) (bv_to_ket x))).

Axiom sem_phase_mat_spec4 :
  forall (k:Z), forall (x:bitvec), ((length x) = 1%Z) ->
  ((mat_mult (sem_phase_mat k) (bv_to_ket x)) =
   (path_sem (phase k) (bv_to_ket x))).

Parameter sem_hadamard_mat: matrix complex.

Axiom sem_hadamard_mat_def : ((rows sem_hadamard_mat) = (power_ 2%Z 1%Z)).

Axiom sem_hadamard_mat_def1 :
  ((columns sem_hadamard_mat) = (power_ 2%Z 1%Z)).

Axiom sem_hadamard_mat_def2 :
  ((mat_mult sem_hadamard_mat (ket 1%Z 0%Z)) =
   (infix_asdtdt (pow_inv_sqrt_2 1%Z)
    (add_ket_l (ket 1%Z 0%Z) (ket 1%Z 1%Z) 1%Z))).

Axiom sem_hadamard_mat_def3 :
  ((mat_mult sem_hadamard_mat (ket 1%Z 1%Z)) =
   (infix_asdtdt (pow_inv_sqrt_2 1%Z)
    (add_ket_l (ket 1%Z 0%Z) (infix_asdtdt (prefix_mndt c_one) (ket 1%Z 1%Z))
     1%Z))).

Axiom sem_hadamard_mat_def4 :
  forall (x:bitvec), ((length x) = 1%Z) ->
  ((mat_mult sem_hadamard_mat (bv_to_ket x)) =
   (path_sem hadamard (bv_to_ket x))).

Parameter cnot_func: bitvec -> bitvec.

Axiom cnot_func_def :
  forall (x:bitvec), ((length x) = 2%Z) -> (((value x) 0%Z) = 0%Z) ->
  ((cnot_func x) = x).

Parameter result25: bitvec -> Z -> Z.

Axiom result_def25 :
  forall (x:bitvec) (i:Z),
  ((i = 0%Z) -> (((result25 x) i) = ((value x) i))) /\
  (~ (i = 0%Z) -> (((result25 x) i) = (1%Z - ((value x) i))%Z)).

Axiom cnot_func_def1 :
  forall (x:bitvec), ((length x) = 2%Z) -> ~ (((value x) 0%Z) = 0%Z) ->
  ((cnot_func x) = (make_bv (result25 x) 2%Z)).

Axiom cnot_func_spec :
  forall (x:bitvec), ((length x) = 2%Z) -> ((length (cnot_func x)) = 2%Z).

Axiom cnot_func_spec1 :
  forall (x:bitvec), ((length x) = 2%Z) -> ((bv_to_int x) = 0%Z) ->
  ((cnot_func x) = (int_to_bv 0%Z 2%Z)).

Axiom cnot_func_spec2 :
  forall (x:bitvec), ((length x) = 2%Z) -> ((bv_to_int x) = 1%Z) ->
  ((cnot_func x) = (int_to_bv 1%Z 2%Z)).

Axiom cnot_func_spec3 :
  forall (x:bitvec), ((length x) = 2%Z) -> ((bv_to_int x) = 2%Z) ->
  ((cnot_func x) = (int_to_bv 3%Z 2%Z)).

Axiom cnot_func_spec4 :
  forall (x:bitvec), ((length x) = 2%Z) -> ((bv_to_int x) = 3%Z) ->
  ((cnot_func x) = (int_to_bv 2%Z 2%Z)).

Axiom invol_cnot_func :
  forall (x:bitvec), ((length x) = 2%Z) -> ((cnot_func (cnot_func x)) = x).

(* Why3 assumption *)
Definition cnot_func_int (i:Z) : Z :=
  bv_to_int (cnot_func (int_to_bv i 2%Z)).

Axiom cnot_func_int_spec : forall (i:Z), (0%Z <= (cnot_func_int i))%Z.

Axiom cnot_func_int_spec1 : forall (i:Z), ((cnot_func_int i) < 4%Z)%Z.

Axiom cnot_func_int_spec2 :
  forall (i:Z), (i = 0%Z) -> ((cnot_func_int i) = 0%Z).

Axiom cnot_func_int_spec3 :
  forall (i:Z), (i = 1%Z) -> ((cnot_func_int i) = 1%Z).

Axiom cnot_func_int_spec4 :
  forall (i:Z), (i = 2%Z) -> ((cnot_func_int i) = 3%Z).

Axiom cnot_func_int_spec5 :
  forall (i:Z), (i = 3%Z) -> ((cnot_func_int i) = 2%Z).

Axiom cnot_func_int_spec6 :
  forall (i:Z), ((0%Z <= i)%Z /\ (i < 4%Z)%Z) ->
  (((int.EuclideanDivision.div i 2%Z) = 0%Z) -> ((cnot_func_int i) = i)) /\
  (~ ((int.EuclideanDivision.div i 2%Z) = 0%Z) ->
   ((cnot_func_int i) = (3%Z - (int.EuclideanDivision.mod1 i 2%Z))%Z)).

Axiom invol_cnot_func_int :
  forall (i:Z), ((0%Z <= i)%Z /\ (i < 4%Z)%Z) ->
  ((cnot_func_int (cnot_func_int i)) = i).

Parameter result26: Z -> Z -> complex.

Axiom result_def26 :
  forall (i:Z) (j:Z),
  ((j = (cnot_func_int i)) -> (((result26 i) j) = c_one)) /\
  (~ (j = (cnot_func_int i)) -> (((result26 i) j) = c_zero)).

(* Why3 assumption *)
Definition sem_cnot_mat (us:unit) : matrix complex :=
  make_f 4%Z 4%Z result26.

Axiom sem_cnot_mat_spec :
  forall (us:unit), ((rows (sem_cnot_mat us)) = (power_ 2%Z 2%Z)).

Axiom sem_cnot_mat_spec1 :
  forall (us:unit), ((columns (sem_cnot_mat us)) = (power_ 2%Z 2%Z)).

Parameter fc24: Z -> Z -> complex.

Axiom fc_def24 :
  forall (i:Z) (j:Z),
  (((((int.EuclideanDivision.div i 2%Z) = 0%Z) /\ (j = i)) \/
    (~ ((int.EuclideanDivision.div i 2%Z) = 0%Z) /\
     (j = (3%Z - (int.EuclideanDivision.mod1 i 2%Z))%Z))) ->
   (((fc24 i) j) = c_one)) /\
  (~ ((((int.EuclideanDivision.div i 2%Z) = 0%Z) -> (j = i)) /\
      (~ ((int.EuclideanDivision.div i 2%Z) = 0%Z) ->
       (j = (3%Z - (int.EuclideanDivision.mod1 i 2%Z))%Z))) ->
...
Axiom sem_cnot_mat_spec2 :
  forall (us:unit), ((sem_cnot_mat us) = (make_f 4%Z 4%Z fc24)).

Axiom sem_cnot_mat_spec3 :
  forall (us:unit), forall (x:bitvec), ((length x) = 2%Z) ->
  ((((value x) 0%Z) = 0%Z) ->
   ((mat_mult (sem_cnot_mat us) (bv_to_ket x)) = (bv_to_ket x))) /\
  (~ (((value x) 0%Z) = 0%Z) ->
   (((bv_to_int x) = 2%Z) ->
    ((mat_mult (sem_cnot_mat us) (bv_to_ket x)) =
     (bv_to_ket (int_to_bv 3%Z 2%Z)))) /\
   (~ ((bv_to_int x) = 2%Z) ->
    ((mat_mult (sem_cnot_mat us) (bv_to_ket x)) =
     (bv_to_ket (int_to_bv 2%Z 2%Z))))).

Parameter fc25: bitvec -> Z -> Z.

Axiom fc_def25 :
  forall (x:bitvec) (i:Z),
  ((i = 0%Z) -> (((fc25 x) i) = ((value x) i))) /\
  (~ (i = 0%Z) -> (((fc25 x) i) = (1%Z - ((value x) i))%Z)).

Axiom sem_cnot_mat_spec4 :
  forall (us:unit), forall (x:bitvec), ((length x) = 2%Z) ->
  ((((value x) 0%Z) = 0%Z) ->
   ((mat_mult (sem_cnot_mat us) (bv_to_ket x)) = (bv_to_ket x))) /\
  (~ (((value x) 0%Z) = 0%Z) ->
   ((mat_mult (sem_cnot_mat us) (bv_to_ket x)) =
    (bv_to_ket (make_bv (fc25 x) 2%Z)))).

Axiom sem_cnot_mat_spec5 :
  forall (us:unit), forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z 2%Z))%Z) ->
  ((i = 0%Z) -> ((mat_mult (sem_cnot_mat us) (ket 2%Z i)) = (ket 2%Z 0%Z))) /\
  (~ (i = 0%Z) ->
   ((i = 1%Z) -> ((mat_mult (sem_cnot_mat us) (ket 2%Z i)) = (ket 2%Z 1%Z))) /\
   (~ (i = 1%Z) ->
    ((i = 2%Z) -> ((mat_mult (sem_cnot_mat us) (ket 2%Z i)) = (ket 2%Z 3%Z))) /\
    (~ (i = 2%Z) ->
     ((mat_mult (sem_cnot_mat us) (ket 2%Z i)) = (ket 2%Z 2%Z))))).

Axiom sem_cnot_mat_spec6 :
  forall (us:unit), forall (x:bitvec), ((length x) = 2%Z) ->
  ((mat_mult (sem_cnot_mat us) (bv_to_ket x)) = (bv_to_ket (cnot_func x))).

Axiom sem_cnot_mat_spec7 :
  forall (us:unit), forall (x:bitvec), ((length x) = 2%Z) ->
  ((mat_mult (sem_cnot_mat us) (bv_to_ket x)) =
   (path_sem cnot (bv_to_ket x))).

Parameter swap_func: bitvec -> bitvec.

Axiom swap_func_def :
  forall (x:bitvec), ((length x) = 2%Z) ->
  ((swap_func x) = (make_bv (fun (i:Z) => ((value x) (1%Z - i)%Z)) 2%Z)).

Axiom swap_func_spec :
  forall (x:bitvec), ((length x) = 2%Z) -> ((length (swap_func x)) = 2%Z).

Axiom swap_func_spec1 :
  forall (x:bitvec), ((length x) = 2%Z) -> ((bv_to_int x) = 0%Z) ->
  ((swap_func x) = (int_to_bv 0%Z 2%Z)).

Axiom swap_func_spec2 :
  forall (x:bitvec), ((length x) = 2%Z) -> ((bv_to_int x) = 1%Z) ->
  ((swap_func x) = (int_to_bv 2%Z 2%Z)).

Axiom swap_func_spec3 :
  forall (x:bitvec), ((length x) = 2%Z) -> ((bv_to_int x) = 2%Z) ->
  ((swap_func x) = (int_to_bv 1%Z 2%Z)).

Axiom swap_func_spec4 :
  forall (x:bitvec), ((length x) = 2%Z) -> ((bv_to_int x) = 3%Z) ->
  ((swap_func x) = (int_to_bv 3%Z 2%Z)).

Axiom invol_swap_func :
  forall (x:bitvec), ((length x) = 2%Z) -> ((swap_func (swap_func x)) = x).

(* Why3 assumption *)
Definition swap_func_int (i:Z) : Z :=
  bv_to_int (swap_func (int_to_bv i 2%Z)).

Axiom swap_func_int_spec : forall (i:Z), (0%Z <= (swap_func_int i))%Z.

Axiom swap_func_int_spec1 : forall (i:Z), ((swap_func_int i) < 4%Z)%Z.

Axiom swap_func_int_spec2 :
  forall (i:Z), (i = 0%Z) -> ((swap_func_int i) = 0%Z).

Axiom swap_func_int_spec3 :
  forall (i:Z), (i = 1%Z) -> ((swap_func_int i) = 2%Z).

Axiom swap_func_int_spec4 :
  forall (i:Z), (i = 2%Z) -> ((swap_func_int i) = 1%Z).

Axiom swap_func_int_spec5 :
  forall (i:Z), (i = 3%Z) -> ((swap_func_int i) = 3%Z).

Axiom swap_func_int_spec6 :
  forall (i:Z), ((0%Z <= i)%Z /\ (i < 4%Z)%Z) ->
  (((int.EuclideanDivision.div i 2%Z) = (int.EuclideanDivision.mod1 i 2%Z)) ->
   ((swap_func_int i) = i)) /\
  (~ ((int.EuclideanDivision.div i 2%Z) = (int.EuclideanDivision.mod1 i 2%Z)) ->
   ((swap_func_int i) = (3%Z - i)%Z)).
...
(* Why3 assumption *)
Definition sem_swap_mat (us:unit) : matrix complex :=
  make_f 4%Z 4%Z (fun (i:Z) (j:Z) => (indic j (swap_func_int i))).

Axiom sem_swap_mat_spec :
  forall (us:unit), ((rows (sem_swap_mat us)) = (power_ 2%Z 2%Z)).

Axiom sem_swap_mat_spec1 :
  forall (us:unit), ((columns (sem_swap_mat us)) = (power_ 2%Z 2%Z)).

Parameter fc26: Z -> Z -> complex.

Axiom fc_def26 :
  forall (i:Z) (j:Z),
  ((i = 0%Z) -> (((fc26 i) j) = (indic j i))) /\
  (~ (i = 0%Z) ->
   ((i = 1%Z) -> (((fc26 i) j) = (indic j 2%Z))) /\
   (~ (i = 1%Z) ->
    ((i = 2%Z) -> (((fc26 i) j) = (indic j 1%Z))) /\
    (~ (i = 2%Z) -> (((fc26 i) j) = (indic j 3%Z))))).

Axiom sem_swap_mat_spec2 :
  forall (us:unit), ((sem_swap_mat us) = (make_f 4%Z 4%Z fc26)).

Axiom sem_swap_mat_spec3 :
  forall (us:unit), forall (x:bitvec), ((length x) = 2%Z) ->
  ((mat_mult (sem_swap_mat us) (bv_to_ket x)) =
   (bv_to_ket (make_bv (fun (i:Z) => ((value x) (1%Z - i)%Z)) 2%Z))).

Axiom sem_swap_mat_spec4 :
  forall (us:unit), forall (x:bitvec), ((length x) = 2%Z) ->
  ((mat_mult (sem_swap_mat us) (bv_to_ket x)) = (bv_to_ket (swap_func x))).

Axiom sem_swap_mat_spec5 :
  forall (us:unit), forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z 2%Z))%Z) ->
  ((i = 0%Z) -> ((mat_mult (sem_swap_mat us) (ket 2%Z i)) = (ket 2%Z 0%Z))) /\
  (~ (i = 0%Z) ->
   ((i = 1%Z) -> ((mat_mult (sem_swap_mat us) (ket 2%Z i)) = (ket 2%Z 2%Z))) /\
   (~ (i = 1%Z) ->
    ((i = 2%Z) -> ((mat_mult (sem_swap_mat us) (ket 2%Z i)) = (ket 2%Z 1%Z))) /\
    (~ (i = 2%Z) ->
     ((mat_mult (sem_swap_mat us) (ket 2%Z i)) = (ket 2%Z 3%Z))))).

Axiom sem_swap_mat_spec6 :
  forall (us:unit), forall (x:bitvec), ((length x) = 2%Z) ->
  ((mat_mult (sem_swap_mat us) (bv_to_ket x)) =
   (path_sem swap (bv_to_ket x))).

Axiom mat_sem_identity : ((mat_sem id) = sem_id_mat).

Axiom mat_sem_rz : forall (k:Z), ((mat_sem (rz k)) = (sem_rz_mat k)).

Axiom mat_sem_phase :
  forall (k:Z), ((mat_sem (phase k)) = (sem_phase_mat k)).

Axiom mat_sem_hadamard : ((mat_sem hadamard) = sem_hadamard_mat).

Axiom mat_sem_cnot : ((mat_sem cnot) = (sem_cnot_mat tt)).

Axiom mat_sem_swap : ((mat_sem cnot) = (sem_swap_mat tt)).
...
Axiom mat_sem_anc :
  forall (c:circuit) (mat_sem_target:matrix complex), (2%Z <= (width c))%Z ->
  (forall (x:matrix complex), (is_a_ket_l x ((width c) - 1%Z)%Z) ->
   ((mat_mult (mat_sem c) (kronecker x (ket 1%Z 0%Z))) =
    (kronecker (mat_mult mat_sem_target x) (ket 1%Z 0%Z)))) ->
  ((mat_sem (ancilla c)) = mat_sem_target).
...
Axiom mat_sem_anc_ :
  forall (c:circuit) (mat_sem_target:matrix complex),
  ((rows mat_sem_target) = (power_ 2%Z ((width c) - 1%Z)%Z)) ->
  ((columns mat_sem_target) = (power_ 2%Z ((width c) - 1%Z)%Z)) ->
  (2%Z <= (width c))%Z ->
  (forall (x:matrix complex), (is_a_ket_l x ((width c) - 1%Z)%Z) ->
   (is_a_ket_basis_elt x) ->
   ((mat_mult (mat_sem c) (kronecker x (ket 1%Z 0%Z))) =
...
(* Why3 assumption *)
Definition correct_path_sum_basis (c:circuit) (h:pps) (x:bitvec) : Prop :=
  (((length x) = (h_width h)) /\ ((h_width h) = (width c))) /\
  ((mat_mult (mat_sem c) (bv_to_ket x)) = (pps_apply_basis h x)).

(* Why3 assumption *)
Definition correct_path_sum (c:circuit) (h:pps) : Prop :=
  ((h_width h) = (width c)) /\
  forall (x:matrix complex), (is_a_ket_l x (width c)) ->
...
Axiom get_correct_path_sum :
  forall (c:circuit) (h:pps) (x:matrix complex), ((h_width h) = (width c)) ->
  (is_a_ket_l x (width c)) -> (correct_path_sum c h) ->
  ((pps_apply h x) = (mat_mult (mat_sem c) x)).
...
Axiom hpart_ket_spec1 :
  forall (m:matrix complex) (i:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
  ((ket_length (hpart_ket m i)) = i).

Axiom hpart_ket_spec2 :
  forall (m:matrix complex) (i:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
...
Axiom tpart_ket_spec1 :
  forall (m:matrix complex) (i:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
  ((ket_length (tpart_ket m i)) = ((ket_length m) - i)%Z).

Axiom tpart_ket_spec2 :
  forall (m:matrix complex) (i:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
...
Axiom H : (2%Z <= (width c))%Z.

Axiom H1 : correct_path_sum c h.

Parameter path_sem_target: (matrix complex) -> matrix complex.
...
Axiom H3 : ((h_width h') = ((width c) - 1%Z)%Z).

Axiom H4 : ((h_range h') = (h_range h)).

Parameter fc27: (Z -> Z) -> Z -> Z.

Axiom fc_def27 :
  forall (x:Z -> Z) (k:Z),
  ((k = ((width c) - 1%Z)%Z) -> (((fc27 x) k) = 0%Z)) /\
  (~ (k = ((width c) - 1%Z)%Z) -> (((fc27 x) k) = (x k))).
...
Axiom H5 :
  ...
  (forall (j:Z), ((0%Z <= j)%Z /\ (j < (h_range h'))%Z) ->
   (0%Z <= (y j))%Z /\ ((y j) < 2%Z)%Z) ->
  (((((h_basis_ket h') x) y) i) = ((((h_basis_ket h) (fc27 x)) y) i)).

Parameter fc28: (Z -> Z) -> Z -> Z.

Axiom fc_def28 :
  forall (x:Z -> Z) (k:Z),
  ((k = ((width c) - 1%Z)%Z) -> (((fc28 x) k) = 0%Z)) /\
  (~ (k = ((width c) - 1%Z)%Z) -> (((fc28 x) k) = (x k))).

Axiom H6 :
  forall (x:Z -> Z) (y:Z -> Z),
  ((((h_angle h') x) y) = (((h_angle h) (fc28 x)) y)).

Parameter fc29: bitvec -> bitvec -> Z -> Z -> complex.

Axiom fc_def29 :
  forall (x:bitvec) (y:bitvec) (i:Z) (j:Z),
  (((i = (bv_to_int (h_basis_ket_bv h' x y))) /\ (j = (bv_to_int x))) ->
   ((((fc29 x y) i) j) = (ang_exp (h_angle_bv h' x y)))) /\
  (~ ((i = (bv_to_int (h_basis_ket_bv h' x y))) /\ (j = (bv_to_int x))) ->
   ((((fc29 x y) i) j) = c_zero)).
...
Parameter fc30: bitvec -> bitvec -> Z -> Z -> complex.

Axiom fc_def30 :
  forall (x:bitvec) (y:bitvec) (i:Z) (j:Z),
  (((i = (bv_to_int (h_basis_ket_bv h' x y))) /\ (j = (bv_to_int x))) ->
   ((((fc30 x y) i) j) = (ang_exp (h_angle_bv h' x y)))) /\
  (~ ((i = (bv_to_int (h_basis_ket_bv h' x y))) /\ (j = (bv_to_int x))) ->
   ((((fc30 x y) i) j) = c_zero)).
...
Axiom H9 : ((rows (pps_to_mat h')) = (power_ 2%Z (h_width h'))).

Axiom H10 : ((columns (pps_to_mat h')) = (power_ 2%Z (h_width h'))).
...
Axiom H13 : ((mat_sem (ancilla c)) = (pps_to_mat h')).

Parameter x: matrix complex.

Axiom H14 : is_a_ket_l x (width (ancilla c)).

Axiom H15 : is_a_ket_basis_elt x.

(* Why3 goal *)
Theorem G : ((h_width h') = (width (ancilla c))).
Proof.
