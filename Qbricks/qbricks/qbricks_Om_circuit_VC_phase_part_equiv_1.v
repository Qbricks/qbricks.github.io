...
Axiom equal_d_frac1 :
  forall (d:d_frac) (d':d_frac), ((value d) = (value d')) -> (d = d').
...
Axiom div_two_spec :
  forall (d:d_frac), ((cpower (value (div_two d)) 2%Z) = (value d)).

Axiom div_two_spec1 :
  forall (d:d_frac), forall (k:Z) (n:Z),
  ((0%Z <= k)%Z /\ (k < (power 2%Z n))%Z) -> (0%Z <= n)%Z ->
  (d = (dyadic k n)) -> ((div_two d) = (dyadic k (n + 1%Z)%Z)).
...
Axiom phase_inv_pre_def :
  forall (i:Z) (d:d_frac), (0%Z <= i)%Z -> (i = 0%Z) ->
  ((phase_inv_pre i d) = d).
...
Axiom phase_inv_pre_spec2 :
  forall (i:Z) (d:d_frac), (0%Z <= i)%Z -> forall (k:Z) (n:Z),
...
Axiom phase_inv_spec :
  forall (i:Z) (d:d_frac), ((int.EuclideanDivision.mod1 i 2%Z) = 0%Z) ->
  ((phase_inv i d) = d).

Axiom phase_inv_spec1 :
  forall (i:Z) (d:d_frac), ((int.EuclideanDivision.mod1 i 2%Z) = 1%Z) ->
  ((phase_inv i d) = (inv1 d)).

Axiom phase_inv_spec2 :
  forall (i:Z) (d:d_frac), forall (k:Z) (n:Z), (0%Z <= n)%Z ->
  (0%Z <= i)%Z -> (d = (dyadic k n)) ->
  ((phase_inv i d) = (dyadic ((power (-1%Z)%Z i) * k)%Z n)).

Axiom phase_inv_spec3 :
  forall (i:Z) (d:d_frac), forall (k:Z) (n:Z), (0%Z <= n)%Z -> (i < 0%Z)%Z ->
  (d = (dyadic k n)) ->
...
Inductive circuit_pre :=
  | Phase : d_frac -> circuit_pre
  | Rz : d_frac -> circuit_pre
...
(* Why3 assumption *)
Fixpoint depth_pre (c:circuit_pre) {struct c}: Z :=
  match c with
  | Cnot => 2%Z
...
Axiom depth_pre_spec : forall (c:circuit_pre), (1%Z <= (depth_pre c))%Z.
...
Parameter pre: circuit -> circuit_pre.

Axiom circuit'invariant : forall (self:circuit), build_correct (pre self).

Axiom injective_pre :
  forall (c:circuit) (c':circuit), ~ (c = c') -> ~ ((pre c) = (pre c')).

Parameter to_qc: circuit_pre -> circuit.
...
(* Why3 assumption *)
Definition depth (c:circuit) : Z := depth_pre (pre c).

Axiom depth_spec : forall (c:circuit), (0%Z < (depth c))%Z.

Parameter sum_range: circuit -> Z.

Axiom sum_range_def :
  forall (c:circuit), forall (x:d_frac), ((pre c) = (Phase x)) ->
  ((sum_range c) = 0%Z).

Axiom sum_range_def1 :
  forall (c:circuit), forall (x:d_frac), ((pre c) = (Rz x)) ->
  ((sum_range c) = 0%Z).

Axiom sum_range_def2 :
  forall (c:circuit), ((pre c) = Hadamard) -> ((sum_range c) = 1%Z).

Axiom sum_range_def3 :
  forall (c:circuit), ((pre c) = Cnot) -> ((sum_range c) = 0%Z).

Axiom sum_range_def4 :
  forall (c:circuit), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Sequence x x1)) ->
  ((sum_range c) = ((sum_range (to_qc x)) + (sum_range (to_qc x1)))%Z).

Axiom sum_range_def5 :
  forall (c:circuit), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Parallel x x1)) ->
  ((sum_range c) = ((sum_range (to_qc x)) + (sum_range (to_qc x1)))%Z).

Axiom sum_range_spec : forall (c:circuit), (0%Z <= (sum_range c))%Z.

Parameter ket_part: circuit -> (Z -> Z) -> (Z -> Z) -> Z -> Z.

Axiom ket_part_def :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), forall (x:d_frac),
  ((pre c) = (Phase x)) -> (i = 0%Z) -> ((ket_part c bvx bvy i) = (bvx i)).

Axiom ket_part_def1 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), forall (x:d_frac),
  ((pre c) = (Phase x)) -> ~ (i = 0%Z) -> ((ket_part c bvx bvy i) = 0%Z).

Axiom ket_part_def2 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), forall (x:d_frac),
  ((pre c) = (Rz x)) -> (i = 0%Z) -> ((ket_part c bvx bvy i) = (bvx i)).

Axiom ket_part_def3 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), forall (x:d_frac),
  ((pre c) = (Rz x)) -> ~ (i = 0%Z) -> ((ket_part c bvx bvy i) = 0%Z).

Axiom ket_part_def4 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), ((pre c) = Hadamard) ->
  (i = 0%Z) -> ((ket_part c bvx bvy i) = (bvy i)).

Axiom ket_part_def5 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), ((pre c) = Hadamard) ->
  ~ (i = 0%Z) -> ((ket_part c bvx bvy i) = 0%Z).

Axiom ket_part_def6 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), ((pre c) = Cnot) ->
  (i = 1%Z) ->
...
Axiom ket_part_def7 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), ((pre c) = Cnot) ->
  ~ (i = 1%Z) -> (i = 0%Z) -> ((ket_part c bvx bvy i) = (bvx i)).

Axiom ket_part_def8 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), ((pre c) = Cnot) ->
  ~ (i = 1%Z) -> ~ (i = 0%Z) -> ((ket_part c bvx bvy i) = 0%Z).

Axiom ket_part_def9 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z),
  forall (x:circuit_pre) (x1:circuit_pre), ((pre c) = (Sequence x x1)) ->
  ((ket_part c bvx bvy i) =
   (ket_part (to_qc x1)
...
Axiom ket_part_def10 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z),
  forall (x:circuit_pre) (x1:circuit_pre), ((pre c) = (Parallel x x1)) ->
  ((ket_part c bvx bvy i) =
   (concat_fun
    ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
        (ket_part y0 y1 y2 y3))
...
Axiom ket_part_spec :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), (binary bvx) ->
  (binary bvy) -> (0%Z <= (ket_part c bvx bvy i))%Z.

Axiom ket_part_spec1 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), (binary bvx) ->
  (binary bvy) -> ((ket_part c bvx bvy i) < 2%Z)%Z.

Axiom ket_part_spec2 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), (i < 0%Z)%Z ->
  ((ket_part c bvx bvy i) = 0%Z).

Axiom ket_part_spec3 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z) (i:Z), ((depth c) <= i)%Z ->
  ((ket_part c bvx bvy i) = 0%Z).

Axiom binary_ket_part :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z), (binary bvx) ->
  (binary bvy) ->
  binary
  ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      (ket_part y0 y1 y2 y3))
...
Parameter phase_part: circuit -> (Z -> Z) -> (Z -> Z) -> d_frac.

Axiom phase_part_def :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z), forall (x:d_frac),
  ((pre c) = (Phase x)) -> ((phase_part c bvx bvy) = x).

Axiom phase_part_def1 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z), forall (x:d_frac),
  ((pre c) = (Rz x)) ->
  ((phase_part c bvx bvy) = (phase_inv (1%Z - (bvx 0%Z))%Z x)).

Axiom phase_part_def2 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z), ((pre c) = Hadamard) ->
  ((phase_part c bvx bvy) = (dyadic ((bvx 0%Z) * (bvy 0%Z))%Z 1%Z)).

Axiom phase_part_def3 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z), ((pre c) = Cnot) ->
  ((phase_part c bvx bvy) = (dyadic 0%Z 0%Z)).

Axiom phase_part_def4 :
  forall (c:circuit) (bvx:Z -> Z) (bvy:Z -> Z),
  forall (x:circuit_pre) (x1:circuit_pre), ((pre c) = (Sequence x x1)) ->
  ((phase_part c bvx bvy) =
   (add1 (phase_part (to_qc x) bvx bvy)
    (phase_part (to_qc x1)
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
         (ket_part y0 y1 y2 y3))
        (to_qc x))
...
Parameter phase: d_frac -> circuit.

Axiom phase_spec : forall (o:d_frac), ((sum_range (phase o)) = 0%Z).

Axiom phase_spec1 : forall (o:d_frac), ((depth (phase o)) = 1%Z).

Axiom phase_spec2 :
  forall (o:d_frac), forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (depth (phase o)))%Z) ->
  ((ket_part (phase o) bvx bvy i) = (bvx i)).

Axiom phase_spec3 :
  forall (o:d_frac), forall (bvx:Z -> Z) (bvy:Z -> Z),
  ((phase_part (phase o) bvx bvy) = o).

Axiom phase_spec4 : forall (o:d_frac), ((pre (phase o)) = (Phase o)).

Parameter rz: d_frac -> circuit.

Axiom rz_spec : forall (o:d_frac), ((sum_range (rz o)) = 0%Z).

Axiom rz_spec1 : forall (o:d_frac), ((depth (rz o)) = 1%Z).

Axiom rz_spec2 :
  forall (o:d_frac), forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (depth (rz o)))%Z) ->
  ((ket_part (rz o) bvx bvy i) = (bvx i)).

Axiom rz_spec3 :
  forall (o:d_frac), forall (bvx:Z -> Z) (bvy:Z -> Z),
  ((phase_part (rz o) bvx bvy) = (phase_inv (1%Z - (bvx 0%Z))%Z o)).

Axiom rz_spec4 : forall (o:d_frac), ((pre (rz o)) = (Rz o)).

Parameter hadamard: unit -> circuit.

Axiom hadamard_spec : forall (us:unit), ((sum_range (hadamard us)) = 1%Z).

Axiom hadamard_spec1 : forall (us:unit), ((depth (hadamard us)) = 1%Z).

Axiom hadamard_spec2 :
  forall (us:unit), forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (depth (hadamard us)))%Z) ->
  ((ket_part (hadamard us) bvx bvy i) = (bvy i)).

Axiom hadamard_spec3 :
  forall (us:unit), forall (bvx:Z -> Z) (bvy:Z -> Z),
  ((phase_part (hadamard us) bvx bvy) =
   (dyadic ((bvx 0%Z) * (bvy 0%Z))%Z 1%Z)).

Axiom hadamard_spec4 : forall (us:unit), ((pre (hadamard us)) = Hadamard).

Parameter cnot: unit -> circuit.

Axiom cnot_spec : forall (us:unit), ((sum_range (cnot us)) = 0%Z).

Axiom cnot_spec1 : forall (us:unit), ((depth (cnot us)) = 2%Z).

Axiom cnot_spec2 :
  forall (us:unit), forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (depth (cnot us)))%Z) ->
  ((i = 1%Z) ->
   ((ket_part (cnot us) bvx bvy i) =
    (int.EuclideanDivision.mod1 ((bvx 0%Z) + (bvx 1%Z))%Z 2%Z))) /\
  (~ (i = 1%Z) -> ((ket_part (cnot us) bvx bvy i) = (bvx i))).

Axiom cnot_spec3 :
  forall (us:unit), forall (bvx:Z -> Z) (bvy:Z -> Z),
  ((phase_part (cnot us) bvx bvy) = (dyadic 0%Z 0%Z)).

Axiom cnot_spec4 : forall (us:unit), ((pre (cnot us)) = Cnot).
...
Axiom parallel_spec2 :
  forall (d:circuit) (e:circuit), forall (bvx:Z -> Z) (bvy:Z -> Z),
  forall (i:Z), ((0%Z <= i)%Z /\ (i < (depth (parallel d e)))%Z) ->
...
Axiom sequence_spec :
  forall (d:circuit) (e:circuit), ((depth d) = (depth e)) ->
...
Axiom sequence_spec2 :
  ...
  ((0%Z <= i)%Z /\ (i < (depth (sequence d e)))%Z) ->
  ((ket_part (sequence d e) bvx bvy i) =
   (ket_part e
    ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      bvx)
     bvy)
    (((fun (y0:Z -> Z) (y1:Z) (y2:Z) => (shift y0 y1 y2)) bvy) (sum_range d))
    i)).
...
Axiom rzp_def :
  forall (n:Z), (0%Z <= n)%Z ->
  ((rzp n) =
   (sequence (phase (dyadic 1%Z (n + 1%Z)%Z)) (rz (dyadic 1%Z (n + 1%Z)%Z)))).

Axiom rzp_spec : forall (n:Z), (0%Z <= n)%Z -> ((depth (rzp n)) = 1%Z).

Axiom rzp_spec1 : forall (n:Z), (0%Z <= n)%Z -> ((sum_range (rzp n)) = 0%Z).

Axiom rzp_spec2 :
  forall (n:Z), (0%Z <= n)%Z -> forall (bvx:Z -> Z) (bvy:Z -> Z),
  forall (i:Z), ((0%Z <= i)%Z /\ (i < (depth (rzp n)))%Z) ->
  ((ket_part (rzp n) bvx bvy i) = (bvx i)).

Axiom rzp_spec3 :
  forall (n:Z), (0%Z <= n)%Z -> forall (bvx:Z -> Z) (bvy:Z -> Z),
  (binary bvx) -> (binary bvy) ->
  ((phase_part (rzp n) bvx bvy) = (k_dyadic ((bvx 0%Z) * n)%Z)).

Parameter flat: circuit -> Prop.

Axiom flat_def :
  forall (c:circuit), forall (x:d_frac), ((pre c) = (Phase x)) -> flat c.

Axiom flat_def1 :
  forall (c:circuit), forall (x:d_frac), ((pre c) = (Rz x)) -> flat c.

Axiom flat_def2 : forall (c:circuit), ((pre c) = Hadamard) -> ~ (flat c).

Axiom flat_def3 : forall (c:circuit), ((pre c) = Cnot) -> flat c.

Axiom flat_def4 :
  forall (c:circuit), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Sequence x x1)) -> (flat c) -> flat (to_qc x).

Axiom flat_def5 :
  forall (c:circuit), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Sequence x x1)) -> (flat c) -> flat (to_qc x1).

Axiom flat_def6 :
  forall (c:circuit), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Sequence x x1)) -> ((flat (to_qc x)) /\ (flat (to_qc x1))) ->
  flat c.

Axiom flat_def7 :
  forall (c:circuit), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Parallel x x1)) -> (flat c) -> flat (to_qc x).

Axiom flat_def8 :
  forall (c:circuit), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Parallel x x1)) -> (flat c) -> flat (to_qc x1).

Axiom flat_def9 :
  forall (c:circuit), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Parallel x x1)) -> ((flat (to_qc x)) /\ (flat (to_qc x1))) ->
  flat c.

Axiom flat_spec : forall (c:circuit), (flat c) -> ((sum_range c) = 0%Z).

Axiom flat_spec1 : forall (c:circuit), ((sum_range c) = 0%Z) -> flat c.

Parameter flat_ket: circuit -> (Z -> Z) -> Z -> Z.

Axiom flat_ket_def :
  forall (c:circuit) (bvx:Z -> Z) (i:Z), (flat c) -> forall (x:d_frac),
  ((pre c) = (Phase x)) -> (i = 0%Z) -> ((flat_ket c bvx i) = (bvx i)).

Axiom flat_ket_def1 :
  forall (c:circuit) (bvx:Z -> Z) (i:Z), (flat c) -> forall (x:d_frac),
  ((pre c) = (Phase x)) -> ~ (i = 0%Z) -> ((flat_ket c bvx i) = 0%Z).

Axiom flat_ket_def2 :
  forall (c:circuit) (bvx:Z -> Z) (i:Z), (flat c) -> forall (x:d_frac),
  ((pre c) = (Rz x)) -> (i = 0%Z) -> ((flat_ket c bvx i) = (bvx i)).

Axiom flat_ket_def3 :
  forall (c:circuit) (bvx:Z -> Z) (i:Z), (flat c) -> forall (x:d_frac),
  ((pre c) = (Rz x)) -> ~ (i = 0%Z) -> ((flat_ket c bvx i) = 0%Z).

Axiom flat_ket_def4 :
  forall (c:circuit) (bvx:Z -> Z) (i:Z), (flat c) -> ((pre c) = Cnot) ->
  (i = 1%Z) ->
  ((flat_ket c bvx i) =
   (int.EuclideanDivision.mod1 ((bvx 0%Z) + (bvx 1%Z))%Z 2%Z)).
...
Axiom flat_ket_def5 :
  forall (c:circuit) (bvx:Z -> Z) (i:Z), (flat c) -> ((pre c) = Cnot) ->
  ~ (i = 1%Z) -> (i = 0%Z) -> ((flat_ket c bvx i) = (bvx i)).

Axiom flat_ket_def6 :
  forall (c:circuit) (bvx:Z -> Z) (i:Z), (flat c) -> ((pre c) = Cnot) ->
  ~ (i = 1%Z) -> ~ (i = 0%Z) -> ((flat_ket c bvx i) = 0%Z).

Axiom flat_ket_def7 :
  forall (c:circuit) (bvx:Z -> Z) (i:Z), (flat c) ->
  forall (x:circuit_pre) (x1:circuit_pre), ((pre c) = (Sequence x x1)) ->
  ((flat_ket c bvx i) =
   (flat_ket (to_qc x1)
    (((fun (y0:circuit) (y1:Z -> Z) (y2:Z) => (flat_ket y0 y1 y2)) (to_qc x))
     bvx)
    i)).
...
Axiom flat_ket_def8 :
  ...
  ((flat_ket c bvx i) =
   (concat_fun
    (((fun (y0:circuit) (y1:Z -> Z) (y2:Z) => (flat_ket y0 y1 y2)) (to_qc x))
     bvx)
    (((fun (y0:circuit) (y1:Z -> Z) (y2:Z) => (flat_ket y0 y1 y2))
      (to_qc x1))
     (((fun (y0:Z -> Z) (y1:Z) (y2:Z) => (shift y0 y1 y2)) bvx)
      (depth (to_qc x))))
    (depth (to_qc x)) i)).
...
Axiom flat_ket_def9 :
  forall (c:circuit) (bvx:Z -> Z) (i:Z), (flat c) -> ((pre c) = Hadamard) ->
  ((flat_ket c bvx i) = 0%Z).

Axiom flat_ket_spec :
  forall (c:circuit) (bvx:Z -> Z) (i:Z), (flat c) -> forall (bvy:Z -> Z),
  ((flat_ket c bvx i) = (ket_part c bvx bvy i)).

Parameter flat_phase: circuit -> (Z -> Z) -> d_frac.

Axiom flat_phase_def :
  forall (c:circuit) (bvx:Z -> Z), (flat c) -> forall (x:d_frac),
  ((pre c) = (Phase x)) -> ((flat_phase c bvx) = x).

Axiom flat_phase_def1 :
  forall (c:circuit) (bvx:Z -> Z), (flat c) -> forall (x:d_frac),
  ((pre c) = (Rz x)) ->
  ((flat_phase c bvx) = (phase_inv (1%Z - (bvx 0%Z))%Z x)).

Axiom flat_phase_def2 :
  forall (c:circuit) (bvx:Z -> Z), (flat c) -> ((pre c) = Cnot) ->
  ((flat_phase c bvx) = (dyadic 0%Z 0%Z)).

Axiom flat_phase_def3 :
  forall (c:circuit) (bvx:Z -> Z), (flat c) ->
  forall (x:circuit_pre) (x1:circuit_pre), ((pre c) = (Sequence x x1)) ->
  ((flat_phase c bvx) =
   (add1 (flat_phase (to_qc x) bvx)
    (flat_phase (to_qc x1)
     (((fun (y0:circuit) (y1:Z -> Z) (y2:Z) => (flat_ket y0 y1 y2))
       (to_qc x))
      bvx)))).

Axiom flat_phase_def4 :
  forall (c:circuit) (bvx:Z -> Z), (flat c) ->
  forall (x:circuit_pre) (x1:circuit_pre), ((pre c) = (Parallel x x1)) ->
  ((flat_phase c bvx) =
   (add1 (flat_phase (to_qc x) bvx)
...
Axiom flat_phase_def5 :
  forall (c:circuit) (bvx:Z -> Z), (flat c) -> ((pre c) = Hadamard) ->
  ((flat_phase c bvx) = (dyadic 0%Z 0%Z)).

Axiom flat_phase_spec :
  forall (c:circuit) (bvx:Z -> Z), (flat c) -> forall (bvy:Z -> Z),
  ((phase_part c bvx bvy) = (flat_phase c bvx)).

(* Why3 assumption *)
Definition d_sum1 (f:Z -> d_frac) (i:Z) (j:Z) : d_frac :=
  int_iterate (fun (y0:d_frac) (y1:d_frac) => (add1 y0 y1)) f i j.

Axiom pre_to_qc : forall (c:circuit), ((to_qc (pre c)) = c).

Axiom ket_part_equiv :
  forall (c:circuit) (bvx:Z -> Z) (bvx':Z -> Z) (bvy:Z -> Z) (bvy':Z -> Z),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < (depth c))%Z) -> ((bvx i) = (bvx' i))) ->
  (forall (j:Z), ((0%Z <= j)%Z /\ (j < (sum_range c))%Z) ->
   ((bvy j) = (bvy' j))) ->
  (((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
       (ket_part y0 y1 y2 y3))
      c)
...
(* Why3 goal *)
Theorem VC_phase_part_equiv :
  ((phase_inv (1%Z - (bvx 0%Z))%Z x) = (phase_inv (1%Z - (bvx' 0%Z))%Z x)).
Proof.
