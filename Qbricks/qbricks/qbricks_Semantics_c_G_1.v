...
Axiom t_modulus_eq :
  ...
  ((t_modulus x) = (t_modulus y)).

Axiom modulus_eq :
  forall (x:t) (y:t),
  (((real_part x) * (real_part x))%R = ((real_part y) * (real_part y))%R) ->
  (((im_part x) * (im_part x))%R = ((im_part y) * (im_part y))%R) ->
  ((modulus x) = (modulus y)).
...
(* Why3 assumption *)
Definition indic_bool {a:Type} {a_WT:WhyType a} (a1:a) (a':a) : bool :=
  match indic a1 a' with
  | tone1 => true
  | _ => false
  end.
...
Axiom cpower_modulus :
  ...
  ((t_modulus (cpower x n)) = (cpower (t_modulus x) n)).

Axiom cpower_modulus1 :
  forall (x:t) (n:Z), (0%Z <= n)%Z -> (0%Z < n)%Z ->
  (infix_lsdt (t_modulus x) tone) -> infix_lsdt (t_modulus (cpower x n)) tone.

Axiom cpower_modulus2 :
  forall (x:t) (n:Z), (0%Z <= n)%Z -> (0%Z < n)%Z ->
  ((t_modulus x) = tone) -> ((t_modulus (cpower x n)) = tone).

Axiom cpower_modulus3 :
  forall (x:t) (n:Z), (0%Z <= n)%Z -> (0%Z < n)%Z ->
  (infix_gtdt (t_modulus x) tone) -> infix_gtdt (t_modulus (cpower x n)) tone.

Axiom cpower_modulus4 :
  forall (x:t) (n:Z), (0%Z <= n)%Z -> (0%Z < n)%Z ->
  (infix_lsdt (t_modulus (cpower x n)) tone) -> infix_lsdt (t_modulus x) tone.

Axiom cpower_modulus5 :
  forall (x:t) (n:Z), (0%Z <= n)%Z -> (0%Z < n)%Z ->
  ((t_modulus (cpower x n)) = tone) -> ((t_modulus x) = tone).

Axiom cpower_modulus6 :
  forall (x:t) (n:Z), (0%Z <= n)%Z -> (0%Z < n)%Z ->
  (infix_gtdt (t_modulus (cpower x n)) tone) -> infix_gtdt (t_modulus x) tone.
...
Axiom bv_make_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:bitvec -> bitvec -> a) (size:Z) (range:Z), (0%Z <= size)%Z ->
  (0%Z <= range)%Z ->
  ((bv_make f size range) =
   (make_f (power 2%Z size) (power 2%Z range)
    (fun (i:Z) (j:Z) => ((f (int_to_bv i size)) (int_to_bv j range))))).

Axiom bv_make_spec :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:bitvec -> bitvec -> a) (size:Z) (range:Z), (0%Z <= size)%Z ->
  (0%Z <= range)%Z -> forall (x:bitvec) (y:bitvec), ((length x) = size) ->
  ((length y) = range) -> ((bv_get (bv_make f size range) x y) = ((f x) y)).

Axiom bv_make_spec1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:bitvec -> bitvec -> a) (size:Z) (range:Z), (0%Z <= size)%Z ->
  (0%Z <= range)%Z -> ((rows (bv_make f size range)) = (power 2%Z size)).

Axiom bv_make_spec2 :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:bitvec -> bitvec -> a) (size:Z) (range:Z), (0%Z <= size)%Z ->
  (0%Z <= range)%Z -> ((columns (bv_make f size range)) = (power 2%Z range)).
...
Axiom result_def11 :
  ...
  ((((length bv1) <= i)%Z /\ (i < ((length bv1) + (length bv2))%Z)%Z) ->
   (((result11 bv1 bv2) i) = ((value bv2) (i - (length bv1))%Z))) /\
  (~ (((length bv1) <= i)%Z /\ (i < ((length bv1) + (length bv2))%Z)%Z) ->
   (((result11 bv1 bv2) i) = ((value bv1) i))).

(* Why3 assumption *)
Definition concat (bv1:bitvec) (bv2:bitvec) : bitvec :=
  make_bv (result11 bv1 bv2) ((length bv1) + (length bv2))%Z.
...
Parameter fc8: Z -> Z -> Z -> Z -> (Z* Z)%type -> bool.
...
Axiom ind_basis_mat_spec3 :
  forall (i:Z) (j:Z) (r:Z) (c:Z), ((0%Z <= i)%Z /\ (i < r)%Z) ->
  ((0%Z <= j)%Z /\ (j < c)%Z) ->
  ((cardinal (filter (fc8 i j r c) (mat_indices (ind_basis_mat i j r c)))) =
   1%Z).
...
Parameter result12: Z -> Z -> (Z* Z)%type -> matrix t.
...
Parameter fc9: (matrix t) -> (Z* Z)%type -> bool.

Axiom fc_def9 :
  forall (m:matrix t) (x:(Z* Z)%type),
  (((fc9 m) x) = true) <-> ((get m (fir x) (sec x)) = tone).

Axiom basis_mat_spec6 :
  forall (r:Z) (c:Z), (0%Z < r)%Z -> (0%Z < c)%Z -> forall (m:matrix t),
  (mem m (basis_mat r c)) ->
  ((cardinal (filter (fc9 m) (mat_indices m))) = 1%Z).

Parameter basis_mat_indexes: (matrix t) -> (Z* Z)%type.

Parameter result13: (matrix t) -> (Z* Z)%type -> bool.
...
Axiom basis_mat_indexes_def :
  ...
  ((basis_mat_indexes m) = (element (filter (result13 m) (mat_indices m)))).
...
Parameter result14: (matrix t) -> (Z* Z)%type -> matrix t.
...
Parameter fc10: (matrix t) -> (Z* Z)%type -> matrix t.

Axiom fc_def10 :
  forall (m:matrix t) (o:(Z* Z)%type),
  ((valid_index m (fir o) (sec o)) ->
   (((fc10 m) o) = (basis_projection m (fir o) (sec o)))) /\
  (~ (valid_index m (fir o) (sec o)) -> (((fc10 m) o) = m)).

Axiom rewrite_basis_projections :
  forall (m:matrix t),
  ((basis_projections m) = (map (fc10 m) (to_indexes m))).
...
Axiom fc_def11 :
  ...
  ((mem a1 s) -> (((fc11 m s f) a1) = (mat_mult m (f a1)))) /\
  (~ (mem a1 s) -> (((fc11 m s f) a1) = m)).
...
Axiom product_mat_sum_r_pre :
  ...
  (0%Z < (cardinal s'))%Z ->
  ((mat_mult m (mat_sum s' f)) = (mat_sum s' (fc11 m s f))).
...
Parameter result16: (matrix t) -> Z -> matrix t.

Axiom result_def16 :
  forall (m:matrix t) (j:Z),
  ((mem j (to_fset 0%Z (power 2%Z (ket_length m)))) ->
   (((result16 m) j) = (ket_basis_projection m j))) /\
  (~ (mem j (to_fset 0%Z (power 2%Z (ket_length m)))) ->
   (((result16 m) j) = m)).
...
Axiom ket_basis_projections_def :
  ...
  ((ket_basis_projections m) =
   (map (result16 m) (to_fset 0%Z (power 2%Z (ket_length m))))).
...
Axiom make_k_spec :
  forall (f:bitvec -> bitvec -> bitvec) (size:Z) (range:Z),
  (0%Z <= size)%Z -> (0%Z <= range)%Z ->
  (forall (x:bitvec) (y:bitvec), ((length x) = size) ->
   ((length y) = range) -> ((length ((f x) y)) = size)) ->
  forall (x:bitvec) (y:bitvec), ((length x) = size) ->
  ((length y) = range) -> ((get_k (make_k f size range) x y) = ((f x) y)).
...
Axiom make_k_spec1 :
  ...
  (forall (x:bitvec) (y:bitvec), ((length x) = size) ->
   ((length y) = range) -> ((length ((f x) y)) = size)) ->
  ((size_k (make_k f size range)) = size).
...
Axiom make_k_spec2 :
  ...
  (forall (x:bitvec) (y:bitvec), ((length x) = size) ->
   ((length y) = range) -> ((length ((f x) y)) = size)) ->
  ((range_k (make_k f size range)) = range).
...
Axiom make_k_spec3 :
  ...
  (forall (x:bitvec) (y:bitvec), ((length x) = size) ->
   ((length y) = range) -> ((length ((f x) y)) = size)) ->
  ((mat_k (make_k f size range)) = (bv_make f size range)).
...
Parameter fc12: Z -> (Z -> Z) -> Z -> Z -> Z -> t.

Axiom fc_def12 :
  forall (n:Z) (f:Z -> Z) (i:Z) (j:Z) (k:Z),
  (((i <= k)%Z /\ (k < j)%Z) -> (((fc12 n f i j) k) = (p_omega n (f k)))) /\
  (~ ((i <= k)%Z /\ (k < j)%Z) -> (((fc12 n f i j) k) = tone)).

Axiom omega_ind_sum_to_prod :
  forall (n:Z) (f:Z -> Z) (i:Z) (j:Z), (0%Z <= n)%Z -> (0%Z <= n)%Z ->
  ((p_omega n (ind_isum f i j)) = (ind_product (fc12 n f i j) i j)).
...
Axiom Ang_mult :
  ...
  ((ang_mult_int (int_to_ang k n) i) = (int_to_ang (k * i)%Z n)).

Axiom Int_To_Ang_value :
  forall (k:Z) (n:Z), (0%Z <= n)%Z ->
  ((ang_exp (int_to_ang k n)) = (p_omega n k)).

Axiom Int_To_Ang_zero_n :
  forall (k:Z) (n:Z), (n = 0%Z) -> ((int_to_ang k n) = ang_zero).

Axiom Int_To_Ang_zero_k :
...
Axiom ang_sum_sum_eq :
  forall (f:Z -> Z -> angle) (g:Z -> Z -> angle) (i:Z) (j:Z) (i':Z) (j':Z)
    (k:Z) (l:Z) (k':Z) (l':Z),
  (i < j)%Z -> (k < l)%Z -> (i = i') -> (j = j') -> (k = k') -> (l = l') ->
  (forall (x:Z) (x':Z), ((i <= x)%Z /\ (x < j)%Z) ->
   ((k <= x')%Z /\ (x' < l)%Z) -> (((f x) x') = ((g x) x'))) ->
  ((ang_sum (fun (x:Z) => (ang_sum (f x) k l)) i j) =
   (ang_sum (fun (x:Z) => (ang_sum (g x) k' l')) i' j')).
...
Axiom make_a_spec :
  forall (f:bitvec -> bitvec -> angle) (size:Z) (range:Z), (0%Z <= size)%Z ->
  (0%Z <= range)%Z -> forall (x:bitvec) (y:bitvec), ((length x) = size) ->
  ((length y) = range) -> ((get_a (make_a f size range) x y) = ((f x) y)).

Axiom make_a_spec1 :
  forall (f:bitvec -> bitvec -> angle) (size:Z) (range:Z), (0%Z <= size)%Z ->
  (0%Z <= range)%Z -> forall (x:bitvec) (y:bitvec), ((length x) = size) ->
  ((length y) = range) ->
  ((get_ac (make_a f size range) x y) = (ang_exp ((f x) y))).

Axiom make_a_spec2 :
  forall (f:bitvec -> bitvec -> angle) (size:Z) (range:Z), (0%Z <= size)%Z ->
  (0%Z <= range)%Z -> ((size_a (make_a f size range)) = size).

Axiom make_a_spec3 :
  forall (f:bitvec -> bitvec -> angle) (size:Z) (range:Z), (0%Z <= size)%Z ->
  (0%Z <= range)%Z -> ((range_a (make_a f size range)) = range).
   ...
   (make_a
    (fun (x:bitvec) (y:bitvec) =>
     (ang_add (get_a a1 x (hpart y (range_a a1)))
      (get_a a2 (get_k k1 (hpart x (size_k k1)) (hpart y (range_a a1)))
       (tpart y (range_a a1)))))
...
Axiom a_seq_spec3 :
  ...
  ((get_ac (a_seq a1 a2 k1) x y) =
   (infix_asdt (get_ac a1 x (hpart y (range_a a1)))
    (get_ac a2 (get_k k1 (hpart x (size_k k1)) (hpart y (range_a a1)))
     (tpart y (range_a a1))))).
...
(* Why3 assumption *)
Inductive circuit_pre :=
  | Phase : angle -> circuit_pre
  | Rz : angle -> circuit_pre
  | Hadamard : circuit_pre
  | Cnot : circuit_pre
  | Sequence : circuit_pre -> circuit_pre -> circuit_pre
  | Parallel : circuit_pre -> circuit_pre -> circuit_pre.
Axiom circuit_pre_WhyType : WhyType circuit_pre.
Existing Instance circuit_pre_WhyType.

(* Why3 assumption *)
Fixpoint size_pre (c:circuit_pre) {struct c}: Z :=
  match c with
  | Cnot => 2%Z
  | Sequence d _ => size_pre d
  | Parallel d e => ((size_pre d) + (size_pre e))%Z
  | _ => 1%Z
  end.

Axiom size_pre_spec : forall (c:circuit_pre), (0%Z <= (size_pre c))%Z.

(* Why3 assumption *)
Fixpoint build_correct (c:circuit_pre) {struct c}: Prop :=
  match c with
  | Sequence d e =>
      ((size_pre d) = (size_pre e)) /\
      ((build_correct d) /\ (build_correct e))
  | Parallel d e => (build_correct d) /\ (build_correct e)
  | _ => True
  end.

Axiom circuit_c : Type.
Parameter circuit_c_WhyType : WhyType circuit_c.
Existing Instance circuit_c_WhyType.

Parameter pre: circuit_c -> circuit_pre.

Axiom circuit_c'invariant :
  forall (self:circuit_c), build_correct (pre self).

Axiom injective_pre :
  forall (c:circuit_c) (c':circuit_c), ~ (c = c') -> ~ ((pre c) = (pre c')).

Parameter to_qc: circuit_pre -> circuit_c.

Axiom to_qc_spec :
  forall (c:circuit_pre), (build_correct c) -> ((pre (to_qc c)) = c).

Axiom to_qc_rev : forall (c:circuit_c), (c = (to_qc (pre c))).

(* Why3 assumption *)
Definition size_c (c:circuit_c) : Z := size_pre (pre c).

Axiom size_c_spec : forall (c:circuit_c), (0%Z <= (size_c c))%Z.

Parameter sum_range_c: circuit_c -> Z.

Axiom sum_range_c_def :
  forall (c:circuit_c), forall (x:angle), ((pre c) = (Phase x)) ->
  ((sum_range_c c) = 0%Z).

Axiom sum_range_c_def1 :
  forall (c:circuit_c), forall (x:angle), ((pre c) = (Rz x)) ->
  ((sum_range_c c) = 0%Z).

Axiom sum_range_c_def2 :
  forall (c:circuit_c), ((pre c) = Hadamard) -> ((sum_range_c c) = 1%Z).

Axiom sum_range_c_def3 :
  forall (c:circuit_c), ((pre c) = Cnot) -> ((sum_range_c c) = 0%Z).

Axiom sum_range_c_def4 :
  forall (c:circuit_c), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Sequence x x1)) ->
  ((sum_range_c c) = ((sum_range_c (to_qc x)) + (sum_range_c (to_qc x1)))%Z).

Axiom sum_range_c_def5 :
  forall (c:circuit_c), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Parallel x x1)) ->
  ((sum_range_c c) = ((sum_range_c (to_qc x)) + (sum_range_c (to_qc x1)))%Z).

Axiom sum_range_c_spec : forall (c:circuit_c), (0%Z <= (sum_range_c c))%Z.

Parameter basis_ket_c: circuit_c -> bk_func.

Axiom basis_ket_c_def :
  forall (c:circuit_c), forall (x:angle), ((pre c) = (Phase x)) ->
  ((basis_ket_c c) = (make_k (fun (x1:bitvec) (us:bitvec) => x1) 1%Z 0%Z)).

Axiom basis_ket_c_def1 :
  forall (c:circuit_c), forall (x:angle), ((pre c) = (Rz x)) ->
  ((basis_ket_c c) = (make_k (fun (x1:bitvec) (us:bitvec) => x1) 1%Z 0%Z)).

Axiom basis_ket_c_def2 :
  forall (c:circuit_c), ((pre c) = Hadamard) ->
  ((basis_ket_c c) = (make_k (fun (us:bitvec) (y:bitvec) => y) 1%Z 1%Z)).

Axiom basis_ket_c_def3 :
  forall (c:circuit_c), ((pre c) = Cnot) ->
  ((basis_ket_c c) =
   (make_k
    (fun (x:bitvec) (y:bitvec) =>
     (make_bv
      (fun (i:Z) =>
       ((i *
         (int.EuclideanDivision.mod1 (((value x) 0%Z) + ((value y) 1%Z))%Z
          2%Z))%Z
        + ((1%Z - i)%Z * ((value x) i))%Z)%Z)
      2%Z))
    2%Z 0%Z)).

Axiom basis_ket_c_def4 :
  forall (c:circuit_c), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Sequence x x1)) ->
  ((basis_ket_c c) =
   (k_seq (basis_ket_c (to_qc x)) (basis_ket_c (to_qc x1)))).

Axiom basis_ket_c_def5 :
  forall (c:circuit_c), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Parallel x x1)) ->
  ((basis_ket_c c) =
   (k_par (basis_ket_c (to_qc x)) (basis_ket_c (to_qc x1)))).

Axiom basis_ket_c_spec :
  forall (c:circuit_c), ((size_k (basis_ket_c c)) = (size_c c)).

Axiom basis_ket_c_spec1 :
  forall (c:circuit_c), ((range_k (basis_ket_c c)) = (sum_range_c c)).

Parameter ang_ind_c: circuit_c -> angle_func.

Axiom ang_ind_c_def :
  forall (c:circuit_c), forall (x:angle), ((pre c) = (Phase x)) ->
  ((ang_ind_c c) = (make_a (fun (us:bitvec) (us1:bitvec) => x) 1%Z 0%Z)).

Axiom ang_ind_c_def1 :
  forall (c:circuit_c), forall (x:angle), ((pre c) = (Rz x)) ->
  ((ang_ind_c c) =
   (make_a
    (fun (x1:bitvec) (us:bitvec) =>
     (phase_inv_ (1%Z - ((value x1) 0%Z))%Z x))
    1%Z 0%Z)).

Axiom ang_ind_c_def2 :
  forall (c:circuit_c), ((pre c) = Hadamard) ->
  ((ang_ind_c c) =
   (make_a
    (fun (x:bitvec) (y:bitvec) =>
...
Axiom ang_ind_c_def3 :
  forall (c:circuit_c), ((pre c) = Cnot) ->
  ((ang_ind_c c) =
   (make_a (fun (us:bitvec) (us1:bitvec) => ang_zero) 2%Z 0%Z)).

Axiom ang_ind_c_def4 :
  forall (c:circuit_c), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Sequence x x1)) ->
  ((ang_ind_c c) =
   (a_seq (ang_ind_c (to_qc x)) (ang_ind_c (to_qc x1))
    (basis_ket_c (to_qc x)))).

Axiom ang_ind_c_def5 :
  forall (c:circuit_c), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Parallel x x1)) ->
  ((ang_ind_c c) = (a_par (ang_ind_c (to_qc x)) (ang_ind_c (to_qc x1)))).

Axiom ang_ind_c_spec :
  forall (c:circuit_c), ((size_a (ang_ind_c c)) = (size_c c)).

Axiom ang_ind_c_spec1 :
  forall (c:circuit_c), ((range_a (ang_ind_c c)) = (sum_range_c c)).

Parameter phase_c: angle -> circuit_c.

Axiom phase_c_spec : forall (o:angle), ((pre (phase_c o)) = (Phase o)).

Axiom phase_c_spec1 : forall (o:angle), ((sum_range_c (phase_c o)) = 0%Z).

Axiom phase_c_spec2 : forall (o:angle), ((size_c (phase_c o)) = 1%Z).

Axiom phase_c_spec3 :
  forall (o:angle),
  ((basis_ket_c (phase_c o)) =
   (make_k (fun (x:bitvec) (us:bitvec) => x) 1%Z 0%Z)).

Axiom phase_c_spec4 :
  forall (o:angle),
  ((ang_ind_c (phase_c o)) =
   (make_a (fun (us:bitvec) (us1:bitvec) => o) 1%Z 0%Z)).

Parameter rz_c: angle -> circuit_c.

Axiom rz_c_spec : forall (o:angle), ((pre (rz_c o)) = (Rz o)).

Axiom rz_c_spec1 : forall (o:angle), ((sum_range_c (rz_c o)) = 0%Z).

Axiom rz_c_spec2 : forall (o:angle), ((size_c (rz_c o)) = 1%Z).
...
Axiom rz_c_spec4 :
  ...
  ((ang_ind_c (rz_c o)) =
   (make_a
    (fun (x:bitvec) (us:bitvec) => (phase_inv_ (1%Z - ((value x) 0%Z))%Z o))
    1%Z 0%Z)).

Parameter hadamard_c: unit -> circuit_c.

Axiom hadamard_c_spec : forall (us:unit), ((pre (hadamard_c us)) = Hadamard).

Axiom hadamard_c_spec1 :
  forall (us:unit), ((sum_range_c (hadamard_c us)) = 1%Z).

Axiom hadamard_c_spec2 : forall (us:unit), ((size_c (hadamard_c us)) = 1%Z).

Axiom hadamard_c_spec3 :
  forall (us:unit),
  ((basis_ket_c (hadamard_c us)) =
   (make_k (fun (us1:bitvec) (y:bitvec) => y) 1%Z 1%Z)).

Axiom hadamard_c_spec4 :
  forall (us:unit),
  ((ang_ind_c (hadamard_c us)) =
   (make_a
    (fun (x:bitvec) (y:bitvec) =>
     (int_to_ang (((value x) 0%Z) * ((value y) 0%Z))%Z 1%Z))
    1%Z 1%Z)).

Parameter cnot_c: unit -> circuit_c.

Axiom cnot_c_spec : forall (us:unit), ((pre (cnot_c us)) = Cnot).

Axiom cnot_c_spec1 : forall (us:unit), ((sum_range_c (cnot_c us)) = 0%Z).

Axiom cnot_c_spec2 : forall (us:unit), ((size_c (cnot_c us)) = 2%Z).

Axiom cnot_c_spec3 :
  forall (us:unit),
  ((basis_ket_c (cnot_c us)) =
   (make_k
    (fun (x:bitvec) (y:bitvec) =>
     (make_bv
      (fun (i:Z) =>
...
Axiom cnot_c_spec4 :
  forall (us:unit),
  ((ang_ind_c (cnot_c us)) =
   (make_a (fun (us1:bitvec) (us2:bitvec) => ang_zero) 2%Z 0%Z)).

Parameter parallel_c: circuit_c -> circuit_c -> circuit_c.

Axiom parallel_c_spec :
  forall (d:circuit_c) (e:circuit_c),
  ((pre (parallel_c d e)) = (Parallel (pre d) (pre e))).

Axiom parallel_c_spec1 :
  forall (d:circuit_c) (e:circuit_c),
  ((parallel_c d e) = (to_qc (Parallel (pre d) (pre e)))).

Axiom parallel_c_spec2 :
  forall (d:circuit_c) (e:circuit_c),
  ((size_c (parallel_c d e)) = ((size_c d) + (size_c e))%Z).

Axiom parallel_c_spec3 :
  forall (d:circuit_c) (e:circuit_c),
  ((sum_range_c (parallel_c d e)) = ((sum_range_c d) + (sum_range_c e))%Z).

Axiom parallel_c_spec4 :
  forall (d:circuit_c) (e:circuit_c),
  ((basis_ket_c (parallel_c d e)) = (k_par (basis_ket_c d) (basis_ket_c e))).

Axiom parallel_c_spec5 :
  forall (d:circuit_c) (e:circuit_c),
  ((ang_ind_c (parallel_c d e)) = (a_par (ang_ind_c d) (ang_ind_c e))).

Parameter sequence_c: circuit_c -> circuit_c -> circuit_c.

Axiom sequence_c_spec :
  forall (d:circuit_c) (e:circuit_c), ((size_c d) = (size_c e)) ->
  ((pre (sequence_c d e)) = (Sequence (pre d) (pre e))).

Axiom sequence_c_spec1 :
  forall (d:circuit_c) (e:circuit_c), ((size_c d) = (size_c e)) ->
  ((sequence_c d e) = (to_qc (Sequence (pre d) (pre e)))).

Axiom sequence_c_spec2 :
  forall (d:circuit_c) (e:circuit_c), ((size_c d) = (size_c e)) ->
  ((sum_range_c (sequence_c d e)) = ((sum_range_c d) + (sum_range_c e))%Z).

Axiom sequence_c_spec3 :
  forall (d:circuit_c) (e:circuit_c), ((size_c d) = (size_c e)) ->
  ((size_c (sequence_c d e)) = (size_c d)).

Axiom sequence_c_spec4 :
  forall (d:circuit_c) (e:circuit_c), ((size_c d) = (size_c e)) ->
  ((basis_ket_c (sequence_c d e)) = (k_seq (basis_ket_c d) (basis_ket_c e))).

Axiom sequence_c_spec5 :
  forall (d:circuit_c) (e:circuit_c), ((size_c d) = (size_c e)) ->
  ((ang_ind_c (sequence_c d e)) =
   (a_seq (ang_ind_c d) (ang_ind_c e) (basis_ket_c d))).
...
Parameter mat_sem_c: circuit_c -> matrix t.

Parameter result17: angle -> Z -> Z -> t.

Axiom result_def17 :
  forall (x:angle) (i:Z) (j:Z),
  ((i = j) -> ((((result17 x) i) j) = (ang_exp x))) /\
  (~ (i = j) -> ((((result17 x) i) j) = tzero)).

Axiom mat_sem_c_def :
  forall (c:circuit_c), forall (x:angle), ((pre c) = (Phase x)) ->
  ((mat_sem_c c) = (make_f 2%Z 2%Z (result17 x))).

Parameter result18: angle -> Z -> Z -> t.

Axiom result_def18 :
  forall (x:angle) (i:Z) (j:Z),
  ((i = j) -> ((((result18 x) i) j) = (ang_exp (phase_inv_ (1%Z - i)%Z x)))) /\
  (~ (i = j) -> ((((result18 x) i) j) = tzero)).

Axiom mat_sem_c_def1 :
  forall (c:circuit_c), forall (x:angle), ((pre c) = (Rz x)) ->
  ((mat_sem_c c) = (make_f 2%Z 2%Z (result18 x))).

Axiom mat_sem_c_def2 :
  forall (c:circuit_c), ((pre c) = Hadamard) ->
  ((mat_sem_c c) =
   (make_f 2%Z 2%Z
    (fun (i:Z) (j:Z) =>
     (infix_asdt (pow_inv_sqrt_2 1%Z) (cpower (prefix_mndt tone) (i * j)%Z))))).

Parameter result19: Z -> Z -> t.

Axiom result_def19 :
  forall (i:Z) (j:Z),
  (((((0%Z <= j)%Z /\ (j < 2%Z)%Z) /\ (i = j)) \/
    (~ ((0%Z <= j)%Z /\ (j < 2%Z)%Z) /\
     (((j = 2%Z) /\ (i = 3%Z)) \/ (~ (j = 2%Z) /\ (i = 2%Z))))) ->
   (((result19 i) j) = tone)) /\
  (~ ((((0%Z <= j)%Z /\ (j < 2%Z)%Z) -> (i = j)) /\
      (~ ((0%Z <= j)%Z /\ (j < 2%Z)%Z) ->
       ((j = 2%Z) -> (i = 3%Z)) /\ (~ (j = 2%Z) -> (i = 2%Z)))) ->
...
Axiom mat_sem_c_def3 :
  forall (c:circuit_c), ((pre c) = Cnot) ->
  ((mat_sem_c c) = (make_f 4%Z 4%Z result19)).

Axiom mat_sem_c_def4 :
  forall (c:circuit_c), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Sequence x x1)) ->
  ((mat_sem_c c) = (mat_mult (mat_sem_c (to_qc x1)) (mat_sem_c (to_qc x)))).

Axiom mat_sem_c_def5 :
  forall (c:circuit_c), forall (x:circuit_pre) (x1:circuit_pre),
  ((pre c) = (Parallel x x1)) ->
  ((mat_sem_c c) = (kronecker (mat_sem_c (to_qc x)) (mat_sem_c (to_qc x1)))).

Axiom mat_sem_c_spec :
  forall (c:circuit_c), ((rows (mat_sem_c c)) = (power 2%Z (size_c c))).

Axiom mat_sem_c_spec1 :
  forall (c:circuit_c), ((columns (mat_sem_c c)) = (power 2%Z (size_c c))).

Parameter path_sum_funcs_basis:
  bk_func -> angle_func -> Z -> Z -> bitvec -> matrix t.

Axiom path_sum_funcs_basis_def :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (x:bitvec),
  ((length x) = size) -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
  ((path_sum_funcs_basis k a size range x) =
   (infix_asdtdt (pow_inv_sqrt_2 range)
    (ket_sum_l (n_bvs range)
     (fun (y:bitvec) => (infix_asdtdt (get_ac a x y) (get_k_ket k x y)))
     size))).

Axiom path_sum_funcs_basis_spec :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (x:bitvec),
  ((length x) = size) -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
  is_a_ket_l (path_sum_funcs_basis k a size range x) size.

Axiom path_sum_funcs_basis_spec1 :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (x:bitvec),
  ((length x) = size) -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
  is_a_ket (path_sum_funcs_basis k a size range x).

Parameter path_sum_funcs:
  bk_func -> angle_func -> Z -> Z -> (matrix t) -> matrix t.

Axiom path_sum_funcs_def :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (u:matrix t),
  (is_a_ket_l u size) -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
  ((path_sum_funcs k a size range u) =
   (ket_sum_l (n_bvs size)
    (fun (x:bitvec) =>
     let x' := hpart x size in
     infix_asdtdt (get u (bv_to_int x') 0%Z)
     (path_sum_funcs_basis k a size range x'))
    size)).

Axiom path_sum_funcs_spec :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (u:matrix t),
  (is_a_ket_l u size) -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
  is_a_ket_l (path_sum_funcs k a size range u) size.

Axiom path_sum_funcs_spec1 :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (u:matrix t),
  (is_a_ket_l u size) -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
  is_a_ket (path_sum_funcs k a size range u).

Axiom path_sum_funcs_spec2 :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (u:matrix t),
  (is_a_ket_l u size) -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
  ((path_sum_funcs k a size range u) =
...
Axiom path_sum_funcs_ket_l :
  forall (k:bk_func) (a:angle_func) (size:Z) (l:Z) (range:Z) (u:matrix t),
  (is_a_ket_l u size) -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) -> (l = size) ->
  is_a_ket_l (path_sum_funcs k a size range u) l.
...
Axiom path_sum_funcs_unit :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (u:matrix t),
  (is_a_ket_l u size) -> (is_a_ket_basis_elt u) -> ((size_a a) = size) ->
  ((range_a a) = range) -> ((size_k k) = size) -> ((range_k k) = range) ->
  ((path_sum_funcs k a size range u) =
   (path_sum_funcs_basis k a size range (ket_to_bv u))).

Axiom path_sum_funcs_unit_sum :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (u:matrix t),
  (is_a_ket_l u size) -> (is_a_ket_basis_elt u) -> ((size_a a) = size) ->
  ((range_a a) = range) -> ((size_k k) = size) -> ((range_k k) = range) ->
  ((path_sum_funcs k a size range u) =
   (infix_asdtdt (pow_inv_sqrt_2 range)
    (ket_sum_l (n_bvs range)
     (fun (y:bitvec) =>
      (infix_asdtdt (get_ac a (ket_to_bv u) y)
       (bv_to_ket (get_k k (ket_to_bv u) y))))
     size))).

Axiom add_path_sum_funcs :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (u:matrix t)
    (v:matrix t),
  (is_a_ket_l u size) -> (is_a_ket_l v size) -> ((size_a a) = size) ->
  ((range_a a) = range) -> ((size_k k) = size) -> ((range_k k) = range) ->
  ((path_sum_funcs k a size range (add_ket_l u v size)) =
   (add_ket_l (path_sum_funcs k a size range u)
    (path_sum_funcs k a size range v) size)).

Axiom scal_path_sum_funcs :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (u:matrix t) (v:t),
  (is_a_ket_l u size) -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
  ((path_sum_funcs k a size range (infix_asdtdt v u)) =
   (infix_asdtdt v (path_sum_funcs k a size range u))).

Axiom mat_sum_path_sum_funcs :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (s:set bitvec)
    (f:bitvec -> matrix t),
  (0%Z < (cardinal s))%Z -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
  (forall (e:bitvec), (mem e s) -> is_a_ket_l (f e) size) ->
  ((path_sum_funcs k a size range (ket_sum_l s f size)) =
   (ket_sum_l s (fun (e:bitvec) => (path_sum_funcs k a size range (f e)))
    size)).

Axiom mat_sum_scal_path_semantics :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (s:set bitvec)
    (scal:bitvec -> t) (mat:bitvec -> matrix t),
  (0%Z < (cardinal s))%Z -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
  (forall (e:bitvec), (mem e s) -> is_a_ket_l (mat e) size) ->
  ((path_sum_funcs k a size range
    (ket_sum_l s (fun (e:bitvec) => (infix_asdtdt (scal e) (mat e))) size))
   =
   (ket_sum_l s
    (fun (e:bitvec) =>
     (infix_asdtdt (scal e) (path_sum_funcs k a size range (mat e))))
    size)).

Axiom mat_sum_scal_path_semantics_rev :
  forall (k:bk_func) (a:angle_func) (size:Z) (range:Z) (s:set bitvec)
    (scal:bitvec -> t) (mat:bitvec -> matrix t),
  (0%Z < (cardinal s))%Z -> ((size_a a) = size) -> ((range_a a) = range) ->
  ((size_k k) = size) -> ((range_k k) = range) ->
...
Axiom path_sum_funcs_decomp :
  ...
  ((path_sum_funcs k a size range u) =
   (ket_sum_l (n_bvs size)
    (fun (bvx:bitvec) =>
     (infix_asdtdt (get u (bv_to_int bvx) 0%Z)
      (path_sum_funcs k a size range (bv_to_ket bvx))))
    size)).

Axiom path_comp_rew :
  forall (k1:bk_func) (k2:bk_func) (a1:angle_func) (a2:angle_func) (size:Z)
    (range1:Z) (range2:Z) (x:bitvec),
  ((size_a a1) = size) -> ((range_a a1) = range1) -> ((size_k k1) = size) ->
  ((range_k k1) = range1) -> ((size_a a2) = size) ->
  ((range_a a2) = range2) -> ((size_k k2) = size) ->
  ((range_k k2) = range2) -> ((length x) = size) ->
  ((path_sum_funcs k2 a2 size range2
    (path_sum_funcs k1 a1 size range1 (bv_to_ket x)))
   =
   (ket_sum_l (n_bvs range1)
    (fun (y:bitvec) =>
     (infix_asdtdt
      (infix_asdt (infix_asdt (pow_inv_sqrt_2 range1) (get_ac a1 x y))
       (pow_inv_sqrt_2 range2))
      (ket_sum_l (n_bvs range2)
       (fun (bvx:bitvec) =>
        (infix_asdtdt (get_ac a2 (get_k k1 x y) bvx)
         (bv_to_ket (get_k k2 (get_k k1 x y) bvx))))
       size)))
    size)).
...
Axiom path_comp :
  ...
  ((path_sum_funcs k2 a2 size range2
    (path_sum_funcs k1 a1 size range1 (bv_to_ket x)))
   =
   (path_sum_funcs (k_seq k1 k2) (a_seq a1 a2 k1) size (range1 + range2)%Z
    (bv_to_ket x))).

Axiom path_comp_ket_basis :
  forall (k1:bk_func) (k2:bk_func) (a1:angle_func) (a2:angle_func) (size:Z)
    (range1:Z) (range2:Z),
  ((size_a a1) = size) -> ((range_a a1) = range1) -> ((size_k k1) = size) ->
  ((range_k k1) = range1) -> ((size_a a2) = size) ->
  ((range_a a2) = range2) -> ((size_k k2) = size) ->
  ((range_k k2) = range2) -> forall (x:matrix t), (is_a_ket_basis_elt x) ->
  (is_a_ket_l x size) ->
  ((path_sum_funcs k2 a2 size range2 (path_sum_funcs k1 a1 size range1 x)) =
   (path_sum_funcs (k_seq k1 k2) (a_seq a1 a2 k1) size (range1 + range2)%Z x)).

Axiom path_comp_ket_basis1 :
  forall (k1:bk_func) (k2:bk_func) (a1:angle_func) (a2:angle_func) (size:Z)
    (range1:Z) (range2:Z),
  ((size_a a1) = size) -> ((range_a a1) = range1) -> ((size_k k1) = size) ->
  ((range_k k1) = range1) -> ((size_a a2) = size) ->
  ((range_a a2) = range2) -> ((size_k k2) = size) ->
  ((range_k k2) = range2) -> forall (x:matrix t), forall (s:t),
  (is_a_ket_basis_elt x) -> (is_a_ket_l x size) ->
  ((path_sum_funcs k2 a2 size range2
    (path_sum_funcs k1 a1 size range1 (infix_asdtdt s x)))
   =
   (path_sum_funcs (k_seq k1 k2) (a_seq a1 a2 k1) size (range1 + range2)%Z
    (infix_asdtdt s x))).
...
Axiom path_comp_ket :
  forall (k1:bk_func) (k2:bk_func) (a1:angle_func) (a2:angle_func) (size:Z)
    (range1:Z) (range2:Z) (x:matrix t),
  (is_a_ket_l x size) -> ((size_a a1) = size) -> ((range_a a1) = range1) ->
  ((size_k k1) = size) -> ((range_k k1) = range1) -> ((size_a a2) = size) ->
  ((range_a a2) = range2) -> ((size_k k2) = size) ->
  ((range_k k2) = range2) ->
  ((path_sum_funcs k2 a2 size range2 (path_sum_funcs k1 a1 size range1 x)) =
   (path_sum_funcs (k_seq k1 k2) (a_seq a1 a2 k1) size (range1 + range2)%Z x)).
...
Axiom diag_two_mat_def :
  ...
  ((diag_two_mat n f) = (make_f (power 2%Z n) (power 2%Z n) (result20 n f))).
...
Parameter result21: Z -> (Z -> Z -> Z -> t) -> Z -> Z -> t.
...
Axiom result_def21 :
  ...
  (~ (((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) /\
      ((0%Z <= j)%Z /\ (j < (power 2%Z n))%Z)) ->
   ((((result21 n f) i) j) = tzero)).

Axiom two_bloc_diag_mat_def :
  forall (n:Z) (f:Z -> Z -> Z -> t), (2%Z <= n)%Z ->
  ((two_bloc_diag_mat n f) =
   (make_f (power 2%Z n) (power 2%Z n) (result21 n f))).
...
Axiom path_par_basis :
  forall (k1:bk_func) (k2:bk_func) (a1:angle_func) (a2:angle_func)
    (x:matrix t) (y:matrix t),
  ((range_a a1) = (range_k k1)) -> ((range_a a2) = (range_k k2)) ->
  ((size_a a1) = (size_k k1)) -> ((size_a a2) = (size_k k2)) ->
  (is_a_ket_l x (size_a a1)) -> (is_a_ket_basis_elt x) ->
  (is_a_ket_l y (size_a a2)) -> (is_a_ket_basis_elt y) ->
  ((path_sum_funcs (k_par k1 k2) (a_par a1 a2) ((size_a a1) + (size_a a2))%Z
    ((range_a a1) + (range_a a2))%Z (kronecker x y))
   =
   (kronecker (path_sum_funcs k1 a1 (size_a a1) (range_a a1) x)
    (path_sum_funcs k2 a2 (size_a a2) (range_a a2) y))).
...
Axiom path_par :
  ...
  ((range_a a1) = (range_k k1)) -> ((range_a a2) = (range_k k2)) ->
  ((size_a a1) = (size_k k1)) -> ((size_a a2) = (size_k k2)) ->
  (is_a_ket_l x (size_a a1)) -> (is_a_ket_l y (size_a a2)) ->
  ((path_sum_funcs (k_par k1 k2) (a_par a1 a2) ((size_a a1) + (size_a a2))%Z
    ((range_a a1) + (range_a a2))%Z (kronecker x y))
   =
   (kronecker (path_sum_funcs k1 a1 (size_a a1) (range_a a1) x)
...
Axiom correct_ps_phase_basis_c :
  forall (x:matrix t) (o:angle), (is_a_ket_l x 1%Z) ->
  (is_a_ket_basis_elt x) ->
  ((mat_mult (mat_sem_c (phase_c o)) x) =
   (path_sum_funcs (make_k (fun (x1:bitvec) (us:bitvec) => x1) 1%Z 0%Z)
    (make_a (fun (us:bitvec) (us1:bitvec) => o) 1%Z 0%Z) 1%Z 0%Z x)).

Axiom correct_ps_rz_basis_c :
  forall (x:matrix t) (o:angle), (is_a_ket_l x 1%Z) ->
  (is_a_ket_basis_elt x) ->
  ((mat_mult (mat_sem_c (rz_c o)) x) =
   (path_sum_funcs (make_k (fun (x1:bitvec) (us:bitvec) => x1) 1%Z 0%Z)
    (make_a
     (fun (x1:bitvec) (us:bitvec) =>
      (phase_inv_ (1%Z - ((value x1) 0%Z))%Z o))
     1%Z 0%Z)
    1%Z 0%Z x)).

Axiom correct_ps_hadamard_basis_c :
  forall (x:matrix t), (is_a_ket_l x 1%Z) -> (is_a_ket_basis_elt x) ->
  ((mat_mult (mat_sem_c (hadamard_c tt)) x) =
   (path_sum_funcs (make_k (fun (us:bitvec) (y:bitvec) => y) 1%Z 1%Z)
    (make_a
     (fun (x1:bitvec) (y:bitvec) =>
      (int_to_ang (((value x1) 0%Z) * ((value y) 0%Z))%Z 1%Z))
     1%Z 1%Z)
    1%Z 1%Z x)).

Parameter x: matrix t.

Axiom H : is_a_ket_l x 2%Z.

Axiom H1 : is_a_ket_basis_elt x.
    ...
    (make_k
     (fun (x1:bitvec) (y:bitvec) =>
      (make_bv
       (fun (i:Z) =>
        ((i *
          (int.EuclideanDivision.mod1 (((value x1) 0%Z) + ((value y) 1%Z))%Z
           2%Z))%Z
         + ((1%Z - i)%Z * ((value x1) i))%Z)%Z)
       2%Z))
     2%Z 0%Z))
   = 2%Z).
...
Axiom H4 :
  ((length
    (make_bv
     (fun (i:Z) =>
      ((i * (int.EuclideanDivision.mod1 ((value (ket_to_bv x)) 0%Z) 2%Z))%Z +
       ((1%Z - i)%Z * ((value (ket_to_bv x)) i))%Z)%Z)
     2%Z))
   = 2%Z).

Axiom H5 : (0%Z <= (ket_length x))%Z.

Axiom H6 : ((rows x) = (power 2%Z (ket_length x))).

Axiom H7 :
  ((length
    (make_bv
     (fun (i:Z) =>
      ((i * ((value (ket_to_bv x)) 0%Z))%Z +
       ((1%Z - i)%Z * ((value (ket_to_bv x)) i))%Z)%Z)
     2%Z))
   = 2%Z).
...
Axiom H8 :
  ...
  (((value
     (make_bv
      (fun (i1:Z) =>
       ((i1 * ((value (ket_to_bv x)) 0%Z))%Z +
        ((1%Z - i1)%Z * ((value (ket_to_bv x)) i1))%Z)%Z)
      2%Z))
    i)
   =
   ((fun (i1:Z) =>
...
Axiom H11 : (0%Z <= (ket_length x))%Z.

Axiom H12 : ((rows x) = (power 2%Z (ket_length x))).

Axiom H13 :
  forall (f:bitvec), (mem f (n_bvs (ket_length x))) ->
  ((length f) = (ket_length x)).
...
Axiom H15 :
  forall (f:bitvec), ((length f) = (ket_length x)) ->
  mem f (n_bvs (ket_length x)).

Axiom H16 : (0%Z < (cardinal (n_bvs (ket_length x))))%Z.

Parameter result22: Z -> Z -> t.

Parameter result23: Z -> Z -> t.
...
Axiom H17 :
  ((ket_sum_l (n_bvs (ket_length x))
    (fun (bvx:bitvec) =>
     (infix_asdtdt
      (get (make_f 4%Z 4%Z result22) (bv_to_int bvx) (ket_to_int x))
      (ket (ket_length x) (bv_to_int bvx))))
    (ket_length x))
   =
   ((fun (bvx:bitvec) =>
     (infix_asdtdt
      (get (make_f 4%Z 4%Z result23) (bv_to_int bvx) (ket_to_int x))
      (ket (ket_length x) (bv_to_int bvx))))
    (make_bv
     (fun (i:Z) =>
      ((i * ((value (ket_to_bv x)) 0%Z))%Z +
...
Axiom Hinst :
  ((pre (cnot_c tt)) = Cnot) ->
  ((mat_sem_c (cnot_c tt)) = (make_f 4%Z 4%Z result24)).

Axiom H18 : (0%Z <= (ket_to_int x))%Z.

Axiom H19 : ((ket_to_int x) < 2%Z)%Z.

(* Why3 goal *)
Theorem G :
  ((((value
      (make_bv (fun (i:Z) => ((1%Z - i)%Z * ((value (ket_to_bv x)) i))%Z)
       2%Z))
     0%Z)
    * (power 2%Z 1%Z))%Z
   = 0%Z).
