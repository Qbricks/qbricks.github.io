...
(* Why3 assumption *)
Definition depth (c:quantum_circuit) : Z := depth_pre (to_pre c).

Axiom depth_spec : forall (c:quantum_circuit), (0%Z < (depth c))%Z.
...
Axiom ket_part__def :
  ...
  match to_pre c with
  | Phase_ _ => ((ket_part_ c bvx bvy i) = (bvx i))
  | Rx _ => ((ket_part_ c bvx bvy i) = (bvy i))
  | Ry _ => ((ket_part_ c bvx bvy i) = (bvy i))
  | Rz_ _ => ((ket_part_ c bvx bvy i) = (bvx i))
  | Cnot_ =>
      ((i = 1%Z) ->
       ((ket_part_ c bvx bvy i) =
        (int.EuclideanDivision.mod1 ((bvx 0%Z) + (bvx 1%Z))%Z 2%Z))) /\
      (~ (i = 1%Z) -> ((ket_part_ c bvx bvy i) = (bvx i)))
  | Sequence_ d e =>
      ((ket_part_ c bvx bvy i) =
       (ket_part_ (to_qc e)
  ...
  | Rx o =>
      (((bvx 0%Z) = (bvy 0%Z)) ->
       ((phase_part_ c bvx bvy) =
        (infix_asdt squarert_two (d_cos (div_two o))))) /\
      (~ ((bvx 0%Z) = (bvy 0%Z)) ->
       ((phase_part_ c bvx bvy) =
        (infix_asdt squarert_two
         (infix_asdt (prefix_mndt im) (d_sin (div_two o))))))
  | Ry o =>
      (((bvx 0%Z) = (bvy 0%Z)) ->
       ((phase_part_ c bvx bvy) =
        (infix_asdt squarert_two (d_cos (div_two o))))) /\
      (~ ((bvx 0%Z) = (bvy 0%Z)) ->
       ((phase_part_ c bvx bvy) =
        (infix_asdt squarert_two
         (infix_asdt (cpower (prefix_mndt tone) (bvx 0%Z))
          (d_sin (div_two o))))))
  | Rz_ o =>
      ((phase_part_ c bvx bvy) =
       (value (phase_inv (1%Z - (bvx 0%Z))%Z (div_two o))))
...
Axiom phase_spec :
  forall (o:d_frac),
  ((sum_range_ (phase o)) = 0%Z) /\
  (((depth (phase o)) = 1%Z) /\
   ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
     ((ket_part_ (phase o) bvx bvy i) = (bvx i))) /\
    forall (bvx:Z -> Z) (bvy:Z -> Z),
    ((phase_part_ (phase o) bvx bvy) = (value o)))).
...
Axiom rz_spec :
  ...
  (((depth (rz o)) = 1%Z) /\
   ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
     ((ket_part_ (rz o) bvx bvy i) = (bvx i))) /\
    forall (bvx:Z -> Z) (bvy:Z -> Z),
    ((phase_part_ (rz o) bvx bvy) =
     (value (phase_inv (1%Z - (bvx 0%Z))%Z (div_two o)))))).
  ...
  (((depth (ry o)) = 1%Z) /\
   ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
    ...
    (~ ((bvx 0%Z) = (bvy 0%Z)) ->
     ((phase_part_ (ry o) bvx bvy) =
      (infix_asdt squarert_two
       (infix_asdt (cpower (prefix_mndt tone) (bvx 0%Z)) (d_sin (div_two o)))))))).
...
Parameter cnot: unit -> quantum_circuit.

Axiom cnot_spec :
  forall (us:unit),
  ((sum_range_ (cnot us)) = 0%Z) /\
  (((depth (cnot us)) = 2%Z) /\
   ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
     ((i = 1%Z) ->
      ((ket_part_ (cnot us) bvx bvy i) =
       (int.EuclideanDivision.mod1 ((bvx 0%Z) + (bvx 1%Z))%Z 2%Z))) /\
     (~ (i = 1%Z) -> ((ket_part_ (cnot us) bvx bvy i) = (bvx i)))) /\
    forall (bvx:Z -> Z) (bvy:Z -> Z),
    ((phase_part_ (cnot us) bvx bvy) = tone))).
...
Axiom parallel_spec :
  ...
  (((sum_range_ (parallel d e)) = ((sum_range_ d) + (sum_range_ e))%Z) /\
   ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
     ((0%Z <= i)%Z /\ (i < (depth d))%Z) ->
     ((ket_part_ (parallel d e) bvx bvy i) = (ket_part_ d bvx bvy i))) /\
    ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
      (((depth d) <= i)%Z /\ (i < ((depth d) + (depth e))%Z)%Z) ->
      ((ket_part_ (parallel d e) bvx bvy i) =
       (ket_part_ e
     ...
     ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
       ((ket_part_ (parallel d e) bvx bvy i) =
        (concat_fun
         ...
         (depth d) i))) /\
      forall (bvx:Z -> Z) (bvy:Z -> Z),
      ((phase_part_ (parallel d e) bvx bvy) =
...
Axiom sequence_spec :
  forall (d:quantum_circuit) (e:quantum_circuit), ((depth d) = (depth e)) ->
  ((sum_range_ (sequence d e)) = ((sum_range_ d) + (sum_range_ e))%Z) /\
  (((depth (sequence d e)) = (depth d)) /\
   ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
     ((ket_part_ (sequence d e) bvx bvy i) =
      (ket_part_ e
       ((((fun (y0:quantum_circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
           (ket_part_ y0 y1 y2 y3))
          d)
       ...
       i))) /\
    forall (bvx:Z -> Z) (bvy:Z -> Z),
    ((phase_part_ (sequence d e) bvx bvy) =
     (infix_asdt (phase_part_ d bvx bvy)
      (phase_part_ e
       ((((fun (y0:quantum_circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
           (ket_part_ y0 y1 y2 y3))
...
Axiom Positive_depth : forall (c:quantum_circuit), (0%Z <= (depth c))%Z.

Axiom binary_ket_part_ :
...
Parameter id_cont: quantum_circuit -> Z -> Z -> Z -> quantum_circuit.

Axiom id_cont_spec :
  forall (circ:quantum_circuit) (c:Z) (ft:Z) (n:Z),
  ((0%Z <= c)%Z /\ (c < n)%Z) ->
  ((0%Z <= ft)%Z /\ (ft <= (n - (depth circ))%Z)%Z) ->
  ((ft <= c)%Z -> ((ft + (depth circ))%Z <= c)%Z) ->
  ((depth (id_cont circ c ft n)) = n) /\
  (((sum_range_ (id_cont circ c ft n)) = (sum_range_ circ)) /\
   ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
     ((((ft <= i)%Z /\ (i < (ft + (depth circ))%Z)%Z) /\ ((bvx c) = 1%Z)) ->
      ((ket_part_ (id_cont circ c ft n) bvx bvy i) =
       (ket_part_ circ
        (((fun (y0:Z -> Z) (y1:Z) (y2:Z) => (shift y0 y1 y2)) bvx) ft) bvy
        (i - ft)%Z))) /\
     (~ (((ft <= i)%Z /\ (i < (ft + (depth circ))%Z)%Z) /\ ((bvx c) = 1%Z)) ->
      ((ket_part_ (id_cont circ c ft n) bvx bvy i) = (bvx i)))) /\
    forall (bvx:Z -> Z) (bvy:Z -> Z),
    (((bvx c) = 1%Z) ->
     ((phase_part_ (id_cont circ c ft n) bvx bvy) =
      (phase_part_ circ
       (((fun (y0:Z -> Z) (y1:Z) (y2:Z) => (shift y0 y1 y2)) bvx) ft) bvy))) /\
    (~ ((bvx c) = 1%Z) ->
     ((phase_part_ (id_cont circ c ft n) bvx bvy) =
      (infix_sldt tone (pow_inv_sqrt_2 (sum_range_ circ))))))).
...
Axiom nonn_mat_subset_def :
  ...
  ((nonn_mat_subset f s) = (filter (result9 f s) s)).
...
Definition bvlength (f:Z -> Z) (i:Z) : Prop :=
  forall (k:Z), (0%Z <= (f k))%Z /\ ((f k) < 2%Z)%Z.
...
Axiom result_def10 :
  ...
  (~ (k = 0%Z) -> (((result10 bv i) k) = ((value1 bv) (k - 1%Z)%Z))).
...
Axiom int_to_bv_def :
  ...
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  ((n = 0%Z) -> ((int_to_bv i n) = (make_bv (fun (k:Z) => i) 1%Z))) /\
  (~ (n = 0%Z) ->
   ((int_to_bv i n) =
    (concat_l
     (int_to_bv (int.EuclideanDivision.mod1 i (power 2%Z (n - 1%Z)%Z))
      (n - 1%Z)%Z)
...
Axiom tail_bits_sum :
  ...
  ((tail_bits i n) =
   (ind_isum
    (fun (l:Z) => (((value1 (int_to_bv i n)) l) * (power 2%Z (n - l)%Z))%Z)
    2%Z (n + 1%Z)%Z)).
...
Axiom bv_to_int_mod :
  ...
  ((int.EuclideanDivision.mod1 (bv_to_int bv)
   ...
   =
   (ind_isum
    (fun (l:Z) => (((value1 bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)
...
Axiom set_n_bvs :
  ...
  ~ ((1%Z <= i)%Z /\ (i <= (length bv))%Z) -> (((value1 bv) i) = 0%Z).
...
Axiom fc_def7 :
  ...
  ((l <= (length bv))%Z ->
   (((fc7 bv) l) = (((value1 bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc7 bv) l) = 0%Z)).

Axiom fc_def8 :
  forall (bv:bitvec) (l:Z),
  ((l <= (length bv))%Z ->
   (((fc8 bv) l) = (((value1 bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc8 bv) l) = 0%Z)).

Axiom kth_decomp :
  forall (bv:bitvec) (k:Z), ((1%Z <= k)%Z /\ (k <= (length bv))%Z) ->
  ((bv_to_int bv) =
   (((ind_isum (fc7 bv) 1%Z k) +
     (((value1 bv) k) * (power 2%Z ((length bv) - k)%Z))%Z)%Z
    + (ind_isum (fc8 bv) (k + 1%Z)%Z ((length bv) + 1%Z)%Z))%Z).
...
Axiom fc_def9 :
  forall (bv:bitvec) (l:Z),
  ((l <= (length bv))%Z ->
   (((fc9 bv) l) = (((value1 bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc9 bv) l) = 0%Z)).

Axiom fc_def10 :
  forall (bv:bitvec) (l:Z),
  ((l <= (length bv))%Z ->
   (((fc10 bv) l) = (((value1 bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc10 bv) l) = 0%Z)).

Axiom kth_decomp_bound_zero :
  forall (bv:bitvec) (k:Z), ((1%Z <= k)%Z /\ (k <= (length bv))%Z) ->
  (((value1 bv) k) = 0%Z) ->
  ((ind_isum (fc9 bv) 1%Z k) <= (bv_to_int bv))%Z /\
  ((bv_to_int bv) <
   ((ind_isum (fc10 bv) 1%Z k) + (power 2%Z ((length bv) - k)%Z))%Z)%Z.
...
Axiom fc_def11 :
  forall (bv:bitvec) (l:Z),
  ((l <= (length bv))%Z ->
   (((fc11 bv) l) = (((value1 bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc11 bv) l) = 0%Z)).

Axiom fc_def12 :
  forall (bv:bitvec) (l:Z),
  ((l <= (length bv))%Z ->
   (((fc12 bv) l) = (((value1 bv) l) * (power 2%Z ((length bv) - l)%Z))%Z)) /\
  (~ (l <= (length bv))%Z -> (((fc12 bv) l) = 0%Z)).

Axiom kth_decomp_bound_one :
  forall (bv:bitvec) (k:Z), ((1%Z <= k)%Z /\ (k <= (length bv))%Z) ->
  (((value1 bv) k) = 1%Z) ->
  (((ind_isum (fc11 bv) 1%Z k) + (power 2%Z ((length bv) - k)%Z))%Z <=
   (bv_to_int bv))%Z /\
  ((bv_to_int bv) <
   ((ind_isum (fc12 bv) 1%Z k) + (power 2%Z (((length bv) - k)%Z + 1%Z)%Z))%Z)%Z.
...
Axiom result_def12 :
  ...
  ((((length bv1) < i)%Z /\ (i <= ((length bv1) + (length bv2))%Z)%Z) ->
   (((result12 bv1 bv2) i) = ((value1 bv2) (i - (length bv1))%Z))) /\
  (~ (((length bv1) < i)%Z /\ (i <= ((length bv1) + (length bv2))%Z)%Z) ->
   (((result12 bv1 bv2) i) = ((value1 bv1) i))).
...
Parameter fc13: Z -> Z -> Z -> Z -> (Z* Z)%type -> bool.
...
Axiom ind_basis_mat_spec :
  ...
  (((columns (ind_basis_mat i j r c)) = c) /\
   ((forall (k:Z) (l:Z), (valid_index (ind_basis_mat i j r c) k l) ->
    ...
    ((cardinal (filter (fc13 i j r c) (mat_indices (ind_basis_mat i j r c))))
     = 1%Z))).
...
Parameter fc14: (matrix t) -> (Z* Z)%type -> bool.

Axiom fc_def14 :
  forall (m:matrix t) (x:(Z* Z)%type),
  (((fc14 m) x) = true) <-> ((get m (fir x) (sec x)) = tone).
   ...
   ((constant_size (basis_mat r c) (fun (y0:matrix t) => y0)) /\
    (((s_columns (basis_mat r c) (fun (y0:matrix t) => y0)) = c) /\
     (((s_rows (basis_mat r c) (fun (y0:matrix t) => y0)) = r) /\
      ...
      ((cardinal (filter (fc14 m) (mat_indices m))) = 1%Z))))).
...
Parameter fc15: (matrix t) -> (Z* Z)%type -> matrix t.

Axiom fc_def15 :
  forall (m:matrix t) (o:(Z* Z)%type),
  ((valid_index m (fir o) (sec o)) ->
   (((fc15 m) o) = (basis_projection m (fir o) (sec o)))) /\
  (~ (valid_index m (fir o) (sec o)) -> (((fc15 m) o) = m)).

Axiom rewrite_basis_projections :
  forall (m:matrix t),
  ((basis_projections m) = (map (fc15 m) (to_indexes m))).
...
Axiom fc_def16 :
  ...
  ((mem a1 s) -> (((fc16 m s f) a1) = (mat_mult m (f a1)))) /\
  (~ (mem a1 s) -> (((fc16 m s f) a1) = m)).
...
Axiom product_mat_sum_r_pre :
  ...
  (0%Z < (cardinal s'))%Z ->
  ((mat_mult m (mat_sum s' f)) = (mat_sum s' (fc16 m s f))) /\
  ...
  (((ket_length (bin_to_ket n bvx)) = n) /\
   (((ket_to_int (bin_to_ket n bvx)) = (bin_to_int bvx n)) /\
    (((rows (bin_to_ket n bvx)) = (power 2%Z n)) /\
     (((columns (bin_to_ket n bvx)) = 0%Z) /\ (is_a_ket (bin_to_ket n bvx)))))).
...
Parameter fc17: (Z -> Z) -> (set Z) -> (Z -> t) -> Z -> Z -> matrix t.
...
Axiom fc_def17 :
  ...
  (~ (mem j s) -> (((fc17 f s a n) j) = (make n 1%Z tzero))).
...
Axiom fc_def18 :
  ...
  (~ (mem j s') -> (((fc18 f s s' a n) j) = (make n 1%Z tzero))).
...
Axiom fun_inversion_ :
  ...
  ((mat_sum s (fc17 f s a n)) = (mat_sum s' (fc18 f s s' a n))).
...
Axiom unit_path_semantics_def :
  ...
  ((ket_length x) = (depth c)) -> (is_a_ket_basis_elt x) ->
  ((ket_length x) = (depth c)) ->
  ((unit_path_semantics c x) =
   (infix_asdtdt (pow_inv_sqrt_2 (sum_range_ c))
    (mat_sum (n_bvs (sum_range_ c))
     (fun (bvy:bitvec) =>
...
Axiom unit_path_semantics_spec :
  ...
  ((ket_length x) = (depth c)) -> (is_a_ket_basis_elt x) ->
  ((ket_length x) = (depth c)) ->
  (is_a_ket (unit_path_semantics c x)) /\
  ((ket_length (unit_path_semantics c x)) = (depth c)).

Parameter path_semantics: quantum_circuit -> (matrix t) -> matrix t.

Axiom path_semantics_def :
  forall (c:quantum_circuit) (x:matrix t), (is_a_ket x) ->
  ((ket_length x) = (depth c)) ->
  ((path_semantics c x) =
   (mat_sum (n_bvs (depth c))
    (fun (bvx:bitvec) =>
     (infix_asdtdt (get x (bv_to_int bvx) 0%Z)
      (unit_path_semantics c (bv_to_ket (make_bv (value1 bvx) (depth c)))))))).
...
Parameter c: quantum_circuit.

Parameter x: matrix t.

Axiom H : is_a_ket_basis_elt x.

Axiom H1 : ((ket_length x) = (depth c)).

Axiom H2 : ((bv_to_int (ket_to_bv x)) = (ket_to_int x)).

Axiom H3 : ((length (ket_to_bv x)) = (ket_length x)).

Axiom H4 : mem (ket_to_bv x) (n_bvs (ket_length x)).

Axiom H5 : (0%Z < (depth c))%Z.

Axiom H6 :
  forall (f:bitvec), (mem f (n_bvs (depth c))) -> ((length f) = (depth c)).

Axiom H7 :
  forall (f:bitvec), (mem f (n_bvs (depth c))) <-> ((length f) = (depth c)).

Axiom H8 : (0%Z < (cardinal (n_bvs (depth c))))%Z.

Axiom h : (0%Z < (depth c))%Z.

(* Why3 goal *)
Theorem VC_path_semantics_unit : (1%Z < (cardinal (n_bvs (depth c))))%Z.
Proof.
