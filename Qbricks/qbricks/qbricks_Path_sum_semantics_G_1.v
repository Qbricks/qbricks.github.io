...
Axiom sup_eq_def2 :
  ...
  (infix_lseqas (real_part y) (real_part x)) \/ (x = y).
...
Axiom decomp_mult :
  ...
  ((infix_asdt a b) =
   (infix_pldt
    (infix_pldt
     (infix_pldt (infix_asdt (r_to_t (real_part a)) (r_to_t (real_part b)))
      (infix_asdt im
       (infix_asdt (r_to_t (real_part a)) (r_to_t (im_part b)))))
     (infix_asdt im (infix_asdt (r_to_t (real_part b)) (r_to_t (im_part a)))))
...
Axiom inv_real :
  ...
  ((real_part (inv1 a)) = (infix_slas 1%R (real_part a))).

Axiom inv_real1 : forall (a:t), ~ (a = tzero) -> (real_ a) -> real_ (inv1 a).
...
Axiom antisym_infeq_t1 : antisym infix_lseqdt_closure.

Axiom transitive_infeq_t :
  forall (a:t) (b:t) (c:t), (infix_lseqdt a b) -> (infix_lseqdt b c) ->
  infix_lseqdt a c.

Axiom transitive_infeq_t1 : transitive infix_lseqdt_closure.
...
Axiom transitive_inf_t1 : transitive infix_lsdt_closure.

Axiom reflexive_infeq_t : forall (a:t), infix_lseqdt a a.

Axiom reflexive_infeq_t1 : reflexive infix_lseqdt_closure.
...
Axiom Cpower_plus_one :
  forall (i:t), forall (n:Z),
  ((cpower i n) = (infix_asdt i (cpower i (n - 1%Z)%Z))).
...
Axiom cpower_mult :
  forall (x:t) (n:Z) (m:Z), (0%Z <= m)%Z -> (0%Z <= n)%Z ->
  ((cpower x (n * m)%Z) = (cpower (cpower x n) m)).

Axiom cpower_inv :
  forall (e:t) (i:Z), (0%Z <= i)%Z ->
  ((cpower e (-i)%Z) = (infix_sldt tone (cpower e i))).
...
Axiom pre_cond_int2 : infix_lsdt tzero tone.

Axiom pre_cond_int3 : partial_order infix_lseqdt_closure.

Axiom pre_cond_int4 : neutral (fun (y0:t) (y1:t) => (infix_asdt y0 y1)) tone.

Axiom pre_cond_int5 : iterable (fun (y0:t) (y1:t) => (infix_asdt y0 y1)).

Axiom pre_cond_int6 : strict infix_lsdt_closure infix_lseqdt_closure.
...
Axiom init_exp : forall (k:t), ((cpower k 0%Z) = tone).

Axiom init_exp1 : forall (k:t), ((cpower k 1%Z) = k).

Axiom init_exp2 : forall (k:t), ((cpower k 2%Z) = (infix_asdt k k)).
...
Axiom init_exp3 : forall (k:Z), ((power k 0%Z) = 1%Z).

Axiom init_exp4 : forall (k:Z), ((power k 1%Z) = k).

Axiom init_exp5 : forall (k:Z), ((power k 2%Z) = (k * k)%Z).
...
Axiom unity_rt_spec :
  forall (n:Z), (0%Z < n)%Z -> ((cpower (unity_rt n) n) = tone).

Axiom unity_rt_spec1 : forall (n:Z), (0%Z < n)%Z -> ~ ((unity_rt n) = tzero).
...
Axiom p_unity_def :
  ...
  ((p_unity n k) = (cpower (unity_rt n) (int.EuclideanDivision.mod1 k n))).
...
Parameter exp_p_unity: Z -> Z -> unit.

Axiom exp_p_unity_def :
  forall (n:Z) (k:Z), (0%Z < n)%Z -> ((exp_p_unity n k) = tt).

Axiom exp_p_unity_spec :
  forall (n:Z) (k:Z), (0%Z < n)%Z ->
  ((p_unity n k) =
   (exp
    (infix_sldt
...
Axiom exp_omega :
  ...
  ((omega n) =
   (exp
    (infix_sldt (infix_asdt (infix_asdt (infix_pldt tone tone) pi) im)
     (i_to_t (power 2%Z n))))).
...
Axiom exp_p_omega :
  ...
  ((p_omega n k) =
   (exp
    (infix_sldt
     (infix_asdt
      (infix_asdt (infix_asdt (i_to_t k) (infix_pldt tone tone)) pi) im)
     (i_to_t (power 2%Z n))))).
...
Axiom weighted_kth_nit_r_spec :
  forall (i:Z) (k:Z) (n:Z), (0%Z <= i)%Z -> (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((power n (k - 1%Z)%Z) < i)%Z -> (0%Z <= (weighted_kth_nit_r i k n))%Z.

Axiom weighted_kth_nit_r_spec1 :
  forall (i:Z) (k:Z) (n:Z), (0%Z <= i)%Z -> (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((power n (k - 1%Z)%Z) < i)%Z -> ((weighted_kth_nit_r i k n) <= i)%Z.

Axiom weighted_kth_nit_r_spec2 :
  forall (i:Z) (k:Z) (n:Z), (0%Z <= i)%Z -> (0%Z < n)%Z -> (0%Z < k)%Z ->
  forall (h:Z), (k < h)%Z ->
  ((weighted_kth_nit_r i k n) =
...
Axiom weighted_kth_nit_l_spec1 :
  forall (i:Z) (k:Z) (n:Z) (h:Z), (0%Z <= i)%Z ->
  ((0%Z < k)%Z /\ (k <= h)%Z) -> (0%Z < n)%Z -> ((nary_length i n) <= h)%Z ->
  (1%Z < k)%Z ->
  ((weighted_kth_nit_l i k n h) =
   (weighted_kth_right i ((h - k)%Z + 1%Z)%Z h ((fun (y0:Z) (y1:Z) => y0) n))).

Axiom weighted_kth_nit_l_spec2 :
  forall (i:Z) (k:Z) (n:Z) (h:Z), (0%Z <= i)%Z ->
  ((0%Z < k)%Z /\ (k <= h)%Z) -> (0%Z < n)%Z -> ((nary_length i n) <= h)%Z ->
  ((power n (n - k)%Z) < i)%Z -> (0%Z <= (weighted_kth_nit_l i k n h))%Z.

Axiom weighted_kth_nit_l_spec3 :
  forall (i:Z) (k:Z) (n:Z) (h:Z), (0%Z <= i)%Z ->
  ((0%Z < k)%Z /\ (k <= h)%Z) -> (0%Z < n)%Z -> ((nary_length i n) <= h)%Z ->
  ((power n (n - k)%Z) < i)%Z -> ((weighted_kth_nit_l i k n h) <= i)%Z.
...
Axiom kth_bit_l_spec1 :
  forall (i:Z) (h:Z) (k:Z), (0%Z <= i)%Z -> ((1%Z <= k)%Z /\ (k <= h)%Z) ->
  (0%Z <= (kth_bit_l i h k))%Z.

Axiom kth_bit_l_spec2 :
  forall (i:Z) (h:Z) (k:Z), (0%Z <= i)%Z -> ((1%Z <= k)%Z /\ (k <= h)%Z) ->
  ((kth_bit_l i h k) <= 1%Z)%Z.

Axiom kth_bit_l_spec3 :
  forall (i:Z) (h:Z) (k:Z), (0%Z <= i)%Z -> ((1%Z <= k)%Z /\ (k <= h)%Z) ->
  ((kth_bit_l i h k) = (kth_bit_r i ((h - k)%Z + 1%Z)%Z)).

Axiom kth_bit_l_spec4 :
  forall (i:Z) (h:Z) (k:Z), (0%Z <= i)%Z -> ((1%Z <= k)%Z /\ (k <= h)%Z) ->
  ((kth_bit_l i h k) =
...
Axiom kth_weigh_spec :
  forall (i:Z) (k:Z), (0%Z <= i)%Z -> (0%Z < k)%Z ->
  ((power 2%Z (k - 1%Z)%Z) < i)%Z -> (0%Z <= (kth_weigh i k))%Z.

Axiom kth_weigh_spec1 :
  forall (i:Z) (k:Z), (0%Z <= i)%Z -> (0%Z < k)%Z ->
  ((power 2%Z (k - 1%Z)%Z) < i)%Z -> ((kth_weigh i k) <= i)%Z.
...
Axiom set_is_all_binary :
  forall (t1:Z -> Z),
  (forall (k:Z), (0%Z <= (t1 k))%Z /\ ((t1 k) < 2%Z)%Z) -> is_all_binary t1.
...
Axiom get_is_binary :
  ...
  ((i <= k)%Z /\ (k < j)%Z) -> (0%Z <= (t1 k))%Z.

Axiom get_is_binary1 :
  forall (t1:Z -> Z) (i:Z) (j:Z), (is_binary t1 i j) -> forall (k:Z),
  ((i <= k)%Z /\ (k < j)%Z) -> ((t1 k) < 2%Z)%Z.
...
Axiom is_a_q_bra1 : forall (m:matrix t), (is_a_q_bra m) -> ((rows m) = 1%Z).
...
Axiom is_a_ket1 : forall (m:matrix t), (is_a_ket m) -> ((columns m) = 1%Z).
...
Axiom bra_to_ket_spec :
  forall (m:matrix t), (is_a_q_bra m) -> is_a_ket (bra_to_ket m).

Axiom bra_to_ket_spec1 :
  forall (m:matrix t), (is_a_q_bra m) -> forall (i:Z) (j:Z),
  (valid_index m i j) -> valid_index (bra_to_ket m) j i.

Axiom bra_to_ket_spec2 :
  forall (m:matrix t), (is_a_q_bra m) -> forall (i:Z) (j:Z),
  (valid_index (bra_to_ket m) j i) -> valid_index m i j.
...
Axiom bra_to_ket_spec5 :
  forall (m:matrix t), (is_a_q_bra m) -> forall (i:Z) (j:Z),
  (valid_index m i j) -> ((get m i j) = (get (bra_to_ket m) j i)).
...
Axiom ket_to_bra_spec1 :
  forall (m:matrix t), (is_a_ket m) -> ((rows (ket_to_bra m)) = (columns m)).

Axiom ket_to_bra_spec2 :
  forall (m:matrix t), (is_a_ket m) -> is_a_q_bra (ket_to_bra m).
...
Axiom ket_to_bra_spec4 :
  forall (m:matrix t), (is_a_ket m) -> forall (i:Z) (j:Z),
  (valid_index (ket_to_bra m) j i) -> valid_index m i j.

Axiom ket_to_bra_spec5 :
  forall (m:matrix t), (is_a_ket m) -> forall (i:Z) (j:Z),
  (valid_index m i j) -> ((get m i j) = (get (ket_to_bra m) j i)).
...
Axiom bra_length_spec :
  forall (m:matrix t), (is_a_q_bra m) -> (0%Z <= (bra_length m))%Z.
...
Axiom set_exchange_growing_spec1 :
  forall (i:Z) (j:Z), (i <= j)%Z ->
...
Axiom set_exchange_decreasing_spec1 :
  forall (i:Z) (j:Z), (i <= j)%Z ->
...
Axiom get_permutation1 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) -> forall (e:Z),
  (mem e s) -> mem (f e) s.

Axiom get_permutation2 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) -> forall (e:Z) (e':Z),
  (mem e s) -> (mem e' s) -> ~ (e = e') -> ~ ((f e) = (f e')).

Axiom get_permutation3 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) -> forall (e:Z) (e':Z),
  (mem e s) -> (mem e' s) -> ((f e) = (f e')) -> (e = e').

Axiom get_permutation4 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) -> forall (e:Z),
  (mem e s) -> exists e':Z, (mem e' s) /\ (e = (f e')).
...
Axiom permut_changed_spec :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) -> forall (e:Z),
  (mem e s) -> (mem e (permut_changed s f)) -> ~ ((f e) = e).

Axiom permut_changed_spec1 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) -> forall (e:Z),
  (mem e s) -> ~ ((f e) = e) -> mem e (permut_changed s f).

Axiom permut_changed_spec2 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) ->
...
Axiom permut_unchanged_spec1 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) -> forall (e:Z),
  (mem e s) -> ((f e) = e) -> mem e (permut_unchanged s f).

Parameter disjoint_permut: (set Z) -> (Z -> Z) -> (Z -> Z) -> Prop.

Axiom disjoint_permut_ :
  forall (s:set Z), forall (f:Z -> Z) (g:Z -> Z), (disjoint_permut s f g) ->
  is_a_permutation s f.

Axiom disjoint_permut_1 :
  forall (s:set Z), forall (f:Z -> Z) (g:Z -> Z), (disjoint_permut s f g) ->
  is_a_permutation s g.

Axiom disjoint_permut_2 :
  forall (s:set Z), forall (f:Z -> Z) (g:Z -> Z), (disjoint_permut s f g) ->
  ((inter (permut_changed s f) (permut_changed s g)) = (empty : set Z)).

Axiom disjoint_permut_3 :
...
Axiom get_disjoint_permut1 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) -> (disjoint_permut s f g) -> forall (i:Z),
  (mem i (permut_changed s f)) -> (((comp_func f g) i) = (f i)).

Axiom get_disjoint_permut2 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) -> (disjoint_permut s f g) -> forall (i:Z),
  (mem i (permut_changed s g)) -> (((comp_func f g) i) = (g i)).

Axiom get_disjoint_permut3 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) -> (disjoint_permut s f g) -> forall (i:Z),
  (mem i (permut_changed s f)) -> (((comp_func g f) i) = (f i)).

Axiom get_disjoint_permut4 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) -> (disjoint_permut s f g) -> forall (i:Z),
  (mem i (permut_changed s g)) -> (((comp_func g f) i) = (g i)).

Axiom get_disjoint_permut5 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) -> (disjoint_permut s f g) -> forall (i:Z),
  (mem i s) -> ~ (((comp_func g f) i) = (g i)) ->
  (((comp_func g f) i) = (f i)).

Axiom get_disjoint_permut6 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) -> (disjoint_permut s f g) -> forall (i:Z),
  (mem i s) -> ~ (((comp_func f g) i) = (g i)) ->
  (((comp_func g f) i) = (f i)).
...
Axiom set_disjoint_permut1 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) ->
  ((inter (permut_changed s f) (permut_changed s g)) = (empty : set Z)) ->
  forall (i:Z), (mem i (permut_changed s f)) -> (((comp_func f g) i) = (f i)).

Axiom set_disjoint_permut2 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) ->
  ((inter (permut_changed s f) (permut_changed s g)) = (empty : set Z)) ->
  forall (i:Z), (mem i (permut_changed s g)) -> (((comp_func f g) i) = (g i)).

Axiom set_disjoint_permut3 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) ->
  ((inter (permut_changed s f) (permut_changed s g)) = (empty : set Z)) ->
  forall (i:Z), (mem i (permut_changed s f)) -> (((comp_func g f) i) = (f i)).

Axiom set_disjoint_permut4 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) ->
  ((inter (permut_changed s f) (permut_changed s g)) = (empty : set Z)) ->
  forall (i:Z), (mem i (permut_changed s g)) -> (((comp_func g f) i) = (g i)).

Axiom set_disjoint_permut5 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (is_a_permutation s g) ->
  ((inter (permut_changed s f) (permut_changed s g)) = (empty : set Z)) ->
...
Axiom exchange_spec1 :
  forall (i:Z) (j:Z), forall (s:set Z), (mem i s) -> (mem j s) ->
  is_a_permutation s (exchange i j).

Axiom exchange_changed :
  forall (i:Z) (j:Z) (s:set Z), (mem i s) -> (mem j s) -> forall (e:Z),
  (mem e (permut_changed s (exchange i j))) -> mem e s.

Axiom exchange_changed1 :
  forall (i:Z) (j:Z) (s:set Z), (mem i s) -> (mem j s) -> forall (e:Z),
  (mem e (permut_changed s (exchange i j))) -> ~ (e = i) -> (e = j).
...
Parameter reverse: (set Z) -> (Z -> Z) -> Z -> Z.

Axiom reverse_def :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) ->
  ((reverse s f) = (inv_f f s s)).

Axiom reverse_spec :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) ->
  is_a_permutation s (reverse s f).

Axiom reverse_spec1 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) -> forall (e:Z),
  (mem e s) -> (((reverse s f) (f e)) = e).

Axiom reverse_spec2 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) -> forall (e:Z),
  (mem e s) -> ((f ((reverse s f) e)) = e).

Parameter permut_equal: (set Z) -> (Z -> Z) -> (Z -> Z) -> Prop.

Axiom Permut_equal :
  forall (s:set Z), forall (f:Z -> Z) (g:Z -> Z), (permut_equal s f g) ->
  is_a_permutation s f.
...
Axiom Permut_reverse :
  forall (s:set Z), forall (f:Z -> Z) (g:Z -> Z), (permut_reverse s f g) ->
  is_a_permutation s f.

Axiom Permut_reverse1 :
  forall (s:set Z), forall (f:Z -> Z) (g:Z -> Z), (permut_reverse s f g) ->
  is_a_permutation s g.

Axiom Permut_reverse2 :
  forall (s:set Z), forall (f:Z -> Z) (g:Z -> Z), (permut_reverse s f g) ->
  forall (e:Z), (mem e s) -> ((f (g e)) = e).

Axiom Permut_reverse3 :
  forall (s:set Z), forall (f:Z -> Z) (g:Z -> Z),
  ((is_a_permutation s f) /\
...
Axiom apply_f_reverse_gen :
  ...
  (mem i s) -> ((f ((reverse s f) i)) = i).

Axiom apply_reverse_f_gen :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) -> forall (i:Z),
  (mem i s) -> (((reverse s f) (f i)) = i).
...
Axiom invol_permut_spec1 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) ->
  (permut_reverse s f f) -> invol_permut s f.

Axiom invol_permut_spec2 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) ->
  (invol_permut s f) -> ((reverse s f) = f).

Axiom invol_permut_spec3 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) ->
  ((reverse s f) = f) -> invol_permut s f.
...
Axiom get_invol_permut :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) ->
  (invol_permut s f) -> forall (e:Z), (mem e s) -> ((f (f e)) = e).

Axiom get_invol_permut1 :
  forall (s:set Z) (f:Z -> Z), (is_a_permutation s f) ->
  (invol_permut s f) -> ((reverse s f) = f).
...
Axiom set_permut_equal :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (forall (e:Z), (mem e s) -> ((f e) = (g e))) -> permut_equal s f g.

Axiom set_permut_equal1 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (is_a_permutation s f) ->
  (forall (e:Z), (mem e s) -> ((f e) = (g e))) -> is_a_permutation s g.

Axiom get_permut_equal :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (permut_equal s f g) ->
  is_a_permutation s f.

Axiom get_permut_equal1 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (permut_equal s f g) ->
  is_a_permutation s g.

Axiom get_permut_equal2 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (permut_equal s f g) ->
  forall (e:Z), (mem e s) -> ((f e) = (g e)).

Axiom get_permut_equal3 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (permut_equal s f g) ->
...
Axiom get_permut_reverse1 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (permut_reverse s f g) ->
  is_a_permutation s g.

Axiom get_permut_reverse2 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (permut_reverse s f g) ->
  forall (e:Z), (mem e s) -> ((f (g e)) = e).

Axiom get_permut_reverse3 :
  forall (s:set Z) (f:Z -> Z) (g:Z -> Z), (permut_reverse s f g) ->
...
Axiom permut_reverse_step_def :
  ...
  (is_a_permutation (to_fset 1%Z n) f) -> (i = 1%Z) ->
  ((permut_reverse_step n f i) = (exchange 1%Z (f 1%Z))).
...
Axiom permut_reverse_step_def1 :
  forall (n:Z) (f:Z -> Z) (i:Z), (mem i (to_fset 1%Z n)) ->
  (is_a_permutation (to_fset 1%Z n) f) -> ~ (i = 1%Z) ->
...
Axiom permut_reverse_iter_def :
  ...
  ((1%Z <= i)%Z /\ (i <= n)%Z) -> (i = 1%Z) ->
  ((permut_reverse_iter n f i) = (fun (y0:Z) => y0)).

Axiom permut_reverse_iter_def1 :
  forall (n:Z) (f:Z -> Z) (i:Z),
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) ->
  ((1%Z <= i)%Z /\ (i <= n)%Z) -> ~ (i = 1%Z) ->
...
Axiom permut_reverse_iter_spec1 :
  forall (n:Z) (f:Z -> Z) (i:Z),
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) ->
  ((1%Z <= i)%Z /\ (i <= n)%Z) ->
...
Axiom permut_reverse_iter_spec2 :
  forall (n:Z) (f:Z -> Z) (i:Z),
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) ->
  ((1%Z <= i)%Z /\ (i <= n)%Z) ->
  ((permut_reverse_iter n f i) =
...
Axiom permut_reverse_iter_spec3 :
  forall (n:Z) (f:Z -> Z) (i:Z),
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) ->
  ((1%Z <= i)%Z /\ (i <= n)%Z) ->
  ((permut_reverse_iter n f i) = (iter_comp (fc7 n f i) 1%Z i)).

Axiom permut_reverse_iter_spec4 :
  forall (n:Z) (f:Z -> Z) (i:Z),
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) ->
  ((1%Z <= i)%Z /\ (i <= n)%Z) ->
...
Axiom permut_reverse_iter_spec5 :
  forall (n:Z) (f:Z -> Z) (i:Z),
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) ->
  ((1%Z <= i)%Z /\ (i <= n)%Z) -> forall (k:Z),
  ((1%Z <= k)%Z /\ (k <= n)%Z) -> ~ (k = i) ->
  ~ (k = ((comp_func (permut_reverse_iter n f i) f) i)) ->
  (((permut_reverse_step (n + 1%Z)%Z f i) k) = k).

Axiom permut_reverse_iter_spec6 :
  forall (n:Z) (f:Z -> Z) (i:Z),
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) ->
  ((1%Z <= i)%Z /\ (i <= n)%Z) ->
...
Axiom permut_reverse_iter_spec7 :
  forall (n:Z) (f:Z -> Z) (i:Z),
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) ->
  ((1%Z <= i)%Z /\ (i <= n)%Z) ->
  (((permut_reverse_step (n + 1%Z)%Z f i)
...
Axiom permut_reverse_iter_spec8 :
  forall (n:Z) (f:Z -> Z) (i:Z),
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) ->
  ((1%Z <= i)%Z /\ (i <= n)%Z) ->
  is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) (permut_reverse_iter n f i).
...
Axiom exchange_double_spec1 :
  forall (a1:Z) (a2:Z) (b1:Z) (b2:Z) (n:Z), ~ (a1 = a2) -> ~ (b1 = b2) ->
  (mem a1 (to_fset 1%Z (n + 1%Z)%Z)) -> (mem a2 (to_fset 1%Z (n + 1%Z)%Z)) ->
  (mem b1 (to_fset 1%Z (n + 1%Z)%Z)) -> (mem b2 (to_fset 1%Z (n + 1%Z)%Z)) ->
  (((exchange_double a1 a2 b1 b2 n) a2) = b2).

Axiom exchange_double_spec2 :
  forall (a1:Z) (a2:Z) (b1:Z) (b2:Z) (n:Z), ~ (a1 = a2) -> ~ (b1 = b2) ->
  (mem a1 (to_fset 1%Z (n + 1%Z)%Z)) -> (mem a2 (to_fset 1%Z (n + 1%Z)%Z)) ->
  (mem b1 (to_fset 1%Z (n + 1%Z)%Z)) -> (mem b2 (to_fset 1%Z (n + 1%Z)%Z)) ->
  (((exchange_double a1 a2 b1 b2 n) b1) = a1).

Axiom exchange_double_spec3 :
  forall (a1:Z) (a2:Z) (b1:Z) (b2:Z) (n:Z), ~ (a1 = a2) -> ~ (b1 = b2) ->
  (mem a1 (to_fset 1%Z (n + 1%Z)%Z)) -> (mem a2 (to_fset 1%Z (n + 1%Z)%Z)) ->
  (mem b1 (to_fset 1%Z (n + 1%Z)%Z)) -> (mem b2 (to_fset 1%Z (n + 1%Z)%Z)) ->
  (((exchange_double a1 a2 b1 b2 n) b2) = a2).

Axiom exchange_double_spec4 :
  forall (a1:Z) (a2:Z) (b1:Z) (b2:Z) (n:Z), ~ (a1 = a2) -> ~ (b1 = b2) ->
  (mem a1 (to_fset 1%Z (n + 1%Z)%Z)) -> (mem a2 (to_fset 1%Z (n + 1%Z)%Z)) ->
  (mem b1 (to_fset 1%Z (n + 1%Z)%Z)) -> (mem b2 (to_fset 1%Z (n + 1%Z)%Z)) ->
  is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) (exchange_double a1 a2 b1 b2 n).

Axiom permut_reverse_iter_assoc :
  forall (n:Z) (f:Z -> Z) (i:Z), ((1%Z <= i)%Z /\ (i <= n)%Z) ->
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) -> (1%Z < i)%Z ->
  ((comp_func (permut_reverse_iter n f i) f) =
   (comp_func (permut_reverse_step (n + 1%Z)%Z f (i - 1%Z)%Z)
    (comp_func (permut_reverse_iter n f (i - 1%Z)%Z) f))).

Axiom permut_reverse_iter_assoc1 :
  forall (n:Z) (f:Z -> Z) (i:Z), ((1%Z <= i)%Z /\ (i <= n)%Z) ->
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) -> forall (k:Z),
  ((1%Z <= k)%Z /\ (k < i)%Z) ->
  (((comp_func (permut_reverse_iter n f i) f) k) = k).

Axiom permut_reverse_iter_assoc2 :
  forall (n:Z) (f:Z -> Z) (i:Z), ((1%Z <= i)%Z /\ (i <= n)%Z) ->
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) -> forall (k:Z),
  ((i <= k)%Z /\ (k < n)%Z) ->
...
Axiom permut_decomp :
  ...
  (permut_reverse_iter n (reverse (to_fset 1%Z (n + 1%Z)%Z) f) n) f.

Axiom permut_decomp_inv :
  forall (n:Z) (f:Z -> Z), (1%Z < n)%Z ->
  (is_a_permutation (to_fset 1%Z (n + 1%Z)%Z) f) ->
  permut_equal (to_fset 1%Z (n + 1%Z)%Z) f
  (permut_reverse_iter n (reverse (to_fset 1%Z (n + 1%Z)%Z) f) n).
...
Axiom bitvec'invariant1 :
  ...
  ((1%Z <= i)%Z /\ (i <= (length self))%Z) -> (0%Z <= ((value self) i))%Z.

Axiom bitvec'invariant2 :
  forall (self:bitvec), forall (i:Z),
  ((1%Z <= i)%Z /\ (i <= (length self))%Z) -> (((value self) i) < 2%Z)%Z.

Axiom bitvec'invariant3 :
  forall (self:bitvec), forall (i:Z), ~ (1%Z <= i)%Z ->
  (((value self) i) = 0%Z).
...
Axiom getbv_spec :
  forall (a:bitvec) (i:Z), ((1%Z <= i)%Z /\ (i <= (length a))%Z) ->
  (0%Z <= (getbv a i))%Z.
...
Axiom getbv_spec2 : forall (a:bitvec) (i:Z), ((getbv a i) = ((value a) i)).
...
Axiom get_bvlength :
  ...
  ((1%Z <= k)%Z /\ (k <= i)%Z) -> (0%Z <= (f k))%Z.

Axiom get_bvlength1 :
  forall (f:Z -> Z) (i:Z), (bvlength f i) -> forall (k:Z),
  ((1%Z <= k)%Z /\ (k <= i)%Z) -> ((f k) < 2%Z)%Z.
...
Axiom get_equal_bv1 :
  ...
  ((1%Z <= i)%Z /\ (i <= (length bv))%Z) -> ((getbv bv i) = (getbv bv' i)).
...
Axiom make_bv_spec1 :
  ...
  (forall (i:Z), ((1%Z <= i)%Z /\ (i <= s)%Z) ->
   (0%Z <= (f i))%Z /\ ((f i) < 2%Z)%Z) ->
  (0%Z <= s)%Z -> forall (i:Z), ((1%Z <= i)%Z /\ (i <= s)%Z) ->
...
Axiom make_bv_m_spec3 :
  forall (f:Z -> Z) (s:Z), (0%Z <= s)%Z -> forall (k:Z), ~ (1%Z <= k)%Z ->
...
Axiom tail_spec1 :
  ...
  (in_range (tail bv) i) -> ((getbv (tail bv) i) = (getbv bv (i + 1%Z)%Z)).
...
Axiom int_to_bv_spec1 :
  forall (i:Z) (n:Z), (0%Z <= n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) -> ((length (int_to_bv i n)) = n).
...
Axiom first_div_spec2 :
  forall (bv1:bitvec) (bv2:bitvec), ((length bv1) = (length bv2)) ->
  ~ (bv1 = bv2) -> (1%Z <= (first_div bv1 bv2))%Z.

Axiom first_div_spec3 :
  forall (bv1:bitvec) (bv2:bitvec), ((length bv1) = (length bv2)) ->
  ~ (bv1 = bv2) -> ((first_div bv1 bv2) <= ((length bv1) + 1%Z)%Z)%Z.

Axiom first_div_spec4 :
  forall (bv1:bitvec) (bv2:bitvec), ((length bv1) = (length bv2)) ->
  ~ (bv1 = bv2) -> ((first_div bv1 bv2) = ((length bv1) + 1%Z)%Z) ->
  (bv1 = bv2).
...
Axiom kth_decomp_bound_zero :
  forall (bv:bitvec) (k:Z), ((1%Z <= k)%Z /\ (k <= (length bv))%Z) ->
  ((getbv bv k) = 0%Z) -> ((ind_isum (fc11 bv) 1%Z k) <= (bv_to_int bv))%Z.
...
Axiom hpart_spec1 :
  ...
  ((1%Z <= k)%Z /\ (k <= m)%Z) -> ((getbv (hpart bv m) k) = (getbv bv k)).

Axiom hpart_spec2 :
  forall (bv:bitvec) (m:Z), (0%Z <= m)%Z -> forall (k:Z), ~ (1%Z <= k)%Z ->
...
Axiom concat_value_ht :
  ...
  ((1%Z <= i)%Z /\ (i <= (length bv3))%Z) -> ~ (1%Z <= i)%Z ->
...
Axiom concat_value_ht2 :
  forall (bv1:bitvec) (bv2:bitvec) (bv3:bitvec) (bv4:bitvec) (i:Z),
  ((1%Z <= i)%Z /\ (i <= (length bv3))%Z) -> ~ (i <= (length bv1))%Z ->
  ~ ((length bv1) < i)%Z -> (bv2 = (tpart bv3 (length bv1))) ->
  ((getbv (concat bv1 bv2) i) = (getbv bv4 i)).
...
Axiom concat_value_ht5 :
  forall (bv1:bitvec) (bv2:bitvec) (bv3:bitvec) (bv4:bitvec) (i:Z),
  ((1%Z <= i)%Z /\ (i <= (length bv3))%Z) ->
  ((getbv bv1 i) = (getbv bv4 i)) -> ((getbv bv3 i) = (getbv bv4 i)) ->
  (bv2 = (tpart bv3 (length bv1))) ->
  ((getbv (concat bv1 bv2) i) = (getbv bv4 i)).
...
Axiom set_is_the_ket_bits_det1 :
  forall (m:matrix t) (i:Z) (n:Z), (0%Z <= n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) -> ((rows m) = (power 2%Z n)) ->
  ((columns m) = 1%Z) ->
  (forall (j:Z), (valid_index m j 0%Z) -> ((get m j 0%Z) = (indic i j))) ->
...
Axiom set_is_the_ket_bits_det2 :
  forall (m:matrix t) (i:Z) (n:Z), (0%Z <= n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) -> ((rows m) = (power 2%Z n)) ->
  ((columns m) = 1%Z) ->
  (forall (j:Z), (valid_index m j 0%Z) -> ((get m j 0%Z) = (indic i j))) ->
...
Axiom get_is_the_ket_bits :
  forall (m:matrix t) (i:Z) (n:Z), (is_the_ket_bits m i n) -> (0%Z <= n)%Z.

Axiom get_is_the_ket_bits1 :
  forall (m:matrix t) (i:Z) (n:Z), (is_the_ket_bits m i n) -> (0%Z <= i)%Z.

Axiom get_is_the_ket_bits2 :
  forall (m:matrix t) (i:Z) (n:Z), (is_the_ket_bits m i n) ->
  (i < (power 2%Z n))%Z.

Axiom get_is_the_ket_bits3 :
  forall (m:matrix t) (i:Z) (n:Z), (is_the_ket_bits m i n) ->
  equal m (ket n i).

Axiom get_is_the_ket_bits4 :
  forall (m:matrix t) (i:Z) (n:Z), (is_the_ket_bits m i n) -> is_a_ket m.

Axiom get_is_the_ket_bits5 :
  forall (m:matrix t) (i:Z) (n:Z), (is_the_ket_bits m i n) ->
  ((ket_length m) = n).

Axiom get_is_the_ket_bits6 :
  forall (m:matrix t) (i:Z) (n:Z), (is_the_ket_bits m i n) -> forall (j:Z),
  (valid_index m j 0%Z) -> ((get m j 0%Z) = (indic i j)).

Parameter is_a_ket_bits: (matrix t) -> Z -> Prop.

Axiom is_a_ket_bits1 :
  forall (m:matrix t), forall (n:Z), (0%Z <= n)%Z -> (is_a_ket_bits m n) ->
  is_a_ket m.

Axiom is_a_ket_bits2 :
  forall (m:matrix t), forall (n:Z), (0%Z <= n)%Z -> (is_a_ket_bits m n) ->
  exists i:Z,
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) /\ (is_the_ket_bits m i n).

Axiom is_a_ket_bits3 :
...
Axiom the_ket_bits_is_a_ket_bits :
  ...
  (0%Z <= n)%Z -> (is_the_ket_bits m i n) -> is_a_ket_bits m n.

Axiom the_ket_bits_is_a_ket_bits1 :
  forall (m:matrix t) (n:Z) (i:Z), ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  (0%Z <= n)%Z -> (is_the_ket_bits m i n) -> is_a_ket m.
...
Axiom kronecker_q_ket1 :
  forall (m:matrix t) (n:matrix t), (is_a_ket m) -> (is_a_ket n) ->
  ((ket_length (kronecker m n)) = ((ket_length m) + (ket_length n))%Z).

Axiom kronecker_q_ket2 :
  forall (m:matrix t) (n:matrix t), (is_a_ket m) -> (is_a_ket n) ->
...
Axiom k_iter_ket :
  ...
  ((0%Z <= l)%Z /\ (l < h)%Z) -> is_a_ket (k_iter f l h).
...
Axiom k_iter_ket2 :
  forall (f:Z -> matrix t) (l:Z) (h:Z),
  (forall (k:Z), ((l <= k)%Z /\ (k < h)%Z) -> is_a_ket (f k)) ->
  ((0%Z <= l)%Z /\ (l < h)%Z) -> forall (ind:Z),
  (valid_index (k_iter f l h) ind 0%Z) ->
...
Axiom k_iter_ket_units1 :
  forall (f:Z -> matrix t) (l:Z) (h:Z), ((1%Z <= l)%Z /\ (l < h)%Z) ->
  (forall (k:Z), ((l <= k)%Z /\ (k < h)%Z) -> is_a_ket (f k)) ->
  (forall (k:Z), ((l <= k)%Z /\ (k < h)%Z) -> ((ket_length (f k)) = 1%Z)) ->
  ((ket_length (k_iter f l h)) = (h - l)%Z).

Axiom k_iter_ket_units2 :
  forall (f:Z -> matrix t) (l:Z) (h:Z), ((1%Z <= l)%Z /\ (l < h)%Z) ->
  (forall (k:Z), ((l <= k)%Z /\ (k < h)%Z) -> is_a_ket (f k)) ->
  (forall (k:Z), ((l <= k)%Z /\ (k < h)%Z) -> ((ket_length (f k)) = 1%Z)) ->
...
Axiom ket_kronecker_indexes1 :
  forall (m:matrix t) (n:matrix t), (is_a_ket m) -> (is_a_ket n) ->
  forall (k:Z) (l:Z), (valid_index (kronecker m n) k l) ->
  valid_index m (int.EuclideanDivision.div k (rows n)) l.

Axiom ket_kronecker_indexes2 :
  forall (m:matrix t) (n:matrix t), (is_a_ket m) -> (is_a_ket n) ->
  forall (k:Z) (l:Z), (valid_index (kronecker m n) k l) ->
  valid_index n (int.EuclideanDivision.mod1 l (rows n)) l.
...
Axiom unary_ket_spec :
  forall (i:Z), ((0%Z <= i)%Z /\ (i < 2%Z)%Z) -> is_a_ket (unary_ket i).

Axiom unary_ket_spec1 :
  forall (i:Z), ((0%Z <= i)%Z /\ (i < 2%Z)%Z) ->
  ((ket_length (unary_ket i)) = 1%Z).

Axiom unary_ket_spec2 :
  forall (i:Z), ((0%Z <= i)%Z /\ (i < 2%Z)%Z) ->
  ((unary_ket i) = (ket 1%Z i)).

Axiom unary_ket_spec3 :
  forall (i:Z), ((0%Z <= i)%Z /\ (i < 2%Z)%Z) ->
...
Axiom init_ket_spec :
  forall (i:Z) (n:Z), ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  (0%Z < n)%Z -> is_a_ket (init_ket i n).

Axiom init_ket_spec1 :
  forall (i:Z) (n:Z), ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  (0%Z < n)%Z -> ((ket_length (init_ket i n)) = n).

Axiom init_ket_spec2 :
  forall (i:Z) (n:Z), ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
...
Axiom ket_apply_is_a_ket_basis_element1 :
  forall (n:Z) (i:Z), (0%Z <= n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) -> ((ket_length (ket n i)) = n).
...
Axiom ket_apply_is_a_ket_basis_element_gen1 :
  forall (n:Z), (0%Z <= n)%Z -> forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) -> ((ket_length (ket n i)) = n).
...
(* Why3 assumption *)
Inductive quantum_circuit :=
  | Phase : (Z* Z)%type -> quantum_circuit
  | Rx : (Z* Z)%type -> quantum_circuit
  | Ry : (Z* Z)%type -> quantum_circuit
  | Rz : (Z* Z)%type -> quantum_circuit
  | Cnot : quantum_circuit
  | Sequence : quantum_circuit -> quantum_circuit -> quantum_circuit
  | Parallel : quantum_circuit -> quantum_circuit -> quantum_circuit.
Axiom quantum_circuit_WhyType : WhyType quantum_circuit.
Existing Instance quantum_circuit_WhyType.

(* Why3 assumption *)
Fixpoint subterms (c:quantum_circuit) {struct c}: set quantum_circuit :=
  match c with
  | Sequence d e => add c (union (subterms d) (subterms e))
  | Parallel d e => add c (union (subterms d) (subterms e))
  | _ => add c (empty : set quantum_circuit)
  end.

Axiom self_subterms_pre :
  forall (c:quantum_circuit) (c':quantum_circuit), (mem c' (subterms c)) ->
  forall (x:quantum_circuit) (x1:quantum_circuit), (c = (Sequence x x1)) ->
  ~ (mem c' (subterms x)) -> ~ (mem c' (subterms x1)) -> (c' = c).

Axiom self_subterms_pre1 :
  forall (c:quantum_circuit) (c':quantum_circuit), (mem c' (subterms c)) ->
  forall (x:quantum_circuit) (x1:quantum_circuit), (c = (Parallel x x1)) ->
  ~ (mem c' (subterms x)) -> ~ (mem c' (subterms x1)) -> (c' = c).

Axiom self_subterms_pre2 :
  forall (c:quantum_circuit) (c':quantum_circuit), (mem c' (subterms c)) ->
  (exists w:(Z* Z)%type, (c = (Phase w))) -> (c' = c).

Axiom self_subterms_pre3 :
  forall (c:quantum_circuit) (c':quantum_circuit), (mem c' (subterms c)) ->
  (exists w:(Z* Z)%type, (c = (Rx w))) -> (c' = c).

Axiom self_subterms_pre4 :
  forall (c:quantum_circuit) (c':quantum_circuit), (mem c' (subterms c)) ->
  (exists w:(Z* Z)%type, (c = (Ry w))) -> (c' = c).

Axiom self_subterms_pre5 :
  forall (c:quantum_circuit) (c':quantum_circuit), (mem c' (subterms c)) ->
  (exists w:(Z* Z)%type, (c = (Rz w))) -> (c' = c).

Axiom self_subterms_pre6 :
  forall (c:quantum_circuit) (c':quantum_circuit), (mem c' (subterms c)) ->
  (c = Cnot) -> (c' = c).

Axiom self_subterms : forall (c:quantum_circuit), mem c (subterms c).

Axiom self_subterms1 :
  forall (c:quantum_circuit), forall (c':quantum_circuit),
  (mem c' (subterms c)) -> forall (x:quantum_circuit) (x1:quantum_circuit),
  (c = (Sequence x x1)) -> ~ (mem c' (subterms x)) ->
  ~ (mem c' (subterms x1)) -> (c' = c).

Axiom self_subterms2 :
  forall (c:quantum_circuit), forall (c':quantum_circuit),
  (mem c' (subterms c)) -> forall (x:quantum_circuit) (x1:quantum_circuit),
  (c = (Parallel x x1)) -> ~ (mem c' (subterms x)) ->
  ~ (mem c' (subterms x1)) -> (c' = c).

Axiom self_subterms3 :
  forall (c:quantum_circuit), forall (c':quantum_circuit),
  (mem c' (subterms c)) -> (exists w:(Z* Z)%type, (c = (Phase w))) ->
  (c' = c).

Axiom self_subterms4 :
  forall (c:quantum_circuit), forall (c':quantum_circuit),
  (mem c' (subterms c)) -> (exists w:(Z* Z)%type, (c = (Rx w))) -> (c' = c).

Axiom self_subterms5 :
  forall (c:quantum_circuit), forall (c':quantum_circuit),
  (mem c' (subterms c)) -> (exists w:(Z* Z)%type, (c = (Ry w))) -> (c' = c).

Axiom self_subterms6 :
  forall (c:quantum_circuit), forall (c':quantum_circuit),
  (mem c' (subterms c)) -> (exists w:(Z* Z)%type, (c = (Rz w))) -> (c' = c).

Axiom self_subterms7 :
  forall (c:quantum_circuit), forall (c':quantum_circuit),
  (mem c' (subterms c)) -> (c = Cnot) -> (c' = c).

Axiom immediate_subterms :
  forall (c:quantum_circuit),
  forall (x:quantum_circuit) (x1:quantum_circuit), (c = (Sequence x x1)) ->
  mem x (subterms c).

Axiom immediate_subterms1 :
  forall (c:quantum_circuit),
  forall (x:quantum_circuit) (x1:quantum_circuit), (c = (Sequence x x1)) ->
  mem x1 (subterms c).

Axiom immediate_subterms2 :
  forall (c:quantum_circuit),
  forall (x:quantum_circuit) (x1:quantum_circuit), (c = (Parallel x x1)) ->
  mem x (subterms c).

Axiom immediate_subterms3 :
  forall (c:quantum_circuit),
  forall (x:quantum_circuit) (x1:quantum_circuit), (c = (Parallel x x1)) ->
  mem x1 (subterms c).

Axiom transitive_subterms :
  forall (c:quantum_circuit) (c':quantum_circuit), (mem c' (subterms c)) ->
  forall (c'':quantum_circuit), (mem c'' (subterms c')) ->
  mem c'' (subterms c).

Axiom transitive_subterms_gen :
  forall (c:quantum_circuit),
  forall (c':quantum_circuit) (c'':quantum_circuit), (mem c' (subterms c)) ->
  (mem c'' (subterms c')) -> mem c'' (subterms c).

(* Why3 assumption *)
Fixpoint depth (c:quantum_circuit) {struct c}: Z :=
  match c with
  | Cnot => 2%Z
  | Sequence d _ => depth d
  | Parallel d e => ((depth d) + (depth e))%Z
  | _ => 1%Z
  end.

Axiom depth_spec : forall (c:quantum_circuit), (1%Z <= (depth c))%Z.

(* Why3 assumption *)
Fixpoint sequence_correct (c:quantum_circuit) {struct c}: Prop :=
  match c with
  | Sequence d e =>
      ((depth d) = (depth e)) /\
      ((sequence_correct d) /\ (sequence_correct e))
  | Parallel d e => (sequence_correct d) /\ (sequence_correct e)
  | _ => True
  end.

Axiom set_sequence_correct :
  forall (c:quantum_circuit),
  (exists x:quantum_circuit, exists x1:quantum_circuit,
   (c = (Sequence x x1)) /\
   (((depth x) = (depth x1)) /\
    ((sequence_correct x) /\ (sequence_correct x1)))) ->
  sequence_correct c.

Axiom set_sequence_correct1 :
  forall (c:quantum_circuit),
  (exists x:quantum_circuit, exists x1:quantum_circuit,
   (c = (Parallel x x1)) /\ ((sequence_correct x) /\ (sequence_correct x1))) ->
  sequence_correct c.

Axiom set_sequence_correct2 :
  forall (c:quantum_circuit), (exists w:(Z* Z)%type, (c = (Phase w))) ->
  sequence_correct c.

Axiom set_sequence_correct3 :
  forall (c:quantum_circuit), (exists w:(Z* Z)%type, (c = (Rx w))) ->
  sequence_correct c.

Axiom set_sequence_correct4 :
  forall (c:quantum_circuit), (exists w:(Z* Z)%type, (c = (Ry w))) ->
  sequence_correct c.

Axiom set_sequence_correct5 :
  forall (c:quantum_circuit), (exists w:(Z* Z)%type, (c = (Rz w))) ->
  sequence_correct c.

Axiom set_sequence_correct6 :
  forall (c:quantum_circuit), (c = Cnot) -> sequence_correct c.

Axiom sub_sequence_correct :
  forall (c:quantum_circuit) (c':quantum_circuit), (sequence_correct c) ->
  (mem c' (subterms c)) -> sequence_correct c'.

(* Why3 assumption *)
Definition constant_depth {a:Type} {a_WT:WhyType a} (s:set a)
    (f:a -> quantum_circuit) : Prop :=
  forall (e:a), (mem e s) -> ((depth (f e)) = (depth (f (choose s)))).

Axiom set_constant_depth :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> quantum_circuit),
  (forall (e:a), (mem e s) -> ((depth (f e)) = (depth (f (choose s))))) ->
  constant_depth s f.

Axiom get_constant_depth :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> quantum_circuit), (constant_depth s f) ->
  forall (e:a), (mem e s) -> ((depth (f e)) = (depth (f (choose s)))).

Axiom subset_constant_depth :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (s':set a) (f:a -> quantum_circuit),
  (constant_depth s f) -> (subset s' s) -> constant_depth s' f.

Axiom bound_depth :
  forall (c:quantum_circuit) (c':quantum_circuit), (mem c' (subterms c)) ->
  (sequence_correct c) -> ((depth c') <= (depth c))%Z.
...
Axiom cos_spec : forall (x:t), (real_ x) -> real_ (cos x).

Axiom cos_spec1 :
  forall (x:t), (real_ x) -> infix_lseqdt (prefix_mndt tone) (cos x).

Axiom cos_spec2 : forall (x:t), (real_ x) -> infix_lseqdt (cos x) tone.
...
Axiom periodic_cos :
  forall (k:Z), forall (x:t),
  ((cos
    (infix_pldt
     (infix_asdt (infix_asdt (i_to_t k) pi) (infix_pldt tone tone)) x))
   = (cos x)).
...
Axiom anti_sym_cos :
  ...
  ((cos
    (infix_pldt
     (infix_pldt (infix_asdt (i_to_t k) pi)
      (infix_sldt pi (infix_pldt tone tone)))
     x))
   =
   (prefix_mndt
    (cos
...
Axiom sin_spec : forall (x:t), (real_ x) -> real_ (sin x).

Axiom sin_spec1 :
  forall (x:t), (real_ x) -> infix_lseqdt (prefix_mndt tone) (sin x).

Axiom sin_spec2 : forall (x:t), (real_ x) -> infix_lseqdt (sin x) tone.

(* Why3 assumption *)
Definition d_inv (o:(Z* Z)%type) : (Z* Z)%type := ((-(fir o))%Z, sec o).

(* Why3 assumption *)
Definition d_omega (o:(Z* Z)%type) : t := p_omega (sec o) (fir o).

Axiom d_omega_spec :
  forall (o:(Z* Z)%type),
  ((d_omega o) = (p_unity (power 2%Z (ZArith.BinInt.Z.abs (sec o))) (fir o))).

(* Why3 assumption *)
Definition mult_two (o:(Z* Z)%type) : (Z* Z)%type :=
  ((2%Z * (fir o))%Z, sec o).

(* Why3 assumption *)
Definition div_two (o:(Z* Z)%type) : (Z* Z)%type :=
  (fir o, ((sec o) + 1%Z)%Z).

(* Why3 assumption *)
Definition phase_inv (i:Z) (o:(Z* Z)%type) : (Z* Z)%type :=
  (((power (-1%Z)%Z i) * (fir o))%Z, sec o).

(* Why3 assumption *)
Definition cos_d (o:(Z* Z)%type) : t :=
  cos (infix_sldt (i_to_t (fir o)) (i_to_t (power 2%Z (sec o)))).

(* Why3 assumption *)
Definition sin_d (o:(Z* Z)%type) : t :=
  sin (infix_sldt (i_to_t (fir o)) (i_to_t (power 2%Z (sec o)))).
...
Axiom bv_to_ket_rows :
  forall (bv:bitvec), ((rows (bv_to_ket bv)) = (power 2%Z (length bv))).

Axiom bv_to_ket_columns :
  forall (bv:bitvec), ((columns (bv_to_ket bv)) = 1%Z).
...
(* Why3 assumption *)
Fixpoint sum_range (c:quantum_circuit) {struct c}: Z :=
  match c with
  | Phase _ => 0%Z
  | Rx _ => 1%Z
  | Ry _ => 1%Z
  | Rz _ => 0%Z
  | Cnot => 0%Z
  | Sequence d e => ((sum_range d) + (sum_range e))%Z
  | Parallel d e => ((sum_range d) + (sum_range e))%Z
  end.

Axiom positive_sum_range :
  forall (c:quantum_circuit), (0%Z <= (sum_range c))%Z.

Axiom upper_bound_sum_range :
  forall (c:quantum_circuit) (c':quantum_circuit), (mem c' (subterms c)) ->
  ((sum_range c') <= (sum_range c))%Z.

Parameter ket_part: quantum_circuit -> bitvec -> bitvec -> bitvec.

Axiom ket_part_def :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:(Z* Z)%type), (c = (Phase x)) ->
  ((ket_part c bvx bvy) =
   (make_bv ((fun (y0:bitvec) (y1:Z) => (getbv y0 y1)) bvx) 1%Z)).

Parameter result20: bitvec -> bitvec -> Z -> Z.

Axiom result_def20 :
  forall (bvx:bitvec) (bvy:bitvec) (i:Z),
  ((i = 1%Z) -> (((result20 bvx bvy) i) = (getbv bvy i))) /\
  (~ (i = 1%Z) -> (((result20 bvx bvy) i) = (getbv bvx i))).

Axiom ket_part_def1 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:(Z* Z)%type), (c = (Rx x)) ->
  ((ket_part c bvx bvy) = (make_bv (result20 bvx bvy) 1%Z)).

Parameter result21: bitvec -> bitvec -> Z -> Z.

Axiom result_def21 :
  forall (bvx:bitvec) (bvy:bitvec) (i:Z),
  ((i = 1%Z) -> (((result21 bvx bvy) i) = (getbv bvy i))) /\
  (~ (i = 1%Z) -> (((result21 bvx bvy) i) = (getbv bvx i))).

Axiom ket_part_def2 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:(Z* Z)%type), (c = (Ry x)) ->
  ((ket_part c bvx bvy) = (make_bv (result21 bvx bvy) 1%Z)).

Axiom ket_part_def3 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:(Z* Z)%type), (c = (Rz x)) ->
  ((ket_part c bvx bvy) =
   (make_bv ((fun (y0:bitvec) (y1:Z) => (getbv y0 y1)) bvx) 1%Z)).

Parameter result22: bitvec -> Z -> Z.

Axiom result_def22 :
  forall (bvx:bitvec) (i:Z),
  ((i = 2%Z) ->
   (((result22 bvx) i) =
    (int.EuclideanDivision.mod1 ((getbv bvx 1%Z) + (getbv bvx 2%Z))%Z 2%Z))) /\
  (~ (i = 2%Z) -> (((result22 bvx) i) = (getbv bvx i))).

Axiom ket_part_def4 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> (c = Cnot) ->
  ((ket_part c bvx bvy) = (make_bv (result22 bvx) 2%Z)).

Axiom ket_part_def5 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:quantum_circuit) (x1:quantum_circuit),
  (c = (Sequence x x1)) ->
  ((ket_part c bvx bvy) =
   (ket_part x1 (ket_part x bvx (hpart bvy (sum_range x)))
    (tpart bvy (sum_range x)))).
...
Axiom ket_part_def6 :
  ...
  (c = (Parallel x x1)) ->
  ((ket_part c bvx bvy) =
   (concat (ket_part x (hpart bvx (depth x)) (hpart bvy (sum_range x)))
    (ket_part x1 (tpart bvx (depth x)) (tpart bvy (sum_range x))))).

Axiom ket_part_spec :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> ((length (ket_part c bvx bvy)) = (depth c)).

Parameter phase_part: quantum_circuit -> bitvec -> bitvec -> t.

Axiom phase_part_def :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:(Z* Z)%type), (c = (Phase x)) ->
  ((phase_part c bvx bvy) = (d_omega x)).

Axiom phase_part_def1 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:(Z* Z)%type), (c = (Rx x)) ->
  ((phase_part c bvx bvy) =
   (infix_asdt squarert_two
    (infix_mndt
     (infix_asdt (indic (getbv bvx 1%Z) (getbv bvy 1%Z)) (cos_d (div_two x)))
     (infix_asdt
      (infix_asdt (indic (getbv bvx 1%Z) (1%Z - (getbv bvy 1%Z))%Z) im)
      (sin_d (div_two x)))))).

Axiom phase_part_def2 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:(Z* Z)%type), (c = (Ry x)) ->
  ((phase_part c bvx bvy) =
   (infix_asdt squarert_two
    (infix_pldt
     (infix_asdt (indic (getbv bvx 1%Z) (getbv bvy 1%Z)) (cos_d (div_two x)))
     (infix_asdt
      (infix_asdt (indic (getbv bvx 1%Z) (1%Z - (getbv bvy 1%Z))%Z)
       (cpower (prefix_mndt tone) (getbv bvx 1%Z)))
      (sin_d (div_two x)))))).

Axiom phase_part_def3 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:(Z* Z)%type), (c = (Rz x)) ->
  ((phase_part c bvx bvy) =
   (d_omega (phase_inv (getbv bvx 1%Z) (div_two x)))).

Axiom phase_part_def4 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> (c = Cnot) -> ((phase_part c bvx bvy) = tone).

Axiom phase_part_def5 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:quantum_circuit) (x1:quantum_circuit),
  (c = (Sequence x x1)) ->
  ((phase_part c bvx bvy) =
   (infix_asdt (phase_part x bvx (hpart bvy (sum_range x)))
    (phase_part x1 (ket_part x bvx (hpart bvy (sum_range x)))
     (tpart bvy (sum_range x))))).

Axiom phase_part_def6 :
  forall (c:quantum_circuit) (bvx:bitvec) (bvy:bitvec),
  (sequence_correct c) -> forall (x:quantum_circuit) (x1:quantum_circuit),
  (c = (Parallel x x1)) ->
  ((phase_part c bvx bvy) =
   (infix_asdt (phase_part x (hpart bvx (depth x)) (hpart bvy (sum_range x)))
    (phase_part x1 (tpart bvx (depth x)) (tpart bvy (sum_range x))))).

Parameter path_sum_func:
  (bitvec -> bitvec -> t) -> (bitvec -> bitvec -> bitvec) -> Z -> Z ->
  (matrix t) -> matrix t.

Axiom path_sum_func_def :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket_basis_elt x) -> (0%Z < (ket_length x))%Z ->
  ((ket_length x) = depth1) -> (0%Z <= m)%Z ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  ((path_sum_func phase_part1 f m depth1 x) =
   (infix_asdtdt (pow_inv_sqrt_2 m)
    (mat_sum (n_bvs m)
     (fun (bvy:bitvec) =>
      (infix_asdtdt ((phase_part1 (ket_to_bv x)) bvy)
       (bv_to_ket ((f (ket_to_bv x)) bvy))))))).

Axiom path_sum_func_spec :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket_basis_elt x) -> (0%Z < (ket_length x))%Z ->
  ((ket_length x) = depth1) -> (0%Z <= m)%Z ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  ((rows (path_sum_func phase_part1 f m depth1 x)) = (power 2%Z depth1)).

Axiom path_sum_func_spec1 :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket_basis_elt x) -> (0%Z < (ket_length x))%Z ->
  ((ket_length x) = depth1) -> (0%Z <= m)%Z ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  ((columns (path_sum_func phase_part1 f m depth1 x)) = 1%Z).

Axiom path_sum_func_spec2 :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket_basis_elt x) -> (0%Z < (ket_length x))%Z ->
  ((ket_length x) = depth1) -> (0%Z <= m)%Z ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  is_a_ket (path_sum_func phase_part1 f m depth1 x).

Axiom path_sum_func_spec3 :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket_basis_elt x) -> (0%Z < (ket_length x))%Z ->
  ((ket_length x) = depth1) -> (0%Z <= m)%Z ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  constant_size (n_bvs m)
  (fun (bvy:bitvec) =>
   (infix_asdtdt ((phase_part1 (ket_to_bv x)) bvy)
    (bv_to_ket ((f (ket_to_bv x)) bvy)))).

Axiom path_sum_func_spec4 :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket_basis_elt x) -> (0%Z < (ket_length x))%Z ->
  ((ket_length x) = depth1) -> (0%Z <= m)%Z ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  ((ket_length (path_sum_func phase_part1 f m depth1 x)) = depth1).

Axiom path_sum_func_columns :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket_basis_elt x) -> (0%Z < (ket_length x))%Z ->
  ((ket_length x) = depth1) -> (0%Z <= m)%Z ->
...
Parameter get_path_sum_func:
  (bitvec -> bitvec -> t) -> (bitvec -> bitvec -> bitvec) -> Z -> Z ->
  (matrix t) -> unit.

Axiom get_path_sum_func_def :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket_basis_elt x) -> (0%Z < (ket_length x))%Z ->
  ((ket_length x) = depth1) -> (0%Z <= m)%Z ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  ((get_path_sum_func phase_part1 f m depth1 x) = tt).

Axiom get_path_sum_func_spec :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket_basis_elt x) -> (0%Z < (ket_length x))%Z ->
  ((ket_length x) = depth1) -> (0%Z <= m)%Z ->
...
Axiom get_path_sum_func_spec1 :
  ...
  ((path_sum_func phase_part1 f m depth1 x) =
   (mat_sum (n_bvs m)
    (fun (bvy:bitvec) =>
     (infix_asdtdt
      (infix_asdt (pow_inv_sqrt_2 m) ((phase_part1 (ket_to_bv x)) bvy))
      (bv_to_ket ((f (ket_to_bv x)) bvy)))))).

Axiom set_constant_size_path_sum :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket x) -> (0%Z < (ket_length x))%Z -> (0%Z <= m)%Z ->
  (0%Z < depth1)%Z ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  constant_size (to_fset 0%Z (power 2%Z depth1))
  (fun (j:Z) =>
   (infix_asdtdt (get x j 0%Z)
    (path_sum_func phase_part1 f m depth1 (ket depth1 j)))).

Axiom set_constant_size_path_sum1 :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket x) -> (0%Z < (ket_length x))%Z -> (0%Z <= m)%Z ->
  (0%Z < depth1)%Z ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  ((s_rows (to_fset 0%Z (power 2%Z depth1))
    (fun (j:Z) =>
     (infix_asdtdt (get x j 0%Z)
      (path_sum_func phase_part1 f m depth1 (ket depth1 j)))))
   = (power 2%Z depth1)).

Axiom set_constant_size_path_sum2 :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket x) -> (0%Z < (ket_length x))%Z -> (0%Z <= m)%Z ->
  (0%Z < depth1)%Z ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  ((s_columns (to_fset 0%Z (power 2%Z depth1))
    (fun (j:Z) =>
     (infix_asdtdt (get x j 0%Z)
      (path_sum_func phase_part1 f m depth1 (ket depth1 j)))))
   = 1%Z).
...
Axiom result_def23 :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t) (j:Z),
  (((0%Z <= j)%Z /\ (j < (power 2%Z depth1))%Z) ->
   (((result23 phase_part1 f m depth1 x) j) =
    (infix_asdtdt (get x j 0%Z)
     (path_sum_func phase_part1 f m depth1 (ket depth1 j))))) /\
  (~ ((0%Z <= j)%Z /\ (j < (power 2%Z depth1))%Z) ->
   (((result23 phase_part1 f m depth1 x) j) =
    (make (power 2%Z depth1) 1%Z tzero))).

Axiom path_sum_def :
  forall (phase_part1:bitvec -> bitvec -> t) (f:bitvec -> bitvec -> bitvec)
    (m:Z) (depth1:Z) (x:matrix t),
  (is_a_ket x) -> ((ket_length x) = depth1) ->
  (forall (bvx:bitvec) (bvy:bitvec), ((length bvx) = depth1) ->
   ((length bvy) = m) -> ((length ((f bvx) bvy)) = depth1)) ->
  (0%Z <= m)%Z -> (0%Z < depth1)%Z ->
  ((path_sum phase_part1 f m depth1 x) =
   (mat_sum (to_fset 0%Z (power 2%Z depth1))
    (result23 phase_part1 f m depth1 x))).
...
Parameter path_semantics: quantum_circuit -> (matrix t) -> matrix t.

Axiom path_semantics_def :
  forall (c:quantum_circuit) (x:matrix t), (sequence_correct c) ->
  (is_a_ket x) -> ((ket_length x) = (depth c)) ->
  ((path_semantics c x) =
   (path_sum
    ((fun (y0:quantum_circuit) (y1:bitvec) (y2:bitvec) =>
      (phase_part y0 y1 y2))
     c)
    ((fun (y0:quantum_circuit) (y1:bitvec) (y2:bitvec) =>
      (ket_part y0 y1 y2))
     c)
    (sum_range c) (depth c) x)).

Axiom path_semantics_spec :
  forall (c:quantum_circuit) (x:matrix t), (sequence_correct c) ->
  (is_a_ket x) -> ((ket_length x) = (depth c)) ->
  ((path_semantics c x) =
   (mat_sum (to_fset 0%Z (power 2%Z (depth c)))
    (fun (j:Z) =>
     (infix_asdtdt (get x j 0%Z)
      (path_sum_func
       ((fun (y0:quantum_circuit) (y1:bitvec) (y2:bitvec) =>
       ...
       ((fun (y0:quantum_circuit) (y1:bitvec) (y2:bitvec) =>
         (ket_part y0 y1 y2))
        c)
       (sum_range c) (depth c) (ket (depth c) j)))))).

Axiom path_semantics_spec1 :
  forall (c:quantum_circuit) (x:matrix t), (sequence_correct c) ->
  (is_a_ket x) -> ((ket_length x) = (depth c)) ->
  is_a_ket (path_semantics c x).

Axiom path_semantics_spec2 :
  forall (c:quantum_circuit) (x:matrix t), (sequence_correct c) ->
  (is_a_ket x) -> ((ket_length x) = (depth c)) ->
  ((ket_length (path_semantics c x)) = (depth c)).

Axiom path_semantics_spec3 :
  forall (c:quantum_circuit) (x:matrix t), (sequence_correct c) ->
  (is_a_ket x) -> ((ket_length x) = (depth c)) ->
  ((columns (path_semantics c x)) = 1%Z).

Axiom path_semantics_spec4 :
  forall (c:quantum_circuit) (x:matrix t), (sequence_correct c) ->
  (is_a_ket x) -> ((ket_length x) = (depth c)) ->
  ((rows (path_semantics c x)) = (power 2%Z (depth c))).

Axiom path_semantics_decomp :
  forall (c:quantum_circuit) (x:matrix t), (sequence_correct c) ->
  (is_a_ket x) -> ((ket_length x) = (depth c)) ->
  ((path_semantics c x) =
   (mat_sum (to_fset 0%Z (power 2%Z (depth c)))
    (fun (j:Z) =>
     (infix_asdtdt (get x j 0%Z)
      (mat_sum (to_fset 0%Z (power 2%Z (sum_range c)))
       (fun (i:Z) =>
        (infix_asdtdt
         (infix_asdt (pow_inv_sqrt_2 (sum_range c))
          (phase_part c (int_to_bv j (depth c)) (int_to_bv i (sum_range c))))
         (bv_to_ket
          (ket_part c (int_to_bv j (depth c)) (int_to_bv i (sum_range c))))))))))).

Axiom rz_spec : forall (o:(Z* Z)%type), sequence_correct (Rz o).

Axiom rz_spec1 : forall (o:(Z* Z)%type), ((sum_range (Rz o)) = 0%Z).

Axiom rz_spec2 : forall (o:(Z* Z)%type), ((depth (Rz o)) = 1%Z).

Axiom rz_spec3 :
  forall (o:(Z* Z)%type), forall (bvx:bitvec) (bvy:bitvec),
  ((ket_part (Rz o) bvx bvy) =
   (make_bv ((fun (y0:bitvec) (y1:Z) => (getbv y0 y1)) bvx) 1%Z)).

Axiom rz_spec4 :
  forall (o:(Z* Z)%type), forall (bvx:bitvec) (bvy:bitvec), forall (i:Z),
  ((1%Z <= i)%Z /\ (i <= 1%Z)%Z) ->
  ((getbv (ket_part (Rz o) bvx bvy) i) = (getbv bvx i)).

Axiom rz_spec5 :
  forall (o:(Z* Z)%type), forall (bvx:bitvec) (bvy:bitvec),
  ((phase_part (Rz o) bvx bvy) =
   (d_omega (phase_inv (getbv bvx 1%Z) (div_two o)))).

Axiom rz_spec6 :
  forall (o:(Z* Z)%type), forall (x:matrix t), (is_a_ket x) ->
  ((ket_length x) = 1%Z) ->
  ((path_semantics (Rz o) x) =
   (mat_sum (to_fset 0%Z 2%Z)
    (fun (j:Z) =>
     (infix_asdtdt (get x j 0%Z)
      (infix_asdtdt (d_omega (phase_inv j (div_two o))) (ket 1%Z j)))))).

Parameter o: Z.

Parameter o1: Z.

Axiom H : sequence_correct (Ry (o, o1)).

Axiom H1 : ((sum_range (Ry (o, o1))) = 1%Z).

Axiom H2 : ((depth (Ry (o, o1))) = 1%Z).

Parameter fc21: bitvec -> bitvec -> Z -> Z.

Axiom fc_def21 :
  forall (bvx:bitvec) (bvy:bitvec) (i:Z),
  ((i = 1%Z) -> (((fc21 bvx bvy) i) = (getbv bvy i))) /\
  (~ (i = 1%Z) -> (((fc21 bvx bvy) i) = (getbv bvx i))).

Axiom H3 :
  forall (bvx:bitvec) (bvy:bitvec),
  ((ket_part (Ry (o, o1)) bvx bvy) = (make_bv (fc21 bvx bvy) 1%Z)).

Axiom H4 :
  forall (bvx:bitvec) (bvy:bitvec), forall (i:Z),
  ((1%Z <= i)%Z /\ (i <= 1%Z)%Z) ->
  ((getbv (ket_part (Ry (o, o1)) bvx bvy) i) = (getbv bvy i)).

Axiom H5 :
  forall (bvx:bitvec) (bvy:bitvec),
  ((phase_part (Ry (o, o1)) bvx bvy) =
   (infix_asdt squarert_two
    (infix_pldt
     (infix_asdt (indic (getbv bvx 1%Z) (getbv bvy 1%Z))
      (cos_d (div_two (o, o1))))
     (infix_asdt
      (infix_asdt (indic (getbv bvx 1%Z) (1%Z - (getbv bvy 1%Z))%Z)
       (cpower (prefix_mndt tone) (getbv bvx 1%Z)))
...
Axiom H7 : ((ket_length x) = 1%Z).

Parameter a: Z.

Axiom H8 : mem a (to_fset 0%Z 2%Z).

Parameter a1: Z.

Axiom H9 : mem a1 (to_fset 0%Z 2%Z).
...
Axiom fc_def22 :
  forall (i1:Z),
  ((i1 = 1%Z) -> ((fc22 i1) = (getbv (int_to_bv a1 1%Z) i1))) /\
  (~ (i1 = 1%Z) ->
   ((fc22 i1) = (getbv (int_to_bv a (depth (Ry (o, o1)))) i1))).

Axiom H10 : valid_index (bv_to_ket (make_bv fc22 1%Z)) i j.

Parameter fc23: Z -> Z.

Axiom fc_def23 :
  forall (i1:Z),
  ((i1 = 1%Z) -> ((fc23 i1) = (getbv (int_to_bv a1 1%Z) i1))) /\
  (~ (i1 = 1%Z) ->
   ((fc23 i1) = (getbv (int_to_bv a (depth (Ry (o, o1)))) i1))).

(* Why3 goal *)
Theorem G :
  ((get (bv_to_ket (make_bv fc23 1%Z)) i j) = (get (ket 1%Z a1) i j)).
Proof.
