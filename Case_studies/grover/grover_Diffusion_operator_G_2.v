...
Axiom arg_spec :
  ...
  ((real_ (arg x)) /\
   (((cos (arg x)) = (t_real_part x)) /\ ((sin (arg x)) = (t_im_part x)))).
...
Axiom grover_'invariant :
  forall (self:grover_),
  (2%Z <= (s self))%Z /\
  (((0%Z < (cardi self))%Z /\ ((cardi self) < (power_ 2%Z (s self)))%Z) /\
...
Axiom grover_oracle_spec :
  forall (f:Z -> bool),
  ((width (grover_oracle f)) = (s (contents (g tt)))) /\
...
Axiom cc_rz_def :
  forall (n:Z), (2%Z <= n)%Z ->
  ((n = 2%Z) -> ((cc_rz n) = (c_rzp_one 0%Z 1%Z n))) /\
  (~ (n = 2%Z) ->
   ((cc_rz n) =
...
Axiom ang_indic_zero_def :
  forall (x:bitvec),
  (((bv_to_int x) = 0%Z) -> ((ang_indic_zero x) = (int_to_ang 1%Z 1%Z))) /\
  (~ ((bv_to_int x) = 0%Z) -> ((ang_indic_zero x) = ang_zero)).

Parameter x_cc_rz: circuit.

Axiom x_cc_rz_def :
  ((width x_cc_rz) = (s (contents (g tt)))) /\
  (flat x_cc_rz
   (fun (x:bitvec) =>
    (int_to_bv
...
Parameter fc41: bitvec -> angle.

Axiom fc_def41 :
  forall (x:bitvec),
  (((bv_to_int x) = 0%Z) -> ((fc41 x) = ang_zero)) /\
  (~ ((bv_to_int x) = 0%Z) -> ((fc41 x) = (int_to_ang 1%Z 1%Z))).

Axiom diff_pre_def :
  ((width diff_pre) = (s (contents (g tt)))) /\
  ((diagonal1 diff_pre fc41) /\
   forall (x:bitvec), ((length x) = (s (contents (g tt)))) ->
   (((bv_to_int x) = 0%Z) ->
...
Axiom unif_pos_def :
  (is_a_ket_l unif_pos (s (contents (g tt)))) /\
  ((forall (i:Z),
...
Parameter unif_neg: matrix complex.

Axiom unif_neg_def :
  (is_a_ket_l unif_neg (s (contents (g tt)))) /\
  ((forall (i:Z),
    ((0%Z <= i)%Z /\ (i < (power_ 2%Z (s (contents (g tt)))))%Z) ->
    ((((functi (contents (g tt))) i) = true) ->
     ((get unif_neg i 0%Z) = c_zero)) /\
    (~ (((functi (contents (g tt))) i) = true) ->
     ((get unif_neg i 0%Z) =
      (infix_sldt c_one
       (square_rt
   ...
   ((path_sem (grover_oracle (functi (contents (g tt)))) unif_neg) =
    unif_neg)).

Parameter theta: unit -> complex.

Axiom theta_spec :
  forall (us:unit),
  (real_ (theta us)) /\
  (((sin (theta us)) =
    (infix_asdt (square_rt (i_to_c (cardi (contents (g tt)))))
     (infix_sldt c_one
      (square_rt (i_to_c (power_ 2%Z (s (contents (g tt))))))))) /\
   ((cos (theta us)) =
    (infix_asdt
     (square_rt
      (i_to_c
...
Axiom superposition_in_f_basis :
  ((superposition_state (s (contents (g tt)))) =
   (add_ket_l (infix_asdtdt (cos (theta tt)) unif_neg)
    (infix_asdtdt (sin (theta tt)) unif_pos) (s (contents (g tt))))).

Axiom H : real_ (theta tt).
...
Axiom H3 : real_ (cos (theta tt)).

Axiom H4 :
  ((columns (infix_asdtdt (cos (theta tt)) unif_pos)) = (columns unif_pos)).

Axiom H5 :
  ((rows (infix_asdtdt (cos (theta tt)) unif_pos)) = (rows unif_pos)).

Axiom H6 :
  forall (i:Z) (j:Z),
  (valid_index (infix_asdtdt (cos (theta tt)) unif_pos) i j) ->
  ((get (infix_asdtdt (cos (theta tt)) unif_pos) i j) =
   (infix_asdt (cos (theta tt)) (get unif_pos i j))).

Axiom H7 :
  forall (i:Z) (j:Z),
  (valid_index (infix_asdtdt (cos (theta tt)) unif_pos) i j) <->
  (valid_index unif_pos i j).

Axiom H8 : real_ (theta tt).
...
Axiom H11 : real_ (sin (theta tt)).

Axiom H12 :
  ((columns (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg)) =
   (columns unif_neg)).

Axiom H13 :
  ((rows (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg)) =
   (rows unif_neg)).

Axiom H14 :
  forall (i:Z) (j:Z),
  (valid_index (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg) i j) ->
  ((get (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg) i j) =
   (infix_asdt (prefix_mndt (sin (theta tt))) (get unif_neg i j))).

Axiom H15 :
  forall (i:Z) (j:Z),
  (valid_index (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg) i j) <->
  (valid_index unif_neg i j).

Axiom H16 :
  is_a_ket_l
  (add_ket_l (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg)
   (infix_asdtdt (cos (theta tt)) unif_pos) (s (contents (g tt))))
  (s (contents (g tt))).
...
Axiom H18 :
  ...
  ((get
   ...
   =
   (infix_pldt
    (get (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg) i 0%Z)
    (get (infix_asdtdt (cos (theta tt)) unif_pos) i 0%Z))).

Axiom H19 :
  (is_a_ket_l (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg)
   (s (contents (g tt)))) ->
  (is_a_ket_l (infix_asdtdt (cos (theta tt)) unif_pos) (s (contents (g tt)))) ->
  ((add_ket_l (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg)
    (infix_asdtdt (cos (theta tt)) unif_pos) (s (contents (g tt))))
   =
   (add_mat (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg)
    (infix_asdtdt (cos (theta tt)) unif_pos))).

Axiom H20 :
  ((get
    (pps_apply (repeat_pps_had (s (contents (g tt))))
     (add_ket_l (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg)
      (infix_asdtdt (cos (theta tt)) unif_pos) (s (contents (g tt)))))
    0%Z 0%Z)
   =
   (infix_asdt (pow_inv_sqrt_2 (s (contents (g tt))))
    (ind_sum
     ((fun (y0:matrix complex) (y1:Z) => (get y0 y1 0%Z))
      (add_ket_l (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg)
       (infix_asdtdt (cos (theta tt)) unif_pos) (s (contents (g tt)))))
     0%Z (power_ 2%Z (s (contents (g tt))))))).

Axiom H21 : real_ (theta tt).
...
Axiom H24 : real_ (sin (theta tt)).

Axiom H25 :
  forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z (s (contents (g tt)))))%Z) ->
  ((get (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg) i 0%Z) =
   (infix_asdt (prefix_mndt (sin (theta tt))) (get unif_neg i 0%Z))).

Axiom H26 : real_ (theta tt).
...
Axiom H29 : real_ (cos (theta tt)).

Axiom H30 :
  forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z (s (contents (g tt)))))%Z) ->
  ((get (infix_asdtdt (cos (theta tt)) unif_pos) i 0%Z) =
   (infix_asdt (cos (theta tt)) (get unif_pos i 0%Z))).
...
Axiom H31 :
  ...
  (~ (((functi (contents (g tt))) i) = true) ->
   ((get
     ...
     i 0%Z)
    =
    (infix_asdt (prefix_mndt (sin (theta tt)))
     (infix_sldt c_one
      (square_rt
       (i_to_c
        ((power_ 2%Z (s (contents (g tt)))) - (cardi (contents (g tt))))%Z)))))).
...
Axiom H32 :
  infix_lsdt c_zero
  (i_to_c ((power_ 2%Z (s (contents (g tt)))) - (cardi (contents (g tt))))%Z).
...
Axiom H41 : real_ (sin (theta tt)).

Axiom H42 : real_ (i_to_c (cardi (contents (g tt)))).

Axiom H43 : real_ (square_rt (i_to_c (cardi (contents (g tt))))).

Axiom H44 :
  ((infix_asdt (square_rt (i_to_c (cardi (contents (g tt)))))
    (square_rt (i_to_c (cardi (contents (g tt))))))
   = (i_to_c (cardi (contents (g tt))))).

Axiom H45 :
  infix_lseqdt c_zero (square_rt (i_to_c (cardi (contents (g tt))))).

Axiom H46 :
  ((infix_sldt c_one (square_rt (i_to_c (cardi (contents (g tt)))))) =
   (infix_asdt c_one (inv (square_rt (i_to_c (cardi (contents (g tt)))))))).

Axiom H47 : real_ (theta tt).
...
Axiom H50 : real_ (cos (theta tt)).

Axiom H51 : real_ (theta tt).
...
Axiom H71 :
  ((ind_sum
   ...
   =
   (infix_pldt
    (infix_asdt (i_to_c (cardi (contents (g tt))))
     (infix_asdt (cos (theta tt))
      (infix_sldt c_one (square_rt (i_to_c (cardi (contents (g tt))))))))
    (infix_asdt
     (i_to_c
...
(* Why3 goal *)
Theorem G :
  ((path_sem (repeat_had (s (contents (g tt))))
    (add_ket_l (infix_asdtdt (prefix_mndt (sin (theta tt))) unif_neg)
     (infix_asdtdt (cos (theta tt)) unif_pos) (s (contents (g tt)))))
   =
   (pps_apply (repeat_pps_had (s (contents (g tt))))
