...
Axiom H5 : forall (i:Z), ((a_depth (fcirc i)) = size).

Axiom H6 : is_a_ket_l x ft.

Axiom H7 : is_a_ket_l y size.

Axiom H8 : ~ (bound = 1%Z).

Parameter res_pre: a_circuit.

Axiom H9 : ((a_depth res_pre) = (ft + size)%Z).

Axiom H10 :
  (is_a_ket_basis_elt x) ->
  semantics res_pre (kronecker x y)
  (infix_asdtdt
   (value1
    (d_sum
...
Axiom H11 : is_a_ket_basis_elt x.

(* Why3 goal *)
Theorem VC_control_eigen_cont_seq : is_a_ket_basis_elt x.
Proof.
