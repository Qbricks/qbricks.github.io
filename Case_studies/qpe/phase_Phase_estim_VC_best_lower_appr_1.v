...
Axiom t_modulus_spec :
  forall (x:t),
  ((t_modulus x) = (r_to_t (modulus x))) /\
  (infix_lseqdt tzero (t_modulus x)).
...
Axiom cpower_modulus :
  ...
  (((0%Z < n)%Z -> (infix_lsdt (t_modulus x) tone) ->
   ...
   (((0%Z < n)%Z -> ((t_modulus x) = tone) ->
     ((t_modulus (cpower x n)) = tone)) /\
    (((0%Z < n)%Z -> (infix_gtdt (t_modulus x) tone) ->
      infix_gtdt (t_modulus (cpower x n)) tone) /\
     (((0%Z < n)%Z -> (infix_lsdt (t_modulus (cpower x n)) tone) ->
       infix_lsdt (t_modulus x) tone) /\
      (((0%Z < n)%Z -> ((t_modulus (cpower x n)) = tone) ->
        ((t_modulus x) = tone)) /\
       ((0%Z < n)%Z -> (infix_gtdt (t_modulus (cpower x n)) tone) ->
...
Axiom conjugate_to_modulus :
  forall (i:t), ((t_modulus i) = (infix_asdt i (conjugate i))).
...
Axiom conjugate_module_one :
  forall (i:t), ((t_modulus i) = tone) -> ((conjugate i) = (inv i)).
...
Axiom itself_prod_conjugate :
  forall (a:t), ((infix_asdt a (conjugate a)) = (t_modulus a)).

Axiom itself_prod_conjugate_modulus_one :
  forall (a:t), ((t_modulus a) = tone) ->
  ((infix_asdt a (conjugate a)) = tone).

Axiom conjugate_prod_itself :
  forall (a:t), ((infix_asdt a (conjugate a)) = (t_modulus a)).
...
Axiom Real_To_Ang_inv :
  forall (phi:t), (real_ phi) ->
  ((ang_inv (real_to_ang phi)) = (real_to_ang (infix_sldt tone phi))).
...
Axiom modulus_one : forall (o:angle), ((t_modulus (ang_exp o)) = tone).

Axiom angle_to_complex :
  forall (o:angle) (o':angle), (o = o') -> ((ang_exp o) = (ang_exp o')).

Axiom complex_to_angle :
  forall (o:angle) (o':angle), ((ang_exp o) = (ang_exp o')) -> (o = o').
...
Axiom real_pos_coeff : real_ (infix_sldt tone squarert_two).
...
Axiom ket_norm_l_def :
  ...
  ((ket_norm_l x n) =
   (sum (to_fset 0%Z (power 2%Z n))
    (fun (k:Z) =>
     (infix_asdt (t_modulus (get x k 0%Z)) (t_modulus (get x k 0%Z)))))).
...
Axiom uniform_ket_norm_l :
  ...
  (forall (e:bitvec), (mem e (n_bvs n)) -> ((t_modulus (f e)) = tone)) ->
  (x =
   ...
   ((forall (x:bitvec) (y:bitvec), ((length x) = 1%Z) ->
    ...
    ((forall (x:bitvec) (y:bitvec), forall (i:Z), ((length x) = 1%Z) ->
     ...
     (((ang_ind_bound (phase o)) = 1%Z) /\
      ((forall (x:bitvec) (y:bitvec), forall (i:Z), ((length x) = 1%Z) ->
        ((length y) = 0%Z) -> (i = 0%Z) -> ((ang_ind_i (phase o) x y i) = o)) /\
       forall (x:bitvec) (y:bitvec), ((length x) = 1%Z) ->
...
Axiom parallel_spec :
  ...
  (((range (parallel d e)) = ((range d) + (range e))%Z) /\
   ((forall (x:bitvec) (y:bitvec), ((length x) = (size (parallel d e))) ->
    ...
    ((forall (x:bitvec) (y:bitvec), forall (i:Z),
      ...
      (~ (i < (size d))%Z ->
       ((basis_ket_i (parallel d e) x y i) =
        (basis_ket_i e (tpart x (size d)) (tpart y (range d))
         (i - (size d))%Z)))) /\
     (((ang_ind_bound (parallel d e)) =
      ...
      ((forall (x:bitvec) (y:bitvec), forall (i:Z),
        ...
        (~ (i < (ang_ind_bound d))%Z ->
         ((ang_ind_i (parallel d e) x y i) =
          (ang_ind_i e (tpart x (size d)) (tpart y (range d))
           (i - (range d))%Z)))) /\
       forall (x:bitvec) (y:bitvec), ((length x) = (size (parallel d e))) ->
       ((length y) = (range (parallel d e))) ->
   ...
   ((forall (x:bitvec) (y:bitvec), ((length x) = (size (sequence d e))) ->
    ...
    ((forall (x:bitvec) (y:bitvec), forall (i:Z),
      ...
      ((basis_ket_i (sequence d e) x y i) =
       (basis_ket_i e (basis_ket d x (hpart y (range d))) (tpart y (range d))
        i))) /\
...
Axiom mat_sem_spec :
  forall (c:gate),
  ((columns (mat_sem c)) = (power 2%Z (size c))) /\
  ((rows (mat_sem c)) = (power 2%Z (size c))).
...
Axiom def_sem :
  ...
  (sem c x y) <-> ((is_a_ket_l x (size c)) /\ ((pat_sem c x) = y)).
...
Axiom pat_to_mat_sem :
  forall (c:gate) (x:matrix t), (is_a_ket_l x (size c)) ->
  ((pat_sem c x) = (mat_mult (mat_sem c) x)).

Axiom mat_to_pat_sem :
  forall (c:gate) (x:matrix t), (is_a_ket_l x (size c)) ->
  ((mat_mult (mat_sem c) x) = (pat_sem c x)).
...
Axiom pat_sem_sum :
  forall {a:Type} {a_WT:WhyType a},
  forall (c:gate) (s:set a) (f:a -> matrix t), (1%Z <= (cardinal s))%Z ->
  (forall (x:a), (mem x s) -> is_a_ket_l (f x) (size c)) ->
  ((pat_sem c (ket_sum_l s f (size c))) =
   (ket_sum_l s (fun (x:a) => (pat_sem c (f x))) (size c))).
...
Axiom sequence_spec_i_spec :
  ...
  (correct_path_sum_i (sequence_spec_i c c' ase a a' l z h bse b b' rse r r')
   ase l h bse rse) /\
  (((size (sequence_spec_i c c' ase a a' l z h bse b b' rse r r')) =
    (size c)) /\
...
Axiom sequence_spec_i_r_spec :
  ...
  (correct_path_sum_i (sequence_spec_i_r c c' ase a' a l h bse b' b rse r r')
   ase l h bse rse) /\
  (((size (sequence_spec_i_r c c' ase a' a l h bse b' b rse r r')) =
    (size c)) /\
   ((sequence_spec_i_r c c' ase a' a l h bse b' b rse r r') =
    (sequence c c'))).
...
Axiom sequence_spec_i_l_spec :
  ...
  (correct_path_sum_i (sequence_spec_i_l c c' ase a a' l h bse b b' rse r r')
   ase l h bse rse) /\
  (((size (sequence_spec_i_l c c' ase a a' l h bse b b' rse r r')) =
    (size c)) /\
   ((sequence_spec_i_l c c' ase a a' l h bse b b' rse r r') =
    (sequence c c'))).
...
Axiom place_i_spec :
  ...
  (correct_path_sum_i c a l h b r) ->
  ((size (place_i c k n a l h b r)) = n) /\
  ((correct_path_sum_i (place_i c k n a l h b r)
    (fun (x:bitvec) (y:bitvec) (i:Z) => (((a (htpart x k (size c))) y) i)) l
    h (fc12 c k b) r) /\
...
Axiom pat_cont_ketz :
  ...
  ((0%Z <= co)%Z /\ (co < n)%Z) ->
  ((0%Z <= ft)%Z /\ (ft <= (n - (size c))%Z)%Z) ->
  ((ft <= co)%Z -> ((ft + (size c))%Z <= co)%Z) -> (is_a_ket_l x n) ->
...
Axiom pat_cont_ketz_gen :
  forall (c:gate) (co:Z) (ft:Z) (n:Z), ((0%Z <= co)%Z /\ (co < n)%Z) ->
  ((0%Z <= ft)%Z /\ (ft <= (n - (size c))%Z)%Z) ->
  ((ft <= co)%Z -> ((ft + (size c))%Z <= co)%Z) -> forall (x:matrix t),
...
Axiom cont_keto_gen :
  ...
  ((ft <= co)%Z -> ((ft + (size c))%Z <= co)%Z) -> forall (x:bitvec),
...
Axiom dcont_def :
  forall (c:gate) (co:Z) (ft:Z) (n:Z), ((0%Z <= co)%Z /\ (co < n)%Z) ->
  ((0%Z <= ft)%Z /\ (ft <= (n - (size c))%Z)%Z) ->
  ((ft <= co)%Z -> ((ft + (size c))%Z <= co)%Z) -> (diag c) ->
...
Axiom c_rzp_def :
  ...
  ((ft <= co)%Z -> (ft < co)%Z) ->
  ((c_rzp k co ft n) = (dcont (rzp k) co ft n)).

Axiom c_rzp_spec :
  forall (k:Z) (co:Z) (ft:Z) (n:Z), (0%Z <= k)%Z -> (0%Z <= n)%Z ->
  ((0%Z <= co)%Z /\ (co < n)%Z) -> ((0%Z <= ft)%Z /\ (ft < n)%Z) ->
  ((ft <= co)%Z -> (ft < co)%Z) ->
  ((size (c_rzp k co ft n)) = n) /\
  ...
  ((diag (c_rzp_neg k co ft n)) /\
   ((forall (x:bitvec), ((length x) = n) ->
    ...
    ((forall (x:bitvec), forall (m:Z), (k <= m)%Z -> ((length x) = n) ->
      (((diag_ang (c_rzp_neg k co ft n)) x) =
       (int_to_ang
        (((-((value x) co))%Z * ((value x) ft))%Z * (power 2%Z (m - k)%Z))%Z
        m))) /\
     forall (x:bitvec), forall (m:Z), (k <= m)%Z -> ((length x) = n) ->
     (((diag_ang (c_rzp_neg k co ft n)) x) =
      (int_to_ang
       (((-((value x) co))%Z * ((value x) ft))%Z * (power_ 2%Z (m - k)%Z))%Z
       m))))).
...
Axiom cascade_cont_rz_def :
  ...
  ((t1 <= ((first_c + l)%Z - 1%Z)%Z)%Z -> (t1 < first_c)%Z) ->
      ...
      (fun (x:bitvec) (us:bitvec) (k:Z) =>
       (int_to_ang
        (((-((value x) k))%Z * ((value x) t1))%Z *
         (power_ 2%Z (((n - k)%Z - 1%Z)%Z + t1)%Z))%Z
        n))
      (t1 + 1%Z)%Z n (fun (x:bitvec) (us:bitvec) (i:Z) => ((value x) i)) 0%Z)))).

Parameter qft_rev_line: Z -> Z -> gate.

Parameter result22: Z -> bitvec -> bitvec -> Z -> Z.

Parameter result23: Z -> bitvec -> bitvec -> Z -> Z.

Axiom result_def22 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((((result22 t1) x) y) i) = ((value y) 0%Z))) /\
  (~ (i = t1) -> (((((result22 t1) x) y) i) = ((value x) i))).

Axiom result_def23 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((result23 t1 x y) i) = ((value y) 0%Z))) /\
  (~ (i = t1) -> (((result23 t1 x y) i) = ((value x) i))).

Axiom qft_rev_line_def :
  forall (t1:Z) (n:Z), ((0%Z <= t1)%Z /\ (t1 < n)%Z) ->
  ((t1 = (n - 1%Z)%Z) -> ((qft_rev_line t1 n) = (place_hadamard t1 n))) /\
  (~ (t1 = (n - 1%Z)%Z) ->
   ((qft_rev_line t1 n) =
    (sequence_spec_i_r (place_hadamard t1 n)
     ...
     (fun (x:bitvec) (y:bitvec) =>
      (int_to_ang
       (((-((value x) t1))%Z * ((value y) 0%Z))%Z *
        (power_ 2%Z (n - 1%Z)%Z))%Z
       n))
     t1 n (result22 t1) (fun (x:bitvec) (us:bitvec) (i:Z) => ((value x) i))
     (fun (x:bitvec) (y:bitvec) => (make_bv (result23 t1 x y) n)) 1%Z 1%Z
     0%Z))).
    ...
    (ang_sum
     (fun (i:Z) =>
      (int_to_ang
       ...
       n))
     j n))
   0%Z n (fun (us:bitvec) (y:bitvec) (i:Z) => ((value y) i)) n).

(* Why3 assumption *)
Definition eigen (c:gate) (x:matrix t) (o:angle) : Prop :=
...
Axiom control_eigen_spec :
  ...
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (size circ))%Z) ->
  (eigen circ y o) ->
  ((size (control_eigen circ y o c ft n)) = n) /\
...
Axiom control_eigen_seq_pre_def :
  ...
  (~ (bound = 1%Z) ->
   ((control_eigen_seq_pre fcirc y fk fc17 ft bound s n x) =
    (sequence
     (control_eigen_seq_pre fcirc y fk fc17 ft (bound - 1%Z)%Z s n x)
     (control_eigen_scal (fcirc (bound - 1%Z)%Z) y (fc17 (bound - 1%Z)%Z) ft
      n
      (ang_sum (fun (i:Z) => (ang_mult_int (fk i) ((value x) (fc17 i)))) 0%Z
       (bound - 1%Z)%Z)
      (fk (bound - 1%Z)%Z))))).
...
Parameter result24: (Z -> t) -> Z -> angle.

Axiom result_def24 :
  forall (fk:Z -> t) (k:Z),
  ((real_ (fk k)) -> (((result24 fk) k) = (real_to_ang (fk k)))) /\
  (~ (real_ (fk k)) -> (((result24 fk) k) = ang_zero)).
...
Axiom control_eigen_seq_real_def :
  ...
  ((control_eigen_seq_real fcirc y fk fc17 ft bound s n) =
   (control_eigen_seq fcirc y (result24 fk) fc17 ft bound s n)).
  ...
  (kronecker
   (infix_asdtdt
    (ang_exp
     (ang_sum
      (fun (i:Z) =>
       (real_to_ang (infix_asdt (fk i) (i_to_t ((value x) (fc17 i))))))
      0%Z bound))
    (bv_to_ket x))
   y).
...
Parameter result25: gate -> Z -> (matrix t) -> t -> Z -> gate.

Axiom result_def25 :
  forall (circ:gate) (ft:Z) (y:matrix t) (theta:t) (i:Z),
  ((0%Z <= ((ft - i)%Z - 1%Z)%Z)%Z ->
   (((result25 circ ft y theta) i) =
...
Axiom cascade_cont_pow_def :
  ...
  ((cascade_cont_pow circ ft y theta) =
   (control_eigen_seq_real (result25 circ ft y theta) y
    (fun (i:Z) =>
...
Parameter result26: (matrix t) -> (Z* Z)%type -> bool.
...
Axiom result_def27 :
  ...
  ((mem a1 sa) -> (((result27 sa sb f r c) a1) = (mat_sum_d sb (f a1) r c))) /\
  (~ (mem a1 sa) -> (((result27 sa sb f r c) a1) = (make r c tzero))).
...
Axiom mat_sum_sum_d_def :
  ...
  (forall (a1:a), forall (b1:b), (mem a1 sa) -> (mem b1 sb) ->
   ((columns ((f a1) b1)) = c)) ->
  ((mat_sum_sum_d sa sb f r c) = (mat_sum_d sa (result27 sa sb f r c) r c)).
...
Axiom result_def28 :
  ...
  (((length y) = range1) ->
   (((result28 a k size1 range1 z) y) =
    (infix_asdtdt (ang_exp ((a z) y))
     (ketbra size1 (bv_to_int ((k z) y)) (bv_to_int z))))) /\
  (~ ((length y) = range1) ->
   (((result28 a k size1 range1 z) y) = (ket size1 0%Z))).

Axiom result_def29 :
  forall (a:bitvec -> bitvec -> angle) (k:bitvec -> bitvec -> bitvec)
    (size1:Z) (range1:Z) (z:bitvec),
  (((length z) = size1) ->
   (((result29 a k size1 range1) z) =
    (ketbra_sum_l (n_bvs range1) (result28 a k size1 range1 z) size1))) /\
  (~ ((length z) = size1) ->
   (((result29 a k size1 range1) z) = (ket size1 0%Z))).
...
Axiom ketbra_sop_def :
  ...
  ((ketbra_sop a k size1 range1) =
   (infix_asdtdt (pow_inv_sqrt_2 range1)
    (ketbra_sum_l (n_bvs size1) (result29 a k size1 range1) size1))).
...
Axiom result_def30 :
  ...
  (((length z) = size1) ->
   (((result30 a k size1 y) z) =
    (infix_asdtdt (ang_exp ((a z) y))
     (ketbra size1 (bv_to_int ((k z) y)) (bv_to_int z))))) /\
  (~ ((length z) = size1) -> (((result30 a k size1 y) z) = (ket size1 0%Z))).

Axiom result_def31 :
  forall (a:bitvec -> bitvec -> angle) (k:bitvec -> bitvec -> bitvec)
    (size1:Z) (range1:Z) (y:bitvec),
  (((length y) = range1) ->
   (((result31 a k size1 range1) y) =
    (ketbra_sum_l (n_bvs size1) (result30 a k size1 y) size1))) /\
  (~ ((length y) = range1) ->
   (((result31 a k size1 range1) y) = (ket size1 0%Z))).
...
Axiom ketbra_sop_rs_def :
  ...
  ((ketbra_sop_rs a k size1 range1) =
   (infix_asdtdt (pow_inv_sqrt_2 range1)
    (ketbra_sum_l (n_bvs range1) (result31 a k size1 range1) size1))).
...
Axiom reverse_spec :
  forall (c:gate),
  (forall (x:matrix t) (y:matrix t), (sem c x y) -> sem (reverse c) y x) /\
  ((forall (x:matrix t) (y:matrix t), (sem (reverse c) y x) -> sem c x y) /\
   ((mat_sem (reverse c)) = (adjoint (mat_sem c)))).
...
Axiom path_sum_scheme_to_mat :
  forall (c:gate) (a:bitvec -> bitvec -> angle)
    (b:bitvec -> bitvec -> bitvec) (r:Z),
  (correct_path_sum c a b r) ->
  ((mat_sem c) = (ketbra_sop a b (size c) r)) /\
...
(* Why3 assumption *)
Definition conj_ang_func (a:bitvec -> bitvec -> angle) (x:bitvec)
    (y:bitvec) : angle :=
  ang_inv ((a x) y).

(* Why3 assumption *)
Definition conj_func_i (a:bitvec -> bitvec -> Z -> angle) (x:bitvec)
    (y:bitvec) (i:Z) : angle :=
  ang_inv (((a x) y) i).
...
Axiom rewrite_qft_rev :
  forall (n:Z), (0%Z < n)%Z ->
  (correct_path_sum (qft_rev n)
   (fun (x:bitvec) (y:bitvec) =>
    (real_to_ang
     (infix_asdt
      (infix_asdt (i_to_t (-(bv_to_int x))%Z)
       (i_to_t (bv_to_int (bv_inversion y))))
      (pow_inv_2 n))))
   (fun (us:bitvec) (y:bitvec) => y) n) /\
  ((forall (x:bitvec), ((length x) = n) ->
    sem (qft_rev n) (bv_to_ket x)
    (infix_asdtdt (pow_inv_sqrt_2 n)
     (ket_sum_l (n_bvs n)
      (fun (z:bitvec) => (infix_asdtdt (qft_rev_coeff x z n) (bv_to_ket z)))
      n))) /\
   forall (x:matrix t), (is_a_ket_l x n) -> (is_a_ket_basis_elt x) ->
   ((pat_sem (qft_rev n) x) =
    (infix_asdtdt (pow_inv_sqrt_2 n)
     (ket_sum_l (n_bvs n)
      (fun (z:bitvec) =>
       (infix_asdtdt (qft_rev_coeff (ket_to_bv x) z n) (bv_to_ket z)))
      n)))).

Parameter apply_qft_rev: Z -> Z -> (matrix t) -> gate.

Axiom apply_qft_rev_def :
  forall (k:Z) (n:Z) (y:matrix t), ((k <= n)%Z /\ (0%Z < k)%Z) ->
  (is_a_ket_l y (n - k)%Z) ->
...
Axiom apply_qft_rev_spec :
  forall (k:Z) (n:Z) (y:matrix t), ((k <= n)%Z /\ (0%Z < k)%Z) ->
  (is_a_ket_l y (n - k)%Z) ->
  ((size (apply_qft_rev k n y)) = n) /\
  forall (x:matrix t) (x':matrix t), (is_a_ket_l x k) ->
  (sem (qft_rev k) x x') ->
  sem (apply_qft_rev k n y) (kronecker x y) (kronecker x' y).

Parameter create_superposition: Z -> Z -> (matrix t) -> gate.
...
Axiom create_superposition_spec :
  forall (k:Z) (n:Z) (y:matrix t), ((k <= n)%Z /\ (0%Z < k)%Z) ->
  (is_a_ket_l y (n - k)%Z) ->
  ((size (create_superposition k n y)) = n) /\
  (sem (create_superposition k n y) (kronecker (ket k 0%Z) y)
   (kronecker
    (infix_asdtdt (pow_inv_sqrt_2 k)
     (ket_sum_l (n_bvs k) (fun (x:bitvec) => (bv_to_ket x)) k))
    y)).

Parameter black_box_coeff: Z -> t -> bitvec -> t.

Axiom black_box_coeff_def :
  forall (n:Z) (theta:t) (y:bitvec), (real_ theta) -> (0%Z < n)%Z ->
  ((black_box_coeff n theta y) =
   (ang_exp (real_to_ang (infix_asdt theta (i_to_t (bv_to_int y)))))).

Parameter apply_black_box: gate -> Z -> Z -> (matrix t) -> t -> gate.

Axiom apply_black_box_def :
  forall (circ:gate) (k:Z) (n:Z) (y:matrix t) (theta:t),
  (n = (k + (size circ))%Z) -> (real_ theta) -> (1%Z <= k)%Z ->
  (is_a_ket_l y (n - k)%Z) -> (eigen circ y (real_to_ang theta)) ->
...
Axiom apply_black_box_spec :
  ...
  (n = (k + (size circ))%Z) -> (real_ theta) -> (1%Z <= k)%Z ->
  (is_a_ket_l y (n - k)%Z) -> (eigen circ y (real_to_ang theta)) ->
  ((size (apply_black_box circ k n y theta)) = n) /\
  ((sem (apply_black_box circ k n y theta) (kronecker (ket k 0%Z) y)
    (kronecker
     (infix_asdtdt (pow_inv_sqrt_2 k)
      (ket_sum_l (n_bvs k)
       (fun (x:bitvec) =>
        (infix_asdtdt (black_box_coeff k theta x) (bv_to_ket x)))
       k))
     y)) /\
...
Axiom proba_measure_def :
  ...
  ((0%Z <= i)%Z /\ (i < n)%Z) ->
  ((proba_measure x i n) = (t_modulus (get x i 0%Z))).
...
Axiom proba_measure_from_sum :
  ...
  (x =
   (ket_sum_l (n_bvs n)
    (fun (k:bitvec) => (infix_asdtdt (f k) (ket n (bv_to_int k)))) n)) ->
  ((proba_measure x i n) = (t_modulus (f (int_to_bv i n)))).

Axiom proba_measure_from_sum_sum :
  forall (x:matrix t) (i:Z) (n:Z) (f:bitvec -> bitvec -> t),
  (is_a_ket_l x n) -> ((0%Z <= i)%Z /\ (i < n)%Z) ->
  (x =
   (ket_sum_l (n_bvs n)
    (fun (k:bitvec) =>
     (ket_sum_l (n_bvs n)
      (fun (l:bitvec) => (infix_asdtdt ((f k) l) (ket n (bv_to_int k)))) n))
    n)) ->
  ((proba_measure x i n) = (t_modulus (sum (n_bvs n) (f (int_to_bv i n))))).

Axiom proba_measure_from_scal_sum_sum :
  forall (x:matrix t) (i:Z) (n:Z) (f:bitvec -> bitvec -> t) (s:t),
  (is_a_ket_l x n) -> ((0%Z <= i)%Z /\ (i < n)%Z) ->
  (x =
   (infix_asdtdt s
    (ket_sum_l (n_bvs n)
     ...
     n))) ->
  ((proba_measure x i n) =
   (infix_asdt s (t_modulus (sum (n_bvs n) (f (int_to_bv i n)))))).

Axiom proba_measure_from_sum_sum_sw :
  forall (x:matrix t) (i:Z) (n:Z) (f:bitvec -> bitvec -> t),
  (is_a_ket_l x n) -> ((0%Z <= i)%Z /\ (i < n)%Z) ->
  (x =
   (ket_sum_l (n_bvs n)
    (fun (l:bitvec) =>
     (ket_sum_l (n_bvs n)
      (fun (k:bitvec) => (infix_asdtdt ((f k) l) (ket n (bv_to_int k)))) n))
    n)) ->
  ((proba_measure x i n) = (t_modulus (sum (n_bvs n) (f (int_to_bv i n))))).

Parameter discard_black_box: gate -> Z -> Z -> (matrix t) -> t -> matrix t.
...
Parameter phase_estimation: gate -> Z -> Z -> (matrix t) -> t -> matrix t.
...
Axiom phase_estimation_def :
  ...
  ((phase_estimation circ k n y theta) =
   (pat_sem (qft_rev k) (discard_black_box circ k n y theta))).

Axiom phase_estimation_spec :
  forall (circ:gate) (k:Z) (n:Z) (y:matrix t) (theta:t),
  (n = (k + (size circ))%Z) -> (real_ theta) -> (1%Z <= k)%Z ->
  (eigen circ y (real_to_ang theta)) ->
  (is_a_ket_l (phase_estimation circ k n y theta) k) /\
  (((phase_estimation circ k n y theta) =
    (infix_asdtdt (pow_inv_sqrt_2 k)
     (ket_sum_l (n_bvs k)
      (fun (y1:bitvec) =>
       (infix_asdtdt (pow_inv_sqrt_2 k)
        (ket_sum_l (n_bvs k)
         (fun (x:bitvec) =>
          (infix_asdtdt
           (infix_asdt (black_box_coeff k theta y1) (qft_rev_coeff y1 x k))
           (bv_to_ket x)))
         k)))
      k))) /\
   (((phase_estimation circ k n y theta) =
          ...
          (infix_asdtdt
           (cpower
            (ang_exp
             (real_to_ang
              (infix_mndt theta
               (infix_asdt (i_to_t (bv_to_int (bv_inversion x)))
                (pow_inv_2 k)))))
            (bv_to_int y1))
           (bv_to_ket x)))
         k))
...
Axiom H : (n = (k + (size circ))%Z).

Axiom H1 : real_ theta.

Axiom H2 : (1%Z <= k)%Z.

Axiom H3 : eigen circ y (real_to_ang theta).

Axiom H4 : infix_lseqdt tzero theta.

Axiom H5 : infix_lsdt theta tone.

Axiom H6 : (0%Z <= (max_dyadic n theta))%Z.

Axiom H7 : ((max_dyadic n theta) < (power_ 2%Z n))%Z.

Axiom H8 :
  infix_lseqdt (infix_asdt (i_to_t (max_dyadic n theta)) (pow_inv_2 n)) theta.

Axiom H9 :
  infix_gteqdt
  (infix_asdt (i_to_t ((max_dyadic n theta) + 1%Z)%Z) (pow_inv_2 n)) theta.

Axiom H10 :
  forall (i:Z), ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  (infix_lseqdt (infix_asdt (i_to_t i) (pow_inv_2 n)) theta) ->
  (i <= (max_dyadic n theta))%Z.

Axiom h :
  infix_gteqdt (infix_mndt theta (i_to_t (max_dyadic n theta))) (pow_inv_2 k).

(* Why3 goal *)
Theorem VC_best_lower_appr :
  infix_lsdt (infix_mndt theta (i_to_t (max_dyadic n theta))) (pow_inv_2 k).
Proof.
