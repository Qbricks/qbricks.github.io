...
Axiom cpower_ang_exp_real :
  ...
  ((cpower (ang_exp (real_to_ang x)) i) =
   (ang_exp (real_to_ang (infix_asdt x (i_to_t i))))).
...
(* Why3 assumption *)
Definition add_ket_l (m:matrix t) (n:matrix t) (l:Z) : matrix t :=
  make_ket l (fun (i:Z) => (infix_pldt (get m i 0%Z) (get n i 0%Z))).

Axiom add_ket_l_spec :
  forall (m:matrix t) (n:matrix t) (l:Z),
...
Axiom null_add_ket_l :
  forall (m:matrix t) (n:matrix t) (l:Z), (null_mat m) ->
  ((add_ket_l m n l) = n).

Axiom add_ket_l_null :
  forall (m:matrix t) (n:matrix t) (l:Z), (null_mat n) ->
  ((add_ket_l m n l) = m).
...
Axiom ket_sum_scalar_l :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (a1:t) (l:Z), (0%Z < (cardinal s))%Z ->
...
Axiom pat_sem_decomp_scal :
  forall (c:circuit) (x:matrix t) (scal:t), (is_a_ket_l x (width c)) ->
  ((infix_asdtdt scal (pat_sem c x)) =
   (ket_sum_l (n_bvs (width c))
    (fun (z:bitvec) =>
     (infix_asdtdt (get x (bv_to_int z) 0%Z)
      (infix_asdtdt (prefix_mndt tone) (pat_sem c (bv_to_ket z)))))
    (width c))).
...
Axiom pat_sem_scal_add_ket_l :
  forall (c:circuit) (x:matrix t) (x':matrix t) (a:t) (a':t) (n:Z),
  ((width c) = n) -> (is_a_ket_l x n) -> (is_a_ket_l x' n) ->
  ((pat_sem c (add_ket_l (infix_asdtdt a x) (infix_asdtdt a' x') n)) =
   (add_ket_l (infix_asdtdt a (pat_sem c x)) (infix_asdtdt a' (pat_sem c x'))
    n)).

Axiom pat_sem_substr :
  forall (c:circuit) (x:matrix t) (x':matrix t) (y:matrix t) (y':matrix t),
  ((pat_sem c x) = y) -> ((pat_sem c x') = y') ->
  ((pat_sem c (mat_substr x x')) = (mat_substr y y')).

Axiom scal_sem :
  forall (c:circuit) (x:matrix t) (y:matrix t) (sc:t), (sem c x y) ->
  sem c (infix_asdtdt sc x) (infix_asdtdt sc y).

Axiom pat_sem_scal_add :
  forall (c:circuit) (x:matrix t) (x':matrix t) (y:matrix t) (y':matrix t)
    (scal:t),
  ((pat_sem c x) = y) -> ((pat_sem c x') = y') ->
  ((pat_sem c (infix_asdtdt scal (add_mat x x'))) =
   (infix_asdtdt scal (add_mat y y'))).

Axiom pat_sem_scal_substr :
  forall (c:circuit) (x:matrix t) (x':matrix t) (y:matrix t) (y':matrix t)
    (scal:t),
  ((pat_sem c x) = y) -> ((pat_sem c x') = y') ->
  ((pat_sem c (infix_asdtdt scal (mat_substr x x'))) =
...
Axiom pat_sem_scal_rev :
  forall (c:circuit) (x:matrix t) (sc:t), (is_a_ket_l x (width c)) ->
  ((infix_asdtdt sc (pat_sem c x)) = (pat_sem c (infix_asdtdt sc x))).
...
Axiom pat_sem_sum_diag :
  forall (c:circuit) (s:set bitvec) (f:bitvec -> t) (l:Z),
  (1%Z <= (cardinal s))%Z -> (l = (width c)) ->
  ((pat_sem c (ket_sum_l_diag s f l)) =
   (ket_sum_l s
    (fun (x:bitvec) => (infix_asdtdt (f x) (pat_sem c (bv_to_ket x)))) l)).
   ...
   ((control_eigen_seq_pre fcirc y fk fc15 ft bound s n x) =
    (sequence
     ...
     (control_eigen_scal (fcirc (bound - 1%Z)%Z) y (fc15 (bound - 1%Z)%Z) ft
      n
      (ang_sum (fun (i:Z) => (ang_mult_int (fk i) ((value x) (fc15 i)))) 0%Z
       (bound - 1%Z)%Z)
      (fk (bound - 1%Z)%Z))))).
  ...
  (kronecker
   (infix_asdtdt
    (ang_exp
     (ang_sum
      (fun (i:Z) =>
       (real_to_ang (infix_asdt (fk i) (i_to_t ((value x) (fc15 i))))))
      0%Z bound))
    (bv_to_ket x))
   y).
...
Axiom c_rzp_one_def :
  forall (co:Z) (t1:Z) (n:Z), (0%Z <= n)%Z ->
  ((0%Z <= co)%Z /\ (co < n)%Z) -> ((0%Z <= t1)%Z /\ (t1 < n)%Z) ->
  ((t1 <= co)%Z -> (t1 < co)%Z) ->
  ((c_rzp_one co t1 n) = (c_rzp 1%Z co t1 n)).

Axiom c_rzp_one_spec :
  forall (co:Z) (t1:Z) (n:Z), (0%Z <= n)%Z ->
  ((0%Z <= co)%Z /\ (co < n)%Z) -> ((0%Z <= t1)%Z /\ (t1 < n)%Z) ->
  ((t1 <= co)%Z -> (t1 < co)%Z) ->
  ((width (c_rzp_one co t1 n)) = n) /\
  (((ancillas (c_rzp_one co t1 n)) = 0%Z) /\
   (((size (c_rzp_one co t1 n)) <= (cont_size * 2%Z)%Z)%Z /\
    ((diag (c_rzp_one co t1 n)) /\
     ((forall (x:bitvec), ((length x) = n) ->
       ((forall (i:Z), ((0%Z <= i)%Z /\ (i < 2%Z)%Z) ->
         (((value x) i) = 1%Z)) ->
        (((diag_ang (c_rzp_one co t1 n)) x) = (int_to_ang 1%Z 1%Z))) /\
       (~ (forall (i:Z), ((0%Z <= i)%Z /\ (i < 2%Z)%Z) ->
           (((value x) i) = 1%Z)) ->
        (((diag_ang (c_rzp_one co t1 n)) x) = ang_zero))) /\
      ((forall (x:bitvec), ((length x) = n) -> (((value x) 0%Z) = 1%Z) ->
        (((value x) 1%Z) = 1%Z) ->
        (((diag_ang (c_rzp_one co t1 n)) x) = (int_to_ang 1%Z 1%Z))) /\
       ((forall (x:bitvec), ((length x) = n) -> (((value x) 0%Z) = 0%Z) ->
         (((diag_ang (c_rzp_one co t1 n)) x) = ang_zero)) /\
        forall (x:bitvec), ((length x) = n) -> (((value x) 0%Z) = 1%Z) ->
        (((diag_ang (c_rzp_one co t1 n)) x) = ang_zero))))))).
   ...
   ((forall (x:bitvec), ((length x) = n) ->
    ...
    ((forall (x:bitvec), ((length x) = n) ->
     ...
     ((forall (x:bitvec), forall (i:Z), ((length x) = n) ->
      ...
      ((forall (x:bitvec), ((length x) = n) ->
        ((bv_to_int ((flat_ket (x_kron n)) x)) =
         (((power_ 2%Z n) - 1%Z)%Z - (bv_to_int x))%Z)) /\
       forall (x:bitvec), ((length x) = n) ->
       (((flat_ket (x_kron n)) x) =
...
Axiom proba_measure_set_of_ind :
  forall (x:matrix t) (s:set Z) (n:Z) (p:Z -> bool) (scal_f:Z -> t)
    (f:Z -> Z),
  (is_a_ket_l x n) ->
...
Axiom proba_measure_set_of_ind_conds :
  forall (x:matrix t) (s:set Z) (k:Z) (n:Z) (p:Z -> bool) (scal:t) (f:Z -> Z),
  (is_a_ket_l x n) ->
  (forall (i:Z), (mem i s) -> (0%Z <= (f i))%Z /\ ((f i) < (power_ 2%Z n))%Z) ->
  ...
  (forall (i:Z) (i':Z), (mem i s) -> (mem i' s) -> ~ (i = i') ->
   ~ ((f i) = (f i'))) ->
  infix_lseqdt (infix_asdt (i_to_t k) scal) (proba_measure_cond x n p).
...
Axiom qbit_plus_spec :
  ...
  (((rows (pat_sem hadamard (ket 1%Z 0%Z))) = 2%Z) /\
   (((columns (pat_sem hadamard (ket 1%Z 0%Z))) = 1%Z) /\
    (((get (pat_sem hadamard (ket 1%Z 0%Z)) 0%Z 0%Z) = (pow_inv_sqrt_2 1%Z)) /\
     (((get (pat_sem hadamard (ket 1%Z 0%Z)) 1%Z 0%Z) = (pow_inv_sqrt_2 1%Z)) /\
      ((pat_sem hadamard (ket 1%Z 0%Z)) =
       (infix_asdtdt (pow_inv_sqrt_2 1%Z)
        (add_mat (ket 1%Z 0%Z) (ket 1%Z 1%Z)))))))).
...
Axiom qbit_minus_spec :
  ...
  (((rows (pat_sem hadamard (ket 1%Z 1%Z))) = 2%Z) /\
   (((columns (pat_sem hadamard (ket 1%Z 1%Z))) = 1%Z) /\
    (((get (pat_sem hadamard (ket 1%Z 1%Z)) 0%Z 0%Z) = (pow_inv_sqrt_2 1%Z)) /\
     (((get (pat_sem hadamard (ket 1%Z 1%Z)) 1%Z 0%Z) =
       (prefix_mndt (pow_inv_sqrt_2 1%Z))) /\
      ((pat_sem hadamard (ket 1%Z 1%Z)) =
       (infix_asdtdt (pow_inv_sqrt_2 1%Z)
        (mat_substr (ket 1%Z 0%Z) (ket 1%Z 1%Z)))))))).

Axiom add_plus_minus :
  ((add_mat (pat_sem hadamard (ket 1%Z 0%Z))
    (pat_sem hadamard (ket 1%Z 1%Z)))
   = (infix_asdtdt (square_rt (infix_pldt tone tone)) (ket 1%Z 0%Z))) /\
  ((add_mat
    (infix_asdtdt (pow_inv_sqrt_2 1%Z) (pat_sem hadamard (ket 1%Z 0%Z)))
    (infix_asdtdt (pow_inv_sqrt_2 1%Z) (pat_sem hadamard (ket 1%Z 1%Z))))
   = (ket 1%Z 0%Z)).

Axiom substr_plus_minus :
  ((mat_substr (pat_sem hadamard (ket 1%Z 0%Z))
    (pat_sem hadamard (ket 1%Z 1%Z)))
   = (infix_asdtdt (square_rt (infix_pldt tone tone)) (ket 1%Z 1%Z))) /\
  ((mat_substr
    (infix_asdtdt (pow_inv_sqrt_2 1%Z) (pat_sem hadamard (ket 1%Z 0%Z)))
    (infix_asdtdt (pow_inv_sqrt_2 1%Z) (pat_sem hadamard (ket 1%Z 1%Z))))
   = (ket 1%Z 1%Z)).
...
Axiom plus_to_zero :
  ((pat_sem hadamard (pat_sem hadamard (ket 1%Z 0%Z))) = (ket 1%Z 0%Z)).

Axiom plus_to_one :
  ((pat_sem hadamard (pat_sem hadamard (ket 1%Z 1%Z))) = (ket 1%Z 1%Z)).
...
Axiom get_ket_superposition :
  ...
  ((get (superposition_state n) i 0%Z) =
   (infix_sldt tone (square_rt (i_to_t (power_ 2%Z n))))).
...
Axiom repeat_had_twice_bv :
  forall (n:Z) (x:bitvec), (1%Z <= n)%Z -> ((length x) = n) ->
  ((pat_sem (repeat_had n) (pat_sem (repeat_had n) (bv_to_ket x))) =
   (bv_to_ket x)).
...
Axiom repeat_had_twice_ket :
  forall (n:Z), (1%Z <= n)%Z -> forall (x:matrix t), (is_a_ket_l x n) ->
  ((pat_sem (repeat_had n) (pat_sem (repeat_had n) x)) = x).

Axiom repeat_had_superposition :
  forall (n:Z), (1%Z <= n)%Z ->
  ((pat_sem (repeat_had n) (superposition_state n)) = (ket n 0%Z)).

Axiom pat_sem_repeat_at_zero_bv :
  forall (n:Z) (x:bitvec), (1%Z <= n)%Z -> ((length x) = n) ->
  ((get (pat_sem (repeat_had n) (bv_to_ket x)) 0%Z 0%Z) = (pow_inv_sqrt_2 n)).

Axiom pat_sem_repeat_at_zero :
  forall (n:Z) (x:matrix t), (1%Z <= n)%Z -> (is_a_ket_l x n) ->
  ((get (pat_sem (repeat_had n) x) 0%Z 0%Z) =
   (infix_asdt (pow_inv_sqrt_2 n)
    (ind_sum ((fun (y0:matrix t) (y1:Z) => (get y0 y1 0%Z)) x) 0%Z
     (power_ 2%Z n)))).
...
Axiom fc_def26 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((fc26 t1 x y) i) = ((value y) 0%Z))) /\
  (~ (i = t1) -> (((fc26 t1 x y) i) = ((value x) i))).

Axiom fc_def27 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((fc27 t1 x y) i) = ((value y) 0%Z))) /\
  (~ (i = t1) -> (((fc27 t1 x y) i) = ((value x) i))).
...
Axiom fc_def28 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((fc28 t1 x y) i) = ((value y) 0%Z))) /\
  (~ (i = t1) -> (((fc28 t1 x y) i) = ((value x) i))).

Axiom fc_def29 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((fc29 t1 x y) i) = ((value y) 0%Z))) /\
  (~ (i = t1) -> (((fc29 t1 x y) i) = ((value x) i))).

Axiom fc_def30 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((fc30 t1 x y) i) = ((value y) 0%Z))) /\
  (~ (i = t1) -> (((fc30 t1 x y) i) = ((value x) i))).
...
Parameter result31: t -> t -> Z -> Z -> t.

Axiom result_def31 :
  forall (a:t) (b:t) (x:Z) (us:Z),
  ((x = 0%Z) -> ((((result31 a b) x) us) = a)) /\
  (~ (x = 0%Z) -> ((((result31 a b) x) us) = b)).

(* Why3 assumption *)
Definition to_binary_vector (a:t) (b:t) : matrix t :=
  make_f 2%Z 1%Z (result31 a b).
...
Parameter result32: Z -> Z -> t.

Parameter result33: Z -> Z -> t.

Axiom result_def32 :
  forall (x:Z) (us:Z),
  ((x = 0%Z) -> (((result32 x) us) = tone)) /\
  (~ (x = 0%Z) -> (((result32 x) us) = tzero)).

Axiom result_def33 :
  forall (x:Z) (us:Z),
  ((x = 1%Z) -> (((result33 x) us) = im)) /\
  (~ (x = 1%Z) -> (((result33 x) us) = tzero)).

Axiom complex_plan_def :
  ((ox complex_plan) = (make_f 2%Z 1%Z result32)) /\
  (((oy complex_plan) = (make_f 2%Z 1%Z result33)) /\
   ((dim complex_plan) = 1%Z)).

Parameter result34: t -> Z -> Z -> t.

Axiom result_def34 :
  forall (x:t) (i:Z) (us:Z),
  ((i = 0%Z) -> ((((result34 x) i) us) = (t_real_part x))) /\
  (~ (i = 0%Z) -> ((((result34 x) i) us) = (t_im_part x))).

(* Why3 assumption *)
Definition complex_as_a_vector (x:t) : matrix t :=
  make_f 2%Z 1%Z (result34 x).
...
Axiom H2 : eigen circ y (real_to_ang theta).

Axiom H3 : is_a_ket_l y (width circ).

Axiom H4 :
  forall (x:bitvec), forall (theta1:t), ((length x) = ft) ->
  (real_ theta1) ->
  ((real_to_ang (infix_asdt theta1 (i_to_t (bv_to_int x)))) =
   (ang_sum
    (fun (i:Z) =>
     (real_to_ang
      (infix_asdt
       (infix_asdt theta1 (i_to_t (power_ 2%Z ((ft - i)%Z - 1%Z)%Z)))
       (i_to_t ((value x) i)))))
    0%Z ft)).

Axiom H5 : (0%Z <= (width circ))%Z.

Axiom H6 : (0%Z <= (width circ))%Z.

Parameter o: Z -> circuit.

Axiom o_def :
  forall (i:Z),
  ((0%Z <= ((ft - i)%Z - 1%Z)%Z)%Z ->
   ((o i) = (pow_pow_2 circ ((ft - i)%Z - 1%Z)%Z y (real_to_ang theta)))) /\
  (~ (0%Z <= ((ft - i)%Z - 1%Z)%Z)%Z ->
   ((o i) = (pow_pow_2 circ 0%Z y (real_to_ang theta)))).

(* Why3 assumption *)
Definition result35 : circuit :=
  control_eigen_seq_real o y
  (fun (i:Z) =>
   (infix_asdt theta (i_to_t (power_ 2%Z ((ft - i)%Z - 1%Z)%Z))))
  (fun (i:Z) => i) ft ft (width circ) (ft + (width circ))%Z.

Axiom H7 : ((width result35) = (ft + (width circ))%Z).

Axiom H8 :
  forall (x:bitvec), ((length x) = ft) ->
  sem result35 (kronecker (bv_to_ket x) y)
  (kronecker
   (infix_asdtdt
    (ang_exp
     (ang_sum
      (fun (i:Z) =>
       (real_to_ang
        (infix_asdt
         ((fun (i1:Z) =>
           (infix_asdt theta (i_to_t (power_ 2%Z ((ft - i1)%Z - 1%Z)%Z))))
          i)
         (i_to_t ((value x) ((fun (i1:Z) => i1) i))))))
      0%Z ft))
    (bv_to_ket x))
   y).

Axiom H9 : ((width result35) = (ft + (width circ))%Z).

Axiom H10 :
  forall (x:bitvec), ((length x) = ft) ->
  ((pat_sem result35 (kronecker (bv_to_ket x) y)) =
   (kronecker (infix_asdtdt (black_box_coeff theta x) (bv_to_ket x)) y)).

(* Why3 goal *)
Theorem G :
  forall (x:bitvec), (mem x (n_bvs ft)) ->
  is_a_ket_l
  ((fun (k:bitvec) => (kronecker ((fun (x1:bitvec) => (bv_to_ket x1)) k) y))
   x)
  (width result35).
Proof.
intros x h1.
