...
Axiom value_eq :
  forall (o:d_frac) (o':d_frac), (o = o') -> ((value o) = (value o')).
...
Axiom value_zero_ : ((value (dyadic 0%Z 0%Z)) = tone).
...
Axiom d_sum_break_zero_l :
  forall (f:Z -> d_frac) (i:Z) (j:Z) (y:Z), ((i <= y)%Z /\ (y <= j)%Z) ->
  (forall (k:Z), ((i <= k)%Z /\ (k < y)%Z) -> ((f k) = (dyadic 0%Z 0%Z))) ->
  ((d_sum f y j) = (d_sum f i j)).
...
Axiom a_phase__spec :
  ...
  (((a_depth_ (a_phase_ o)) = 1%Z) /\
   ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
    ...
    ((a_phase_part_ (a_phase_ o) bvx bvy) = (value o)))).
...
Axiom a_rzp__spec :
  ...
  (((a_sum_range_ (a_rzp_ n)) = 0%Z) /\
   ((forall (bvx:Z -> Z) (bvy:Z -> Z), forall (i:Z),
    ...
    ((a_phase_part_ (a_rzp_ n) bvx bvy) = (value (dyadic (bvx 0%Z) n))))).
...
Parameter inv_: d_frac_ -> d_frac_.
...
Axiom Inv_def_l2 : forall (x:d_frac_), ((add_ (inv_ x) x) = zero_d_).

Axiom Inv_def_r2 : forall (x:d_frac_), ((add_ x (inv_ x)) = zero_d_).
...
Axiom Add2 :
  forall (d:d_frac_) (d':d_frac_),
  ((value_ (add_ d d')) = (infix_asdt (value_ d) (value_ d'))).
...
Axiom Odd_phase_inv1 :
  forall (d:d_frac_), forall (i:Z),
  ((int.EuclideanDivision.mod1 i 2%Z) = 1%Z) -> ((phase_inv_ i d) = (inv_ d)).
...
Axiom d_sum_break_zero_l1 :
  forall (f:Z -> d_frac_) (i:Z) (j:Z) (y:Z), ((i <= y)%Z /\ (y <= j)%Z) ->
  (forall (k:Z), ((i <= k)%Z /\ (k < y)%Z) -> ((f k) = zero_d_)) ->
  ((d_sum_ f y j) = (d_sum_ f i j)).
...
Axiom Phase_to_gen :
  forall (o:d_frac), forall (o':d_frac_), ((value o) = (value_ o')) ->
...
Axiom inv__def :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b) (e:b), (p_bijective f s s') ->
  (mem e s') -> ((inv_1 f s s' e) = (inv_func f s s' e)).

Axiom inv__spec :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b) (e:b), (p_bijective f s s') ->
  (mem e s') -> (mem (inv_1 f s s' e) s) /\ ((f (inv_1 f s s' e)) = e).

Axiom inv_bijective :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b), (p_bijective f s s') ->
  p_bijective
  ((((fun (y0:a -> b) (y1:set a) (y2:set b) (y3:b) => (inv_1 y0 y1 y2 y3)) f)
    s)
   s')
  s' s.
...
Axiom result_def11 :
  ...
  (((0%Z <= i)%Z /\ (i < (length bv1))%Z) ->
   (((result11 bv1 bv2) i) = (bin_and ((value1 bv1) i) ((value1 bv2) i)))) /\
  (~ ((0%Z <= i)%Z /\ (i < (length bv1))%Z) ->
...
Axiom bin_andv_spec :
  ...
  (((bin_andv bv1 bv2) =
    (make_bv (fun (i:Z) => (bin_and ((value1 bv1) i) ((value1 bv2) i)))
     (length bv1))) /\
   ((bvlength (value1 (bin_andv bv1 bv2)) (length bv1)) /\
    forall (i:Z), ((0%Z <= i)%Z /\ (i < (length (bin_andv bv1 bv2)))%Z) ->
    (((((value1 bv1) i) = 1%Z) /\ (((value1 bv2) i) = 1%Z)) ->
     (((value1 (bin_andv bv1 bv2)) i) = 1%Z)) /\
    (~ ((((value1 bv1) i) = 1%Z) /\ (((value1 bv2) i) = 1%Z)) ->
     (((value1 (bin_andv bv1 bv2)) i) = 0%Z)))).

Axiom bin_andv_values :
  forall (bv1:bitvec) (bv2:bitvec) (k:Z), ((length bv1) = (length bv2)) ->
  ((0%Z <= k)%Z /\ (k < (length bv1))%Z) ->
  (((value1 (bin_andv bv1 bv2)) k) =
   (bin_and ((value1 bv1) k) ((value1 bv2) k))).
...
Axiom int_bin_and_seq_spec :
  ...
  ((0%Z <= j)%Z /\ (j < (power 2%Z n))%Z) ->
  (forall (k:Z), ((0%Z <= k)%Z /\ (k < n)%Z) ->
   (((value1 (int_bin_and_seq i j n)) k) =
    (bin_and ((value1 (int_to_bv i n)) k) ((value1 (int_to_bv j n)) k)))) /\
  (bvlength (value1 (int_bin_and_seq i j n)) n).
...
Axiom int_bin_and_seq_zero :
  ...
  forall (k:Z), ((0%Z <= k)%Z /\ (k < n)%Z) ->
  (((value1 (int_bin_and_seq i j n)) k) = 0%Z).
...
Axiom ket_fun_inversion :
  ...
  (m =
   (mat_sum (to_fset 0%Z pow_2_n)
    (fun (j:Z) =>
     (infix_asdtdt
      (a (inv_1 f (to_fset 0%Z pow_2_n) (to_fset 0%Z pow_2_n) j))
      (ket (ket_length m) j))))).
...
Axiom ket_sum_semantics :
  forall {a:Type} {a_WT:WhyType a},
  forall (c:a_circuit) (s:set a) (f:a -> matrix t) (g:a -> matrix t) 
    (n:Z) (n':Z),
  (n = (a_depth c)) -> (n' = (a_depth c)) -> (1%Z <= (cardinal s))%Z ->
  (forall (e:a), (mem e s) -> semantics c (f e) (g e)) ->
  semantics c (ket_sum_l s f n) (ket_sum_l s g n').
  ...
  ((path_semantics c x) =
   (infix_asdtdt (pow_inv_sqrt_2 (a_sum_range c))
    (ket_sum_l (n_bvs (a_sum_range c))
     (fun (bvy:bitvec) =>
      (infix_asdtdt
       (value_ (a_phase_part c (value1 (ket_to_bv x)) (value1 bvy)))
...
Axiom ket_sum_semantics1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (c:a_circuit_) (s:set a) (f:a -> matrix t) (g:a -> matrix t) 
    (n:Z) (n':Z),
  (n = (a_depth_ c)) -> (n' = (a_depth_ c)) -> (1%Z <= (cardinal s))%Z ->
  (forall (e:a), (mem e s) -> semantics_ c (f e) (g e)) ->
  semantics_ c (ket_sum_l s f n) (ket_sum_l s g n').
...
Axiom id_cont__spec :
  ...
  (forall (bv:bitvec), (mem bv (n_bvs n)) -> (((value1 bv) c) = 0%Z) ->
   semantics_ (id_cont_ circ c ft n) (bv_to_ket bv) (bv_to_ket bv)) /\
  ((forall (bv:bitvec), (mem bv (n_bvs n)) -> (((value1 bv) c) = 1%Z) ->
...
Axiom par_id_k_gen :
  forall (c:a_circuit) (k:Z), (1%Z <= k)%Z ->
  forall (x:matrix t) (y:matrix t) (z:matrix t), (is_a_ket_l y k) ->
  (semantics c x z) -> semantics (par_id c k) (kronecker x y) (kronecker z y).
  ...
  (((a_sum_range (id_cont circ c ft n)) = (a_sum_range circ)) /\
   (((a_to_gen_circuit (id_cont circ c ft n)) =
    ...
    ((forall (x:matrix t), (is_a_ket_l x n) ->
      (((value1 (ket_to_bv x)) c) = 0%Z) ->
      semantics (id_cont circ c ft n) x x) /\
     forall (x:matrix t), (is_a_ket_l x n) ->
     (((value1 (ket_to_bv x)) c) = 1%Z) ->
...
Axiom id_cont_kron_gen :
  forall (circ:a_circuit) (c:Z) (ft:Z) (n:Z) (y:matrix t) (z:matrix t),
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (a_depth circ))%Z) ->
  (semantics circ y z) ->
  ...
  (((rows (mat_semantics (reverse c))) = (rows (mat_semantics c))) /\
   (((columns (mat_semantics (reverse c))) = (columns (mat_semantics c))) /\
    ((forall (x:matrix t) (x':matrix t), (semantics c x x') ->
     ...
     ((a_depth (reverse c)) = (a_depth c))))).

Axiom Reverse_phase1 :
  forall (o:d_frac_), ((reverse (a_phase o)) = (a_phase (inv_ o))).

Axiom Reverse_rz1 :
  forall (o:d_frac_), ((reverse (a_rz o)) = (a_rz (inv_ o))).
...
Parameter id_cont_rz: Z -> Z -> Z -> Z -> a_circuit.

Axiom id_cont_rz_spec :
  forall (c:Z) (t1:Z) (n:Z) (k:Z), (0%Z <= k)%Z ->
  ((0%Z <= c)%Z /\ (c < n)%Z) -> ((0%Z <= t1)%Z /\ (t1 < n)%Z) ->
  ~ (t1 = c) ->
  ((a_depth (id_cont_rz c t1 n k)) = n) /\
  ((a_diag (id_cont_rz c t1 n k)) /\
   forall (bvx:Z -> Z), (binary bvx) ->
   (((bvx c) = 1%Z) ->
    ((a_flat_phase (id_cont_rz c t1 n k) bvx) = (dyadic_ (bvx t1) k))) /\
   (~ ((bvx c) = 1%Z) ->
    ((a_flat_phase (id_cont_rz c t1 n k) bvx) = zero_d_))).
...
Axiom H1 : (0%Z <= first_c)%Z.

Axiom H2 : (first_c < n)%Z.

Axiom H3 : (0%Z <= t1)%Z.

Axiom H4 : (t1 < n)%Z.

Axiom H5 : (((first_c + l)%Z - 1%Z)%Z < n)%Z.

Axiom H6 : (t1 <= ((first_c + l)%Z - 1%Z)%Z)%Z -> (t1 < first_c)%Z.

Parameter fc13: Z -> a_circuit.

Axiom fc_def13 :
  forall (k:Z),
  (((first_c <= k)%Z /\ (k < (first_c + l)%Z)%Z) ->
   ((fc13 k) = (id_cont_rz k t1 n ((k - first_c)%Z + 2%Z)%Z))) /\
  (~ ((first_c <= k)%Z /\ (k < (first_c + l)%Z)%Z) ->
   ((fc13 k) = (a_rzp 1%Z))).

Axiom H7 :
  ((diag_seq_prod fc13 n first_c (first_c + l)%Z) =
   (diag_seq_prod
    (fun (k:Z) => (id_cont_rz k t1 n ((k - first_c)%Z + 2%Z)%Z)) n first_c
    (first_c + l)%Z)).

Parameter k: Z.

Axiom H8 : (first_c <= k)%Z.

Axiom H9 : (k < (first_c + l)%Z)%Z.

Axiom H10 : (0%Z <= ((k - first_c)%Z + 2%Z)%Z)%Z.

(* Why3 goal *)
Theorem VC_cascade_cont_rz : (0%Z <= k)%Z /\ (k < n)%Z.
Proof.
