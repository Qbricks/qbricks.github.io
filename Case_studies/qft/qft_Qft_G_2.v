...
Axiom get_path_sem_rev_qft_ket :
  ...
  ((get (path_sem (qft_rev n) (ket n i)) j 0%Z) =
   (infix_asdt (pow_inv_sqrt_2 n)
   ...
   (((width (qft n)) = n) /\
    ...
    ((path_sem (qft n)
      (infix_asdtdt (pow_inv_sqrt_2 n)
       (ket_sum_l (n_bvs n)
        (fun (y:bitvec) =>
         (infix_asdtdt (qft_rev_coeff x y n) (bv_to_ket y)))
        n)))
     = (bv_to_ket x)))).

Parameter qft_coeff: bitvec -> bitvec -> Z -> complex.
...
Axiom qft_coeff_def :
  ...
  ((qft_coeff x y n) =
   (ang_exp
    (real_to_ang
     (infix_asdt
      (infix_asdt (i_to_c (bv_to_int (bv_inversion x)))
       (i_to_c (bv_to_int y)))
      (pow_inv_2 n))))).

Axiom qft_coeff_spec :
  forall (x:bitvec) (y:bitvec) (n:Z), (0%Z < n)%Z ->
  ((modulus (qft_coeff x y n)) = c_one) /\
  ((qft_coeff x y n) =
   (ang_exp (int_to_ang ((bv_to_int (bv_inversion x)) * (bv_to_int y))%Z n))).

Axiom qft_coeff_int_to_ang :
  forall (x:bitvec) (y:bitvec) (n:Z), (0%Z < n)%Z -> ((length x) = n) ->
  ((length y) = n) ->
  ((qft_coeff x y n) =
   (ang_exp (int_to_ang ((bv_to_int (bv_inversion x)) * (bv_to_int y))%Z n))).
   ...
   (ang_exp
    (real_to_ang
     (infix_asdt
      (infix_asdt
       (i_to_c
        (int_bit_inversion (int.EuclideanDivision.mod1 i (power_ 2%Z n)) n))
       (i_to_c (int.EuclideanDivision.mod1 j (power_ 2%Z n))))
      (pow_inv_2 n))))).
...
Axiom int_qft_coeff_spec :
  ...
  (((int_qft_coeff i j n) =
    (ang_exp
     (int_to_ang
      ((int_bit_inversion (int.EuclideanDivision.mod1 i (power_ 2%Z n)) n) *
       (int.EuclideanDivision.mod1 j (power_ 2%Z n)))%Z
      n))) /\
   ((int_qft_coeff i j n) =
...
Axiom int_qft_coeff_expo :
  ...
  ((int_qft_coeff i j n) =
   (cpower
    (ang_exp
     (int_to_ang
      (int_bit_inversion (int.EuclideanDivision.mod1 i (power_ 2%Z n)) n) n))
...
Axiom int_qft_coeff_expo_ :
  ...
  ((int_qft_coeff i j n) =
   (cpower
    (ang_exp (int_to_ang (int.EuclideanDivision.mod1 j (power_ 2%Z n)) n))
    (int_bit_inversion (int.EuclideanDivision.mod1 i (power_ 2%Z n)) n))).

Axiom int_qft_coeff_inv :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_rev_coeff i j n) = (infix_sldt c_one (int_qft_coeff j i n))).

Axiom int_qft_rev_coeff_inv :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_coeff i j n) = (infix_sldt c_one (int_qft_rev_coeff j i n))).

Axiom int_qft_rev_coeff_to_qft_coeff :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((0%Z <= j)%Z /\ (j < (power_ 2%Z n))%Z) ->
  ((int_qft_rev_coeff i j n) = (int_qft_coeff j (-i)%Z n)).
...
Axiom int_qft_rev_coeff_no_mod :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_rev_coeff i j n) =
   (ang_exp
    (real_to_ang
     (infix_asdt
      (infix_asdt (prefix_mndt (i_to_c i))
       (i_to_c
        (int_bit_inversion (int.EuclideanDivision.mod1 j (power_ 2%Z n)) n)))
      (pow_inv_2 n))))).
...
Axiom rev_qft_apply_qft :
  ...
  ((path_sem (qft_rev n)
    (infix_asdtdt (pow_inv_sqrt_2 n)
     (ket_sum_l (n_bvs n)
      (fun (y:bitvec) =>
       (infix_asdtdt (qft_coeff (int_to_bv i n) y n) (bv_to_ket y)))
      n)))
...
Axiom qft_coeff_add :
  ...
  ((int_qft_coeff j (i + i')%Z n) =
   (infix_asdt (int_qft_coeff j i n) (int_qft_coeff j i' n))).
...
Axiom h :
  forall (k:Z) (k':Z) (n1:Z), (0%Z <= n1)%Z ->
  ((int.EuclideanDivision.mod1 k (power_ 2%Z n1)) =
   (int.EuclideanDivision.mod1 k' (power_ 2%Z n1))) ->
  ((int_to_ang k n1) = (int_to_ang k' n1)).
...
Theorem G :
  ((int.EuclideanDivision.mod1
    ((int.EuclideanDivision.mod1
      (-((int.EuclideanDivision.mod1 i (power_ 2%Z n)) +
         (int.EuclideanDivision.mod1 i' (power_ 2%Z n)))%Z)%Z
      (power_ 2%Z n))
     *
     (int_bit_inversion
      (int.EuclideanDivision.mod1
       (int.EuclideanDivision.mod1 j (power_ 2%Z n)) (power_ 2%Z n))
      n))%Z
    (power_ 2%Z n))
   =
   (int.EuclideanDivision.mod1
    (((int.EuclideanDivision.mod1
       (-(int.EuclideanDivision.mod1 i (power_ 2%Z n)))%Z (power_ 2%Z n))
      +
      (int.EuclideanDivision.mod1
       (-(int.EuclideanDivision.mod1 i' (power_ 2%Z n)))%Z (power_ 2%Z n)))%Z
     *
     (int_bit_inversion
      (int.EuclideanDivision.mod1
       (int.EuclideanDivision.mod1 j (power_ 2%Z n)) (power_ 2%Z n))
