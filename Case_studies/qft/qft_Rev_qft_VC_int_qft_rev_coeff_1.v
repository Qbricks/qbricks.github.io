...
Parameter teq: complex -> complex -> Prop.

Axiom teq_def : forall (x:complex) (y:complex), (teq x y) -> infix_eqeq x y.

Axiom teq_def1 : forall (x:complex) (y:complex), (infix_eqeq x y) -> teq x y.

Axiom teq_spec : forall (x:complex) (y:complex), (teq x y) -> (x = y).

Axiom teq_spec1 : forall (x:complex) (y:complex), (x = y) -> teq x y.
...
Parameter infix_mn: complex -> complex -> complex.

Axiom infix_mn_def :
  forall (x:complex) (y:complex),
  ((infix_mn x y) = (infix_pldt x (prefix_mndt y))).

Parameter infix_sl: complex -> complex -> complex.

Axiom infix_sl_def :
  forall (x:complex) (y:complex), ((infix_sl x y) = (infix_asdt x (inv y))).
...
Parameter infix_mndt: complex -> complex -> complex.
...
Axiom infix_eqas_def1 :
  forall (x:R) (y:R), (infix_eqeq x y) -> infix_eqas x y.
...
Axiom infix_lsgtas_def1 :
  forall (x:R) (y:R), ~ (infix_eqeq x y) -> infix_lsgtas x y.
...
Axiom infix_lseqas_def1 : forall (x:R) (y:R), (x <= y)%R -> infix_lseqas x y.
...
Axiom infix_lsas_def :
  forall (x:R) (y:R), (infix_lsas x y) -> infix_lseqas x y.

Axiom infix_lsas_def1 :
  forall (x:R) (y:R), (infix_lsas x y) -> infix_lsgtas x y.

Axiom infix_lsas_def2 :
  forall (x:R) (y:R), ((infix_lseqas x y) /\ (infix_lsgtas x y)) ->
  infix_lsas x y.
...
Axiom infix_gtas_def1 :
  forall (x:R) (y:R), (infix_lsas y x) -> infix_gtas x y.
...
Axiom infix_gteqas_def1 :
  forall (x:R) (y:R), (infix_lseqas y x) -> infix_gteqas x y.
...
Parameter ttwo: complex.

Axiom ttwo_def : (ttwo = (infix_pldt c_one c_one)).
...
Axiom r_to_c_add :
  forall (i:R) (j:R),
  ((infix_pldt (r_to_c i) (r_to_c j)) = (r_to_c (infix_plas i j))).

Axiom r_to_c_add_rev :
  forall (i:R) (j:R),
  ((r_to_c (infix_plas i j)) = (infix_pldt (r_to_c i) (r_to_c j))).

Axiom r_to_c_opp :
  forall (i:R), ((r_to_c (prefix_mnas i)) = (prefix_mndt (r_to_c i))).
...
Axiom r_to_c_mult :
  forall (i:R) (j:R),
  ((infix_asdt (r_to_c i) (r_to_c j)) = (r_to_c (infix_asas i j))).

Axiom r_to_c_mult_rev :
  forall (i:R) (j:R),
  ((r_to_c (infix_asas i j)) = (infix_asdt (r_to_c i) (r_to_c j))).
...
Axiom Real_part_opposite :
  forall (i:complex),
  ((real_part (prefix_mndt i)) = (prefix_mnas (real_part i))).

Axiom Im_part_opposite :
  forall (i:complex), ((im_part (prefix_mndt i)) = (prefix_mnas (im_part i))).
...
Parameter real_: complex -> Prop.

Axiom real__def :
  forall (x:complex), (real_ x) -> infix_eqeq (im_part x) 0%R.

Axiom real__def1 :
  forall (x:complex), (infix_eqeq (im_part x) 0%R) -> real_ x.

Parameter pure_im_: complex -> Prop.

Axiom pure_im__def :
  forall (x:complex), (pure_im_ x) -> infix_eqeq (real_part x) 0%R.

Axiom pure_im__def1 :
  forall (x:complex), (infix_eqeq (real_part x) 0%R) -> pure_im_ x.
...
Parameter t_real_part: complex -> complex.

Axiom t_real_part_def :
  forall (x:complex), ((t_real_part x) = (r_to_c (real_part x))).
...
Parameter t_im_part: complex -> complex.

Axiom t_im_part_def :
  forall (x:complex), ((t_im_part x) = (r_to_c (im_part x))).
...
Axiom mult_real_real1 :
  forall (a:complex) (b:complex), (real_ a) -> (real_ b) ->
  ((infix_asdt (r_to_c (real_part a)) (r_to_c (real_part b))) =
   (r_to_c (infix_asas (real_part a) (real_part b)))).
...
Axiom complex_squared :
  ...
  ((infix_asdt a a) =
   (infix_pldt
    ...
    (infix_asdt (infix_asdt (infix_asdt im ttwo) (t_real_part a))
     (t_im_part a)))).
...
Axiom complex_squared2 :
  ...
  ((t_im_part (infix_asdt a a)) =
   (infix_asdt (infix_asdt ttwo (t_real_part a)) (t_im_part a))).
...
Axiom twice : forall (i:complex), ((infix_asdt ttwo i) = (infix_pldt i i)).

Axiom twice_half : ((infix_asdt ttwo (infix_sldt c_one ttwo)) = c_one).

Axiom half_plus_half :
  forall (i:complex),
  ((infix_pldt (infix_sldt i ttwo) (infix_sldt i ttwo)) = i).
...
Parameter infix_lseqdt: complex -> complex -> Prop.

Axiom infix_lseqdt_def :
  forall (x:complex) (y:complex), (infix_lseqdt x y) ->
  (real_ x) \/ (infix_eqeq x y).

Axiom infix_lseqdt_def1 :
  forall (x:complex) (y:complex), (infix_lseqdt x y) ->
  (real_ y) \/ (infix_eqeq x y).

Axiom infix_lseqdt_def2 :
  forall (x:complex) (y:complex), (infix_lseqdt x y) ->
  (infix_lseqas (real_part x) (real_part y)) \/ (infix_eqeq x y).

Axiom infix_lseqdt_def3 :
  forall (x:complex) (y:complex),
  ((real_ x) /\ ((real_ y) /\ (infix_lseqas (real_part x) (real_part y)))) ->
  infix_lseqdt x y.

Axiom infix_lseqdt_def4 :
  forall (x:complex) (y:complex), (infix_eqeq x y) -> infix_lseqdt x y.

Parameter infix_lsdt: complex -> complex -> Prop.

Axiom infix_lsdt_def :
  forall (x:complex) (y:complex), (infix_lsdt x y) -> infix_lseqdt x y.

Axiom infix_lsdt_def1 :
  forall (x:complex) (y:complex), (infix_lsdt x y) -> ~ (infix_eqeq x y).

Axiom infix_lsdt_def2 :
  forall (x:complex) (y:complex),
  ((infix_lseqdt x y) /\ ~ (infix_eqeq x y)) -> infix_lsdt x y.

Parameter infix_gteqdt: complex -> complex -> Prop.

Axiom infix_gteqdt_def :
  forall (x:complex) (y:complex), (infix_gteqdt x y) -> infix_lseqdt y x.

Axiom infix_gteqdt_def1 :
  forall (x:complex) (y:complex), (infix_lseqdt y x) -> infix_gteqdt x y.

Parameter infix_gtdt: complex -> complex -> Prop.

Axiom infix_gtdt_def :
  forall (x:complex) (y:complex), (infix_gtdt x y) -> infix_gteqdt x y.

Axiom infix_gtdt_def1 :
  forall (x:complex) (y:complex), (infix_gtdt x y) -> ~ (infix_eqeq x y).

Axiom infix_gtdt_def2 :
  forall (x:complex) (y:complex),
  ((infix_gteqdt x y) /\ ~ (infix_eqeq x y)) -> infix_gtdt x y.
...
Axiom Refl1 : forall (x:complex), infix_gteqdt x x.

Axiom Trans1 :
  forall (x:complex) (y:complex) (z:complex), (infix_gteqdt x y) ->
  (infix_gteqdt y z) -> infix_gteqdt x z.

Axiom Antisymm1 :
  forall (x:complex) (y:complex), (infix_gteqdt x y) -> (infix_gteqdt y x) ->
  (x = y).
...
Axiom r_to_c_inf :
  forall (i:R) (j:R), (infix_lseqdt (r_to_c i) (r_to_c j)) ->
  infix_lseqas i j.

Axiom r_to_c_inf1 :
  forall (i:R) (j:R), (infix_lseqas i j) ->
  infix_lseqdt (r_to_c i) (r_to_c j).
...
Axiom inf_from_r :
  forall (a:complex) (b:complex), (real_ a) -> (real_ b) ->
  (infix_lseqas (real_part a) (real_part b)) -> infix_lseqdt a b.
...
Axiom pi_sup_ttwo : infix_lsdt ttwo pi.
...
Axiom inf_to_non_sup_eq :
  forall (x:complex) (y:complex), (real_ x) -> (real_ y) ->
  (infix_lsdt x y) -> ~ (infix_gteqdt x y).

Axiom sup_eq_to_non_inf :
  forall (x:complex) (y:complex), (real_ x) -> (real_ y) ->
  (infix_gteqdt x y) -> ~ (infix_lsdt x y).
...
Axiom compat_r_to_c_infeq :
  ...
  infix_lseqdt (r_to_c a) (r_to_c b).
...
Axiom compat_r_to_c_supeq :
  ...
  infix_gteqdt (r_to_c a) (r_to_c b).

Axiom compat_r_to_c_sup :
  forall (a:R) (b:R), (infix_gtas a b) -> infix_gtdt (r_to_c a) (r_to_c b).
...
Axiom rewrite_supeq :
  forall (x:complex) (y:complex), (infix_lseqdt x y) -> infix_gteqdt y x.
...
Axiom sup_eq_def :
  forall (x:complex) (y:complex), (infix_gteqdt x y) -> (real_ x) \/ (x = y).

Axiom sup_eq_def1 :
  forall (x:complex) (y:complex), (infix_gteqdt x y) -> (real_ y) \/ (x = y).

Axiom sup_eq_def2 :
  forall (x:complex) (y:complex), (infix_gteqdt x y) ->
...
Axiom sup_eq_def4 :
  forall (x:complex) (y:complex), (x = y) -> infix_gteqdt x y.
...
Axiom transitive_supeq :
  forall (a:complex) (b:complex) (c:complex), (infix_gteqdt a b) ->
  (infix_gteqdt b c) -> infix_gteqdt a c.
...
Axiom transitive_sup_l :
  ...
  (infix_gteqdt b c) -> infix_gtdt a c.
...
Axiom compat_mult_sup_eq_right :
  forall (a:complex) (b:complex) (c:complex), (infix_lseqdt c_zero a) ->
  (infix_gteqdt b c) -> infix_gteqdt (infix_asdt a b) (infix_asdt a c).
...
Axiom infeq_to_supeq :
  forall (a:complex) (b:complex), (infix_lseqdt a b) -> infix_gteqdt b a.
...
Axiom supeq_elim_left :
  forall (a:complex) (b:complex), (real_ a) -> (real_ b) ->
  (infix_gteqdt a b) -> infix_gteqdt c_zero (infix_mndt b a).
...
Axiom mult_im_im1 :
  forall (a:complex) (b:complex), (pure_im_ a) -> (pure_im_ b) ->
  ((infix_asdt a b) =
   (prefix_mndt (r_to_c (infix_asas (im_part a) (im_part b))))).
...
Axiom mult_real_im1 :
  forall (a:complex) (b:complex), (real_ a) -> (pure_im_ b) ->
  ((infix_asdt a b) =
   (infix_asdt im (r_to_c (infix_asas (real_part a) (im_part b))))).
...
Axiom mult_im_real1 :
  forall (a:complex) (b:complex), (pure_im_ a) -> (real_ b) ->
  ((infix_asdt a b) =
   (infix_asdt im (r_to_c (infix_asas (im_part a) (real_part b))))).
...
Axiom inv_sup_eq :
  forall (a:complex) (b:complex), (infix_lsdt c_zero a) ->
  (infix_lsdt c_zero b) -> (infix_gteqdt a b) ->
  infix_gteqdt (infix_sldt c_one b) (infix_sldt c_one a).
...
Axiom inv_eqinf :
  ...
  infix_gteqdt (infix_sldt c_one x) (infix_sldt c_one y).

Axiom inv_eqsup :
  forall (x:complex) (y:complex), (real_ x) -> (real_ y) ->
  ((infix_gteqdt x y) /\ (infix_gtdt y c_zero)) ->
...
Axiom lower_inv :
  ...
  infix_gteqdt (infix_sldt a b) (infix_sldt a c).
...
Axiom triang_p :
  ...
  ((infix_asdt (infix_pldt a b) (infix_pldt a b)) =
   (infix_pldt (infix_pldt (infix_asdt a a) (infix_asdt b b))
    (infix_asdt (infix_asdt ttwo a) b))).
...
Axiom real_sqrt_spec :
  forall (x:R), (infix_lseqas 0%R x) ->
  ((infix_asas (real_sqrt x) (real_sqrt x)) = x).
...
Axiom pos_square_rt :
  forall (x:complex), (real_ x) -> (infix_lseqdt c_zero x) ->
  infix_gteqdt (square_rt x) c_zero.
...
Parameter modulus: complex -> complex.
...
Parameter c_one_modulus: complex -> Prop.

Axiom c_one_modulus_def :
  forall (x:complex), (c_one_modulus x) -> ((modulus x) = c_one).

Axiom c_one_modulus_def1 :
  forall (x:complex), ((modulus x) = c_one) -> c_one_modulus x.
...
Axiom constant_f_def :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b), (constant_f f) ->
  exists a1:b, (f = ((fun (y0:b) (y1:a) => (const y0 y1)) a1)).

Axiom constant_f_def1 :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b),
  (exists a1:b, (f = ((fun (y0:b) (y1:a) => (const y0 y1)) a1))) ->
  constant_f f.
...
Axiom eq_e_def1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:a) (a':a), (a1 = a') -> eq_e a1 a'.
...
Axiom commute_def :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (o:(a* b)%type), forall (x:a) (x1:b), (o = (x, x1)) ->
  ((commute o) = (x1, x)).
...
Axiom op_neutral_left_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (neutral:im1),
  (forall (e:im1), (((op1 neutral) e) = e)) -> op_neutral_left op1 neutral.
...
Axiom op_neutral_right_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (neutral:im1),
  (forall (e:im1), (((op1 e) neutral) = e)) -> op_neutral_right op1 neutral.
...
Axiom op_assoc_def :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1), (op_assoc op1) ->
...
Axiom op_neutral_left_comm_def :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (neutral:im1),
  (op_neutral_left_comm op1 neutral) -> forall (a:im1),
  (forall (b:im1), (((op1 a) b) = b)) -> (a = neutral).

Axiom op_neutral_left_comm_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (neutral:im1),
...
Axiom commut_def :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1), (commut op1) -> forall (a:im1) (b:im1),
  (((op1 a) b) = ((op1 b) a)).

Axiom commut_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1),
  (forall (a:im1) (b:im1), (((op1 a) b) = ((op1 b) a))) -> commut op1.
...
Axiom assoc_def :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1), (assoc op1) ->
  forall (a:im1) (b:im1) (c:im1),
  (((op1 ((op1 a) b)) c) = ((op1 a) ((op1 b) c))).
...
Axiom opposite_n_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (po1:im1 -> im1 -> im1) (neutral:im1),
  (forall (a:im1), (((po1 a) a) = neutral)) -> opposite_n op1 po1 neutral.
...
Axiom inverse_def :
  ...
  (inverse op1 po1 inver1) -> forall (a:im1) (b:im1),
  (((po1 a) b) = ((op1 a) (inver1 b))).
...
Axiom opposite_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (po1:im1 -> im1 -> im1),
  (forall (a:im1) (b:im1), (((op1 ((po1 a) b)) b) = a)) -> opposite1 op1 po1.
...
Axiom opposite_com_def :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (po1:im1 -> im1 -> im1),
  (opposite_com op1 po1) -> forall (a:im1) (b:im1),
  (((po1 ((op1 a) b)) b) = a).

Axiom opposite_com_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (po1:im1 -> im1 -> im1),
...
Axiom neutral_def :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (neut:im1), (neutral op1 neut) ->
  op_neutral_left op1 neut.

Axiom neutral_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (neut:im1), (neutral op1 neut) ->
  op_neutral_right op1 neut.
...
Axiom has_neutral_def :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1), (has_neutral op1) ->
  exists e:im1, neutral op1 e.

Axiom has_neutral_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1), (exists e:im1, neutral op1 e) ->
  has_neutral op1.
...
Axiom iterates_def :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (neutral1:im1), (iterates op1 neutral1) ->
...
Axiom iterable_def :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1), (iterable op1) ->
  exists e:im1, iterates op1 e.

Axiom iterable_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1), (exists e:im1, iterates op1 e) ->
  iterable op1.
...
Axiom inverse_tuple_def :
  ...
  (inverse_tuple op1 po1 neutral1) -> opposite_n op1 po1 neutral1.

Axiom inverse_tuple_def1 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (po1:im1 -> im1 -> im1) (neutral1:im1),
  (inverse_tuple op1 po1 neutral1) -> opposite1 op1 po1.

Axiom inverse_tuple_def2 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (po1:im1 -> im1 -> im1) (neutral1:im1),
  (inverse_tuple op1 po1 neutral1) -> opposite_com op1 po1.

Axiom inverse_tuple_def3 :
  forall {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (po1:im1 -> im1 -> im1) (neutral1:im1),
...
Axiom to_set_spec :
  forall {a:Type} {a_WT:WhyType a},
  forall (e:a), forall (b:a), (b = e) -> mem b (to_set e).
...
Axiom p_injective_in_def1 :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b), (p_injective_in f s s') ->
  forall (e:a), (mem e s) -> forall (e1:a) (e':a), (mem e1 s) ->
  (mem e' s) -> ~ (e1 = e') -> ~ ((f e1) = (f e')).

Axiom p_injective_in_def2 :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b),
  (forall (e:a), (mem e s) ->
   (mem (f e) s') /\
...
Axiom equal_func_def1 :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (g:a -> b), (forall (e:a), ((f e) = (g e))) ->
  equal_func f g.
...
Axiom p_surjective_def1 :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b), (p_surjective f s s') ->
  forall (e':b), (mem e' s') -> exists e:a, (mem e s) /\ ((f e) = e').

Axiom p_surjective_def2 :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b),
  ((forall (e:a), (mem e s) -> mem (f e) s') /\
   forall (e':b), (mem e' s') -> exists e:a, (mem e s) /\ ((f e) = e')) ->
...
Axiom p_bijective_def1 :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b), (p_bijective f s s') ->
  p_surjective f s s'.

Axiom p_bijective_def2 :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b),
  ((p_injective_in f s s') /\ (p_surjective f s s')) -> p_bijective f s s'.
...
Axiom isum_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (t:a -> Z),
  ((isum s t) = (iterate (fun (y0:Z) (y1:Z) => (y0 + y1)%Z) s t)).

Parameter iproduct:
  forall {a:Type} {a_WT:WhyType a}, (set a) -> (a -> Z) -> Z.

Axiom iproduct_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (t:a -> Z),
  ((iproduct s t) = (iterate (fun (y0:Z) (y1:Z) => (y0 * y1)%Z) s t)).
...
Axiom nonn_part_def :
  forall {a:Type} {a_WT:WhyType a} {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (s:set a) (t:a -> im1),
  ((nonn_part op1 s t) = (filter (result2 op1 t) s)).
...
Axiom n_part_def :
  forall {a:Type} {a_WT:WhyType a} {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (s:set a) (t:a -> im1),
  ((n_part op1 s t) = (filter (result3 op1 t) s)).
...
Axiom couple_def :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b}
    {im1:Type} {im1_WT:WhyType im1},
  forall (f:a -> b -> im1) (o:(a* b)%type), forall (x:a) (x1:b),
  (o = (x, x1)) -> ((couple f o) = ((f x) x1)).
...
Parameter sum:
  forall {a:Type} {a_WT:WhyType a}, (set a) -> (a -> complex) -> complex.
...
Parameter eq_t: complex -> complex -> Prop.

Axiom eq_t_def : forall (a:complex) (a':complex), (eq_t a a') -> (a = a').

Axiom eq_t_def1 : forall (a:complex) (a':complex), (a = a') -> eq_t a a'.
...
Axiom sum_plus_one :
  forall {b:Type} {b_WT:WhyType b},
  forall (s:set b) (f:b -> complex), ((cardinal s) > 1%Z)%Z ->
  ((sum s f) = (infix_pldt (f (choose s)) (sum (remove (choose s) s) f))).

Axiom sum_real :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> complex),
  (forall (a1:a), (mem a1 s) -> real_ (f a1)) -> ((cardinal s) > 0%Z)%Z ->
  real_ (sum s f).
...
Parameter ind_sum: (Z -> complex) -> Z -> Z -> complex.
...
Parameter non_c_zero:
  forall {a:Type} {a_WT:WhyType a}, (set a) -> (a -> complex) -> set a.

Axiom non_c_zero_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (t:a -> complex),
  ((non_c_zero s t) =
...
Parameter ind_product: (Z -> complex) -> Z -> Z -> complex.
...
Axiom nonn_part_def1 :
  forall {a:Type} {a_WT:WhyType a} {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (s:set a) (t:a -> im1),
  ((nonn_part1 op1 s t) = (filter (result4 op1 t) s)).
...
Axiom n_part_def1 :
  forall {a:Type} {a_WT:WhyType a} {im1:Type} {im1_WT:WhyType im1},
  forall (op1:im1 -> im1 -> im1) (s:set a) (t:a -> im1),
  ((n_part1 op1 s t) = (filter (result5 op1 t) s)).
...
Parameter sum_indic:
  forall {a:Type} {a_WT:WhyType a}, (set a) -> (a -> complex) -> a ->
  complex.

Axiom sum_indic_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (t:a -> complex) (i:a),
  ((sum_indic s t i) = (sum s (fun (e:a) => (infix_asdt (t e) (indic i e))))).
...
Axiom setbv_def :
  ...
  let result6 := setbv bv i j in
  forall (k:Z),
  ((k = i) -> ((result6 k) = j)) /\ (~ (k = i) -> ((result6 k) = (bv k))).
...
Axiom setbv_int_def :
  ...
  let result6 := setbv_int bv1 bv2 i j in
  forall (k:Z),
  (((i < k)%Z /\ (k <= j)%Z) -> ((result6 k) = (bv2 (k - i)%Z))) /\
  (~ ((i < k)%Z /\ (k <= j)%Z) -> ((result6 k) = (bv1 k))).
...
Axiom inter1 :
  ...
  ((0%Z <= k)%Z /\ (k <= n)%Z) ->
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < n)%Z) -> (((getbv x) i) = 0%Z)) ->
  ((ind_iproduct (fun (i:Z) => (1%Z - ((getbv x) i))%Z) 0%Z k) = 1%Z).
...
Axiom in_range_def :
  forall (bv:bitvec) (r:Z), (in_range bv r) -> (0%Z <= r)%Z.

Axiom in_range_def1 :
  forall (bv:bitvec) (r:Z), (in_range bv r) -> (r < (length bv))%Z.

Axiom in_range_def2 :
  forall (bv:bitvec) (r:Z), ((0%Z <= r)%Z /\ (r < (length bv))%Z) ->
  in_range bv r.
...
Axiom result_def7 :
  ...
  (~ (k = 0%Z) -> (((result7 bv i) k) = ((getbv bv) (k - 1%Z)%Z))).
...
Axiom bv_to_int_def :
  forall (bv:bitvec),
  ((bv_to_int bv) = (ind_isum (result8 bv) 0%Z (length bv))).
...
Axiom power__def :
  forall (e:Z) (i:Z), (i >= 0%Z)%Z -> ((power_ e i) = (power e i)).

Axiom power__def1 :
  forall (e:Z) (i:Z), ~ (i >= 0%Z)%Z -> ((power_ e i) = 0%Z).
...
Parameter i_to_c: Z -> complex.

Axiom i_to_c_def : forall (i:Z), ((i_to_c i) = (r_to_c (from_int i))).
...
Axiom i_to_c_ttwo : ((i_to_c 2%Z) = ttwo).
...
Axiom compat_i_to_c_supeq :
  forall (a:Z) (b:Z), (a >= b)%Z -> infix_gteqdt (i_to_c a) (i_to_c b).

Axiom compat_i_to_c_sup :
  forall (a:Z) (b:Z), (a > b)%Z -> infix_gtdt (i_to_c a) (i_to_c b).

Axiom positive_int_squrt :
  forall (i:Z), (i > 0%Z)%Z -> infix_gtdt (square_rt (i_to_c i)) c_zero.

Axiom non_null_int_squrt :
  forall (i:Z), (i > 0%Z)%Z -> ~ ((square_rt (i_to_c i)) = c_zero).
...
Axiom cpower_ttwo_two : ((cpower ttwo 2%Z) = (i_to_c 4%Z)).

Parameter squarert_two: complex.
...
Axiom complete_rt_two :
  forall (a:complex), (a = (infix_sldt squarert_two ttwo)) ->
  ((infix_asdt squarert_two a) = c_one).
...
Axiom cpower_squarert_two :
  forall (i:Z), (0%Z <= i)%Z ->
  ((cpower squarert_two i) = (square_rt (i_to_c (power_ 2%Z i)))).
...
Axiom cpower_c_one_pos :
  forall (m:Z), (m >= 0%Z)%Z -> ((cpower c_one m) = c_one).
...
Axiom cpower_iterate :
  ...
  ((cpower e i) =
   (int_iterate (fun (y0:complex) (y1:complex) => (infix_asdt y0 y1))
    ((fun (y0:complex) (y1:Z) => (const y0 y1)) e) 0%Z i)).
...
Axiom cpower_modulus1 :
  forall (x:complex) (n:Z), (0%Z <= n)%Z -> (n > 0%Z)%Z ->
...
Axiom non_zero_cpower_pos :
  forall (i:complex) (n:Z), ~ (i = c_zero) -> (n >= 0%Z)%Z ->
  ~ ((cpower i n) = c_zero).
...
Axiom zero_cpower_pos :
  forall (n:Z), (n > 0%Z)%Z -> ((cpower c_zero n) = c_zero).
...
Axiom real_modulus_pos :
  forall (x:complex), (real_ x) -> (infix_gteqdt x c_zero) ->
  ((modulus x) = x).

Parameter conjugate: complex -> complex.
...
Axiom ind_geometric_series_r :
  forall (a:complex) (q:complex) (n:Z), (n >= 1%Z)%Z -> ~ (c_one = q) ->
  ((ind_sum (fun (i:Z) => (infix_asdt a (cpower q i))) 0%Z n) =
   (infix_sldt (infix_asdt a (infix_mndt c_one (cpower q n)))
    (infix_mndt c_one q))).

Axiom ind_geometric_series :
  forall (q:complex) (n:Z), (n >= 1%Z)%Z -> ~ (c_one = q) ->
...
Parameter two_pi_i: complex.

Axiom two_pi_i_def : (two_pi_i = (infix_asdt (infix_asdt im pi) ttwo)).

Axiom exp_pi : ((exp (infix_asdt im pi)) = (prefix_mndt c_one)).

Axiom exp_two_pi : ((exp two_pi_i) = c_one).

Axiom exp_two_pi_mul :
  forall (k:Z), ((exp (infix_asdt (i_to_c k) two_pi_i)) = c_one).

Axiom exp_two_pi_mul_den :
  forall (k:Z) (l:Z), ~ (k = 0%Z) ->
  ((exp (infix_sldt (infix_asdt (i_to_c (k * l)%Z) two_pi_i) (i_to_c k))) =
   c_one).

Axiom exp_two_pi_mul_den_add :
  forall (k:Z) (l:Z) (m:Z),
  ((exp (infix_asdt (i_to_c ((k * m)%Z + l)%Z) two_pi_i)) =
   (exp (infix_asdt (i_to_c l) two_pi_i))).
...
Axiom Equal_angle :
  ...
  ((exp (infix_asdt two_pi_i (ang_meas o))) =
   (exp (infix_asdt two_pi_i (ang_meas o')))) ->
  (o = o').
...
Parameter ang_exp: angle -> complex.

Axiom ang_exp_def :
  forall (o:angle), ((ang_exp o) = (exp (infix_asdt two_pi_i (ang_meas o)))).
...
Axiom meas_value_plus_one :
  forall (phi:complex), (real_ phi) ->
  ((exp (infix_asdt two_pi_i (ang_meas (real_to_ang phi)))) =
   (exp
    (infix_asdt two_pi_i (infix_pldt (ang_meas (real_to_ang phi)) c_one)))).
...
Axiom Truncate_down_pos :
  forall (x:R), (x >= 0%R)%R -> ((BuiltIn.IZR (truncate x)) <= x)%R.

Axiom Truncate_down_pos1 :
  forall (x:R), (x >= 0%R)%R -> (x < (BuiltIn.IZR ((truncate x) + 1%Z)%Z))%R.
...
Axiom not_null_powers_squarert_two :
  forall (i:Z), (0%Z <= i)%Z -> ~ ((cpower squarert_two i) = c_zero).

Parameter pos_coeff: complex.

Axiom pos_coeff_def : (pos_coeff = (infix_sldt c_one squarert_two)).

Axiom real_pos_coeff : real_ pos_coeff.

Parameter neg_coeff: complex.

Axiom neg_coeff_def :
  (neg_coeff = (infix_sldt (prefix_mndt c_one) squarert_two)).
...
Axiom pow_inv_sqrt_2_2_add :
  ((infix_pldt (pow_inv_sqrt_2 1%Z) (pow_inv_sqrt_2 1%Z)) = squarert_two).

Axiom pow_inv_2_cpower :
  forall (i:Z), (0%Z <= i)%Z ->
  ((pow_inv_2 i) = (infix_sldt c_one (cpower ttwo i))).
...
Axiom valid_index_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:matrix a) (r:Z) (c:Z), (valid_index a1 r c) -> (0%Z <= r)%Z.

Axiom valid_index_def1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:matrix a) (r:Z) (c:Z), (valid_index a1 r c) -> (r < (rows a1))%Z.

Axiom valid_index_def2 :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:matrix a) (r:Z) (c:Z), (valid_index a1 r c) -> (0%Z <= c)%Z.

Axiom valid_index_def3 :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:matrix a) (r:Z) (c:Z), (valid_index a1 r c) ->
  (c < (columns a1))%Z.

Axiom valid_index_def4 :
  forall {a:Type} {a_WT:WhyType a},
...
Axiom equal_size_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:matrix a) (b:matrix a), (equal_size a1 b) ->
  ((rows a1) = (rows b)).

Axiom equal_size_def1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:matrix a) (b:matrix a), (equal_size a1 b) ->
  ((columns a1) = (columns b)).

Axiom equal_size_def2 :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:matrix a) (b:matrix a),
  (((rows a1) = (rows b)) /\ ((columns a1) = (columns b))) -> equal_size a1 b.
...
Axiom equal_def1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (m:matrix a) (n:matrix a), (infix_eqeq m n) -> equal m n.
...
Parameter null_mat: (matrix complex) -> Prop.
...
Parameter kronecker_neutral: matrix complex.

Axiom kronecker_neutral_def : (kronecker_neutral = (make 1%Z 1%Z c_one)).
...
Parameter kronecker: (matrix complex) -> (matrix complex) -> matrix complex.
...
Axiom neutral_ :
  forall (m:matrix complex), ((kronecker m kronecker_neutral) = m).

Axiom neutral_1 :
  forall (m:matrix complex), ((kronecker kronecker_neutral m) = m).
...
Parameter frows: (Z -> matrix complex) -> Z -> Z.

Axiom frows_def :
  forall (f:Z -> matrix complex) (k:Z), ((frows f k) = (rows (f k))).

Axiom frows_spec :
  forall (f:Z -> matrix complex) (k:Z), ((frows f k) > 0%Z)%Z.

Parameter fcolumns: (Z -> matrix complex) -> Z -> Z.

Axiom fcolumns_def :
  forall (f:Z -> matrix complex) (k:Z), ((fcolumns f k) = (columns (f k))).

Axiom fcolumns_spec :
  forall (f:Z -> matrix complex) (k:Z), ((fcolumns f k) > 0%Z)%Z.

Axiom const_fcol :
  forall (m:matrix complex) (k:Z),
  ((fcolumns ((fun (y0:matrix complex) (y1:Z) => (const y0 y1)) m) k) =
   (columns m)).

Axiom const_frows :
  forall (m:matrix complex) (k:Z),
  ((frows ((fun (y0:matrix complex) (y1:Z) => (const y0 y1)) m) k) =
   (rows m)).
...
Axiom mat_mult_id :
  forall (n:Z) (m:matrix complex), (n >= 0%Z)%Z ->
...
Parameter infix_asdtdt: complex -> (matrix complex) -> matrix complex.
...
Axiom pow_inv_2_plus_one :
  forall (i:Z), (0%Z <= i)%Z ->
  ((pow_inv_2 (i + 1%Z)%Z) =
   (infix_asdt (infix_sldt c_one ttwo) (pow_inv_2 i))).
...
Axiom pow_inv_2_one :
  forall (i:Z), (i = 1%Z) -> ((i_to_c (power_ 2%Z i)) = ttwo).
...
Axiom inv_pow_inv_sqrt_2 :
  ((infix_asdt (pow_inv_sqrt_2 1%Z) squarert_two) = c_one).

Axiom pow_inv_sqrt_2_values :
  forall (i:Z), (0%Z <= i)%Z ->
  ((pow_inv_sqrt_2 i) = (infix_sldt c_one (cpower squarert_two i))).

Axiom neg_pow_inv_sqrt_2_values :
  forall (i:Z), (0%Z <= i)%Z ->
  ((neg_pow_inv_sqrt_2 i) =
   (infix_asdt (mop i) (infix_sldt c_one (cpower squarert_two i)))).
...
Axiom int_to_ang_to_real_to_ang_gen :
  forall (k:Z) (n:Z) (kx:complex), (n >= 0%Z)%Z -> (kx = (i_to_c k)) ->
...
Axiom ang_minus_one_from_real :
  (ang_minus_one = (real_to_ang (infix_sldt c_one ttwo))).

Axiom ang_exp_minus_one : ((ang_exp ang_minus_one) = (prefix_mndt c_one)).
...
Parameter div_two: angle -> angle.

Axiom div_two_def :
  forall (d:angle),
  ((div_two d) = (real_to_ang (infix_sldt (ang_meas d) ttwo))).

Axiom div_two_spec :
  forall (d:angle), ((ang_meas (div_two d)) = (infix_sldt (ang_meas d) ttwo)).
...
Parameter constant_size:
  forall {a:Type} {a_WT:WhyType a}, (set a) -> (a -> matrix complex) -> Prop.

Axiom constant_size_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix complex), (constant_size s f) ->
  forall (e1:a), (mem e1 s) -> ((rows (f e1)) = (rows (f (choose s)))).

Axiom constant_size_def1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix complex), (constant_size s f) ->
  forall (e1:a), (mem e1 s) -> ((columns (f e1)) = (columns (f (choose s)))).

Axiom constant_size_def2 :
  forall {a:Type} {a_WT:WhyType a},
...
Axiom set_s_rows_rem :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix complex), ((cardinal s) > 1%Z)%Z ->
...
Axiom set_s_rows_add :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix complex) (x:a), ((cardinal s) > 0%Z)%Z ->
...
Axiom mat_sum_dim_to_mat_sum :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix complex) (r:Z) (c:Z),
  ((cardinal s) > 0%Z)%Z -> (0%Z < r)%Z -> (0%Z < c)%Z ->
  (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
...
Axiom mat_sum_const :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (x:matrix complex), ((cardinal s) > 0%Z)%Z ->
...
Axiom map_mat_sum :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:b -> matrix complex) (s:set a) (t:a -> b),
  ((cardinal s) > 0%Z)%Z -> (constant_size s (fun (a1:a) => (f (t a1)))) ->
  (p_injective t s) ->
...
Axiom mat_sum_id :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> matrix complex) (s:set a), ((cardinal s) > 0%Z)%Z ->
  (constant_size s f) ->
  (constant_size (map f s) (fun (y0:matrix complex) => (p_id y0))) ->
  (p_injective f s) ->
  ((mat_sum (map f s) (fun (y0:matrix complex) => (p_id y0))) =
   (mat_sum s f)).
...
Axiom result_def10 :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> matrix complex) (s:set a) (e1:a),
  (((result10 f s) e1) = true) <->
  ~ (equal (f e1) (make (s_rows s f) (s_columns s f) c_zero)).
...
Axiom nonn_mat_sum_plus_one :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> matrix complex) (s:set a) (r:Z) (c:Z),
  ((cardinal s) > 1%Z)%Z -> (r > 0%Z)%Z -> (c > 0%Z)%Z ->
  (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
...
Axiom nonn_mat_sum :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> matrix complex) (s:set a) (r:Z) (c:Z), (r > 0%Z)%Z ->
...
Axiom mat_sum_null :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> matrix complex) (s:set a), ((cardinal s) > 1%Z)%Z ->
  (constant_size s f) ->
  (forall (e1:a), (mem e1 s) -> forall (i:Z) (j:Z),
   (valid_index (f e1) i j) -> ((get (f e1) i j) = c_zero)) ->
...
Axiom inv_func_def :
  ...
  (mem e' s') ->
  ((inv_func f s s' e') =
   (element (my_filter s (fun (e1:a) => (indic_bool (f e1) e'))))).
...
Axiom inv_f_back :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b) (e1:b), (mem e1 s') ->
  (p_bijective f s s') -> ((f ((inv_f f s s') e1)) = e1).

Axiom inv_f_back_rev :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b) (e1:a), (mem e1 s) ->
  (p_bijective f s s') -> (((inv_f f s s') (f e1)) = e1).

Axiom injective_is_bijective :
  forall {a:Type} {a_WT:WhyType a} {b:Type} {b_WT:WhyType b},
  forall (f:a -> b) (s:set a) (s':set b), (p_injective f s) ->
  (forall (e1:a), (mem e1 s) -> mem (f e1) s') ->
  ((cardinal s) = (cardinal s')) -> p_bijective f s s'.

Axiom injective_is_bijective_auto :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> a) (s:set a), (p_injective f s) ->
  (forall (e1:a), (mem e1 s) -> mem (f e1) s) -> p_bijective f s s.

Axiom injective_is_bijective_auto1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> a) (s:set a), (p_injective f s) ->
  (forall (e1:a), (mem e1 s) -> mem (f e1) s) -> ((map f s) = s).
...
Axiom inv_auto_spec :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> a) (s:set a), (p_injective f s) ->
  (forall (e1:a), (mem e1 s) -> mem (f e1) s) -> forall (e1:a), (mem e1 s) ->
  mem ((inv_auto f s) e1) s.

Axiom inv_auto_spec1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> a) (s:set a), (p_injective f s) ->
  (forall (e1:a), (mem e1 s) -> mem (f e1) s) -> forall (e1:a), (mem e1 s) ->
  ((f ((inv_auto f s) e1)) = e1).
...
Axiom ind_isum_mod_ :
  forall (bv:bitvec) (i:Z), ((0%Z <= i)%Z /\ (i < (length bv))%Z) ->
  ((int.EuclideanDivision.mod1
    (ind_isum (fun (l:Z) => (((getbv bv) l) * (power_ 2%Z (i - l)%Z))%Z) 0%Z
     (i + 1%Z)%Z)
    2%Z)
   = ((getbv bv) i)).
...
Axiom mod_isum_ :
  ...
  ((int.EuclideanDivision.mod1 i (power_ 2%Z k)) =
   (ind_isum
    (fun (l:Z) =>
     (((getbv (int_to_bv i n)) l) * (power_ 2%Z ((n - 1%Z)%Z - l)%Z))%Z)
    (n - k)%Z n)).
...
Axiom int_to_bv_value_zero_ :
  forall (i:Z) (n:Z), (0%Z < n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((i < (power_ 2%Z (n - 1%Z)%Z))%Z -> (((getbv (int_to_bv i n)) 0%Z) = 0%Z)) /\
...
Axiom mapz_pre_spec1 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e1:bitvec), (mem e1 (mapz_pre n s)) -> (((getbv e1) 0%Z) = 0%Z).

Axiom mapz_pre_spec2 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e1:bitvec), (mem e1 (mapz_pre n s)) ->
  exists bv:bitvec, (mem bv s) /\ (e1 = (concat_l bv 0%Z)).

Axiom mapz_pre_spec3 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e1:bitvec), (mem e1 (mapz_pre n s)) -> ((length e1) = n).

Axiom mapz_pre_spec4 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e1:bitvec), ((length e1) = n) -> (((getbv e1) 0%Z) = 0%Z) ->
  mem e1 (mapz_pre n s).
...
Axiom mapo_pre_spec1 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e1:bitvec), (mem e1 (mapo_pre n s)) -> (((getbv e1) 0%Z) = 1%Z).

Axiom mapo_pre_spec2 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e1:bitvec), (mem e1 (mapo_pre n s)) ->
  exists bv:bitvec, (mem bv s) /\ (e1 = (concat_l bv 1%Z)).

Axiom mapo_pre_spec3 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e1:bitvec), (mem e1 (mapo_pre n s)) -> ((length e1) = n).

Axiom mapo_pre_spec4 :
  forall (n:Z) (s:set bitvec), (1%Z <= n)%Z ->
  (forall (f:bitvec), (mem f s) <-> ((length f) = (n - 1%Z)%Z)) ->
  forall (e1:bitvec), ((length e1) = n) -> (((getbv e1) 0%Z) = 1%Z) ->
  mem e1 (mapo_pre n s).
...
Axiom mapz_spec2 :
  forall (n:Z), (1%Z <= n)%Z -> forall (e1:bitvec), (mem e1 (mapz n)) ->
  (((getbv e1) 0%Z) = 0%Z).

Axiom mapz_spec3 :
  forall (n:Z), (1%Z <= n)%Z -> forall (e1:bitvec), (mem e1 (mapz n)) ->
  exists bv:bitvec, (mem bv (n_bvs (n - 1%Z)%Z)) /\ (e1 = (concat_l bv 0%Z)).
...
Axiom mapz_spec5 :
  forall (n:Z), (1%Z <= n)%Z -> forall (e1:bitvec), ((length e1) = n) ->
  (((getbv e1) 0%Z) = 0%Z) -> mem e1 (mapz n).
...
Axiom mapo_spec2 :
  forall (n:Z), (1%Z <= n)%Z -> forall (e1:bitvec), (mem e1 (mapo n)) ->
  (((getbv e1) 0%Z) = 1%Z).

Axiom mapo_spec3 :
  forall (n:Z), (1%Z <= n)%Z -> forall (e1:bitvec), (mem e1 (mapo n)) ->
  exists bv:bitvec, (mem bv (n_bvs (n - 1%Z)%Z)) /\ (e1 = (concat_l bv 1%Z)).
...
Axiom mapo_spec5 :
  forall (n:Z), (1%Z <= n)%Z -> forall (e1:bitvec), ((length e1) = n) ->
  (((getbv e1) 0%Z) = 1%Z) -> mem e1 (mapo n).
...
Parameter n_bvsz: unit -> set bitvec.

Axiom n_bvsz_def : forall (us:unit), ((n_bvsz us) = (n_bvs 0%Z)).

Axiom n_bvsz_spec :
  forall (us:unit), forall (x:bitvec), ((length x) = 0%Z) ->
  mem x (n_bvsz us).

Axiom n_bvsz_spec1 :
  forall (us:unit), forall (x:bitvec), (mem x (n_bvsz us)) ->
  (x = (make_bv (fun (us1:Z) => 0%Z) 0%Z)).

Axiom n_bvsz_spec2 :
  forall (us:unit),
  ((n_bvsz us) = (to_set (make_bv (fun (us1:Z) => 0%Z) 0%Z))).

Axiom n_bvsz_spec3 :
  forall (us:unit),
  ((choose (n_bvsz us)) = (make_bv (fun (us1:Z) => 0%Z) 0%Z)).

Axiom n_bvsz_spec4 :
  forall (us:unit), forall (f:bitvec -> matrix complex),
  ((mat_sum (n_bvsz us) f) = (f (make_bv (fun (us1:Z) => 0%Z) 0%Z))).

Parameter n_bvso: unit -> set bitvec.

Axiom n_bvso_def : forall (us:unit), ((n_bvso us) = (n_bvs 1%Z)).
...
Axiom n_bvso_spec1 :
  forall (us:unit), forall (x:bitvec), (mem x (n_bvso us)) ->
  ((length x) = 1%Z).

Axiom n_bvso_spec2 :
  forall (us:unit),
  ((n_bvso us) =
   (add (make_bv (fun (us1:Z) => 0%Z) 1%Z)
    (to_set (make_bv (fun (us1:Z) => 1%Z) 1%Z)))).

Axiom n_bvso_spec3 :
  forall (us:unit), forall (f:bitvec -> matrix complex),
  (constant_size (n_bvso us) f) ->
  ((mat_sum (n_bvso us) f) =
   (add_mat (f (make_bv (fun (us1:Z) => 0%Z) 1%Z))
    (f (make_bv (fun (us1:Z) => 1%Z) 1%Z)))).
...
Axiom bv_to_int_length_2 :
  ...
  (((getbv x) 0%Z) = (int.EuclideanDivision.div (bv_to_int x) 2%Z)).

Axiom bv_to_int_length_21 :
  forall (x:bitvec), ((length x) = 2%Z) ->
  (((getbv x) 1%Z) = (int.EuclideanDivision.mod1 (bv_to_int x) 2%Z)).
...
Parameter is_a_ket_l: (matrix complex) -> Z -> Prop.

Axiom is_a_ket_l_def :
  forall (m:matrix complex) (l:Z), (is_a_ket_l m l) -> (l >= 0%Z)%Z.

Axiom is_a_ket_l_def1 :
  forall (m:matrix complex) (l:Z), (is_a_ket_l m l) -> ((columns m) = 1%Z).

Axiom is_a_ket_l_def2 :
  forall (m:matrix complex) (l:Z), (is_a_ket_l m l) ->
  ((rows m) = (power 2%Z l)).

Axiom is_a_ket_l_def3 :
...
Parameter ket_valid_index: (matrix complex) -> Z -> Prop.

Axiom ket_valid_index_def :
  forall (m:matrix complex) (i:Z), (ket_valid_index m i) ->
  valid_index m i 0%Z.

Axiom ket_valid_index_def1 :
  forall (m:matrix complex) (i:Z), (valid_index m i 0%Z) ->
  ket_valid_index m i.
...
Parameter get_ket: (matrix complex) -> Z -> complex.

Axiom get_ket_def :
  forall (m:matrix complex) (i:Z), ((get_ket m i) = (get m i 0%Z)).

Axiom get_ket_rev :
  forall (m:matrix complex) (i:Z), ((get m i 0%Z) = (get_ket m i)).
...
Axiom get_ket_add :
  ...
  ((get_ket (add_mat x y) i) = (infix_pldt (get_ket x i) (get_ket y i))).

Axiom get_ket_substr :
  forall (x:matrix complex) (y:matrix complex) (i:Z), (is_a_ket x) ->
  (is_a_ket y) -> ((ket_length x) = (ket_length y)) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z (ket_length y)))%Z) ->
  ((get_ket (mat_substr x y) i) = (infix_mndt (get_ket x i) (get_ket y i))).
...
Axiom make_ket_def :
  forall (n:Z) (f:Z -> complex), (n >= 0%Z)%Z ->
  ((make_ket n f) = (make_f (power 2%Z n) 1%Z (fun (x:Z) (us:Z) => (f x)))).

Axiom make_ket_spec :
  forall (n:Z) (f:Z -> complex), (n >= 0%Z)%Z -> is_a_ket_l (make_ket n f) n.

Axiom make_ket_spec1 :
  forall (n:Z) (f:Z -> complex), (n >= 0%Z)%Z -> forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  ((get_ket (make_ket n f) i) = (f i)).

Axiom make_ket_spec2 :
  forall (n:Z) (f:Z -> complex), (n >= 0%Z)%Z -> forall (i:Z) (j:Z),
...
Axiom make_ket_constant_spec1 :
  forall (n:Z) (c:complex), (n >= 0%Z)%Z -> forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  ((get_ket (make_ket_constant n c) i) = c).

Axiom make_ket_constant_spec2 :
  forall (n:Z) (c:complex), (n >= 0%Z)%Z -> forall (i:Z) (j:Z),
...
Axiom add_ket_l_def :
  ...
  ((add_ket_l m n l) =
   (make_ket l (fun (i:Z) => (infix_pldt (get_ket m i) (get_ket n i))))).
...
Axiom scalar_ket_valid_index :
  forall (m:matrix complex) (a:complex) (i:Z), (ket_valid_index m i) ->
  (is_a_ket m) -> ket_valid_index (infix_asdtdt a m) i.
...
Axiom set_is_a_ket_l :
  forall (m:matrix complex) (l:Z), (l >= 0%Z)%Z -> ((columns m) = 1%Z) ->
...
Parameter scal_ket_zero: matrix complex.

Axiom scal_ket_zero_def : (scal_ket_zero = (ket 0%Z 0%Z)).

Parameter scal_ket_one: matrix complex.
...
Axiom g_ket_value :
  ...
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  ((0%Z <= j)%Z /\ (j < (power 2%Z n))%Z) ->
  ((i = j) -> ((get_ket (ket n i) j) = c_one)) /\
  (~ (i = j) -> ((get_ket (ket n i) j) = c_zero)).
...
Axiom basis_mat_spec3 :
  forall (r:Z) (c:Z), (0%Z < r)%Z -> (0%Z < c)%Z ->
  constant_size (basis_mat r c) (fun (y0:matrix complex) => (p_id y0)).

Axiom basis_mat_spec4 :
  forall (r:Z) (c:Z), (0%Z < r)%Z -> (0%Z < c)%Z ->
  ((s_columns (basis_mat r c) (fun (y0:matrix complex) => (p_id y0))) = c).

Axiom basis_mat_spec5 :
  forall (r:Z) (c:Z), (0%Z < r)%Z -> (0%Z < c)%Z ->
  ((s_rows (basis_mat r c) (fun (y0:matrix complex) => (p_id y0))) = r).

Parameter fc8: (matrix complex) -> (Z* Z)%type -> bool.

Axiom fc_def8 :
  forall (m:matrix complex) (x:(Z* Z)%type),
  (((fc8 m) x) = true) <-> (eq_t (get m (fir x) (sec x)) c_one).
...
Parameter basis_projections: (matrix complex) -> set (matrix complex).
...
Axiom basis_projections_def :
  forall (m:matrix complex),
  ((basis_projections m) = (map (result15 m) (to_indexes m))).
...
Axiom basis_projections_spec1 :
  forall (m:matrix complex), forall (e1:matrix complex),
...
Axiom basis_projections_spec3 :
  forall (m:matrix complex),
  constant_size (basis_projections m) (fun (y0:matrix complex) => (p_id y0)).
...
Parameter indexes_decomp: (matrix complex) -> matrix complex.
...
Axiom indexes_decomp_def :
  forall (m:matrix complex),
  ((indexes_decomp m) = (mat_sum (to_indexes m) (result16 m))).
...
Parameter basis_decomp: (matrix complex) -> matrix complex.

Axiom basis_decomp_def :
  forall (m:matrix complex),
  ((basis_decomp m) =
   (mat_sum (basis_projections m) (fun (y0:matrix complex) => (p_id y0)))).
...
Axiom ket_basis_projections_antec_spec :
  forall (m:matrix complex), (is_a_ket m) -> forall (e1:matrix complex),
...
Axiom ket_sum_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix complex), ((cardinal s) > 0%Z)%Z ->
  (forall (e1:a), (mem e1 s) -> is_a_ket (f e1)) ->
...
Axiom ket_sum_l_def1 :
  ...
  ((ket_sum_l s f l) =
   (make_ket l
    ((fun (y0:matrix complex) (y1:Z) => (get_ket y0 y1)) (f (choose s))))).
...
Axiom ket_sum_l_rows :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix complex) (l:Z), (0%Z <= l)%Z ->
  ((cardinal s) > 0%Z)%Z -> ((rows (ket_sum_l s f l)) = (power 2%Z l)).
...
Axiom ket_sum_null :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix complex) (l:Z), ((cardinal s) > 1%Z)%Z ->
  (l >= 0%Z)%Z ->
  (forall (e1:a), (mem e1 s) -> forall (i:Z),
   ((0%Z <= i)%Z /\ (i < (power_ 2%Z l))%Z) -> ((get_ket (f e1) i) = c_zero)) ->
  forall (j:Z), ((0%Z <= j)%Z /\ (j < (power 2%Z l))%Z) ->
  ((get_ket (ket_sum_l s f l) j) = c_zero).

Axiom ket_sum_l_null_but_maybe_one_elt :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> matrix complex) (s:set a) (e1:a) (l:Z), (0%Z <= l)%Z ->
  ((cardinal s) > 1%Z)%Z -> (mem e1 s) ->
  (forall (e':a), (mem e' s) -> ~ (e' = e1) -> forall (i:Z),
   ((0%Z <= i)%Z /\ (i < (power_ 2%Z l))%Z) -> ((get_ket (f e') i) = c_zero)) ->
  ((ket_sum_l s f l) =
   (make_ket l ((fun (y0:matrix complex) (y1:Z) => (get_ket y0 y1)) (f e1)))).
...
Axiom ket_sum_scal_bvs_eq :
  ...
  (0%Z <= l1)%Z -> (l1 = l2) -> (n1 = n2) -> (s1 = s2) -> (n1 >= 0%Z)%Z ->
  (forall (e1:bitvec), (mem e1 (n_bvs n1)) -> ((f e1) = (g e1))) ->
...
Axiom ket_sum_sum_scal_bvs_eq :
  ...
  (0%Z <= l1)%Z -> ((l1 = l2) /\ ((l2 = l1') /\ (l1' = l2'))) ->
  (n1 = n1') -> (n1 >= 0%Z)%Z -> (n2 = n2') -> (s1 = s2) -> (n2 >= 0%Z)%Z ->
  (forall (e1:bitvec) (e':bitvec), (mem e1 (n_bvs n1)) ->
   (mem e' (n_bvs n2)) -> (((f e1) e') = ((g e1) e'))) ->
  ((infix_asdtdt s1
    (ket_sum_l (n_bvs n1) (fun (k:bitvec) => (ket_sum_l (n_bvs n2) (f k) l1))
...
Axiom ket_sum_sum_scal_mult_bvs_eq :
  ...
  (0%Z <= l1)%Z -> ((l1 = l2) /\ ((l2 = l1') /\ (l1' = l2'))) ->
  (n1 = n1') -> (n1 >= 0%Z)%Z -> (s3 = (infix_asdt s1 s2)) -> (n2 = n2') ->
  (n2 >= 0%Z)%Z ->
  (forall (e1:bitvec) (e':bitvec), (mem e1 (n_bvs n1)) ->
   (mem e' (n_bvs n2)) -> (((f e1) e') = ((g e1) e'))) ->
  ((infix_asdtdt s1
...
Axiom ket_sum_l_plus_one :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (e1:a) (f:a -> matrix complex) (l:Z), (0%Z <= l)%Z ->
  ((cardinal s) > 0%Z)%Z -> ~ (mem e1 s) ->
...
Axiom sum_concat :
  forall (f:bitvec -> matrix complex) (i:Z) (r:Z) (c:Z), (i > 0%Z)%Z ->
...
Axiom geometric_series_bv :
  forall (a:complex) (q:complex) (n:Z), (n >= 1%Z)%Z -> ~ (q = c_one) ->
  ((sum (n_bvs n)
...
Axiom geometric_series_bv_init_one :
  forall (q:complex) (n:Z), (n >= 1%Z)%Z -> ~ (q = c_one) ->
...
Axiom ket_mult_diag :
  forall (m:matrix complex) (x:matrix complex), ((ket_length x) >= 1%Z)%Z ->
...
Axiom fun_inversion_pre :
  ...
  (0%Z <= n)%Z -> ((cardinal s) > 0%Z)%Z -> (p_bijective f s s') ->
...
Parameter bv_to_ket: bitvec -> matrix complex.
...
Axiom get_ket_bv_to_ket_length :
  ...
  ((k = (bv_to_int bv)) -> ((get_ket (bv_to_ket bv) k) = c_one)) /\
  (~ (k = (bv_to_int bv)) -> ((get_ket (bv_to_ket bv) k) = c_zero)).
...
Axiom is_a_ket_l_scal_bvs :
  forall (e1:bitvec) (n:Z) (a:complex), (0%Z <= n)%Z -> (mem e1 (n_bvs n)) ->
...
Axiom ket_decomp_ :
  ...
  (m =
   (ket_sum_l (n_bvs n)
    (fun (bvx:bitvec) =>
     (infix_asdtdt (get_ket m (bv_to_int bvx)) (bv_to_ket bvx)))
    n)).
...
Axiom uniform_ket_norm_l :
  ...
  (forall (e1:bitvec), (mem e1 (n_bvs n)) -> ((modulus (f e1)) = c_one)) ->
  (x =
...
Axiom ket_sum_l_diag_spec1 :
  ...
  ((get_ket (ket_sum_l_diag f l) i) = (f (int_to_bv i l))).

Axiom ket_sum_of_scalars :
  forall (f:bitvec -> complex) (n:Z), (n >= 0%Z)%Z ->
  is_a_ket_l
...
Axiom ket_sum_of_scalars1 :
  forall (f:bitvec -> complex) (n:Z), (n >= 0%Z)%Z -> forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((get
    (ket_sum_l (n_bvs n)
...
Axiom mat_mult_ket_basis_bv_value :
  ...
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z l))%Z) ->
  (((columns m) = (rows m)) /\ ((rows m) = (power_ 2%Z l))) ->
  ((get_ket (mat_mult m (bv_to_ket x)) i) = (get m i (bv_to_int x))).
...
Axiom build_pps_spec2 :
  ...
  (((((h_basis_ket (build_pps w r k a)) (getbv x)) (getbv y)) i) =
   (int.EuclideanDivision.mod1 (((k (getbv x)) (getbv y)) i) 2%Z)).
...
Axiom build_pps_spec3 :
  ...
  ((((h_angle (build_pps w r k a)) (getbv x)) (getbv y)) =
   ((a (getbv x)) (getbv y))).
...
Axiom build_pps_bv_spec2 :
  ...
  forall (x:bitvec) (y:bitvec), forall (i:Z), ((length x) = w) ->
  ((length y) = r) -> ((0%Z <= i)%Z /\ (i < w)%Z) ->
  (((((h_basis_ket (build_pps_bv w r k a)) (getbv x)) (getbv y)) i) =
   ((getbv ((k x) y)) i)).
...
Axiom build_pps_bv_spec3 :
  ...
  (forall (x:bitvec) (y:bitvec), ((length x) = w) -> ((length y) = r) ->
   ((length ((k x) y)) = w)) ->
  forall (x:bitvec) (y:bitvec), ((length x) = w) -> ((length y) = r) ->
  ((((h_angle (build_pps_bv w r k a)) (getbv x)) (getbv y)) = ((a x) y)).
...
Axiom h_basis_ket_bv_def :
  ...
  ((h_basis_ket_bv h x y) =
   (make_bv (((h_basis_ket h) (getbv x)) (getbv y)) (h_width h))).
...
Axiom h_basis_ket_bv_spec1 :
  ...
  (((getbv (h_basis_ket_bv h x y)) i) =
   ((((h_basis_ket h) (getbv x)) (getbv y)) i)).
...
Axiom h_angle_bv_def :
  forall (h:pps) (x:bitvec) (y:bitvec), ((length x) = (h_width h)) ->
  ((length y) = (h_range h)) ->
  ((h_angle_bv h x y) = (((h_angle h) (getbv x)) (getbv y))).
  ...
  ((pps_apply_basis h x) =
   (infix_asdtdt (pow_inv_sqrt_2 (h_range h))
    (ket_sum_l (n_bvs (h_range h))
     (fun (y:bitvec) =>
      (infix_asdtdt (ang_exp (((h_angle h) (getbv x)) (getbv y)))
       (bv_to_ket
        (make_bv (((h_basis_ket h) (getbv x)) (getbv y)) (h_width h)))))
     (h_width h)))).
...
Axiom pps_apply_basis_spec1 :
  ...
  ((get_ket (pps_apply_basis h x) i) =
   (infix_asdt (pow_inv_sqrt_2 (h_range h))
    (sum (n_bvs (h_range h))
     (fun (y:bitvec) =>
      (infix_asdt (ang_exp (((h_angle h) (getbv x)) (getbv y)))
       (indic
        (bv_to_int
         (make_bv (((h_basis_ket h) (getbv x)) (getbv y)) (h_width h)))
        i)))))).
...
Axiom result_def18 :
  ...
  (((length y) = (h_width h)) ->
   (((result18 h x) y) =
    (infix_asdtdt (get_ket x (bv_to_int y)) (pps_apply_basis h y)))) /\
...
Axiom pps_apply_decomp :
  ...
  ((pps_apply h x) =
   (ket_sum_l (n_bvs (h_width h))
    (fun (z:bitvec) =>
     (infix_asdtdt (get_ket x (bv_to_int z)) (pps_apply h (bv_to_ket z))))
    (h_width h))).
...
Axiom pps_apply_sum :
  ...
  (1%Z <= (cardinal s))%Z ->
  (forall (e1:a), (mem e1 s) -> is_a_ket_l (f e1) (h_width h)) ->
  (l = (h_width h)) ->
  ((pps_apply h (ket_sum_l s f l)) =
   (ket_sum_l s (fun (e1:a) => (pps_apply h (f e1))) l)).
...
Axiom pps_hadamard_def3 :
  ...
  ((((x 0%Z) = (y 0%Z)) /\ ((y 0%Z) = 1%Z)) ->
   ((((h_angle pps_hadamard) x) y) = ang_minus_one)) /\
  (~ (((x 0%Z) = (y 0%Z)) /\ ((y 0%Z) = 1%Z)) ->
...
Axiom h_basis_ket_bv_anc_ :
  ...
  (((getbv x) ((h_width h) - 1%Z)%Z) = 0%Z) -> ((length x) = (h_width h)) ->
...
Parameter is_diagonal: (matrix complex) -> Prop.
...
Axiom is_diagonal_def :
  forall (m:matrix complex), (is_diagonal m) ->
  exists f:Z -> complex, (m = (make_f (rows m) (rows m) (fc13 f))).

Parameter fc14: (Z -> complex) -> Z -> Z -> complex.

Axiom fc_def14 :
  forall (f:Z -> complex) (i:Z) (j:Z),
  ((i = j) -> ((((fc14 f) i) j) = (f i))) /\
  (~ (i = j) -> ((((fc14 f) i) j) = c_zero)).

Axiom is_diagonal_def1 :
  forall (m:matrix complex),
  (exists f:Z -> complex, (m = (make_f (rows m) (rows m) (fc14 f)))) ->
  is_diagonal m.
...
Axiom id_mat_spec :
  forall (n:Z), (n >= 1%Z)%Z -> forall (i:Z), ((0%Z <= i)%Z /\ (i < n)%Z) ->
  ((diagonal (id_mat n) i) = c_one).

Axiom id_mat_spec1 : forall (n:Z), (n >= 1%Z)%Z -> ((rows (id_mat n)) = n).

Axiom id_mat_spec2 :
  forall (n:Z), (n >= 1%Z)%Z -> ((columns (id_mat n)) = n).
...
Axiom id_mat_prod_l :
  forall (n:Z) (m:matrix complex), (n >= 1%Z)%Z -> ((columns m) = n) ->
...
Axiom filter_sum_mod_indic :
  forall (v:Z) (n:Z) (p:Z) (g:Z -> complex), (n > 0%Z)%Z -> (v > 0%Z)%Z ->
  ((0%Z <= p)%Z /\ (p < v)%Z) ->
...
Axiom lnr_spec1 :
  forall (m:matrix complex), (pow2dim m) -> ((lnr m) >= 0%Z)%Z.
...
Axiom lnc_spec1 :
  forall (m:matrix complex), (pow2dim m) -> ((lnc m) >= 0%Z)%Z.
...
Parameter pps_apply_equiv: pps -> pps -> Prop.

Axiom pps_apply_equiv_def :
  forall (h1:pps) (h2:pps), (pps_apply_equiv h1 h2) ->
  ((h_width h1) = (h_width h2)).

Axiom pps_apply_equiv_def1 :
  forall (h1:pps) (h2:pps), (pps_apply_equiv h1 h2) ->
  forall (x:matrix complex), (is_a_ket_l x (h_width h1)) ->
  ((pps_apply h1 x) = (pps_apply h2 x)).

Axiom pps_apply_equiv_def2 :
  forall (h1:pps) (h2:pps),
  (((h_width h1) = (h_width h2)) /\
   forall (x:matrix complex), (is_a_ket_l x (h_width h1)) ->
   ((pps_apply h1 x) = (pps_apply h2 x))) ->
...
Axiom pps_apply_basis_anc :
  ...
  ((length x) = (h_width h)) -> (((getbv x) ((h_width h) - 1%Z)%Z) = 0%Z) ->
...
Axiom pps_anc_pred :
  ...
  (forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
   ...
   (((((h_basis_ket h2) x) y) i) = ((((h_basis_ket h1) (fc15 h1 x)) y) i))) ->
  (forall (x:Z -> Z) (y:Z -> Z),
   (forall (j:Z), ((0%Z <= j)%Z /\ (j < (h_width h2))%Z) ->
    (0%Z <= (x j))%Z /\ ((x j) < 2%Z)%Z) ->
   (forall (j:Z), ((0%Z <= j)%Z /\ (j < (h_range h2))%Z) ->
    (0%Z <= (y j))%Z /\ ((y j) < 2%Z)%Z) ->
   ((((h_angle h2) x) y) = (((h_angle h1) (fc16 h1 x)) y))) ->
  forall (x:bitvec), ((length x) = (h_width h2)) ->
  ((pps_apply_basis h2 x) = (path_sem_target x)).

Parameter fc17: pps -> (Z -> Z) -> Z -> Z.

Parameter fc18: pps -> (Z -> Z) -> Z -> Z.
...
Axiom fc_def18 :
  forall (h1:pps) (x:Z -> Z) (k:Z),
  ((k = ((h_width h1) - 1%Z)%Z) -> (((fc18 h1 x) k) = 0%Z)) /\
  (~ (k = ((h_width h1) - 1%Z)%Z) -> (((fc18 h1 x) k) = (x k))).
...
Axiom pps_anc_pred_ :
  ...
  (forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
   ...
   (forall (j:Z), ((0%Z <= j)%Z /\ (j < (h_range h2))%Z) ->
    (0%Z <= (y j))%Z /\ ((y j) < 2%Z)%Z) ->
   ((0%Z <= i)%Z /\ (i < (h_width h2))%Z) ->
   (((((h_basis_ket h2) x) y) i) = ((((h_basis_ket h1) (fc17 h1 x)) y) i))) ->
  (forall (x:Z -> Z) (y:Z -> Z),
   (forall (j:Z), ((0%Z <= j)%Z /\ (j < (h_width h2))%Z) ->
    (0%Z <= (x j))%Z /\ ((x j) < 2%Z)%Z) ->
   (forall (j:Z), ((0%Z <= j)%Z /\ (j < (h_range h2))%Z) ->
    (0%Z <= (y j))%Z /\ ((y j) < 2%Z)%Z) ->
   ((((h_angle h2) x) y) = (((h_angle h1) (fc18 h1 x)) y))) ->
  forall (x:bitvec), ((length x) = (h_width h2)) ->
  ((pps_apply_basis h1 (concat x (make_bv (fun (us:Z) => 0%Z) 1%Z))) =
   (kronecker (pps_apply_basis h2 x) (ket 1%Z 0%Z))).

Parameter pps_to_mat: pps -> matrix complex.
...
Axiom pps_to_mat_def :
  forall (h:pps),
  ((pps_to_mat h) =
   (infix_asdtdt (pow_inv_sqrt_2 (h_range h))
    (mat_sum_dim (n_bvs (h_width h))
     (fun (x:bitvec) =>
      (mat_sum_dim (n_bvs (h_range h)) (result21 h x)
...
Parameter fc20: pps -> bitvec -> bitvec -> Z -> Z -> complex.

Axiom fc_def20 :
  forall (h:pps) (x:bitvec) (y:bitvec) (i:Z) (j:Z),
  (((i = (bv_to_int (h_basis_ket_bv h x y))) /\ (j = (bv_to_int x))) ->
   ((((fc20 h x y) i) j) = (ang_exp (h_angle_bv h x y)))) /\
  (~ ((i = (bv_to_int (h_basis_ket_bv h x y))) /\ (j = (bv_to_int x))) ->
   ((((fc20 h x y) i) j) = c_zero)).
...
Axiom min_filter_spec2 :
  ...
  (mem e1 s) -> ((p e1) = true) -> ((min_filter s p) <= e1)%Z.

Axiom min_filter_spec3 :
  forall (s:set Z) (p:Z -> bool),
  (exists e1:Z, (mem e1 s) /\ ((p e1) = true)) -> forall (e1:Z),
  (mem e1 s) -> (e1 < (min_filter s p))%Z -> ~ ((p e1) = true).
...
Axiom max_filter_spec3 :
  forall (s:set Z) (p:Z -> bool),
  (exists e1:Z, (mem e1 s) /\ ((p e1) = true)) -> forall (e1:Z),
  (mem e1 s) -> ((max_filter s p) < e1)%Z -> ~ ((p e1) = true).
...
Parameter sem: circuit -> (matrix complex) -> (matrix complex) -> Prop.
...
Axiom sem_def1 :
  forall (c:circuit) (x:matrix complex) (y:matrix complex), (sem c x y) ->
  infix_eqeq y (path_sem c x).

Axiom sem_def2 :
  forall (c:circuit) (x:matrix complex) (y:matrix complex),
  ((is_a_ket_l x (width c)) /\ (infix_eqeq y (path_sem c x))) -> sem c x y.
...
Axiom hadamard_def6 :
  forall (x:Z -> Z) (y:Z -> Z),
  ((((x 0%Z) = (y 0%Z)) /\ ((y 0%Z) = 1%Z)) ->
   ((ang_ind hadamard x y) = ang_minus_one)) /\
  (~ (((x 0%Z) = (y 0%Z)) /\ ((y 0%Z) = 1%Z)) ->
...
Axiom parallel_spec :
  ...
  ((circ_to_pps (parallel d e1)) =
   (pps_par (circ_to_pps d) (circ_to_pps e1))).
...
Axiom parallel_spec5 :
  forall (d:circuit) (e1:circuit), forall (x:Z -> Z) (y:Z -> Z),
  ((ang_ind (parallel d e1) x y) =
   (ang_add (ang_ind d x y)
    (ang_ind e1 (fun (k:Z) => (x (k + (width d))%Z))
...
Axiom parallel_spec6 :
  ...
  forall (i:Z),
  ((i < (width d))%Z ->
   ((basis_ket (parallel d e1) x y i) = (basis_ket d x y i))) /\
  (~ (i < (width d))%Z ->
   ((basis_ket (parallel d e1) x y i) =
    (basis_ket e1 (fun (k:Z) => (x (k + (width d))%Z))
...
Axiom sequence_spec :
  ...
  ((circ_to_pps (sequence d e1)) =
   (pps_seq (circ_to_pps d) (circ_to_pps e1))).
  ...
  ((path_sem_basis c x) =
   (infix_asdtdt (pow_inv_sqrt_2 (range c))
    (ket_sum_l (n_bvs (range c))
     (fun (y:bitvec) =>
      (infix_asdtdt (ang_exp (ang_ind c (getbv (ket_to_bv x)) (getbv y)))
       (bv_to_ket
        (make_bv
         ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
             (basis_ket y0 y1 y2 y3))
...
Axiom get_path_sem :
  ...
  ((path_sem c x) =
   (ket_sum_l (n_bvs (width c))
    (fun (y:bitvec) =>
     (infix_asdtdt (get_ket x (bv_to_int y))
...
Axiom parallel_basis_ket :
  forall (d:circuit) (e1:circuit) (x:Z -> Z) (y:Z -> Z) (i:Z),
  ((i < (width d))%Z ->
   ((basis_ket (parallel d e1) x y i) = (basis_ket d x y i))) /\
  (~ (i < (width d))%Z ->
   ((basis_ket (parallel d e1) x y i) =
...
Axiom parallel_angle :
  forall (d:circuit) (e1:circuit) (x:Z -> Z) (y:Z -> Z),
  ((ang_ind (parallel d e1) x y) =
   (ang_add (ang_ind d x y)
    (ang_ind e1 (fun (k:Z) => (x (k + (width d))%Z))
     (fun (k:Z) => (y (k + (range d))%Z))))).
...
Axiom ancilla_basis_ket :
  ...
  (exists path_sem_target:(matrix complex) -> matrix complex,
   ...
   ((path_sem c (kronecker x1 (ket 1%Z 0%Z))) =
    (kronecker (path_sem_target x1) (ket 1%Z 0%Z)))) ->
  ((basis_ket (ancilla c) x y i) = (basis_ket c (fc21 c x) y i)).

Parameter fc22: circuit -> (Z -> Z) -> Z -> Z.

Axiom fc_def22 :
  forall (c:circuit) (x:Z -> Z) (k:Z),
  ((k = ((width c) - 1%Z)%Z) -> (((fc22 c x) k) = 0%Z)) /\
  (~ (k = ((width c) - 1%Z)%Z) -> (((fc22 c x) k) = (x k))).
...
Axiom ancilla_angle :
  ...
  (exists path_sem_target:(matrix complex) -> matrix complex,
   ...
   ((path_sem c (kronecker x1 (ket 1%Z 0%Z))) =
    (kronecker (path_sem_target x1) (ket 1%Z 0%Z)))) ->
  ((ang_ind (ancilla c) x y) = (ang_ind c (fc22 c x) y)).
...
Axiom path_sem_decomp :
  ...
  ((path_sem c x) =
   (ket_sum_l (n_bvs (width c))
    (fun (z:bitvec) =>
     (infix_asdtdt (get_ket x (bv_to_int z)) (path_sem c (bv_to_ket z))))
    (width c))).
...
Axiom path_sem_comp :
  forall (d:circuit) (e1:circuit) (x:matrix complex) (y:matrix complex)
    (z:matrix complex),
  (is_a_ket_l x (width d)) -> ((path_sem d x) = y) ->
  ((path_sem e1 y) = z) -> ((width d) = (width e1)) ->
  ((path_sem (sequence d e1) x) = z).

Axiom sem_comp :
  forall (d:circuit) (e1:circuit) (x:matrix complex) (y:matrix complex)
    (z:matrix complex),
  (sem d x y) -> (sem e1 y z) -> ((width d) = (width e1)) ->
  sem (sequence d e1) x z.

Axiom path_sem_kron :
  forall (d:circuit) (e1:circuit) (x:matrix complex) (x':matrix complex)
    (y:matrix complex) (y':matrix complex),
  (is_a_ket_l x (width d)) -> (is_a_ket_l y (width e1)) ->
  ((path_sem d x) = x') -> ((path_sem e1 y) = y') ->
  ((path_sem (parallel d e1) (kronecker x y)) = (kronecker x' y')).

Axiom path_sem_kron_ :
  forall (d:circuit) (e1:circuit) (x:matrix complex) (y:matrix complex),
  (is_a_ket_l x (width d)) -> (is_a_ket_l y (width e1)) ->
  ((path_sem (parallel d e1) (kronecker x y)) =
   (kronecker (path_sem d x) (path_sem e1 y))).

Axiom path_sem_sequence_parallel :
  forall (a:circuit) (b:circuit) (d:circuit) (e1:circuit) (x:matrix complex),
  (is_a_ket_l x ((width a) + (width b))%Z) -> ((width a) = (width d)) ->
  ((width b) = (width e1)) ->
  ((path_sem (sequence (parallel a b) (parallel d e1)) x) =
   (path_sem (parallel (sequence a d) (sequence b e1)) x)).
...
Parameter qbit_zero: unit -> matrix complex.

Axiom qbit_zero_def : forall (us:unit), ((qbit_zero us) = (ket 1%Z 0%Z)).

Axiom qbit_zero_spec :
  forall (us:unit), ((get_ket (qbit_zero us) 0%Z) = c_one).

Axiom qbit_zero_spec1 :
  forall (us:unit), ((get_ket (qbit_zero us) 1%Z) = c_zero).

Axiom qbit_zero_spec2 : forall (us:unit), is_a_ket_l (qbit_zero us) 1%Z.

Axiom qbit_zero_spec3 : forall (us:unit), ((rows (qbit_zero us)) = 2%Z).

Axiom qbit_zero_spec4 : forall (us:unit), ((columns (qbit_zero us)) = 1%Z).

Axiom qbit_zero_spec5 :
  forall (us:unit), ((get (qbit_zero us) 0%Z 0%Z) = c_one).

Axiom qbit_zero_spec6 :
  forall (us:unit), ((get (qbit_zero us) 1%Z 0%Z) = c_zero).

Axiom qbit_zero_spec7 : forall (us:unit), is_a_ket_basis_elt (qbit_zero us).

Parameter qbit_one: unit -> matrix complex.

Axiom qbit_one_def : forall (us:unit), ((qbit_one us) = (ket 1%Z 1%Z)).

Axiom qbit_one_spec :
  forall (us:unit), ((get_ket (qbit_one us) 0%Z) = c_zero).

Axiom qbit_one_spec1 :
  forall (us:unit), ((get_ket (qbit_one us) 1%Z) = c_one).

Axiom qbit_one_spec2 : forall (us:unit), is_a_ket_l (qbit_one us) 1%Z.

Axiom qbit_one_spec3 : forall (us:unit), ((rows (qbit_one us)) = 2%Z).

Axiom qbit_one_spec4 : forall (us:unit), ((columns (qbit_one us)) = 1%Z).

Axiom qbit_one_spec5 :
  forall (us:unit), ((get (qbit_one us) 0%Z 0%Z) = c_zero).

Axiom qbit_one_spec6 :
  forall (us:unit), ((get (qbit_one us) 1%Z 0%Z) = c_one).

Axiom qbit_one_spec7 : forall (us:unit), is_a_ket_basis_elt (qbit_one us).

Parameter qbit_plus: unit -> matrix complex.

Axiom qbit_plus_def :
  forall (us:unit),
  ((qbit_plus us) = (pps_apply pps_hadamard (qbit_zero tt))).

Axiom qbit_plus_spec :
  forall (us:unit),
  ((qbit_plus us) =
   (infix_asdtdt (pow_inv_sqrt_2 1%Z)
    (add_ket_l (qbit_zero tt) (qbit_one tt) 1%Z))).

Axiom qbit_plus_spec1 : forall (us:unit), is_a_ket_l (qbit_plus us) 1%Z.

Axiom qbit_plus_spec2 : forall (us:unit), ((rows (qbit_plus us)) = 2%Z).

Axiom qbit_plus_spec3 : forall (us:unit), ((columns (qbit_plus us)) = 1%Z).

Axiom qbit_plus_spec4 :
  forall (us:unit), ((get_ket (qbit_plus us) 0%Z) = (pow_inv_sqrt_2 1%Z)).

Axiom qbit_plus_spec5 :
  forall (us:unit), ((get_ket (qbit_plus us) 1%Z) = (pow_inv_sqrt_2 1%Z)).

Parameter qbit_minus: unit -> matrix complex.

Axiom qbit_minus_def :
  forall (us:unit),
  ((qbit_minus us) = (pps_apply pps_hadamard (qbit_one tt))).

Axiom qbit_minus_spec :
  forall (us:unit),
  ((qbit_minus us) =
   (infix_asdtdt (pow_inv_sqrt_2 1%Z)
    (add_ket_l (qbit_zero tt)
     (infix_asdtdt (prefix_mndt c_one) (qbit_one tt)) 1%Z))).

Axiom qbit_minus_spec1 : forall (us:unit), is_a_ket_l (qbit_minus us) 1%Z.

Axiom qbit_minus_spec2 : forall (us:unit), ((rows (qbit_minus us)) = 2%Z).

Axiom qbit_minus_spec3 : forall (us:unit), ((columns (qbit_minus us)) = 1%Z).

Axiom qbit_minus_spec4 :
  forall (us:unit), ((get_ket (qbit_minus us) 0%Z) = (pow_inv_sqrt_2 1%Z)).

Axiom qbit_minus_spec5 :
  forall (us:unit),
  ((get_ket (qbit_minus us) 1%Z) = (prefix_mndt (pow_inv_sqrt_2 1%Z))).

Axiom add_plus_minus :
  ((add_ket_l (qbit_plus tt) (qbit_minus tt) 1%Z) =
   (infix_asdtdt squarert_two (qbit_zero tt))).

Axiom add_plus_minus1 :
  ((add_ket_l (infix_asdtdt (pow_inv_sqrt_2 1%Z) (qbit_plus tt))
    (infix_asdtdt (pow_inv_sqrt_2 1%Z) (qbit_minus tt)) 1%Z)
   = (qbit_zero tt)).

Axiom substr_plus_minus :
  ((add_ket_l (qbit_plus tt)
    (infix_asdtdt (prefix_mndt c_one) (qbit_minus tt)) 1%Z)
   = (infix_asdtdt squarert_two (qbit_one tt))).

Axiom substr_plus_minus1 :
  ((add_ket_l (infix_asdtdt (pow_inv_sqrt_2 1%Z) (qbit_plus tt))
    (infix_asdtdt (prefix_mndt (pow_inv_sqrt_2 1%Z)) (qbit_minus tt)) 1%Z)
   = (qbit_one tt)).

Axiom plus_to_zero :
  ((pps_apply pps_hadamard (qbit_plus tt)) = (qbit_zero tt)).

Axiom plus_to_one :
  ((pps_apply pps_hadamard (qbit_minus tt)) = (qbit_one tt)).
...
Axiom xor_qbit_minus :
  ...
  ((xor_qbits (ket 1%Z i) (qbit_minus tt)) =
   (infix_asdtdt (cpower (prefix_mndt c_one) i) (qbit_minus tt))).
...
Axiom ket_sum_xor_qbit_minus :
  ...
  ((ket_sum_l s (fun (e1:a) => (xor_qbits (ket 1%Z (f e1)) (qbit_minus tt)))
   ...
   (ket_sum_l s
    (fun (e1:a) =>
     (infix_asdtdt (cpower (prefix_mndt c_one) (f e1)) (qbit_minus tt)))
    1%Z)).
...
Axiom bv_check_zero_def :
  ...
  ((bv_check_zero x) = ang_minus_one).

Axiom bv_check_zero_def1 :
  forall (x:bitvec), ~ ((length x) = 0%Z) -> ((length x) = 1%Z) ->
  (((getbv x) 0%Z) = 1%Z) -> ((bv_check_zero x) = ang_minus_one).

Axiom bv_check_zero_def2 :
  forall (x:bitvec), ~ ((length x) = 0%Z) -> ((length x) = 1%Z) ->
  ~ (((getbv x) 0%Z) = 1%Z) -> ((bv_check_zero x) = ang_zero).
...
Axiom bv_check_zero_int :
  ...
  ((i = ((power_ 2%Z n) - 1%Z)%Z) ->
   ((bv_check_zero (int_to_bv i n)) = ang_minus_one)) /\
  (~ (i = ((power_ 2%Z n) - 1%Z)%Z) ->
...
Axiom bv_check_zero_two :
  forall (x:bitvec), ((length x) = 2%Z) ->
  (((((getbv x) 0%Z) = ((getbv x) 1%Z)) /\ (((getbv x) 1%Z) = 1%Z)) ->
   ((bv_check_zero x) = ang_minus_one)) /\
  (~ ((((getbv x) 0%Z) = ((getbv x) 1%Z)) /\ (((getbv x) 1%Z) = 1%Z)) ->
   ((bv_check_zero x) = ang_zero)).
...
Axiom repeat_pps_had_spec :
  forall (n:Z), (n >= 1%Z)%Z -> ((h_width (repeat_pps_had n)) = n).

Axiom repeat_pps_had_spec1 :
  forall (n:Z), (n >= 1%Z)%Z -> ((h_range (repeat_pps_had n)) = n).

Axiom repeat_pps_had_spec2 :
  forall (n:Z), (n >= 1%Z)%Z -> forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
  ((0%Z <= i)%Z /\ (i < n)%Z) ->
  (((((h_basis_ket (repeat_pps_had n)) x) y) i) = (y i)).

Parameter fc23: (Z -> Z) -> (Z -> Z) -> Z -> angle.

Axiom fc_def23 :
  forall (x:Z -> Z) (y:Z -> Z) (i:Z),
  ((((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc23 x y) i) = (int_to_ang 1%Z 1%Z))) /\
  (~ (((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc23 x y) i) = (int_to_ang 0%Z 1%Z))).

Axiom repeat_pps_had_spec3 :
  forall (n:Z), (n >= 1%Z)%Z -> forall (x:Z -> Z) (y:Z -> Z),
  ((((h_angle (repeat_pps_had n)) x) y) = (ang_sum (fc23 x y) 0%Z n)).
  ...
  ((kron_had_coeffs n i j) =
   (infix_asdt (pow_inv_sqrt_2 n)
    (cpower (prefix_mndt c_one)
     (ind_isum
      (fun (k:Z) =>
       (((getbv (int_to_bv i n)) k) * ((getbv (int_to_bv j n)) k))%Z)
      0%Z n)))).
...
Axiom superposition_state_spec2 :
  forall (n:Z), (n >= 1%Z)%Z -> is_a_ket_l (superposition_state n) n.

Axiom get_ket_superposition :
  forall (n:Z) (i:Z), (1%Z <= n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((get_ket (superposition_state n) i) =
...
Axiom repeat_had_twice_ket :
  forall (n:Z), (n >= 1%Z)%Z -> forall (x:matrix complex),
  (is_a_ket_l x n) ->
...
Axiom path_sem_repeat_at_zero_bv :
  forall (n:Z) (x:bitvec), (n >= 1%Z)%Z -> ((length x) = n) ->
  ((get_ket (pps_apply (repeat_pps_had n) (bv_to_ket x)) 0%Z) =
   (pow_inv_sqrt_2 n)).

Axiom path_sem_repeat_at_zero :
  forall (n:Z) (x:matrix complex), (n >= 1%Z)%Z -> (is_a_ket_l x n) ->
  ((get_ket (pps_apply (repeat_pps_had n) x) 0%Z) =
   (infix_asdt (pow_inv_sqrt_2 n)
    (ind_sum ((fun (y0:matrix complex) (y1:Z) => (get_ket y0 y1)) x) 0%Z
     (power_ 2%Z n)))).
...
Axiom path_sem_hadamard_zero :
  forall (x:matrix complex), (x = (qbit_zero tt)) ->
  ((path_sem hadamard x) = (qbit_plus tt)).

Axiom path_sem_hadamard_one :
  forall (x:matrix complex), (x = (qbit_one tt)) ->
  ((path_sem hadamard x) = (qbit_minus tt)).

Axiom path_sem_hadamard_plus :
  forall (x:matrix complex), (x = (qbit_plus tt)) ->
  ((path_sem hadamard x) = (qbit_zero tt)).

Axiom path_sem_hadamard_minus :
  forall (x:matrix complex), (x = (qbit_minus tt)) ->
  ((path_sem hadamard x) = (qbit_one tt)).
...
Axiom ancilla_g_spec5 :
  ...
  (forall (x:matrix complex), (is_a_ket_l x ((width c) - 1%Z)%Z) ->
   ((path_sem c (kronecker x (ket 1%Z 0%Z))) =
    (kronecker (path_sem_target x) (ket 1%Z 0%Z)))) ->
  forall (x:Z -> Z) (y:Z -> Z),
  ((ang_ind (ancilla_g c path_sem_target) x y) = (ang_ind c (fc25 c x) y)).
...
Parameter fc27: circuit -> (Z -> Z) -> Z -> Z.
...
Axiom fc_def27 :
  forall (c:circuit) (x:Z -> Z) (k:Z),
  ((k = ((width c) - 1%Z)%Z) -> (((fc27 c x) k) = 0%Z)) /\
  (~ (k = ((width c) - 1%Z)%Z) -> (((fc27 c x) k) = (x k))).
...
Axiom correct_ancilla :
  ...
  (forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
   ...
   (forall (j:Z), ((0%Z <= j)%Z /\ (j < (h_range h'))%Z) ->
    (0%Z <= (y j))%Z /\ ((y j) < 2%Z)%Z) ->
   (((((h_basis_ket h') x) y) i) = ((((h_basis_ket h) (fc26 c x)) y) i))) ->
  (forall (x:Z -> Z) (y:Z -> Z),
   ((((h_angle h') x) y) = (((h_angle h) (fc27 c x)) y))) ->
...
Axiom set_correct_main_path_sum :
  ...
  (forall (x:bitvec) (y:bitvec), ((length x) = (width c)) ->
   ((length y) = (range c)) ->
   ((((h_angle h) (getbv x)) (getbv y)) = (ang_ind c (getbv x) (getbv y)))) ->
  (forall (x:bitvec) (y:bitvec), forall (i:Z),
   ((0%Z <= i)%Z /\ (i < (width c))%Z) -> ((length x) = (width c)) ->
   ((length y) = (range c)) ->
   (((((h_basis_ket h) (getbv x)) (getbv y)) i) =
    (basis_ket c (getbv x) (getbv y) i))) ->
  correct_path_sum c h.
...
Axiom set_path_sem_by_main_pps :
  ...
  ((path_sem c (bv_to_ket x)) =
   (infix_asdtdt (pow_inv_sqrt_2 (range c))
    (ket_sum_l (n_bvs (range c))
     (fun (y:bitvec) =>
      (infix_asdtdt (ang_exp (ang_ind c (getbv x) (getbv y)))
       (bv_to_ket
        (make_bv
         ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
             (basis_ket y0 y1 y2 y3))
...
Axiom path_sum_equiv :
  forall (c:circuit) (h:pps) (h':pps), ((h_range h) >= 0%Z)%Z ->
...
Axiom correct_path_sum_bv_main :
  ...
  (forall (x:bitvec) (y:bitvec), ((length x) = (width c)) ->
   ((length y) = r) -> (((a x) y) = (ang_ind c (getbv x) (getbv y)))) ->
...
Axiom place_get_ket :
  ...
  ((get_ket (path_sem (place c k n) (bv_to_ket x)) (bv_to_int y)) =
   (get_ket
    (path_sem c
     (bv_to_ket (make_bv (fun (i:Z) => ((getbv x) (i + k)%Z)) (width c))))
    (bv_to_int (make_bv (fun (i:Z) => ((getbv y) (i + k)%Z)) (width c))))).

Axiom place_get_ket_hpart_null :
  forall (c:circuit) (k:Z) (n:Z) (x:bitvec) (y:bitvec), (0%Z <= k)%Z ->
  (((width c) + k)%Z <= n)%Z -> ((length x) = n) -> ((length y) = n) ->
  ~ ((hpart x k) = (hpart y k)) ->
  ((get_ket (path_sem (place c k n) (bv_to_ket x)) (bv_to_int y)) = c_zero).
...
Axiom place_hadamard_spec5 :
  ...
  forall (x:Z -> Z) (y:Z -> Z),
  ((((x k) = (y 0%Z)) /\ ((y 0%Z) = 1%Z)) ->
   ((ang_ind (place_hadamard k n) x y) = ang_minus_one)) /\
  (~ (((x k) = (y 0%Z)) /\ ((y 0%Z) = 1%Z)) ->
   ((ang_ind (place_hadamard k n) x y) = ang_zero)).

Axiom place_hadamard_spec6 :
  forall (k:Z) (n:Z), ((0%Z <= k)%Z /\ (k < n)%Z) ->
  forall (x:Z -> Z) (y:Z -> Z), forall (m:Z), (m >= 1%Z)%Z ->
  ((((x k) = (y 0%Z)) /\ ((y 0%Z) = 1%Z)) ->
...
Axiom place_hadamard_bv_spec5 :
  ...
  forall (x:Z -> Z) (y:Z -> Z),
  ((((x k) = (y 0%Z)) /\ ((y 0%Z) = 1%Z)) ->
   ((ang_ind (place_hadamard_bv k n) x y) = ang_minus_one)) /\
  (~ (((x k) = (y 0%Z)) /\ ((y 0%Z) = 1%Z)) ->
...
Axiom fc_def28 :
  ...
  ((i = k) -> (((fc28 k x y) i) = ((getbv y) 0%Z))) /\
  (~ (i = k) -> (((fc28 k x y) i) = ((getbv x) i))).

Axiom place_hadamard_bv_spec7 :
  forall (k:Z) (n:Z), ((0%Z <= k)%Z /\ (k < n)%Z) ->
  correct_path_sum_bv (place_hadamard_bv k n) 1%Z
  (fun (x:bitvec) (y:bitvec) => (make_bv (fc28 k x y) n))
  (fun (x:bitvec) (y:bitvec) =>
   (int_to_ang
    ((((getbv x) k) * ((getbv y) 0%Z))%Z * (power_ 2%Z (n - 1%Z)%Z))%Z n)).
...
Axiom with_permutation_get_ket :
  ...
  (p_bijective f (to_fset 0%Z (width c)) (to_fset 0%Z (width c))) ->
  ((get_ket (path_sem (with_permutation c f) (bv_to_ket x)) (bv_to_int y)) =
   (get_ket
    (path_sem c
     (bv_to_ket (make_bv (fun (i:Z) => ((getbv x) (f i))) (width c))))
    (bv_to_int (make_bv (fun (i:Z) => ((getbv y) (f i))) (width c))))).

Parameter fc29: Z -> Z -> Z -> Z.

Axiom fc_def29 :
  forall (k:Z) (n:Z) (i:Z),
  ((i < k)%Z -> (((fc29 k n) i) = ((i + n)%Z - k)%Z)) /\
  (~ (i < k)%Z -> (((fc29 k n) i) = (i - k)%Z)).
...
Axiom with_permutation_kronecker :
  ...
  ((path_sem (with_permutation c (fc29 k n)) (kronecker ant_d ant_c)) =
   (kronecker im_d im_c)).
...
Axiom cont_zero_spec4 :
  ...
  ((length bv) = ((width c) + 1%Z)%Z) -> (((getbv bv) 0%Z) = 0%Z) ->
  ((path_sem (cont_zero c) (bv_to_ket bv)) = (bv_to_ket bv)).

Axiom cont_zero_spec5 :
  forall (c:circuit), forall (bv:bitvec),
  ((length bv) = ((width c) + 1%Z)%Z) -> (((getbv bv) 0%Z) = 1%Z) ->
...
Axiom cont_last_qbit_spec4 :
  forall (c:circuit), forall (bv:bitvec),
  ((length bv) = ((width c) + 1%Z)%Z) -> (((getbv bv) (width c)) = 0%Z) ->
  ((path_sem (cont_last_qbit c) (bv_to_ket bv)) = (bv_to_ket bv)).

Axiom cont_last_qbit_spec5 :
  forall (c:circuit), forall (bv:bitvec),
  ((length bv) = ((width c) + 1%Z)%Z) -> (((getbv bv) (width c)) = 1%Z) ->
  ((path_sem (cont_last_qbit c) (bv_to_ket bv)) =
   (path_sem (place c 0%Z ((width c) + 1%Z)%Z) (bv_to_ket bv))).

Parameter cont_last_qbit_kron: circuit -> circuit.

Axiom cont_last_qbit_kron_spec :
  forall (c:circuit),
  ((size (cont_last_qbit_kron c)) <= ((size c) * cont_size)%Z)%Z.

Axiom cont_last_qbit_kron_spec1 :
  forall (c:circuit), ((ancillas (cont_last_qbit_kron c)) = (ancillas c)).

Axiom cont_last_qbit_kron_spec2 :
  forall (c:circuit), ((range (cont_last_qbit_kron c)) = (range c)).

Axiom cont_last_qbit_kron_spec3 :
  forall (c:circuit), ((width (cont_last_qbit_kron c)) = ((width c) + 1%Z)%Z).

Axiom cont_last_qbit_kron_spec4 :
  forall (c:circuit), forall (x:matrix complex) (y:matrix complex),
  (sem c x y) ->
  sem (cont_last_qbit_kron c) (kronecker x (ket 1%Z 0%Z))
  (kronecker x (ket 1%Z 0%Z)).

Axiom cont_last_qbit_kron_spec5 :
  forall (c:circuit), forall (x:matrix complex) (y:matrix complex),
  (sem c x y) ->
  sem (cont_last_qbit_kron c) (kronecker x (ket 1%Z 1%Z))
...
Axiom path_cont_ketz :
  ...
  (((getbv (ket_to_bv x)) co) = 0%Z) -> ((path_sem (cont c co k n) x) = x).
...
Axiom cont_kron_pat_right_gen :
  ...
  (is_a_ket_l y (width circ)) -> ((length x) = k) -> (((getbv x) c) = 0%Z) ->
...
Axiom cont_kron_pat_right_gen1 :
  forall (circ:circuit) (c:Z) (k:Z) (n:Z), ((0%Z <= c)%Z /\ (c < k)%Z) ->
  (n = (k + (width circ))%Z) -> forall (y:matrix complex), forall (x:bitvec),
  (is_a_ket_l y (width circ)) -> ((length x) = k) -> (((getbv x) c) = 1%Z) ->
  ((path_sem (cont circ c k n) (kronecker (bv_to_ket x) y)) =
   (kronecker (bv_to_ket x) (path_sem circ y))).

Parameter diagonal1: circuit -> (bitvec -> angle) -> Prop.

Axiom diagonal_def1 :
  forall (c:circuit) (g:bitvec -> angle), (diagonal1 c g) ->
  correct_path_sum_bv c 0%Z (fun (x:bitvec) (us:bitvec) => x)
  (fun (x:bitvec) (us:bitvec) => (g x)).

Axiom diagonal_def2 :
  forall (c:circuit) (g:bitvec -> angle),
  (correct_path_sum_bv c 0%Z (fun (x:bitvec) (us:bitvec) => x)
   (fun (x:bitvec) (us:bitvec) => (g x))) ->
  diagonal1 c g.
...
Axiom diag_rz_spec3 :
  forall (k:Z), (0%Z <= k)%Z ->
  diagonal1 (diag_rz k) (fun (x:bitvec) => (int_to_ang ((getbv x) 0%Z) k)).
...
Axiom diag_rz_neg_spec3 :
  ...
  (fun (x:bitvec) => (int_to_ang (-((getbv x) 0%Z))%Z (-k)%Z)).
...
Axiom diag_sequence_def :
  forall (d:circuit) (e1:circuit) (f:bitvec -> angle) (g:bitvec -> angle)
    (h:bitvec -> angle),
  (diagonal1 d f) -> (diagonal1 e1 g) -> ((width d) = (width e1)) ->
  (forall (x:bitvec), ((length x) = (width d)) ->
   ((h x) = (ang_add (f x) (g x)))) ->
  ((diag_sequence d e1 f g h) = (sequence d e1)).
...
Axiom diag_sequence_spec :
  ...
  (forall (x:bitvec), ((length x) = (width d)) ->
   ((h x) = (ang_add (f x) (g x)))) ->
  diagonal1 (diag_sequence d e1 f g h) h.
...
Axiom diag_sequence_spec1 :
  ...
  (forall (x:bitvec), ((length x) = (width d)) ->
   ((h x) = (ang_add (f x) (g x)))) ->
  ((width (diag_sequence d e1 f g h)) = (width d)).
...
Axiom diag_sequence_spec2 :
  ...
  (forall (x:bitvec), ((length x) = (width d)) ->
   ((h x) = (ang_add (f x) (g x)))) ->
  ((size (diag_sequence d e1 f g h)) = ((size d) + (size e1))%Z).
...
Axiom diag_sequence_spec3 :
  ...
  (forall (x:bitvec), ((length x) = (width d)) ->
   ((h x) = (ang_add (f x) (g x)))) ->
  ((ancillas (diag_sequence d e1 f g h)) =
   (ZArith.BinInt.Z.max (ancillas d) (ancillas e1))).
...
Axiom sequence_diag_gen_def :
  forall (d:circuit) (e1:circuit) (f:bitvec -> angle)
    (g:bitvec -> bitvec -> angle) (h:bitvec -> bitvec -> bitvec) (r:Z),
  (diagonal1 d f) -> (r = (range e1)) -> ((width d) = (width e1)) ->
  (forall (x:bitvec) (y:bitvec), ((length x) = (width d)) ->
   ((length y) = r) -> ((length ((h x) y)) = (width d))) ->
  (forall (x:bitvec) (y:bitvec), ((length x) = (width d)) ->
   ((length y) = r) ->
   (((g x) y) = (ang_add (f x) (ang_ind e1 (getbv x) (getbv y))))) ->
  (forall (x:bitvec) (y:bitvec), ((length x) = (width d)) ->
   ((length y) = r) ->
   (((h x) y) =
    (make_bv
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      (getbv y))
     (width d)))) ->
  ((sequence_diag_gen d e1 f g h r) =
   (seq_pps_bv d e1 0%Z r r (fun (x:bitvec) (us:bitvec) => x) h h
    (fun (x:bitvec) (us:bitvec) => (f x))
    (fun (x:bitvec) (y:bitvec) => (ang_ind e1 (getbv x) (getbv y))) g)).
   ...
   (((h x) y) =
    (make_bv
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      (getbv y))
     (width d)))) ->
  ((width (sequence_diag_gen d e1 f g h r)) = (width d)).
   ...
   (((h x) y) =
    (make_bv
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      (getbv y))
     (width d)))) ->
  ((size (sequence_diag_gen d e1 f g h r)) = ((size d) + (size e1))%Z).
   ...
   (((h x) y) =
    (make_bv
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      (getbv y))
     (width d)))) ->
  ((ancillas (sequence_diag_gen d e1 f g h r)) =
   (ZArith.BinInt.Z.max (ancillas d) (ancillas e1))).
   ...
   (((h x) y) =
    (make_bv
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      (getbv y))
     (width d)))) ->
  correct_path_sum_bv (sequence_diag_gen d e1 f g h r) r h g.
...
Axiom sequence_gen_diag_def :
  ...
  (forall (x:bitvec) (y:bitvec), ((length x) = (width d)) ->
   ((length y) = r) ->
   (((g x) y) = (ang_add (ang_ind e1 (getbv x) (getbv y)) (f ((h x) y))))) ->
  (forall (x:bitvec) (y:bitvec), ((length x) = (width d)) ->
   ((length y) = r) ->
   (((h x) y) =
    (make_bv
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      (getbv y))
     (width d)))) ->
  ((sequence_gen_diag d e1 f g h r) =
   (seq_pps_bv e1 d r 0%Z r h (fun (x:bitvec) (us:bitvec) => x) h
    (fun (x:bitvec) (y:bitvec) => (ang_ind e1 (getbv x) (getbv y)))
   ...
   (((h x) y) =
    (make_bv
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      (getbv y))
     (width d)))) ->
  ((width (sequence_gen_diag d e1 f g h r)) = (width d)).
   ...
   (((h x) y) =
    (make_bv
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      (getbv y))
     (width d)))) ->
  ((size (sequence_gen_diag d e1 f g h r)) = ((size d) + (size e1))%Z).
   ...
   (((h x) y) =
    (make_bv
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      (getbv y))
     (width d)))) ->
  ((ancillas (sequence_gen_diag d e1 f g h r)) =
   (ZArith.BinInt.Z.max (ancillas d) (ancillas e1))).
   ...
   (((h x) y) =
    (make_bv
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
      ...
      (getbv y))
     (width d)))) ->
  correct_path_sum_bv (sequence_gen_diag d e1 f g h r) r h g.
...
Axiom diag_parallel_def :
  forall (d:circuit) (e1:circuit) (f:bitvec -> angle) (g:bitvec -> angle)
    (h:bitvec -> angle),
  (diagonal1 d f) -> (diagonal1 e1 g) ->
  (forall (x:bitvec),
   ((h x) = (ang_add (f (hpart x (width d))) (g (tpart x (width d)))))) ->
  ((diag_parallel d e1 f g h) = (parallel d e1)).
...
Axiom diag_parallel_spec :
  ...
  (forall (x:bitvec),
   ((h x) = (ang_add (f (hpart x (width d))) (g (tpart x (width d)))))) ->
  diagonal1 (diag_parallel d e1 f g h) h.
...
Axiom diag_cont_def :
  ...
  (diagonal1 c f) ->
  (forall (x:bitvec), ((length x) = n) ->
   ((((getbv x) co) = 0%Z) /\ ((g x) = ang_zero)) \/
   (~ (((getbv x) co) = 0%Z) /\ ((g x) = (f (htpart x k (width c)))))) ->
...
Axiom crzp_def :
  ...
  ((crzp co t k n) =
   (diag_cont (diag_rz k) co t n
    (fun (x:bitvec) => (int_to_ang ((getbv x) 0%Z) k))
    (fun (x:bitvec) => (int_to_ang (((getbv x) co) * ((getbv x) t))%Z k)))).
...
Axiom przp_def :
  ...
  ((przp i k n) =
   (diag_place (diag_rz i) k n
    (fun (x:bitvec) => (int_to_ang ((getbv x) 0%Z) i))
    (fun (x:bitvec) =>
...
Axiom crzn_def :
  ...
  ((crzn co t k n) =
   (diag_cont (diag_rz_neg k) co t n
    (fun (x:bitvec) => (int_to_ang (-((getbv x) 0%Z))%Z (-k)%Z))
    (fun (x:bitvec) =>
     (int_to_ang ((-((getbv x) co))%Z * ((getbv x) t))%Z (-k)%Z)))).
...
Axiom crzp_up_spec3 :
  ...
  (fun (x:bitvec) =>
   (int_to_ang
    ((((getbv x) co) * ((getbv x) t))%Z * (power_ 2%Z (den - k)%Z))%Z den)).
...
Axiom crzn_up_spec3 :
  ...
  (fun (x:bitvec) =>
   (int_to_ang
    (((-((getbv x) co))%Z * ((getbv x) t))%Z * (power_ 2%Z (den + k)%Z))%Z
    den)).

Parameter c_rzp_one: Z -> Z -> Z -> circuit.

Axiom c_rzp_one_def :
  forall (co:Z) (t:Z) (n:Z), (n >= 0%Z)%Z -> ((0%Z <= co)%Z /\ (co < n)%Z) ->
...
Axiom c_rzp_one_spec3 :
  ...
  (fun (x:bitvec) => (int_to_ang (((getbv x) co) * ((getbv x) t))%Z 1%Z)).

Parameter fc30: Z -> Z -> bitvec -> angle.

Axiom fc_def30 :
  forall (co:Z) (t:Z) (x:bitvec),
  (((((getbv x) co) = ((getbv x) t)) /\ (((getbv x) t) = 1%Z)) ->
   (((fc30 co t) x) = ang_minus_one)) /\
  (~ ((((getbv x) co) = ((getbv x) t)) /\ (((getbv x) t) = 1%Z)) ->
...
Parameter fc31: Z -> Z -> bitvec -> angle.

Axiom fc_def31 :
  forall (co:Z) (t:Z) (x:bitvec),
  (((((getbv x) co) = ((getbv x) t)) /\ (((getbv x) t) = 1%Z)) ->
   (((fc31 co t) x) = ang_minus_one)) /\
  (~ ((((getbv x) co) = ((getbv x) t)) /\ (((getbv x) t) = 1%Z)) ->
   (((fc31 co t) x) = ang_zero)).

Axiom c_rzp_one_spec9 :
  forall (co:Z) (t:Z) (n:Z), (n >= 0%Z)%Z -> ((0%Z <= co)%Z /\ (co < n)%Z) ->
  ((0%Z <= t)%Z /\ (t < n)%Z) -> (t < co)%Z ->
  diagonal1 (c_rzp_one co t n) (fc31 co t).
   ...
   (diag_sequence (cascade_cont_rz_neg first_k first_c t (l - 1%Z)%Z n)
    ...
    (fun (x:bitvec) =>
     (int_to_ang
      (-(ind_isum
         (fun (k:Z) =>
          ((((getbv x) (first_c + k)%Z) * ((getbv x) t))%Z *
           (power_ 2%Z (n - (k + first_k)%Z)%Z))%Z)
         0%Z l))%Z
      n))
    (fun (x:bitvec) =>
     (int_to_ang
      (((-((getbv x) (first_c + l)%Z))%Z * ((getbv x) t))%Z *
...
Axiom cascade_cont_rz_neg_def2 :
  ...
  ((0%Z <= l)%Z /\ (l < n)%Z) -> ((0%Z <= first_c)%Z /\ (first_c < n)%Z) ->
  ((0%Z <= t)%Z /\ (t < n)%Z) -> ((first_c + l)%Z < n)%Z ->
  (0%Z <= first_k)%Z -> ((first_k + l)%Z <= n)%Z -> (t < first_c)%Z ->
  (l = 0%Z) ->
  ((cascade_cont_rz_neg first_k first_c t l n) =
   (crzn_up first_c t (-first_k)%Z n n)).
...
Axiom cascade_cont_qft_spec3 :
  ...
  (fun (x:bitvec) =>
   (int_to_ang
    (-(ind_isum
       (fun (k:Z) =>
        ((((getbv x) ((t + 1%Z)%Z + k)%Z) * ((getbv x) t))%Z *
...
Axiom qft_rev_line_def :
  forall (t:Z) (n:Z), ((0%Z <= t)%Z /\ (t < n)%Z) -> (t = (n - 1%Z)%Z) ->
  ((qft_rev_line t n) = (place_hadamard_bv t n)).

Parameter result23: Z -> bitvec -> bitvec -> Z -> Z.

Axiom result_def23 :
  forall (t:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t) -> (((result23 t x y) i) = ((getbv y) 0%Z))) /\
  (~ (i = t) -> (((result23 t x y) i) = ((getbv x) i))).
...
Parameter fc32: Z -> bitvec -> bitvec -> Z -> Z.

Axiom fc_def32 :
  forall (t:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t) -> (((fc32 t x y) i) = ((getbv y) 0%Z))) /\
  (~ (i = t) -> (((fc32 t x y) i) = ((getbv x) i))).

Axiom qft_rev_line_spec3 :
  forall (t:Z) (n:Z), ((0%Z <= t)%Z /\ (t < n)%Z) ->
  correct_path_sum_bv (qft_rev_line t n) 1%Z
  (fun (x:bitvec) (y:bitvec) => (make_bv (fc32 t x y) n))
  (fun (x:bitvec) (y:bitvec) =>
   (int_to_ang
    (-(ind_isum
       (fun (j:Z) =>
        ((((getbv x) j) * ((getbv y) 0%Z))%Z *
...
Axiom qft_rev_spec2 : forall (n:Z), (0%Z < n)%Z -> ((width (qft_rev n)) = n).

Axiom qft_rev_spec3 :
  forall (n:Z), (0%Z < n)%Z ->
  correct_path_sum_bv (qft_rev n) n (fun (us:bitvec) (y:bitvec) => y)
  (fun (x:bitvec) (y:bitvec) =>
   (int_to_ang
    (ind_isum
     (fun (l:Z) =>
...
Axiom H2 :
  ((-((int.EuclideanDivision.div i (power_ 2%Z n)) + 1%Z)%Z)%Z =
   (int.EuclideanDivision.div (-i)%Z (power_ 2%Z n))).

Axiom H3 :
  (((power_ 2%Z n) - (int.EuclideanDivision.mod1 i (power_ 2%Z n)))%Z =
   (int.EuclideanDivision.mod1 (-i)%Z (power_ 2%Z n))).

Axiom H4 : real_ (pow_inv_2 n).

Axiom H5 : infix_gtdt (pow_inv_2 n) c_zero.

Axiom H6 : ((pow_inv_2 n) = (pow_inv_sqrt_2 (2%Z * n)%Z)).

Axiom H7 :
  ((pow_inv_2 n) = (infix_asdt (pow_inv_sqrt_2 n) (pow_inv_sqrt_2 n))).

Axiom H8 :
  (0%Z <=
   (int_bit_inversion (int.EuclideanDivision.mod1 j (power_ 2%Z n)) n))%Z.
...
Axiom H11 :
  real_ (i_to_c (int.EuclideanDivision.mod1 (-i)%Z (power_ 2%Z n))).
...
Axiom H12 :
  ((real_to_ang
   ...
   (real_to_ang
    (infix_pldt
     (i_to_c ((-(int.EuclideanDivision.div i (power_ 2%Z n)))%Z + 1%Z)%Z)
     (infix_asdt
      (infix_asdt (i_to_c (int.EuclideanDivision.mod1 (-i)%Z (power_ 2%Z n)))
       (i_to_c
        (int_bit_inversion (int.EuclideanDivision.mod1 j (power_ 2%Z n)) n)))
...
Axiom H13 : real_ (pow_inv_2 n).

Axiom H14 : infix_gtdt (pow_inv_2 n) c_zero.

Axiom H15 : ((pow_inv_2 n) = (pow_inv_sqrt_2 (2%Z * n)%Z)).
...
Axiom H21 : ~ (result24 = c_zero).

(* Why3 goal *)
Theorem VC_int_qft_rev_coeff :
  ((ang_exp
    (real_to_ang
     (infix_pldt
      (i_to_c ((-(int.EuclideanDivision.div i (power_ 2%Z n)))%Z + 1%Z)%Z)
      (infix_asdt
       (infix_asdt
        (i_to_c (int.EuclideanDivision.mod1 (-i)%Z (power_ 2%Z n)))
        (i_to_c
         (int_bit_inversion (int.EuclideanDivision.mod1 j (power_ 2%Z n)) n)))
       (pow_inv_2 n)))))
   =
