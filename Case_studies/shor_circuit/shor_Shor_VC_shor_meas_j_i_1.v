...
Axiom modular_expo :
  forall (a:Z) (bound:Z) (i:Z), (0%Z <= i)%Z -> (co_prime a bound) ->
  (2%Z <= bound)%Z ->
  ((int.EuclideanDivision.mod1 (power_ a i) bound) =
   (int.EuclideanDivision.mod1
    (power_ a (int.EuclideanDivision.mod1 i (multi_order a bound))) bound)).
    ...
    (ket_sum_l (n_bvs n')
     (fun (i1:bitvec) =>
      (ket_sum_l (n_bvs n')
       ...
       n))
     n))) ->
  (forall (ind:Z), ((0%Z <= i)%Z /\ (i < k)%Z) -> ((g ind) = i)) ->
  ((proba_measure_from_scal_sum_sum_fun x i y k n n1 n2 n' f g scal) =
   (cpower (modulus (get x ((i * (power_ 2%Z n2))%Z + y)%Z 0%Z)) 2%Z)).
...
Axiom proba_measure_from_scal_sum_sum_fun_spec :
  ...
  (infix_lseqdt
   (proba_measure_from_scal_sum_sum_fun x i y k n n1 n2 n' f g scal)
   (proba_measure x ((i * (power_ 2%Z n2))%Z + y)%Z n)) /\
  ((proba_measure_from_scal_sum_sum_fun x i y k n n1 n2 n' f g scal) =
   (cpower
    (infix_asdt scal
...
Axiom best_appr__spec :
  ...
  (infix_lseqdt
   (modulus
    (infix_mndt (i_to_t (best_appr_ k a bound n))
     (i_to_t (k * (multi_order a bound))%Z)))
   (infix_sldt tone (infix_pldt tone tone))).
...
Axiom H49 : (1%Z <= (multi_order a bound))%Z.

Axiom H50 : ((multi_order a bound) < bound)%Z.
...
Axiom H53 : real_ (i_to_t (power_ 2%Z ((2%Z * n)%Z + 1%Z)%Z)).

Axiom H54 : (1%Z <= (multi_order a bound))%Z.

Axiom H55 : ((multi_order a bound) < bound)%Z.
...
Axiom H57 :
  real_
  (i_to_t
   (int.EuclideanDivision.div (power_ 2%Z (2%Z * n)%Z) (multi_order a bound))).

Axiom H58 :
  infix_lseqdt (infix_sldt tone (i_to_t (power_ 2%Z ((2%Z * n)%Z + 1%Z)%Z)))
  (infix_sldt tone
   (infix_asdt (infix_pldt tone tone)
    (i_to_t
     (int.EuclideanDivision.div (power_ 2%Z (2%Z * n)%Z)
...
Axiom H59 : (1%Z <= (multi_order a bound))%Z.

Axiom H60 : ((multi_order a bound) < bound)%Z.

Axiom H61 :
  ((int.EuclideanDivision.mod1 (power_ a (multi_order a bound)) bound) = 1%Z).

Axiom H62 : real_ (pow_inv_2 (2%Z * n)%Z).

Axiom H63 : infix_gtdt (pow_inv_2 (2%Z * n)%Z) tzero.
...
Axiom H66 : (1%Z <= (multi_order a bound))%Z.

Axiom H67 : ((multi_order a bound) < bound)%Z.

Axiom H68 :
  ((int.EuclideanDivision.mod1 (power_ a (multi_order a bound)) bound) = 1%Z).

Axiom H69 : real_ (i_to_t (k * (multi_order a bound))%Z).
...
Axiom H76 : is_a_ket (ket n 1%Z).

Axiom H77 : ((ket_length (ket n 1%Z)) = n).

Axiom H78 : ((columns (ket n 1%Z)) = 1%Z).

Axiom H79 : ((rows (ket n 1%Z)) = (power 2%Z n)).
...
Axiom H83 : is_a_ket (ket (2%Z * n)%Z 0%Z).

Axiom H84 : ((ket_length (ket (2%Z * n)%Z 0%Z)) = (2%Z * n)%Z).

Axiom H85 : ((columns (ket (2%Z * n)%Z 0%Z)) = 1%Z).

Axiom H86 : ((rows (ket (2%Z * n)%Z 0%Z)) = (power 2%Z (2%Z * n)%Z)).
...
Axiom H92 :
  forall (i1:Z) (j1:Z),
  (valid_index (kronecker (ket (2%Z * n)%Z 0%Z) (ket n 1%Z)) i1 j1) ->
  ((get (kronecker (ket (2%Z * n)%Z 0%Z) (ket n 1%Z)) i1 j1) =
   (infix_asdt
    (get (ket (2%Z * n)%Z 0%Z)
     (int.EuclideanDivision.div i1 (rows (ket n 1%Z)))
     (int.EuclideanDivision.div j1 (columns (ket n 1%Z))))
    (get (ket n 1%Z) (int.EuclideanDivision.mod1 i1 (rows (ket n 1%Z)))
     (int.EuclideanDivision.mod1 j1 (columns (ket n 1%Z)))))).

Axiom H93 : ((width (shor_circ a bound n)) = (3%Z * n)%Z).

Axiom H94 : ((ancillas (shor_circ a bound n)) = (n + 2%Z)%Z).
   ...
   (cpower
    (modulus
     (get
      (pat_sem (shor_circ a bound n)
       (kronecker (ket (2%Z * n)%Z 0%Z) (ket n 1%Z)))
      ((j * (power_ 2%Z n))%Z + i)%Z 0%Z))
    2%Z)).

Axiom H99 : real_ (pow_inv_2 (2%Z * n)%Z).

Axiom H100 : infix_gtdt (pow_inv_2 (2%Z * n)%Z) tzero.
...
Axiom H103 : (1%Z <= (multi_order a bound))%Z.

Axiom H104 : ((multi_order a bound) < bound)%Z.

Axiom H105 :
  ((int.EuclideanDivision.mod1 (power_ a (multi_order a bound)) bound) = 1%Z).

Axiom H106 : is_a_ket (ket n 1%Z).

Axiom H107 : ((ket_length (ket n 1%Z)) = n).

Axiom H108 : ((columns (ket n 1%Z)) = 1%Z).

Axiom H109 : ((rows (ket n 1%Z)) = (power 2%Z n)).
...
Axiom H113 : is_a_ket (ket (2%Z * n)%Z 0%Z).

Axiom H114 : ((ket_length (ket (2%Z * n)%Z 0%Z)) = (2%Z * n)%Z).

Axiom H115 : ((columns (ket (2%Z * n)%Z 0%Z)) = 1%Z).

Axiom H116 : ((rows (ket (2%Z * n)%Z 0%Z)) = (power 2%Z (2%Z * n)%Z)).
...
Axiom H123 : ((width (shor_circ a bound n)) = (3%Z * n)%Z).

Axiom H124 : ((ancillas (shor_circ a bound n)) = (n + 2%Z)%Z).
...
Axiom H128 :
  infix_lseqdt
  (proba_measure_from_scal_sum_sum_fun
   (pat_sem (shor_circ a bound n)
    (kronecker (ket (2%Z * n)%Z 0%Z) (ket n 1%Z)))
   i j (int.EuclideanDivision.div i (multi_order a bound)) (3%Z * n)%Z
   (2%Z * n)%Z n (2%Z * n)%Z
   (fun (i1:Z) (j1:Z) => (int_qft_rev_coeff i1 j1 (2%Z * n)%Z))
   (fun (k1:Z) =>
    (int.EuclideanDivision.mod1
     (power_ a ((k1 * (multi_order a bound))%Z + i)%Z) bound))
   (pow_inv_2 (2%Z * n)%Z))
  (proba_measure
   (pat_sem (shor_circ a bound n)
    (kronecker (ket (2%Z * n)%Z 0%Z) (ket n 1%Z)))
   ((i * (power_ 2%Z n))%Z + j)%Z (3%Z * n)%Z).
   ...
   (cpower
    (infix_asdt (pow_inv_2 (2%Z * n)%Z)
     (modulus
      (ind_sum
       (fun (i1:Z) =>
        (((fun (i11:Z) (j1:Z) => (int_qft_rev_coeff i11 j1 (2%Z * n)%Z))
          ((fun (k1:Z) =>
            (int.EuclideanDivision.mod1
             (power_ a ((k1 * (multi_order a bound))%Z + i)%Z) bound))
           i1))
         j))
       0%Z (int.EuclideanDivision.div i (multi_order a bound)))))
    2%Z)).

Axiom H130 : real_ (i_to_t 4%Z).

(* Why3 goal *)
Theorem VC_shor_meas_j_i : ~ ((cpower pi 2%Z) = tzero).
Proof.
