...
Axiom teq_spec :
  forall (x:complex) (y:complex), (infix_eqeq x y) <-> (x = y).
...
Axiom modulus_real_div :
  forall (x:complex) (y:complex), (real_ x) -> (infix_lsdt c_zero x) ->
...
Axiom indic_def :
  forall {a:Type} {a_WT:WhyType a},
  forall (a1:a) (a':a),
  ((infix_eqeq a1 a') -> ((indic a1 a') = c_one)) /\
  (~ (infix_eqeq a1 a') -> ((indic a1 a') = c_zero)).
...
Axiom div_mod_minus :
  forall (a:Z) (b:Z), (0%Z < b)%Z -> (0%Z < a)%Z ->
  ((int.EuclideanDivision.mod1 (-a)%Z b) =
...
Axiom modulus_one_decomp :
  forall (k:Z) (n:Z), ((0%Z <= k)%Z /\ (k < (power_ 2%Z n))%Z) ->
  ((modulus
    (infix_pldt
...
Parameter result9: Z -> Z -> complex.

Axiom result_def9 :
  forall (i:Z) (j:Z),
  ((i = j) -> (((result9 i) j) = c_one)) /\
  (~ (i = j) -> (((result9 i) j) = c_zero)).
...
Axiom ket_value :
  ...
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  ((0%Z <= j)%Z /\ (j < (power 2%Z n))%Z) ->
  ((i = j) -> ((get (ket n i) j 0%Z) = c_one)) /\
  (~ (i = j) -> ((get (ket n i) j 0%Z) = c_zero)).
...
Axiom kronecker_kets_ :
  forall (i1:Z) (i2:Z) (n1:Z) (n2:Z), (0%Z <= n1)%Z -> (0%Z <= n2)%Z ->
  ((0%Z <= i1)%Z /\ (i1 < (power_ 2%Z n1))%Z) ->
  ((0%Z <= i2)%Z /\ (i2 < (power_ 2%Z n2))%Z) ->
  ((kronecker (ket n1 i1) (ket n2 i2)) =
   (ket (n1 + n2)%Z ((i1 * (power_ 2%Z n2))%Z + i2)%Z)).
  ...
  ((m =
   ...
   (((get m (fir (basis_mat_indexes m)) (sec (basis_mat_indexes m))) = c_one) /\
    ((forall (i:Z) (j:Z), (valid_index m i j) ->
      ...
      ~ (j = (sec (basis_mat_indexes m))) -> ((get m i j) = c_zero)) /\
   ...
   (((basis_projection m i j) =
    ...
    (((get (basis_projection m i j) i j) = (get m i j)) /\
     ((forall (i':Z) (j':Z), (valid_index (basis_projection m i j) i' j') ->
       ~ (i' = i) -> ((get (basis_projection m i j) i' j') = c_zero)) /\
      forall (i':Z) (j':Z), (valid_index (basis_projection m i j) i' j') ->
      ~ (j' = j) -> ((get (basis_projection m i j) i' j') = c_zero))))).
   ...
   (map
    ((fun (y0:Z -> Z -> matrix complex) (y1:(Z* Z)%type) => (couple y0 y1))
     ((fun (y0:matrix complex) (y1:Z) (y2:Z) => (basis_projection y0 y1 y2))
      m))
    (to_indexes m))) /\
  ((forall (e:matrix complex), (mem e (basis_projections m)) ->
    ((rows e) = (rows m))) /\
   ((forall (e:matrix complex), (mem e (basis_projections m)) ->
     ((columns e) = (columns m))) /\
...
Axiom ket_basis_spec :
  ...
  (((ket_basis n) = (basis_mat (power 2%Z n) 1%Z)) /\
   ((forall (mat:matrix complex), (mem mat (ket_basis n)) ->
...
Axiom bv_to_ket_spec :
  ...
  (((ket_to_int (bv_to_ket bv)) = (bv_to_int bv)) /\
   ((is_a_ket_l (bv_to_ket bv) (length bv)) /\
...
Axiom h_basis_ket_bv_spec :
  ...
  forall (i:Z), ((0%Z <= i)%Z /\ (i < (h_width h))%Z) ->
...
Axiom pps_apply_basis_spec :
  ...
  forall (i:Z), ((0%Z <= i)%Z /\ (i < (power_ 2%Z (h_width h)))%Z) ->
...
Axiom pps_swap_def :
  ((h_width pps_swap) = 2%Z) /\
  (((h_range pps_swap) = 0%Z) /\
   ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
     (((x 0%Z) = (x 1%Z)) -> (((((h_basis_ket pps_swap) x) y) i) = (x i))) /\
     (~ ((x 0%Z) = (x 1%Z)) ->
...
Axiom pps_phase_spec :
  forall (k:Z),
  ((h_width (pps_phase k)) = 1%Z) /\
  (((h_range (pps_phase k)) = 0%Z) /\
   ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
     (((((h_basis_ket (pps_phase k)) x) y) i) = (x i))) /\
    forall (x:Z -> Z) (y:Z -> Z),
    ((0%Z <= k)%Z -> ((((h_angle (pps_phase k)) x) y) = (int_to_ang 1%Z k))) /\
    (~ (0%Z <= k)%Z ->
...
Axiom pps_rz_spec :
  forall (k:Z),
  ((h_width (pps_rz k)) = 1%Z) /\
  (((h_range (pps_rz k)) = 0%Z) /\
   ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
     (((((h_basis_ket (pps_rz k)) x) y) i) = (x i))) /\
    forall (x:Z -> Z) (y:Z -> Z),
    (((x 0%Z) = 0%Z) -> ((((h_angle (pps_rz k)) x) y) = ang_zero)) /\
    (~ ((x 0%Z) = 0%Z) ->
...
Axiom pps_hadamard_def :
  ((h_width pps_hadamard) = 1%Z) /\
  (((h_range pps_hadamard) = 1%Z) /\
   ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
     (((((h_basis_ket pps_hadamard) x) y) i) = (y i))) /\
    forall (x:Z -> Z) (y:Z -> Z),
    ((((x 0%Z) = (y 0%Z)) /\ ((y 0%Z) = 1%Z)) ->
...
Axiom pps_cnot_def :
  ((h_width pps_cnot) = 2%Z) /\
  (((h_range pps_cnot) = 0%Z) /\
   ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
     ((i = 0%Z) -> (((((h_basis_ket pps_cnot) x) y) i) = (x i))) /\
     (~ (i = 0%Z) ->
...
Axiom pps_swap_apply_basis :
  forall (x:bitvec), ((length x) = 2%Z) ->
  (((bv_to_int x) = 0%Z) -> ((pps_apply_basis pps_swap x) = (ket 2%Z 0%Z))) /\
  (~ ((bv_to_int x) = 0%Z) ->
   (((bv_to_int x) = 1%Z) -> ((pps_apply_basis pps_swap x) = (ket 2%Z 2%Z))) /\
   (~ ((bv_to_int x) = 1%Z) ->
    (((bv_to_int x) = 2%Z) -> ((pps_apply_basis pps_swap x) = (ket 2%Z 1%Z))) /\
    (~ ((bv_to_int x) = 2%Z) ->
     ((pps_apply_basis pps_swap x) = (ket 2%Z 3%Z))))).

Axiom pps_cnot_apply_basis :
  forall (x:bitvec), ((length x) = 2%Z) ->
  (((bv_to_int x) = 0%Z) -> ((pps_apply_basis pps_cnot x) = (ket 2%Z 0%Z))) /\
  (~ ((bv_to_int x) = 0%Z) ->
   (((bv_to_int x) = 1%Z) -> ((pps_apply_basis pps_cnot x) = (ket 2%Z 1%Z))) /\
   (~ ((bv_to_int x) = 1%Z) ->
    (((bv_to_int x) = 2%Z) -> ((pps_apply_basis pps_cnot x) = (ket 2%Z 3%Z))) /\
    (~ ((bv_to_int x) = 2%Z) ->
     ((pps_apply_basis pps_cnot x) = (ket 2%Z 2%Z))))).

Axiom pps_phase_apply_basis :
  forall (k:Z) (x:bitvec), ((length x) = 1%Z) ->
  ((0%Z <= k)%Z ->
...
Axiom pps_hadamard_apply_basis :
  ...
  (~ (((value x) 0%Z) = 0%Z) ->
   ((pps_apply_basis pps_hadamard x) =
    (infix_asdtdt (pow_inv_sqrt_2 1%Z)
     (add_ket_l (ket 1%Z 0%Z)
      (infix_asdtdt (prefix_mndt c_one) (ket 1%Z 1%Z)) 1%Z)))).
...
Axiom diag_mat_spec :
  forall (f:Z -> complex) (s:Z), (0%Z < s)%Z ->
  (is_diagonal (diag_mat f s)) /\
  (((rows (diag_mat f s)) = s) /\ ((columns (diag_mat f s)) = s)).
...
Axiom diag_mat_values :
  ...
  ((0%Z <= i)%Z /\ (i < s)%Z) -> ((0%Z <= j)%Z /\ (j < s)%Z) ->
  ((i = j) -> ((get (diag_mat f s) i j) = (f i))) /\
  (~ (i = j) -> ((get (diag_mat f s) i j) = c_zero)).
...
Axiom mat_size_spec :
  forall (m:matrix complex), (isa_square m) ->
...
Axiom kronecker_add_null :
  ...
  ((null_mat m2) /\ forall (x'1:matrix complex), null_mat (kronecker m2 x'1)).
...
Axiom pps_anc_gen_def :
  forall (h:pps) (k:Z), (1%Z <= (h_width h))%Z ->
  ((k = 1%Z) -> ((pps_anc_gen h k) = (pps_anc h))) /\
  (~ (k = 1%Z) ->
      ...
      (fun (x:bitvec) =>
       (mat_sum (n_bvs (h_range h))
        (fun (y:bitvec) =>
         (make_f (power_ 2%Z (h_width h)) (power_ 2%Z (h_width h))
          (fc19 h x y)))))))) /\
   (((rows (pps_to_mat h)) = (power_ 2%Z (h_width h))) /\
    (((columns (pps_to_mat h)) = (power_ 2%Z (h_width h))) /\
     ((forall (x:bitvec), ((length x) = (h_width h)) ->
       ((mat_mult (pps_to_mat h) (bv_to_ket x)) = (pps_apply_basis h x))) /\
      forall (x:matrix complex), (is_a_ket_l x (h_width h)) ->
...
Axiom max_right :
  forall (a:Z) (b:Z), (a <= b)%Z -> ((ZArith.BinInt.Z.max a b) = b).

Axiom max_left :
  forall (a:Z) (b:Z), (b <= a)%Z -> ((ZArith.BinInt.Z.max a b) = a).
...
Axiom appr :
  forall (theta:complex) (n:Z), (0%Z < n)%Z -> (real_ theta) ->
  ((infix_lseqdt c_zero theta) /\ (infix_lseqdt theta c_one)) ->
  exists k:Z,
  (mem k (to_fset 0%Z (n + 1%Z)%Z)) /\
  (infix_lseqdt
   (modulus (infix_mndt theta (infix_sldt (i_to_c k) (i_to_c n))))
...
Axiom width_spec :
  forall (c:circuit),
  (1%Z <= (width c))%Z /\ ((width c) = (h_width (circ_to_pps c))).
...
Axiom range_spec :
  forall (c:circuit),
  (0%Z <= (range c))%Z /\ ((range c) = (h_range (circ_to_pps c))).
...
Axiom basis_ket_spec :
  ...
  ((forall (i1:Z), ((0%Z <= i1)%Z /\ (i1 < (width c))%Z) ->
   ...
   (forall (i1:Z), ((0%Z <= i1)%Z /\ (i1 < (range c))%Z) ->
    (0%Z <= (y i1))%Z /\ ((y i1) < 2%Z)%Z) ->
   ((0%Z <= i)%Z /\ (i < (width c))%Z) ->
   (0%Z <= (basis_ket c x y i))%Z /\ ((basis_ket c x y i) < 2%Z)%Z).
...
Axiom sem_to_path_sem :
  forall (c:circuit) (x:matrix complex) (y:matrix complex), (sem c x y) ->
  ((path_sem c x) = y).
  ...
  (((ancillas id) = 0%Z) /\
   (((size id) = 0%Z) /\
    (((range id) = 0%Z) /\
     (((width id) = 1%Z) /\
      ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
        ((basis_ket id x y i) = (x i))) /\
       forall (x:Z -> Z) (y:Z -> Z), ((ang_ind id x y) = ang_zero)))))).

Parameter swap: circuit.

Axiom swap_def :
  ((circ_to_pps swap) = pps_swap) /\
  (((ancillas swap) = 0%Z) /\
   (((size swap) = 0%Z) /\
    (((range swap) = 0%Z) /\
     (((width swap) = 2%Z) /\
...
Axiom phase_spec :
  ...
  (((ancillas (phase k)) = 0%Z) /\
   (((size (phase k)) = 1%Z) /\
    (((range (phase k)) = 0%Z) /\
     (((width (phase k)) = 1%Z) /\
      ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
        ((basis_ket (phase k) x y i) = (x i))) /\
       (((0%Z <= k)%Z -> forall (x:Z -> Z) (y:Z -> Z),
         ((ang_ind (phase k) x y) = (int_to_ang 1%Z k))) /\
        ((k < 0%Z)%Z -> forall (x:Z -> Z) (y:Z -> Z),
      ...
      ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
       ...
       (((0%Z <= k)%Z -> forall (x:Z -> Z) (y:Z -> Z),
        ...
        ((k < 0%Z)%Z -> forall (x:Z -> Z) (y:Z -> Z),
         (((x 0%Z) = 0%Z) -> ((ang_ind (rz k) x y) = ang_zero)) /\
         (~ ((x 0%Z) = 0%Z) ->
          ((ang_ind (rz k) x y) = (int_to_ang (-1%Z)%Z (-k)%Z)))))))))).
...
Axiom cnot_def :
  ((circ_to_pps cnot) = pps_cnot) /\
  (((ancillas cnot) = 0%Z) /\
   (((size cnot) = 1%Z) /\
    (((range cnot) = 0%Z) /\
     (((width cnot) = 2%Z) /\
      ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
        ((i = 0%Z) -> ((basis_ket cnot x y i) = (x i))) /\
        (~ (i = 0%Z) ->
  ...
  ((path_sem_basis c x) =
   (infix_asdtdt (pow_inv_sqrt_2 (range c))
    (ket_sum_l (n_bvs (range c))
     (fun (y:bitvec) =>
      (infix_asdtdt (ang_exp (ang_ind c (value (ket_to_bv x)) (value y)))
       (bv_to_ket
        (make_bv
         ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
             (basis_ket y0 y1 y2 y3))
...
Axiom path_sem_comp_ :
  ...
  (is_a_ket_l x (width d)) -> ((width d) = (width e)) ->
...
Axiom path_sem_rz_basis :
  forall (x:matrix complex) (k:Z), (is_a_ket_l x 1%Z) ->
  (is_a_ket_basis_elt x) ->
  (((ket_to_int x) = 0%Z) -> ((path_sem (rz k) x) = x)) /\
  (~ ((ket_to_int x) = 0%Z) ->
   ((0%Z <= k)%Z ->
...
Axiom qbit_zero_spec :
  ((get (ket 1%Z 0%Z) 0%Z 0%Z) = c_one) /\
  (((get (ket 1%Z 0%Z) 1%Z 0%Z) = c_zero) /\
   ((is_a_ket_l (ket 1%Z 0%Z) 1%Z) /\
    (((rows (ket 1%Z 0%Z)) = 2%Z) /\
     (((columns (ket 1%Z 0%Z)) = 1%Z) /\
      (((get (ket 1%Z 0%Z) 0%Z 0%Z) = c_one) /\
       (((get (ket 1%Z 0%Z) 1%Z 0%Z) = c_zero) /\
        (is_a_ket_basis_elt (ket 1%Z 0%Z)))))))).

Axiom qbit_one_spec :
  ((get (ket 1%Z 1%Z) 0%Z 0%Z) = c_zero) /\
  (((get (ket 1%Z 1%Z) 1%Z 0%Z) = c_one) /\
   ((is_a_ket_l (ket 1%Z 1%Z) 1%Z) /\
    (((rows (ket 1%Z 1%Z)) = 2%Z) /\
     (((columns (ket 1%Z 1%Z)) = 1%Z) /\
      (((get (ket 1%Z 1%Z) 0%Z 0%Z) = c_zero) /\
       (((get (ket 1%Z 1%Z) 1%Z 0%Z) = c_one) /\
        (is_a_ket_basis_elt (ket 1%Z 1%Z)))))))).
...
Axiom int_bit_inversion_ext_spec :
  ...
  ((i = (power_ 2%Z n)) -> ((int_bit_inversion_ext i n) = (power_ 2%Z n))).
      ...
      (fun (k:Z) =>
       (int_to_ang
        ((((value y) k) * ((value x) target))%Z *
         (power_ 2%Z (((n - k)%Z - 1%Z)%Z + ((n - target)%Z - 1%Z)%Z)%Z))%Z
        n))
      ((n - target)%Z - 1%Z)%Z n))
    0%Z n)
   = (int_to_ang ((bv_to_int x) * (bv_to_int y))%Z n)).
...
Axiom bv_check_zero_def :
  forall (x:bitvec),
  (((length x) = 0%Z) -> ((bv_check_zero x) = (int_to_ang 1%Z 1%Z))) /\
  (~ ((length x) = 0%Z) ->
   (((length x) = 1%Z) ->
...
Axiom bv_check_zero_plus_one :
  forall (x:bitvec), (1%Z < (length x))%Z ->
  ((((value x) 0%Z) = 1%Z) ->
   ((bv_check_zero x) = (bv_check_zero (tpart x 1%Z)))) /\
  (~ (((value x) 0%Z) = 1%Z) -> ((bv_check_zero x) = ang_zero)).
...
Axiom repeat_pps_had_def :
  forall (n:Z), (1%Z <= n)%Z ->
  ((n = 1%Z) -> ((repeat_pps_had n) = pps_hadamard)) /\
  (~ (n = 1%Z) ->
...
Axiom path_sem_cnot_basis :
  ...
  (~ ((ket_to_int x) = 0%Z) ->
   (((ket_to_int x) = 1%Z) -> ((path_sem cnot x) = (ket 2%Z 1%Z))) /\
   (~ ((ket_to_int x) = 1%Z) ->
...
Axiom path_sem_swap_basis :
  ...
  (~ ((ket_to_int x) = 0%Z) ->
   (((ket_to_int x) = 1%Z) -> ((path_sem swap x) = (ket 2%Z 2%Z))) /\
   (~ ((ket_to_int x) = 1%Z) ->
   ...
   (((range (ancilla_g c path_sem_target)) = (range c)) /\
    (((width (ancilla_g c path_sem_target)) = ((width c) - 1%Z)%Z) /\
     ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
      ...
      ((forall (x:Z -> Z) (y:Z -> Z),
        ((ang_ind (ancilla_g c path_sem_target) x y) =
         (ang_ind c (fc24 c x) y))) /\
       ((forall (x:matrix complex),
         (is_a_ket_l x (width (ancilla_g c path_sem_target))) ->
         ((kronecker (path_sem (ancilla_g c path_sem_target) x)
           (ket 1%Z 0%Z))
          = (path_sem c (kronecker x (ket 1%Z 0%Z))))) /\
        forall (x:matrix complex),
        (is_a_ket_l x (width (ancilla_g c path_sem_target))) ->
...
Axiom ancilla_ket_spec :
  ...
  ((0%Z < k)%Z /\ (k < n)%Z) ->
  (exists f:(matrix complex) -> matrix complex,
   forall (x:matrix complex), (is_a_ket_l x (n - k)%Z) ->
   (is_a_ket_basis_elt x) ->
   ((path_sem c (kronecker x (ket k 0%Z))) = (kronecker (f x) (ket k 0%Z)))) ->
  ((ancillas (ancilla_ket c k n)) = (k + (ancillas c))%Z) /\
  (((size (ancilla_ket c k n)) = (size c)) /\
   ((forall (x:matrix complex) (y:matrix complex),
     (is_a_ket_l x (n - k)%Z) ->
     (sem c (kronecker x (ket k 0%Z)) (kronecker y (ket k 0%Z))) ->
     sem (ancilla_ket c k n) x y) /\
  ...
  (((width (seq_pps_bv c c' r1 r2 r3 k1 k2 k3 a1 a2 a3)) = (width c)) /\
   (((size (seq_pps_bv c c' r1 r2 r3 k1 k2 k3 a1 a2 a3)) =
    ...
    (((ancillas (seq_pps_bv c c' r1 r2 r3 k1 k2 k3 a1 a2 a3)) =
      (ZArith.BinInt.Z.max (ancillas c) (ancillas c'))) /\
     (correct_path_sum_bv (seq_pps_bv c c' r1 r2 r3 k1 k2 k3 a1 a2 a3) r3 k3
      a3)))).
...
Axiom reverse_spec :
  ...
  (((size (reverse c)) = (size c)) /\
   (((ancillas (reverse c)) = 0%Z) /\
    ((forall (x:matrix complex) (y:matrix complex),
      (is_a_ket_l x (width c)) -> (is_a_ket_l y (width c)) ->
      ((path_sem c x) = y) <-> ((path_sem (reverse c) y) = x)) /\
     ((forall (x:matrix complex) (y:matrix complex), (sem c x y) ->
       sem (reverse c) y x) /\
      forall (x:matrix complex) (y:matrix complex), (sem (reverse c) y x) ->
      sem c x y)))).
   ...
   (((ancillas (ids n)) = 0%Z) /\
    (((range (ids n)) = 0%Z) /\
     ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
      ...
      ((forall (x:Z -> Z) (y:Z -> Z), ((ang_ind (ids n) x y) = ang_zero)) /\
       ((forall (x:matrix complex), (is_a_ket_l x n) ->
         (is_a_ket_basis_elt x) -> ((path_sem (ids n) x) = x)) /\
        forall (x:matrix complex), (is_a_ket_l x n) ->
        ((path_sem (ids n) x) = x))))))).
   ...
   (((range (place c k n)) = (range c)) /\
    (((width (place c k n)) = n) /\
     ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
      ...
      ((forall (x:Z -> Z) (y:Z -> Z),
        ((ang_ind (place c k n) x y) =
         (ang_ind c (fun (j:Z) => (x (j + k)%Z)) y))) /\
       ((((k = 0%Z) /\ (n = (k + (width c))%Z)) -> ((place c k n) = c)) /\
        (~ ((k = 0%Z) /\ (n = (k + (width c))%Z)) ->
         ((k = 0%Z) ->
...
Axiom place_kron_gen_ :
  forall (c:circuit) (k:Z) (n:Z), (0%Z < k)%Z -> (((width c) + k)%Z < n)%Z ->
  forall (x:matrix complex) (y:matrix complex) (y':matrix complex)
    (z:matrix complex),
  (is_a_ket_l x k) -> (is_a_ket_l y (width c)) ->
  (is_a_ket_l z ((n - (width c))%Z - k)%Z) -> (sem c y y') ->
       ...
       ((forall (x:Z -> Z) (y:Z -> Z), forall (m:Z), (1%Z <= m)%Z ->
        ...
        (correct_path_sum_bv (place_hadamard_bv k n) 1%Z
         ...
         (fun (x:bitvec) (y:bitvec) =>
          (int_to_ang
           ((((value x) k) * ((value y) 0%Z))%Z * (power_ 2%Z (n - 1%Z)%Z))%Z
           n))))))))).
...
Axiom qbit_permutes_spec :
  forall (c:circuit),
  ((qbit_permutes c) -> ((size c) = 0%Z)) /\
  (((qbit_permutes c) -> ((ancillas c) = 0%Z)) /\
   (((qbit_permutes c) -> ((range c) = 0%Z)) /\
    ((qbit_permutes c) -> forall (x:Z -> Z) (y:Z -> Z),
   ...
   ((qbit_permutes (permute_atom k fk n)) /\
    ((((qbit_permutation (permute_atom k fk n)) k) = fk) /\
     ((((qbit_permutation (permute_atom k fk n)) fk) = k) /\
      forall (i:Z), ((0%Z <= i)%Z /\ (i < n)%Z) -> ~ (i = k) -> ~ (i = fk) ->
    ...
    ((forall (i:Z), ((0%Z <= i)%Z /\ (i < n)%Z) ->
     ...
     ((forall (i:Z), ((0%Z <= i)%Z /\ (i < n)%Z) ->
      ...
      ((path_sem (permutation_circuit n f) (bv_to_ket x)) =
       (bv_to_ket (make_bv (fun (i:Z) => ((value x) (f i))) n))))))).
...
Parameter insert_qbits: circuit -> Z -> Z -> Z -> circuit.

Axiom insert_qbits_spec :
  forall (c:circuit) (k:Z) (n:Z) (i:Z), ((width c) = n) ->
  ((0%Z <= k)%Z /\ (k < n)%Z) -> (0%Z < i)%Z ->
  ((ancillas (insert_qbits c k n i)) = (ancillas c)) /\
  (((width (insert_qbits c k n i)) = (n + i)%Z) /\
   (((size (insert_qbits c k n i)) = (size c)) /\
    forall (y:matrix complex) (im_c:matrix complex) (im_d:matrix complex)
      (ant_c:matrix complex) (ant_d:matrix complex),
    (is_a_ket_l y i) -> (is_a_ket_l im_c k) -> (is_a_ket_l im_d (n - k)%Z) ->
    (is_a_ket_l ant_c k) -> (is_a_ket_l ant_d (n - k)%Z) ->
    (sem c (kronecker ant_c ant_d) (kronecker im_c im_d)) ->
    sem (insert_qbits c k n i) (kronecker ant_c (kronecker y ant_d))
    (kronecker im_c (kronecker y im_d)))).
...
Axiom cont_zero_spec :
  forall (c:circuit),
  ((size (cont_zero c)) <= ((size c) * cont_size)%Z)%Z /\
  (((ancillas (cont_zero c)) = (ancillas c)) /\
   (((range (cont_zero c)) = (range c)) /\
    (((width (cont_zero c)) = ((width c) + 1%Z)%Z) /\
     ((forall (bv:bitvec), ((length bv) = ((width c) + 1%Z)%Z) ->
       (((value bv) 0%Z) = 0%Z) ->
...
Axiom cont_zero_sem_kron_spec :
  ...
  (((ancillas (cont_zero c)) = (ancillas c)) /\
   (((range (cont_zero c)) = (range c)) /\
    (((width (cont_zero c)) = ((width c) + 1%Z)%Z) /\
     ((forall (x:matrix complex) (y:matrix complex), (sem c x y) ->
       sem (cont_zero c) (kronecker (ket 1%Z 1%Z) x)
       (kronecker (ket 1%Z 1%Z) y)) /\
      forall (x:matrix complex),
      sem (cont_zero c) (kronecker (ket 1%Z 0%Z) x)
      (kronecker (ket 1%Z 0%Z) x))))).
...
Axiom cont_last_qbit_spec :
  ...
  (((ancillas (cont_last_qbit c)) = (ancillas c)) /\
   (((range (cont_last_qbit c)) = (range c)) /\
    (((width (cont_last_qbit c)) = ((width c) + 1%Z)%Z) /\
     ((forall (bv:bitvec), ((length bv) = ((width c) + 1%Z)%Z) ->
       (((value bv) (width c)) = 0%Z) ->
       ((path_sem (cont_last_qbit c) (bv_to_ket bv)) = (bv_to_ket bv))) /\
      forall (bv:bitvec), ((length bv) = ((width c) + 1%Z)%Z) ->
      (((value bv) (width c)) = 1%Z) ->
      ((path_sem (cont_last_qbit c) (bv_to_ket bv)) =
       (path_sem (place c 0%Z ((width c) + 1%Z)%Z) (bv_to_ket bv))))))).

Axiom cont_last_qbit_kron_spec :
  forall (c:circuit),
  ((size (cont_last_qbit c)) <= ((size c) * cont_size)%Z)%Z /\
  (((ancillas (cont_last_qbit c)) = (ancillas c)) /\
   (((range (cont_last_qbit c)) = (range c)) /\
    (((width (cont_last_qbit c)) = ((width c) + 1%Z)%Z) /\
     ((forall (x:matrix complex) (y:matrix complex), (sem c x y) ->
       sem (cont_last_qbit c) (kronecker x (ket 1%Z 1%Z))
       (kronecker y (ket 1%Z 1%Z))) /\
      forall (x:matrix complex),
      sem (cont_last_qbit c) (kronecker x (ket 1%Z 0%Z))
      (kronecker x (ket 1%Z 0%Z)))))).
...
Axiom size_cont :
  ...
  ((0%Z <= co)%Z /\ (co < n)%Z) ->
  ((0%Z <= k)%Z /\ (k <= (n - (width c))%Z)%Z) ->
  ((k <= co)%Z -> ((k + (width c))%Z <= co)%Z) -> ((size c) <= s)%Z ->
...
Axiom path_cont_ketz :
  ...
  ((0%Z <= co)%Z /\ (co < n)%Z) ->
  ((0%Z <= k)%Z /\ (k <= (n - (width c))%Z)%Z) ->
  ((k <= co)%Z -> ((k + (width c))%Z <= co)%Z) -> (is_a_ket_l x n) ->
...
Axiom path_cont_ketz_gen :
  forall (c:circuit) (co:Z) (k:Z) (n:Z), ((0%Z <= co)%Z /\ (co < n)%Z) ->
  ((0%Z <= k)%Z /\ (k <= (n - (width c))%Z)%Z) ->
  ((k <= co)%Z -> ((k + (width c))%Z <= co)%Z) -> forall (x:matrix complex),
...
Axiom place_kron_left_sem :
  ...
  (is_a_ket_l y (n - (width c))%Z) -> (sem c x z) ->
  sem (place c 0%Z n) (kronecker x y) (kronecker z y).
...
Axiom cont_kron_pat_right :
  ...
  (forall (x:matrix complex), (is_a_ket_basis_elt x) -> (is_a_ket_l x k) ->
...
Axiom cont_kron_pat_right_gen :
  ...
  (n = (k + (width circ))%Z) ->
  (forall (y:matrix complex), forall (x:bitvec),
   (is_a_ket_l y (width circ)) -> ((length x) = k) ->
   (((value x) c) = 0%Z) ->
...
Axiom diag_rz_neg_spec :
  forall (k:Z), (k <= 0%Z)%Z ->
  ((size (diag_rz_neg k)) = 1%Z) /\
  (((ancillas (diag_rz_neg k)) = 0%Z) /\
   (((width (diag_rz_neg k)) = 1%Z) /\
...
Axiom diag_phase_spec :
  forall (k:Z), (0%Z <= k)%Z ->
  ((size (diag_phase k)) = 1%Z) /\
  (((ancillas (diag_phase k)) = 0%Z) /\
   (((width (diag_phase k)) = 1%Z) /\
...
Axiom diag_phase_neg_spec :
  forall (k:Z), (k <= 0%Z)%Z ->
  ((size (diag_phase_neg k)) = 1%Z) /\
  (((ancillas (diag_phase_neg k)) = 0%Z) /\
   (((width (diag_phase_neg k)) = 1%Z) /\
...
Axiom diag_cont_def :
  ...
  ((0%Z <= co)%Z /\ (co < n)%Z) ->
  ((0%Z <= k)%Z /\ (k <= (n - (width c))%Z)%Z) ->
  ((k <= co)%Z -> ((k + (width c))%Z <= co)%Z) -> (diagonal1 c f) ->
  (forall (x:bitvec), ((length x) = n) ->
...
Axiom crzp_up_spec :
  ...
  ((0%Z <= t)%Z /\ (t < n)%Z) -> ~ (t = co) -> (0%Z <= k)%Z ->
  (k <= den)%Z ->
  ((size (crzp_up co t k n den)) <= cont_size)%Z /\
  (((ancillas (crzp_up co t k n den)) = 0%Z) /\
   (((width (crzp_up co t k n den)) = n) /\
...
Axiom crzn_up_spec :
  ...
  ((0%Z <= t)%Z /\ (t < n)%Z) -> ~ (t = co) -> (k <= 0%Z)%Z ->
  ((-k)%Z <= den)%Z ->
  ((size (crzn_up co t k n den)) <= cont_size)%Z /\
  (((ancillas (crzn_up co t k n den)) = 0%Z) /\
   (((width (crzn_up co t k n den)) = n) /\
...
Axiom cascade_cont_rz_neg_def :
  forall (first_k:Z) (first_c:Z) (t:Z) (l:Z) (n:Z),
  ((0%Z <= l)%Z /\ (l < n)%Z) -> ((0%Z <= first_c)%Z /\ (first_c < n)%Z) ->
  ((0%Z <= t)%Z /\ (t < n)%Z) -> ((first_c + l)%Z < n)%Z ->
  (0%Z <= first_k)%Z -> ((first_k + l)%Z <= n)%Z ->
  ((t <= (first_c + l)%Z)%Z -> (t < first_c)%Z) ->
  ((l = 0%Z) ->
   ((cascade_cont_rz_neg first_k first_c t l n) =
    (crzn_up first_c t (-first_k)%Z n n))) /\
  (~ (l = 0%Z) ->
   ((cascade_cont_rz_neg first_k first_c t l n) =
    (diag_sequence (cascade_cont_rz_neg first_k first_c t (l - 1%Z)%Z n)
     (crzn_up (first_c + l)%Z t (-(first_k + l)%Z)%Z n n)
     (fun (x:bitvec) =>
      (int_to_ang
       (-(ind_isum
          (fun (k:Z) =>
           ((((value x) (first_c + k)%Z) * ((value x) t))%Z *
            (power_ 2%Z (n - (k + first_k)%Z)%Z))%Z)
          0%Z l))%Z
       n))
     (fun (x:bitvec) =>
      (int_to_ang
       (((-((value x) (first_c + l)%Z))%Z * ((value x) t))%Z *
        (power_ 2%Z (n - (l + first_k)%Z)%Z))%Z
       n))
     (fun (x:bitvec) =>
      (int_to_ang
       (-(ind_isum
...
Axiom cascade_cont_rz_neg_spec :
  ...
  (0%Z <= first_k)%Z -> ((first_k + l)%Z <= n)%Z ->
  ((t <= (first_c + l)%Z)%Z -> (t < first_c)%Z) ->
  ((width (cascade_cont_rz_neg first_k first_c t l n)) = n) /\
  (((ancillas (cascade_cont_rz_neg first_k first_c t l n)) = 0%Z) /\
   (((size (cascade_cont_rz_neg first_k first_c t l n)) <=
     (cont_size * (l + 1%Z)%Z)%Z)%Z /\
    (diagonal1 (cascade_cont_rz_neg first_k first_c t l n)
     (fun (x:bitvec) =>
      (int_to_ang
       (-(ind_isum
          (fun (k:Z) =>
...
Axiom cascade_cont_qft_def :
  forall (t:Z) (n:Z), ((0%Z <= t)%Z /\ (t < (n - 1%Z)%Z)%Z) ->
  ((cascade_cont_qft t n) =
   (cascade_cont_rz_neg 2%Z (t + 1%Z)%Z t (n - (t + 2%Z)%Z)%Z n)).

Axiom cascade_cont_qft_spec :
  forall (t:Z) (n:Z), ((0%Z <= t)%Z /\ (t < (n - 1%Z)%Z)%Z) ->
  ((width (cascade_cont_qft t n)) = n) /\
  (((size (cascade_cont_qft t n)) <= (cont_size * ((n - t)%Z - 1%Z)%Z)%Z)%Z /\
   (((ancillas (cascade_cont_qft t n)) = 0%Z) /\
    ((diagonal1 (cascade_cont_qft t n)
      (fun (x:bitvec) =>
       (int_to_ang
        (-(ind_isum
           (fun (k:Z) =>
            ((((value x) ((t + 1%Z)%Z + k)%Z) * ((value x) t))%Z *
             (power_ 2%Z (n - (k + 2%Z)%Z)%Z))%Z)
           0%Z ((n - (t + 2%Z)%Z)%Z + 1%Z)%Z))%Z
        n))) /\
     (diagonal1 (cascade_cont_qft t n)
      (fun (x:bitvec) =>
       (int_to_ang
        (-(ind_isum
           (fun (k:Z) =>
            ((((value x) t) * ((value x) k))%Z *
             (power_ 2%Z (((n - k)%Z - 1%Z)%Z + t)%Z))%Z)
           (t + 1%Z)%Z n))%Z
        n)))))).

Parameter qft_rev_line: Z -> Z -> circuit.

Parameter result23: Z -> bitvec -> bitvec -> Z -> Z.

Axiom result_def23 :
  forall (t:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t) -> (((result23 t x y) i) = ((value y) 0%Z))) /\
  (~ (i = t) -> (((result23 t x y) i) = ((value x) i))).

Axiom qft_rev_line_def :
  forall (t:Z) (n:Z), ((0%Z <= t)%Z /\ (t < n)%Z) ->
  ((t = (n - 1%Z)%Z) -> ((qft_rev_line t n) = (place_hadamard_bv t n))) /\
  (~ (t = (n - 1%Z)%Z) ->
   ((qft_rev_line t n) =
    (sequence_gen_diag (cascade_cont_qft t n) (place_hadamard_bv t n)
     (fun (x:bitvec) =>
      (int_to_ang
       (-(ind_isum
          (fun (k:Z) =>
     ...
     (fun (x:bitvec) (y:bitvec) =>
      (int_to_ang
       (-(ind_isum
          ...
          t n))%Z
       n))
     (fun (x:bitvec) (y:bitvec) => (make_bv (result23 t x y) n)) 1%Z))).

Parameter fc30: Z -> bitvec -> bitvec -> Z -> Z.

Axiom fc_def30 :
  forall (t:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t) -> (((fc30 t x y) i) = ((value y) 0%Z))) /\
  (~ (i = t) -> (((fc30 t x y) i) = ((value x) i))).

Axiom qft_rev_line_spec :
  forall (t:Z) (n:Z), ((0%Z <= t)%Z /\ (t < n)%Z) ->
  ((size (qft_rev_line t n)) <= (cont_size * n)%Z)%Z /\
  (((ancillas (qft_rev_line t n)) = 0%Z) /\
   (((width (qft_rev_line t n)) = n) /\
    (correct_path_sum_bv (qft_rev_line t n) 1%Z
     (fun (x:bitvec) (y:bitvec) => (make_bv (fc30 t x y) n))
     (fun (x:bitvec) (y:bitvec) =>
      (int_to_ang
       (-(ind_isum
          (fun (j:Z) =>
           ((((value x) j) * ((value y) 0%Z))%Z *
            (power_ 2%Z (((n - j)%Z - 1%Z)%Z + t)%Z))%Z)
          t n))%Z
       n))))).

Parameter qft_rev_be: Z -> circuit.

Axiom qft_rev_be_spec :
  forall (n:Z), (0%Z < n)%Z ->
  ((size (qft_rev_be n)) <= (polysquare n cont_size 0%Z 0%Z))%Z /\
  (((ancillas (qft_rev_be n)) = 0%Z) /\
   (((width (qft_rev_be n)) = n) /\
    (correct_path_sum_bv (qft_rev_be n) n (fun (us:bitvec) (y:bitvec) => y)
     (fun (x:bitvec) (y:bitvec) =>
      (int_to_ang
       (ind_isum
        (fun (l:Z) =>
...
Parameter qft_rev_coeff: bitvec -> bitvec -> Z -> complex.
...
Axiom path_sem_rev_qft_unit_be :
  forall (n:Z), (0%Z < n)%Z -> forall (x:matrix complex), (is_a_ket_l x n) ->
  (is_a_ket_basis_elt x) ->
  ((path_sem (qft_rev_be n) x) =
   (infix_asdtdt (pow_inv_sqrt_2 n)
    (ket_sum_l (n_bvs n)
     (fun (y:bitvec) =>
...
Parameter int_qft_rev_coeff: Z -> Z -> Z -> complex.
...
Axiom int_qft_rev_coeff_def :
  ...
  ((int_qft_rev_coeff i j n) =
   (ang_exp
    (real_to_ang
     (infix_asdt
      (infix_asdt (i_to_c (int.EuclideanDivision.mod1 (-i)%Z (power_ 2%Z n)))
       (i_to_c
...
Axiom int_qft_rev_coeff_spec :
  ...
  ((int_qft_rev_coeff i j n) =
   (ang_exp
    (real_to_ang
     (infix_asdt
      (infix_asdt (i_to_c (-(int.EuclideanDivision.mod1 i (power_ 2%Z n)))%Z)
       (i_to_c
        (int_bit_inversion (int.EuclideanDivision.mod1 j (power_ 2%Z n)) n)))
      (pow_inv_2 n))))) /\
  ((int_qft_rev_coeff i j n) =
...
Axiom get_path_sem_rev_qft_ket_be :
  ...
  ((get (path_sem (qft_rev_be n) (ket n i)) j 0%Z) =
   (infix_asdt (pow_inv_sqrt_2 n)
...
Axiom path_sem_rev_qft_bv_be :
  forall (n:Z), (0%Z < n)%Z -> forall (x:bitvec), ((length x) = n) ->
  ((path_sem (qft_rev_be n) (bv_to_ket x)) =
   (infix_asdtdt (pow_inv_sqrt_2 n)
    (ket_sum_l (n_bvs n)
...
Parameter qft_rev_pre: Z -> bitvec -> circuit.

Axiom qft_rev_pre_def :
  forall (n:Z) (x:bitvec), (0%Z < n)%Z -> ((length x) = n) ->
  ((qft_rev_pre n x) =
   (sequence (qft_rev_be n)
    (permutation_circuit n ((fun (y0:Z) (y1:Z) => (y0 - y1)%Z) (n - 1%Z)%Z)))).

Axiom qft_rev_pre_spec :
  forall (n:Z) (x:bitvec), (0%Z < n)%Z -> ((length x) = n) ->
  ((size (qft_rev_pre n x)) <= (polysquare n cont_size 0%Z 0%Z))%Z /\
  (((ancillas (qft_rev_pre n x)) = 0%Z) /\
   (((width (qft_rev_pre n x)) = n) /\
    ((path_sem (qft_rev_pre n x) (bv_to_ket x)) =
     (infix_asdtdt (pow_inv_sqrt_2 n)
      (ket_sum_l (n_bvs n)
       (fun (y:bitvec) =>
...
Axiom qft_rev_spec :
  forall (n:Z), (0%Z < n)%Z ->
  ((size (qft_rev n)) <= (polysquare n cont_size 0%Z 0%Z))%Z /\
  (((ancillas (qft_rev n)) = 0%Z) /\
   (((width (qft_rev n)) = n) /\
    ((forall (x:bitvec), ((length x) = n) ->
      ((path_sem (qft_rev n) (bv_to_ket x)) =
       (infix_asdtdt (pow_inv_sqrt_2 n)
        (ket_sum_l (n_bvs n)
         (fun (y:bitvec) =>
          (infix_asdtdt (qft_rev_coeff x (bv_inversion y) n) (bv_to_ket y)))
     ...
     ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
     ((get (path_sem (qft_rev n) (bv_to_ket x)) i 0%Z) =
      (infix_asdt (pow_inv_sqrt_2 n)
       (qft_rev_coeff x (bv_inversion (int_to_bv i n)) n)))))).

Parameter qft: Z -> circuit.

Axiom qft_def :
  forall (n:Z), (0%Z < n)%Z -> ((qft n) = (reverse (qft_rev n))).

Axiom qft_spec :
  forall (n:Z), (0%Z < n)%Z ->
  ((size (qft n)) <= (polysquare n cont_size 0%Z 0%Z))%Z /\
  (((ancillas (qft n)) = 0%Z) /\
   (((width (qft n)) = n) /\
    forall (x:bitvec), ((length x) = n) ->
    ((path_sem (qft n)
...
Parameter int_qft_coeff: Z -> Z -> Z -> complex.

Axiom int_qft_coeff_def :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_coeff i j n) = (ang_exp (int_to_ang (i * j)%Z n))).

Axiom int_qft_coeff_spec :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((modulus (int_qft_coeff i j n)) = c_one) /\
  ((int_qft_coeff i j n) =
   (int_qft_rev_coeff (-i)%Z
    (int_bit_inversion (int.EuclideanDivision.mod1 j (power_ 2%Z n)) n) n)).

Axiom int_qft_coeff_rev :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_coeff i j n) = (int_qft_coeff j i n)).

Axiom int_qft_coeff_minus_to_right :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_coeff (-i)%Z j n) = (int_qft_coeff i (-j)%Z n)).

Axiom int_qft_coeff_minus_to_left :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_coeff i (-j)%Z n) = (int_qft_coeff (-i)%Z j n)).

Axiom int_qft_coeff_as_real :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_coeff i j n) =
   (ang_exp (real_to_ang (infix_asdt (i_to_c (i * j)%Z) (pow_inv_2 n))))).

Axiom int_qft_coeff_expo :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_coeff i j n) = (cpower (ang_exp (int_to_ang i n)) j)).

Axiom int_qft_coeff_expo_ :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_coeff i j n) = (cpower (ang_exp (int_to_ang j n)) i)).

Axiom int_qft_coeff_as_mod :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((int_qft_coeff i j n) =
   (int_qft_coeff (int.EuclideanDivision.mod1 i (power_ 2%Z n))
    (int.EuclideanDivision.mod1 j (power_ 2%Z n)) n)).
...
Axiom int_qft_rev_coeff_to_qft_coeff :
  ...
  ((0%Z <= j)%Z /\ (j < (power_ 2%Z n))%Z) ->
  ((int_qft_rev_coeff i j n) =
   (int_qft_coeff (int_bit_inversion j n) (-i)%Z n)).

Parameter qft_rev_: Z -> circuit.

Axiom qft_rev__def :
  forall (n:Z), (0%Z < n)%Z -> ((qft_rev_ n) = (qft_rev n)).

Axiom qft_rev__spec :
  forall (n:Z), (0%Z < n)%Z ->
  ((size (qft_rev_ n)) <= (polysquare n cont_size 0%Z 0%Z))%Z /\
  (((ancillas (qft_rev_ n)) = 0%Z) /\
   (((width (qft_rev_ n)) = n) /\
    ((forall (x:bitvec), ((length x) = n) ->
      ((path_sem (qft_rev_ n) (bv_to_ket x)) =
       (infix_asdtdt (pow_inv_sqrt_2 n)
        (ket_sum_l (n_bvs n)
         (fun (y:bitvec) =>
          (infix_asdtdt (int_qft_coeff (-(bv_to_int y))%Z (bv_to_int x) n)
           (bv_to_ket y)))
         n)))) /\
     ((forall (x:bitvec), forall (i:Z), ((length x) = n) ->
       ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
       ((get (path_sem (qft_rev_ n) (bv_to_ket x)) i 0%Z) =
        (infix_asdt (pow_inv_sqrt_2 n)
         (int_qft_coeff (-i)%Z (bv_to_int x) n)))) /\
      forall (x:bitvec), forall (i:Z), ((length x) = n) ->
      ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
      ((get (path_sem (qft_rev_ n) (bv_to_ket x)) i 0%Z) =
       (infix_asdt (pow_inv_sqrt_2 n) (int_qft_coeff i (-(bv_to_int x))%Z n))))))).

Axiom path_sem_rev_qft_unit :
  forall (n:Z), (0%Z < n)%Z -> forall (x:matrix complex), (is_a_ket_l x n) ->
  (is_a_ket_basis_elt x) ->
  ((path_sem (qft_rev n) x) =
   (infix_asdtdt (pow_inv_sqrt_2 n)
    (ket_sum_l (n_bvs n)
     (fun (y:bitvec) =>
      (infix_asdtdt (int_qft_coeff (-(ket_to_int x))%Z (bv_to_int y) n)
       (bv_to_ket y)))
     n))).

Axiom path_sem_rev_qft_unit_int :
  forall (n:Z), (0%Z < n)%Z -> forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((path_sem (qft_rev n) (ket n i)) =
   (infix_asdtdt (pow_inv_sqrt_2 n)
    (ket_sum_l (n_bvs n)
     (fun (y:bitvec) =>
      (infix_asdtdt (int_qft_coeff (-i)%Z (bv_to_int y) n) (bv_to_ket y)))
     n))).
...
Parameter result24: complex -> Z -> Z -> complex.

Axiom result_def24 :
  forall (x:complex) (i:Z) (us:Z),
  ((i = 0%Z) -> ((((result24 x) i) us) = (t_real_part x))) /\
  (~ (i = 0%Z) -> ((((result24 x) i) us) = (t_im_part x))).

(* Why3 assumption *)
Definition complex_as_a_vector (x:complex) : matrix complex :=
  make_f 2%Z 1%Z (result24 x).
...
Axiom non_c_zero_sin_bounded_mod :
  forall (x:complex), (real_ x) ->
  ((infix_lsdt c_zero (modulus x)) /\ (infix_lsdt (modulus x) c_one)) ->
  ~ ((sin (infix_asdt pi x)) = c_zero).

Axiom non_ang_zero_bounded_mod :
  forall (x:complex), (real_ x) ->
  ((infix_lsdt c_zero (modulus x)) /\ (infix_lsdt (modulus x) c_one)) ->
  ~ ((real_to_ang x) = ang_zero).

Axiom non_ang_zero_int_to_ang :
  forall (k:Z) (n:Z),
  ~ ((int.EuclideanDivision.mod1 k (power_ 2%Z n)) = 0%Z) ->
  ~ ((int_to_ang k n) = ang_zero).
...
Parameter apply_qft: Z -> Z -> matrix complex.
...
Axiom apply_qft_spec :
  ...
  ((apply_qft n i) =
   (path_sem (qft n) (ket n (int.EuclideanDivision.mod1 i (power_ 2%Z n))))).

Axiom qft_correct_bv :
  forall (n:Z), (0%Z < n)%Z ->
  correct_path_sum_bv (qft n) n (fun (us:bitvec) (y:bitvec) => y)
  (fun (x:bitvec) (y:bitvec) =>
   (int_to_ang ((bv_to_int x) * (bv_to_int y))%Z n)).
...
Axiom path_sem_qft_pre :
  ...
  ((path_sem (qft n)
    (infix_asdtdt (pow_inv_sqrt_2 n)
     (ket_sum_l (n_bvs n)
      (fun (y:bitvec) =>
       (infix_asdtdt (int_qft_coeff (-(bv_to_int x))%Z (bv_to_int y) n)
        (bv_to_ket y)))
      n)))
   = (bv_to_ket x)).
...
Axiom get_ket_apply_qft :
  forall (n:Z) (i:Z) (j:Z), (0%Z < n)%Z ->
  ((0%Z <= j)%Z /\ (j < (power_ 2%Z n))%Z) ->
  ((get (apply_qft n i) j 0%Z) =
   (infix_asdt (pow_inv_sqrt_2 n) (int_qft_coeff i j n))).
...
Axiom qft_rev_qft_int :
  forall (n:Z) (i:Z), (0%Z < n)%Z ->
  ((path_sem (qft_rev n) (apply_qft n i)) =
   (ket n (int.EuclideanDivision.mod1 i (power_ 2%Z n)))).

Axiom from_qft_basis :
  forall (n:Z) (i:Z), (0%Z < n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((path_sem (qft_rev n) (apply_qft n i)) = (ket n i)).
...
Axiom sem_qft_rev_qft_int :
  forall (n:Z) (i:Z), (0%Z < n)%Z ->
  sem (qft_rev n) (apply_qft n i)
  (ket n (int.EuclideanDivision.mod1 i (power_ 2%Z n))).

Axiom sem_from_qft_basis :
  forall (n:Z) (i:Z), (0%Z < n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  sem (qft_rev n) (apply_qft n i) (ket n i).

Axiom sem_qft_apply_basis :
  forall (n:Z) (i:Z), (0%Z < n)%Z ->
  sem (qft n) (ket n (int.EuclideanDivision.mod1 i (power_ 2%Z n)))
  (apply_qft n i).
...
Axiom to_qft_basis :
  forall (n:Z) (i:Z), (0%Z < n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) -> forall (x:bitvec),
  ((length x) = n) -> ((path_sem (qft n) (ket n i)) = (apply_qft n i)).

Parameter place_qft_zero: Z -> Z -> circuit.

Axiom place_qft_zero_def :
  forall (n:Z) (k:Z), (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((place_qft_zero n k) = (place (qft n) 0%Z (n + k)%Z)).

Axiom place_qft_zero_spec :
  forall (n:Z) (k:Z), (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((width (place_qft_zero n k)) = (n + k)%Z) /\
  (((size (place_qft_zero n k)) <= (polysquare n cont_size 0%Z 0%Z))%Z /\
   (((ancillas (place_qft_zero n k)) = 0%Z) /\
    ((forall (g:Z), forall (y:matrix complex),
      ((0%Z <= g)%Z /\ (g < (power_ 2%Z n))%Z) -> (is_a_ket_l y k) ->
      sem (place_qft_zero n k) (kronecker (ket n g) y)
      (kronecker (apply_qft n g) y)) /\
     ((width (place_qft_zero n k)) = (n + k)%Z)))).

Parameter place_rev_qft_zero: Z -> Z -> circuit.

Axiom place_rev_qft_zero_def :
  forall (n:Z) (k:Z), (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((place_rev_qft_zero n k) = (reverse (place_qft_zero n k))).

Axiom place_rev_qft_zero_spec :
  forall (n:Z) (k:Z), (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((width (place_rev_qft_zero n k)) = (n + k)%Z) /\
  (((size (place_rev_qft_zero n k)) <= (polysquare n cont_size 0%Z 0%Z))%Z /\
   (((ancillas (place_rev_qft_zero n k)) = 0%Z) /\
    forall (g:Z), forall (y:matrix complex),
    ((0%Z <= g)%Z /\ (g < (power_ 2%Z n))%Z) -> (is_a_ket_l y k) ->
    sem (place_rev_qft_zero n k) (kronecker (apply_qft n g) y)
    (kronecker (ket n g) y))).

Parameter place_qft: Z -> Z -> Z -> circuit.

Axiom place_qft_def :
  forall (n:Z) (k:Z) (size_reg:Z), (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((k + n)%Z < size_reg)%Z ->
  ((place_qft n k size_reg) = (place (qft n) k size_reg)).

Axiom place_qft_spec :
  forall (n:Z) (k:Z) (size_reg:Z), (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((k + n)%Z < size_reg)%Z ->
  ((width (place_qft n k size_reg)) = size_reg) /\
  (((size (place_qft n k size_reg)) <= (polysquare n cont_size 0%Z 0%Z))%Z /\
   (((ancillas (place_qft n k size_reg)) = 0%Z) /\
    ((forall (g:Z), forall (y:matrix complex) (z:matrix complex),
      ((0%Z <= g)%Z /\ (g < (power_ 2%Z n))%Z) -> (is_a_ket_l y k) ->
      (is_a_ket_l z ((size_reg - k)%Z - n)%Z) ->
      sem (place_qft n k size_reg) (kronecker y (kronecker (ket n g) z))
      (kronecker y (kronecker (apply_qft n g) z))) /\
     ((width (place_qft n k size_reg)) = size_reg)))).

Parameter place_rev_qft: Z -> Z -> Z -> circuit.

Axiom place_rev_qft_def :
  forall (n:Z) (k:Z) (size_reg:Z), (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((k + n)%Z < size_reg)%Z ->
  ((place_rev_qft n k size_reg) = (reverse (place_qft n k size_reg))).

Axiom place_rev_qft_spec :
  forall (n:Z) (k:Z) (size_reg:Z), (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((k + n)%Z < size_reg)%Z ->
  ((width (place_rev_qft n k size_reg)) = size_reg) /\
  (((size (place_rev_qft n k size_reg)) <=
    (polysquare n cont_size 0%Z 0%Z))%Z /\
   (((ancillas (place_rev_qft n k size_reg)) = 0%Z) /\
    ((forall (g:Z), forall (y:matrix complex) (z:matrix complex),
      ((0%Z <= g)%Z /\ (g < (power_ 2%Z n))%Z) -> (is_a_ket_l y k) ->
      (is_a_ket_l z ((size_reg - k)%Z - n)%Z) ->
      sem (place_rev_qft n k size_reg)
      (kronecker y (kronecker (apply_qft n g) z))
      (kronecker y (kronecker (ket n g) z))) /\
     ((width (place_rev_qft n k size_reg)) = size_reg)))).

Parameter apply_function_in_qft_basis:
  circuit -> Z -> Z -> Z -> (Z -> Z) -> circuit.

Axiom apply_function_in_qft_basis_spec :
  forall (c:circuit) (n:Z) (k:Z) (size_reg:Z) (f:Z -> Z), (0%Z < n)%Z ->
  (0%Z < k)%Z -> ((k + n)%Z < size_reg)%Z -> ((width c) = size_reg) ->
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
   (0%Z <= (f i))%Z /\ ((f i) < (power_ 2%Z n))%Z) ->
  ((size (apply_function_in_qft_basis c n k size_reg f)) <=
   ((polysquare n (cont_size * 2%Z)%Z 0%Z 0%Z) + (size c))%Z)%Z /\
  (((ancillas (apply_function_in_qft_basis c n k size_reg f)) = (ancillas c)) /\
   (((width (apply_function_in_qft_basis c n k size_reg f)) = size_reg) /\
    ((forall (y:matrix complex) (z:matrix complex), forall (i:Z),
      ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) -> (is_a_ket_l y k) ->
      (is_a_ket_l z ((size_reg - n)%Z - k)%Z) ->
      (sem c (kronecker y (kronecker (apply_qft n i) z))
       (kronecker y (kronecker (apply_qft n (f i)) z))) ->
      sem (apply_function_in_qft_basis c n k size_reg f)
      (kronecker y (kronecker (ket n i) z))
      (kronecker y (kronecker (ket n (f i)) z))) /\
     ((apply_function_in_qft_basis c n k size_reg f) =
      (sequence (sequence (place_qft n k size_reg) c)
       (place_rev_qft n k size_reg)))))).

Parameter apply_function_in_qft_basis_zero:
  circuit -> Z -> Z -> (Z -> Z) -> circuit.

Axiom apply_function_in_qft_basis_zero_spec :
  forall (c:circuit) (n:Z) (size_reg:Z) (f:Z -> Z), (0%Z < n)%Z ->
  (n < size_reg)%Z -> ((width c) = size_reg) ->
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
   (0%Z <= (f i))%Z /\ ((f i) < (power_ 2%Z n))%Z) ->
  ((size (apply_function_in_qft_basis_zero c n size_reg f)) <=
   ((polysquare n (cont_size * 2%Z)%Z 0%Z 0%Z) + (size c))%Z)%Z /\
  (((ancillas (apply_function_in_qft_basis_zero c n size_reg f)) =
    (ancillas c)) /\
   (((width (apply_function_in_qft_basis_zero c n size_reg f)) = size_reg) /\
    ((forall (z:matrix complex), forall (i:Z),
      ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
      (is_a_ket_l z (size_reg - n)%Z) ->
      (sem c (kronecker (apply_qft n i) z) (kronecker (apply_qft n (f i)) z)) ->
      sem (apply_function_in_qft_basis_zero c n size_reg f)
      (kronecker (ket n i) z) (kronecker (ket n (f i)) z)) /\
     ((apply_function_in_qft_basis_zero c n size_reg f) =
      (sequence (sequence (place_qft_zero n (size_reg - n)%Z) c)
       (place_rev_qft_zero n (size_reg - n)%Z)))))).

Parameter apply_from_qft_zero: Z -> Z -> circuit -> circuit.

Axiom apply_from_qft_zero_spec :
  forall (n:Z) (k:Z) (c:circuit), (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((width c) = (n + k)%Z) ->
  ((size (apply_from_qft_zero n k c)) <=
   ((polysquare n (cont_size * 2%Z)%Z 0%Z 0%Z) + (size c))%Z)%Z /\
  (((ancillas (apply_from_qft_zero n k c)) = (ancillas c)) /\
   (((width (apply_from_qft_zero n k c)) = (n + k)%Z) /\
    forall (y:matrix complex) (z:matrix complex), forall (i:Z),
    ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) -> (is_a_ket_l y k) ->
    (is_a_ket_l z k) ->
    (sem c (kronecker (ket n i) y) (kronecker (ket n i) z)) ->
    sem (apply_from_qft_zero n k c) (kronecker (apply_qft n i) y)
    (kronecker (apply_qft n i) z))).

Parameter apply_in_qft_zero: Z -> Z -> circuit -> circuit.

Axiom apply_in_qft_zero_spec :
  forall (n:Z) (k:Z) (c:circuit), (0%Z < n)%Z -> (0%Z < k)%Z ->
  ((width c) = (n + k)%Z) ->
  ((size (apply_in_qft_zero n k c)) <=
   ((polysquare n (cont_size * 2%Z)%Z 0%Z 0%Z) + (size c))%Z)%Z /\
  (((ancillas (apply_in_qft_zero n k c)) = (ancillas c)) /\
   (((width (apply_in_qft_zero n k c)) = (n + k)%Z) /\
    forall (y:matrix complex) (z:matrix complex), forall (i:Z),
    ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) -> (is_a_ket_l y k) ->
    (is_a_ket_l z k) ->
    (sem c (kronecker (apply_qft n i) y) (kronecker (apply_qft n i) z)) ->
    sem (apply_in_qft_zero n k c) (kronecker (ket n i) y)
    (kronecker (ket n i) z))).
  ...
  (((size (flat_parallel c c' k1 k2 k3 a1 a2 a3)) = ((size c) + (size c'))%Z) /\
   (((ancillas (flat_parallel c c' k1 k2 k3 a1 a2 a3)) =
    ...
    ((flat (flat_parallel c c' k1 k2 k3 a1 a2 a3) k3 a3) /\
     ((forall (x:bitvec), ((length x) = ((width c) + (width c'))%Z) ->
...
Axiom flat_sequence_spec :
  ...
  (((width (flat_sequence c c' k1 k2 k3 a1 a2 a3)) = (width c)) /\
   (((size (flat_sequence c c' k1 k2 k3 a1 a2 a3)) =
     ((size c) + (size c'))%Z) /\
...
Parameter result25: Z -> bitvec -> Z -> Z.

Axiom result_def25 :
  forall (c:Z) (x:bitvec) (i:Z),
  ((i = c) -> (((result25 c x) i) = (1%Z - ((value x) c))%Z)) /\
  (~ (i = c) -> (((result25 c x) i) = ((value x) i))).

Axiom place_xx_def :
  forall (c:Z) (n:Z), ((0%Z <= c)%Z /\ (c < n)%Z) ->
  ((place_xx c n) =
   (flat_place (sequence (sequence hadamard (rz 1%Z)) hadamard) c n
    (fun (x:bitvec) => (make_bv (result25 c x) n))
    (fun (x:bitvec) =>
     (make_bv (fun (us:Z) => (1%Z - ((value x) 0%Z))%Z) 1%Z))
...
Axiom place_xx_spec :
  ...
  (((size (place_xx c n)) = 3%Z) /\
   (((ancillas (place_xx c n)) = 0%Z) /\ ((width (place_xx c n)) = n))).
  ...
  (((range (repeat_had n)) = n) /\
   (((size (repeat_had n)) = n) /\
    (((ancillas (repeat_had n)) = 0%Z) /\
     ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
       ((0%Z <= i)%Z /\ (i < n)%Z) ->
       ((basis_ket (repeat_had n) x y i) = (y i))) /\
      ((forall (x:Z -> Z) (y:Z -> Z),
...
Axiom path_sem_repeat_had_invol :
  forall (n:Z) (x:matrix complex), (is_a_ket_l x n) -> (1%Z <= n)%Z ->
  ((path_sem (repeat_had n) (path_sem (repeat_had n) x)) = x).
...
Axiom ind_cnot_spec :
  ...
  (((ancillas (ind_cnot c k n)) = 0%Z) /\
   ((flat (ind_cnot c k n) (fc35 c k n) (fun (us:bitvec) => ang_zero)) /\
    ((forall (ket1:matrix complex), (is_a_ket_l ket1 n) ->
     ...
     ((forall (ket1:matrix complex), (is_a_ket_l ket1 n) ->
       ...
       ((path_sem (ind_cnot c k n) ket1) =
        (bv_to_ket (make_bv (fc36 k ket1) n)))) /\
...
Axiom sem_ind_cnot_zero :
  forall (n:Z), (1%Z < n)%Z ->
  (forall (ket1:matrix complex), forall (i:Z),
   (is_a_ket_l ket1 (n - 1%Z)%Z) -> (is_a_ket_basis_elt ket1) ->
   ((0%Z <= i)%Z /\ (i < 2%Z)%Z) -> (((value (ket_to_bv ket1)) 0%Z) = 1%Z) ->
   ((path_sem (ind_cnot 0%Z (n - 1%Z)%Z n) (kronecker ket1 (ket 1%Z i))) =
    (kronecker ket1 (ket 1%Z (1%Z - i)%Z)))) /\
  forall (ket1:matrix complex), forall (i:Z),
  (is_a_ket_l ket1 (n - 1%Z)%Z) -> (is_a_ket_basis_elt ket1) ->
  ((0%Z <= i)%Z /\ (i < 2%Z)%Z) -> (((value (ket_to_bv ket1)) 0%Z) = 0%Z) ->
  ((path_sem (ind_cnot 0%Z (n - 1%Z)%Z n) (kronecker ket1 (ket 1%Z i))) =
   (kronecker ket1 (ket 1%Z i))).
...
Axiom fc_def40 :
  forall (n:Z) (ket1:matrix complex) (i:Z),
  ((i = (n - 1%Z)%Z) ->
   (((fc40 n ket1) i) = (1%Z - ((value (ket_to_bv ket1)) i))%Z)) /\
  (~ (i = (n - 1%Z)%Z) -> (((fc40 n ket1) i) = ((value (ket_to_bv ket1)) i))).
...
Axiom sem_ind_neg_cnot_zero :
  ...
  ((forall (i:Z),
    ...
    ((path_sem (ind_neg_cnot 0%Z n (n + 1%Z)%Z)
     ...
     = (kronecker (ket n i) (ket 1%Z 0%Z)))) /\
   ((forall (ket1:matrix complex), (is_a_ket_l ket1 n) ->
     (is_a_ket_basis_elt ket1) -> (((value (ket_to_bv ket1)) 0%Z) = 1%Z) ->
     ((path_sem (ind_neg_cnot 0%Z n (n + 1%Z)%Z) ket1) = ket1)) /\
    forall (ket1:matrix complex), (is_a_ket_l ket1 n) ->
    (is_a_ket_basis_elt ket1) -> (((value (ket_to_bv ket1)) 0%Z) = 0%Z) ->
    ((path_sem (ind_neg_cnot 0%Z n (n + 1%Z)%Z) ket1) =
     (bv_to_ket (make_bv (fc40 n ket1) n))))).
...
Parameter hpart_ket: (matrix complex) -> Z -> matrix complex.

Axiom hpart_ket_def :
  forall (m:matrix complex) (i:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
  ((hpart_ket m i) =
   (ket i
    (int.EuclideanDivision.div (ket_to_int m)
     (power 2%Z ((ket_length m) - i)%Z)))).

Axiom hpart_ket_spec :
  forall (m:matrix complex) (i:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
  (is_a_ket_basis_elt (hpart_ket m i)) /\
  (((ket_length (hpart_ket m i)) = i) /\
   ((ket_to_int (hpart_ket m i)) =
    (int.EuclideanDivision.div (ket_to_int m)
     (power 2%Z ((ket_length m) - i)%Z)))).
...
Axiom hpart_ket_rows :
  forall (m:matrix complex) (i:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
  ((rows (hpart_ket m i)) = (power 2%Z i)).

Axiom hpart_ket_l :
  forall (m:matrix complex) (i:Z) (j:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) -> (i = j) ->
  is_a_ket_l (hpart_ket m i) j.

Parameter tpart_ket: (matrix complex) -> Z -> matrix complex.

Axiom tpart_ket_def :
  forall (m:matrix complex) (i:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
  ((tpart_ket m i) =
   (ket ((ket_length m) - i)%Z
    (int.EuclideanDivision.mod1 (ket_to_int m)
     (power 2%Z ((ket_length m) - i)%Z)))).

Axiom tpart_ket_spec :
  forall (m:matrix complex) (i:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
  (is_a_ket_basis_elt (tpart_ket m i)) /\
  (((ket_length (tpart_ket m i)) = ((ket_length m) - i)%Z) /\
   ((ket_to_int (tpart_ket m i)) =
    (int.EuclideanDivision.mod1 (ket_to_int m)
     (power 2%Z ((ket_length m) - i)%Z)))).
...
Axiom tpart_ket_l :
  forall (m:matrix complex) (i:Z) (j:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
  (j = ((ket_length m) - i)%Z) -> is_a_ket_l (tpart_ket m i) j.

Axiom tpart_ket_rows :
  forall (m:matrix complex) (i:Z), (is_a_ket_basis_elt m) ->
  ((0%Z <= i)%Z /\ (i <= (ket_length m))%Z) ->
  ((rows (tpart_ket m i)) = (power 2%Z ((ket_length m) - i)%Z)).
...
Axiom cascade_adder__def :
  ...
  ((((n - target)%Z - 1%Z)%Z <= step)%Z /\ (step < n)%Z) ->
  ((length y) = n) ->
  ((step = ((n - target)%Z - 1%Z)%Z) ->
   ((cascade_adder_ target n step y) =
    (przp (((value y) step) * 1%Z)%Z target n))) /\
  (~ (step = ((n - target)%Z - 1%Z)%Z) ->
   ((cascade_adder_ target n step y) =
    (diag_sequence (cascade_adder_ target n (step - 1%Z)%Z y)
     (przp
      (((value y) step) * ((step - ((n - target)%Z - 1%Z)%Z)%Z + 1%Z)%Z)%Z
      target n)
     (fun (x:bitvec) =>
      (ang_sum
       (fun (k:Z) =>
        (int_to_ang
         ((((value y) k) * ((value x) target))%Z *
          (power_ 2%Z (((n - k)%Z - 1%Z)%Z + ((n - target)%Z - 1%Z)%Z)%Z))%Z
         n))
       ((n - target)%Z - 1%Z)%Z ((step - 1%Z)%Z + 1%Z)%Z))
     (fun (x:bitvec) =>
      (int_to_ang
       ((((value y) step) * ((value x) target))%Z *
        (power_ 2%Z (((n - step)%Z - 1%Z)%Z + ((n - target)%Z - 1%Z)%Z)%Z))%Z
       n))
     (fun (x:bitvec) =>
      (ang_sum
       (fun (k:Z) =>
...
Axiom cascade_adder__spec :
  ...
  ((diagonal1 (cascade_adder_ target n step y)
    (fun (x:bitvec) =>
     (ang_sum
      (fun (k:Z) =>
       (int_to_ang
...
Axiom pre_adder_const__spec :
  ...
  (((size (pre_adder_const_ n y)) <= (polysquare n 1%Z 0%Z 0%Z))%Z /\
   (((width (pre_adder_const_ n y)) = n) /\
    ((diagonal1 (pre_adder_const_ n y)
      (fun (x:bitvec) =>
       (ang_sum
        (fun (target:Z) =>
         (ang_sum
        ...
        0%Z n))) /\
     ((diagonal1 (pre_adder_const_ n y)
       (fun (x:bitvec) => (int_to_ang ((bv_to_int x) * (bv_to_int y))%Z n))) /\
      forall (x:bitvec), ((length x) = n) ->
      ((path_sem (pre_adder_const_ n y) (bv_to_ket x)) =
       (infix_asdtdt (int_qft_coeff (bv_to_int y) (bv_to_int x) n)
        (bv_to_ket x))))))).

Parameter pre_adder_const_apply: Z -> Z -> Z -> matrix complex.
...
Axiom pre_adder_const_add :
  forall (n:Z) (j:Z), (0%Z < n)%Z ->
  ((0%Z <= j)%Z /\ (j < (power_ 2%Z n))%Z) -> forall (i:Z),
  ((path_sem (pre_adder_const_ n (int_to_bv j n)) (apply_qft n i)) =
   (apply_qft n (i + j)%Z)).

Parameter add_in_qft: Z -> Z -> circuit.

Axiom add_in_qft_def :
  forall (added:Z) (n:Z), (0%Z < n)%Z ->
  ((add_in_qft added n) =
   (pre_adder_const_ (n + 1%Z)%Z
    (int_to_bv (int.EuclideanDivision.mod1 added (power_ 2%Z (n + 1%Z)%Z))
     (n + 1%Z)%Z))).

Axiom add_in_qft_spec :
  forall (added:Z) (n:Z), (0%Z < n)%Z ->
  ((width (add_in_qft added n)) = (n + 1%Z)%Z) /\
  (((ancillas (add_in_qft added n)) = 0%Z) /\
   (((size (add_in_qft added n)) <= (polysquare (n + 1%Z)%Z 1%Z 0%Z 0%Z))%Z /\
    ((forall (b:Z),
      sem (add_in_qft added n) (apply_qft (n + 1%Z)%Z b)
      (apply_qft (n + 1%Z)%Z (added + b)%Z)) /\
     ((width (add_in_qft added n)) = (n + 1%Z)%Z)))).

Parameter place_add_in_qft: Z -> Z -> Z -> circuit.

Axiom place_add_in_qft_def :
  forall (added:Z) (n:Z) (k:Z), (0%Z < k)%Z -> (0%Z < n)%Z ->
  ((place_add_in_qft added n k) =
   (place (add_in_qft added n) 0%Z ((n + 1%Z)%Z + k)%Z)).

Axiom place_add_in_qft_spec :
  forall (added:Z) (n:Z) (k:Z), (0%Z < k)%Z -> (0%Z < n)%Z ->
  ((width (place_add_in_qft added n k)) = ((n + 1%Z)%Z + k)%Z) /\
  (((ancillas (place_add_in_qft added n k)) = 0%Z) /\
   (((size (place_add_in_qft added n k)) <=
     (polysquare (n + 1%Z)%Z 1%Z 0%Z 0%Z))%Z /\
    ((forall (b:Z), forall (y:matrix complex), (is_a_ket_l y k) ->
      sem (place_add_in_qft added n k)
      (kronecker (apply_qft (n + 1%Z)%Z b) y)
      (kronecker (apply_qft (n + 1%Z)%Z (b + added)%Z) y)) /\
     ((width (place_add_in_qft added n k)) = ((n + 1%Z)%Z + k)%Z)))).

Parameter place_substract_in_qft: Z -> Z -> Z -> circuit.

Axiom place_substract_in_qft_def :
  forall (substracted:Z) (n:Z) (k:Z), (0%Z < k)%Z -> (0%Z < n)%Z ->
  ((place_substract_in_qft substracted n k) =
   (reverse (place_add_in_qft substracted n k))).

Axiom place_substract_in_qft_spec :
  forall (substracted:Z) (n:Z) (k:Z), (0%Z < k)%Z -> (0%Z < n)%Z ->
  ((width (place_substract_in_qft substracted n k)) = ((n + 1%Z)%Z + k)%Z) /\
  (((ancillas (place_substract_in_qft substracted n k)) = 0%Z) /\
   (((size (place_substract_in_qft substracted n k)) <=
     (polysquare (n + 1%Z)%Z 1%Z 0%Z 0%Z))%Z /\
    ((forall (b:Z), forall (y:matrix complex), (is_a_ket_l y k) ->
      (is_a_ket_l y 1%Z) ->
      sem (place_substract_in_qft substracted n k)
      (kronecker (apply_qft (n + 1%Z)%Z b) y)
      (kronecker (apply_qft (n + 1%Z)%Z (b - substracted)%Z) y)) /\
     ((width (place_substract_in_qft substracted n k)) = ((n + 1%Z)%Z + k)%Z)))).

Parameter place_add_in_comput_basis: Z -> Z -> Z -> circuit.

Axiom place_add_in_comput_basis_def :
  forall (added:Z) (n:Z) (size_reg:Z), (0%Z < n)%Z ->
  ((n + 1%Z)%Z < size_reg)%Z ->
  ((place_add_in_comput_basis added n size_reg) =
   (apply_function_in_qft_basis_zero
    (place_add_in_qft added n ((size_reg - n)%Z - 1%Z)%Z) (n + 1%Z)%Z
    size_reg
    (fun (i:Z) =>
     (int.EuclideanDivision.mod1 (i + added)%Z (power_ 2%Z (n + 1%Z)%Z))))).

Axiom place_add_in_comput_basis_spec :
  forall (added:Z) (n:Z) (size_reg:Z), (0%Z < n)%Z ->
  ((n + 1%Z)%Z < size_reg)%Z ->
  ((width (place_add_in_comput_basis added n size_reg)) = size_reg) /\
  (((ancillas (place_add_in_comput_basis added n size_reg)) = 0%Z) /\
   (((size (place_add_in_comput_basis added n size_reg)) <=
     (polysquare (n + 1%Z)%Z ((cont_size * 2%Z)%Z + 1%Z)%Z 0%Z 0%Z))%Z /\
    ((forall (b:Z), forall (z:matrix complex),
      ((0%Z <= b)%Z /\ (b < (power_ 2%Z (n + 1%Z)%Z))%Z) ->
      (is_a_ket_l z ((size_reg - n)%Z - 1%Z)%Z) ->
      sem (place_add_in_comput_basis added n size_reg)
      (kronecker (ket (n + 1%Z)%Z b) z)
      (kronecker
       (ket (n + 1%Z)%Z
        (int.EuclideanDivision.mod1 (b + added)%Z (power_ 2%Z (n + 1%Z)%Z)))
       z)) /\
     ((width (place_add_in_comput_basis added n size_reg)) = size_reg)))).

Parameter place_substract_in_comput_basis: Z -> Z -> Z -> circuit.

Axiom place_substract_in_comput_basis_def :
  forall (substracted:Z) (n:Z) (size_reg:Z), (0%Z < n)%Z ->
  ((n + 1%Z)%Z < size_reg)%Z ->
  ((place_substract_in_comput_basis substracted n size_reg) =
   (place_add_in_comput_basis (-substracted)%Z n size_reg)).

Axiom place_substract_in_comput_basis_spec :
  forall (substracted:Z) (n:Z) (size_reg:Z), (0%Z < n)%Z ->
  ((n + 1%Z)%Z < size_reg)%Z ->
  ((width (place_substract_in_comput_basis substracted n size_reg)) =
   size_reg) /\
  (((ancillas (place_substract_in_comput_basis substracted n size_reg)) =
    0%Z) /\
   (((size (place_substract_in_comput_basis substracted n size_reg)) <=
     (polysquare (n + 1%Z)%Z ((cont_size * 2%Z)%Z + 1%Z)%Z 0%Z 0%Z))%Z /\
    ((forall (b:Z), forall (z:matrix complex),
      ((0%Z <= b)%Z /\ (b < (power_ 2%Z (n + 1%Z)%Z))%Z) ->
      (is_a_ket_l z ((size_reg - n)%Z - 1%Z)%Z) ->
      sem (place_substract_in_comput_basis substracted n size_reg)
      (kronecker (ket (n + 1%Z)%Z b) z)
      (kronecker
       (ket (n + 1%Z)%Z
        (int.EuclideanDivision.mod1 (b - substracted)%Z
         (power_ 2%Z (n + 1%Z)%Z)))
       z)) /\
     ((width (place_substract_in_comput_basis substracted n size_reg)) =
      size_reg)))).

Parameter cont_add_in_qft: Z -> Z -> Z -> circuit.

Axiom cont_add_in_qft_def :
  forall (added:Z) (n:Z) (k:Z), (0%Z < n)%Z ->
  ((0%Z <= added)%Z /\ (added < (power_ 2%Z n))%Z) ->
  ((cont_add_in_qft added n k) = (cont_last_qbit (add_in_qft added n))).

Axiom cont_add_in_qft_spec :
  forall (added:Z) (n:Z) (k:Z), (0%Z < n)%Z ->
  ((0%Z <= added)%Z /\ (added < (power_ 2%Z n))%Z) ->
  ((width (cont_add_in_qft added n k)) = (n + 2%Z)%Z) /\
  (((ancillas (cont_add_in_qft added n k)) = 0%Z) /\
   (((size (cont_add_in_qft added n k)) <=
     (polysquare (n + 1%Z)%Z cont_size 0%Z 0%Z))%Z /\
    ((forall (b:Z),
      sem (cont_add_in_qft added n k)
      (kronecker (apply_qft (n + 1%Z)%Z b) (ket 1%Z 0%Z))
      (kronecker (apply_qft (n + 1%Z)%Z b) (ket 1%Z 0%Z))) /\
     ((forall (b:Z),
       sem (cont_add_in_qft added n k)
       (kronecker (apply_qft (n + 1%Z)%Z b) (ket 1%Z 1%Z))
       (kronecker (apply_qft (n + 1%Z)%Z (added + b)%Z) (ket 1%Z 1%Z))) /\
      ((width (cont_add_in_qft added n k)) = (n + 2%Z)%Z))))).

Parameter check_first_bit_is_one: Z -> circuit.

Axiom check_first_bit_is_one_def :
  forall (n:Z), (0%Z < n)%Z ->
  ((check_first_bit_is_one n) = (ind_cnot 0%Z (n + 1%Z)%Z (n + 2%Z)%Z)).

Axiom check_first_bit_is_one_spec :
  forall (n:Z), (0%Z < n)%Z ->
  ((size (check_first_bit_is_one n)) <= (cont_size * 3%Z)%Z)%Z /\
  (((ancillas (check_first_bit_is_one n)) = 0%Z) /\
   (((width (check_first_bit_is_one n)) = (n + 2%Z)%Z) /\
    ((forall (g:Z), ((0%Z <= g)%Z /\ (g < (power_ 2%Z n))%Z) ->
      sem (check_first_bit_is_one n)
      (kronecker (ket (n + 1%Z)%Z g) (ket 1%Z 0%Z))
      (kronecker (ket (n + 1%Z)%Z g) (ket 1%Z 0%Z))) /\
     forall (g:Z),
     (((power_ 2%Z n) <= g)%Z /\ (g < (power_ 2%Z (n + 1%Z)%Z))%Z) ->
     sem (check_first_bit_is_one n)
     (kronecker (ket (n + 1%Z)%Z g) (ket 1%Z 0%Z))
     (kronecker (ket (n + 1%Z)%Z g) (ket 1%Z 1%Z))))).

Parameter uncheck_first_bit_is_zero: Z -> circuit.

Axiom uncheck_first_bit_is_zero_def :
  forall (n:Z), (0%Z < n)%Z ->
  ((uncheck_first_bit_is_zero n) =
   (ind_neg_cnot 0%Z (n + 1%Z)%Z (n + 2%Z)%Z)).

Axiom uncheck_first_bit_is_zero_spec :
  forall (n:Z), (0%Z < n)%Z ->
  ((size (uncheck_first_bit_is_zero n)) <= ((cont_size * 3%Z)%Z + 6%Z)%Z)%Z /\
  (((ancillas (uncheck_first_bit_is_zero n)) = 0%Z) /\
   (((width (uncheck_first_bit_is_zero n)) = (n + 2%Z)%Z) /\
    ((forall (g:Z), ((0%Z <= g)%Z /\ (g < (power_ 2%Z n))%Z) ->
      sem (uncheck_first_bit_is_zero n)
      (kronecker (ket (n + 1%Z)%Z g) (ket 1%Z 1%Z))
      (kronecker (ket (n + 1%Z)%Z g) (ket 1%Z 0%Z))) /\
     forall (g:Z),
     (((power_ 2%Z n) <= g)%Z /\ (g < (power_ 2%Z (n + 1%Z)%Z))%Z) ->
...
Parameter check_first_bit_is_one_from_qft: Z -> circuit.

Axiom check_first_bit_is_one_from_qft_def :
  forall (n:Z), (0%Z < n)%Z ->
  ((check_first_bit_is_one_from_qft n) =
   (apply_from_qft_zero (n + 1%Z)%Z 1%Z (check_first_bit_is_one n))).

Axiom check_first_bit_is_one_from_qft_spec :
  forall (n:Z), (0%Z < n)%Z ->
  ((size (check_first_bit_is_one_from_qft n)) <=
   (polysquare (n + 1%Z)%Z (cont_size * 2%Z)%Z 0%Z
    ((cont_size * 3%Z)%Z + 6%Z)%Z))%Z /\
  (((ancillas (check_first_bit_is_one_from_qft n)) = 0%Z) /\
   (((width (check_first_bit_is_one_from_qft n)) = (n + 2%Z)%Z) /\
    ((forall (g:Z), ((0%Z <= g)%Z /\ (g < (power_ 2%Z n))%Z) ->
      sem (check_first_bit_is_one_from_qft n)
...
Parameter uncheck_first_bit_is_zero_from_qft: Z -> circuit.

Axiom uncheck_first_bit_is_zero_from_qft_def :
  forall (n:Z), (0%Z < n)%Z ->
  ((uncheck_first_bit_is_zero_from_qft n) =
   (apply_from_qft_zero (n + 1%Z)%Z 1%Z (uncheck_first_bit_is_zero n))).

Axiom uncheck_first_bit_is_zero_from_qft_spec :
  forall (n:Z), (0%Z < n)%Z ->
  ((size (uncheck_first_bit_is_zero_from_qft n)) <=
   (polysquare (n + 1%Z)%Z (cont_size * 2%Z)%Z 0%Z
    ((cont_size * 3%Z)%Z + 6%Z)%Z))%Z /\
  (((ancillas (uncheck_first_bit_is_zero_from_qft n)) = 0%Z) /\
   (((width (uncheck_first_bit_is_zero_from_qft n)) = (n + 2%Z)%Z) /\
    ((forall (g:Z), ((0%Z <= g)%Z /\ (g < (power_ 2%Z n))%Z) ->
      sem (uncheck_first_bit_is_zero_from_qft n)
      (kronecker (apply_qft (n + 1%Z)%Z g) (ket 1%Z 1%Z))
      (kronecker (apply_qft (n + 1%Z)%Z g) (ket 1%Z 0%Z))) /\
     forall (g:Z),
     (((power_ 2%Z n) <= g)%Z /\ (g < (power_ 2%Z (n + 1%Z)%Z))%Z) ->
...
Parameter substract_and_check: Z -> Z -> Z -> circuit.

Axiom substract_and_check_def :
  forall (n:Z) (bound:Z) (value1:Z), (0%Z < n)%Z ->
  ((0%Z <= value1)%Z /\ (value1 < (2%Z * bound)%Z)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((substract_and_check n bound value1) =
   (sequence (place_substract_in_qft bound n 1%Z)
    (check_first_bit_is_one_from_qft n))).

Axiom substract_and_check_spec :
  forall (n:Z) (bound:Z) (value1:Z), (0%Z < n)%Z ->
  ((0%Z <= value1)%Z /\ (value1 < (2%Z * bound)%Z)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((ancillas (substract_and_check n bound value1)) = 0%Z) /\
  (((width (substract_and_check n bound value1)) = (n + 2%Z)%Z) /\
   (((size (substract_and_check n bound value1)) <=
     (polysquare (n + 1%Z)%Z ((cont_size * 2%Z)%Z + 1%Z)%Z 0%Z
      ((cont_size * 3%Z)%Z + 6%Z)%Z))%Z /\
    (((value1 < bound)%Z ->
      sem (substract_and_check n bound value1)
      (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))
      (kronecker (apply_qft (n + 1%Z)%Z (value1 - bound)%Z) (ket 1%Z 1%Z))) /\
     ((bound <= value1)%Z ->
      sem (substract_and_check n bound value1)
      (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))
      (kronecker (apply_qft (n + 1%Z)%Z (value1 - bound)%Z) (ket 1%Z 0%Z)))))).

Parameter reduces_to_modulo_pre: Z -> Z -> Z -> circuit.

Axiom reduces_to_modulo_pre_def :
  forall (n:Z) (bound:Z) (value1:Z), (0%Z < n)%Z ->
  ((0%Z <= value1)%Z /\ (value1 < (2%Z * bound)%Z)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((reduces_to_modulo_pre n bound value1) =
   (sequence (substract_and_check n bound value1)
    (cont_add_in_qft bound n 1%Z))).

Axiom reduces_to_modulo_pre_spec :
  forall (n:Z) (bound:Z) (value1:Z), (0%Z < n)%Z ->
  ((0%Z <= value1)%Z /\ (value1 < (2%Z * bound)%Z)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((ancillas (reduces_to_modulo_pre n bound value1)) = 0%Z) /\
  (((width (reduces_to_modulo_pre n bound value1)) = (n + 2%Z)%Z) /\
   (((size (reduces_to_modulo_pre n bound value1)) <=
     (polysquare (n + 1%Z)%Z ((cont_size * 3%Z)%Z + 1%Z)%Z 0%Z
      ((cont_size * 3%Z)%Z + 6%Z)%Z))%Z /\
    (((value1 < bound)%Z ->
      sem (reduces_to_modulo_pre n bound value1)
      (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))
      (kronecker
       (apply_qft (n + 1%Z)%Z (int.EuclideanDivision.mod1 value1 bound))
       (ket 1%Z 1%Z))) /\
     (((bound <= value1)%Z ->
       sem (reduces_to_modulo_pre n bound value1)
       (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))
       (kronecker
        ...
        (ket 1%Z 0%Z))) /\
      forall (value':Z),
      ((0%Z <= value')%Z /\ (value' < (2%Z * bound)%Z)%Z) ->
      ((reduces_to_modulo_pre n bound value1) =
       (sequence (substract_and_check n bound value')
        (cont_add_in_qft bound n 1%Z))))))).

Parameter add_modulo_pre: Z -> Z -> Z -> Z -> circuit.

Axiom add_modulo_pre_def :
  forall (n:Z) (bound:Z) (added:Z) (value1:Z), (0%Z < n)%Z ->
  ((0%Z <= added)%Z /\ (added < bound)%Z) ->
  ((0%Z <= value1)%Z /\ (value1 < bound)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((add_modulo_pre n bound added value1) =
   (sequence (place_add_in_qft added n 1%Z)
    (reduces_to_modulo_pre n bound (value1 + added)%Z))).

Axiom add_modulo_pre_spec :
  forall (n:Z) (bound:Z) (added:Z) (value1:Z), (0%Z < n)%Z ->
  ((0%Z <= added)%Z /\ (added < bound)%Z) ->
  ((0%Z <= value1)%Z /\ (value1 < bound)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((ancillas (add_modulo_pre n bound added value1)) = 0%Z) /\
  (((width (add_modulo_pre n bound added value1)) = (n + 2%Z)%Z) /\
   (((size (add_modulo_pre n bound added value1)) <=
     (polysquare (n + 1%Z)%Z ((cont_size * 3%Z)%Z + 2%Z)%Z 0%Z
      ((cont_size * 3%Z)%Z + 6%Z)%Z))%Z /\
    ((((value1 + added)%Z < bound)%Z ->
      sem (add_modulo_pre n bound added value1)
      (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))
      (kronecker
       (apply_qft (n + 1%Z)%Z
        (int.EuclideanDivision.mod1 (added + value1)%Z bound))
       (ket 1%Z 1%Z))) /\
     (((bound <= (value1 + added)%Z)%Z ->
       sem (add_modulo_pre n bound added value1)
       (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))
       (kronecker
        (apply_qft (n + 1%Z)%Z
         (int.EuclideanDivision.mod1 (added + value1)%Z bound))
        (ket 1%Z 0%Z))) /\
      forall (value':Z), ((0%Z <= value')%Z /\ (value' < bound)%Z) ->
      ((add_modulo_pre n bound added value1) =
       (sequence (place_add_in_qft added n 1%Z)
        (reduces_to_modulo_pre n bound (value' + added)%Z))))))).

Parameter substract_and_uncheck: Z -> Z -> Z -> circuit.

Axiom substract_and_uncheck_def :
  forall (n:Z) (substracted:Z) (value1:Z), (0%Z < n)%Z ->
  ((0%Z <= value1)%Z /\ (value1 < (power_ 2%Z n))%Z) ->
  ((0%Z <= substracted)%Z /\ (substracted < (power_ 2%Z n))%Z) ->
  ((substract_and_uncheck n substracted value1) =
   (sequence (place_substract_in_qft substracted n 1%Z)
    (uncheck_first_bit_is_zero_from_qft n))).

Axiom substract_and_uncheck_spec :
  forall (n:Z) (substracted:Z) (value1:Z), (0%Z < n)%Z ->
  ((0%Z <= value1)%Z /\ (value1 < (power_ 2%Z n))%Z) ->
  ((0%Z <= substracted)%Z /\ (substracted < (power_ 2%Z n))%Z) ->
  ((ancillas (substract_and_uncheck n substracted value1)) = 0%Z) /\
  (((width (substract_and_uncheck n substracted value1)) = (n + 2%Z)%Z) /\
   (((size (substract_and_uncheck n substracted value1)) <=
     (polysquare (n + 1%Z)%Z ((cont_size * 2%Z)%Z + 1%Z)%Z 0%Z
      ((cont_size * 3%Z)%Z + 6%Z)%Z))%Z /\
    (((value1 < substracted)%Z ->
      sem (substract_and_uncheck n substracted value1)
      (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))
      (kronecker (apply_qft (n + 1%Z)%Z (value1 - substracted)%Z)
       (ket 1%Z 0%Z))) /\
     ((substracted <= value1)%Z ->
      sem (substract_and_uncheck n substracted value1)
      (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 1%Z))
      (kronecker (apply_qft (n + 1%Z)%Z (value1 - substracted)%Z)
       (ket 1%Z 0%Z)))))).

Parameter uncheck_modulo: Z -> Z -> Z -> circuit.

Axiom uncheck_modulo_def :
  forall (n:Z) (substracted:Z) (value1:Z), (0%Z < n)%Z ->
  ((0%Z <= value1)%Z /\ (value1 < (power_ 2%Z n))%Z) ->
  ((0%Z <= substracted)%Z /\ (substracted < (power_ 2%Z n))%Z) ->
  ((uncheck_modulo n substracted value1) =
   (sequence (substract_and_uncheck n substracted value1)
    (place_add_in_qft substracted n 1%Z))).

Axiom uncheck_modulo_spec :
  forall (n:Z) (substracted:Z) (value1:Z), (0%Z < n)%Z ->
  ((0%Z <= value1)%Z /\ (value1 < (power_ 2%Z n))%Z) ->
  ((0%Z <= substracted)%Z /\ (substracted < (power_ 2%Z n))%Z) ->
  ((ancillas (uncheck_modulo n substracted value1)) = 0%Z) /\
  (((width (uncheck_modulo n substracted value1)) = (n + 2%Z)%Z) /\
   (((size (uncheck_modulo n substracted value1)) <=
     (polysquare (n + 1%Z)%Z ((cont_size * 2%Z)%Z + 2%Z)%Z 0%Z
      ((cont_size * 3%Z)%Z + 6%Z)%Z))%Z /\
    (((value1 < substracted)%Z ->
      sem (uncheck_modulo n substracted value1)
      (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))
      (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))) /\
     (((substracted <= value1)%Z ->
       sem (uncheck_modulo n substracted value1)
       ...
       (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))) /\
      forall (value':Z),
      ((0%Z <= value')%Z /\ (value' < (power_ 2%Z n))%Z) ->
      ((uncheck_modulo n substracted value1) =
       (sequence (substract_and_uncheck n substracted value')
        (place_add_in_qft substracted n 1%Z))))))).
...
Axiom modular_adder__def :
  ...
  ((0%Z <= value1)%Z /\ (value1 < bound)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((modular_adder_ n bound added value1) =
   (sequence (add_modulo_pre n bound added value1)
    (uncheck_modulo n added
     (int.EuclideanDivision.mod1 (value1 + added)%Z bound)))).
...
Axiom modular_adder__spec :
  ...
  ((0%Z <= value1)%Z /\ (value1 < bound)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((ancillas (modular_adder_ n bound added value1)) = 0%Z) /\
  (((width (modular_adder_ n bound added value1)) = (n + 2%Z)%Z) /\
   (((size (modular_adder_ n bound added value1)) <=
     (polysquare (n + 1%Z)%Z ((cont_size * 5%Z)%Z + 4%Z)%Z 0%Z
      ((cont_size * 6%Z)%Z + 12%Z)%Z))%Z /\
    ((sem (modular_adder_ n bound added value1)
      (kronecker (apply_qft (n + 1%Z)%Z value1) (ket 1%Z 0%Z))
      (kronecker
       (apply_qft (n + 1%Z)%Z
        (int.EuclideanDivision.mod1 (added + value1)%Z bound))
     ...
     forall (value':Z), ((0%Z <= value')%Z /\ (value' < bound)%Z) ->
     ((modular_adder_ n bound added value1) =
      (sequence (add_modulo_pre n bound added value')
       (uncheck_modulo n added
        (int.EuclideanDivision.mod1 (value' + added)%Z bound))))))).

Parameter modular_adder: Z -> Z -> Z -> circuit.

Axiom modular_adder_def :
  forall (added:Z) (bound:Z) (n:Z), (0%Z < n)%Z ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((modular_adder added bound n) =
   (modular_adder_ n bound (int.EuclideanDivision.mod1 added bound) 0%Z)).

Axiom modular_adder_spec :
  forall (added:Z) (bound:Z) (n:Z), (0%Z < n)%Z ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((size (modular_adder added bound n)) <=
   (polysquare (n + 1%Z)%Z ((5%Z * cont_size)%Z + 4%Z)%Z 0%Z
    ((6%Z * cont_size)%Z + 12%Z)%Z))%Z /\
  (((ancillas (modular_adder added bound n)) = 0%Z) /\
   (((width (modular_adder added bound n)) = (n + 2%Z)%Z) /\
    ((forall (value1:Z), ((0%Z <= value1)%Z /\ (value1 < bound)%Z) ->
      ((modular_adder added bound n) =
       (modular_adder_ n bound (int.EuclideanDivision.mod1 added bound)
        value1))) /\
     ((forall (b:Z), ((0%Z <= b)%Z /\ (b < bound)%Z) ->
       sem (modular_adder added bound n)
       (kronecker (apply_qft (n + 1%Z)%Z b) (ket 1%Z 0%Z))
       (kronecker
        (apply_qft (n + 1%Z)%Z
         (int.EuclideanDivision.mod1 (added + b)%Z bound))
        (ket 1%Z 0%Z))) /\
      forall (b:Z),
      sem (modular_adder added bound n)
      (kronecker (apply_qft (n + 1%Z)%Z (int.EuclideanDivision.mod1 b bound))
       (ket 1%Z 0%Z))
      (kronecker
       (apply_qft (n + 1%Z)%Z
        (int.EuclideanDivision.mod1 (added + b)%Z bound))
...
Axiom adder_gate_bound_def :
  ...
  ((adder_gate_bound n) =
   (polysquare (n + 1%Z)%Z ((5%Z * cont_size)%Z + 4%Z)%Z 0%Z
    ((6%Z * cont_size)%Z + 12%Z)%Z)).

Axiom adder_gate_bound_spec :
  forall (n:Z), (0%Z < n)%Z ->
  (0%Z <= (adder_gate_bound n))%Z /\
  forall (added:Z) (bound:Z),
  (((power_ 2%Z (n - 1%Z)%Z) < bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((0%Z <= added)%Z /\ (added < bound)%Z) ->
  ((size (modular_adder added bound n)) <= (adder_gate_bound n))%Z.

Parameter divisors: Z -> set Z.

Parameter result29: Z -> Z -> bool.
...
Axiom divisors_def :
  forall (i:Z), (0%Z < i)%Z ->
  ((divisors i) = (my_filter (to_fset 1%Z (i + 1%Z)%Z) (result29 i))).
...
Axiom get_mem_divisors_inf :
  forall (j:Z) (i:Z), (0%Z < i)%Z -> (mem j (divisors i)) -> (j <= i)%Z.
...
Parameter result30: Z -> Z -> Z -> bool.

Axiom result_def30 :
  forall (a:Z) (b:Z) (i:Z),
  (((result30 a b) i) = true) <-> (mem (power_ b i) (divisors a)).

Axiom prime_factors_def :
  forall (a:Z) (b:Z), (1%Z <= a)%Z ->
  (((1%Z < b)%Z /\ (prime b)) ->
   ((prime_factors a b) =
    (max_filter (to_fset 0%Z (a + 1%Z)%Z) (result30 a b)))) /\
...
Axiom divisors_euclid_lemma_co_prime_itself :
  forall (a:Z) (b:Z) (c:Z), (0%Z < a)%Z -> (0%Z < b)%Z -> (0%Z < c)%Z ->
  (mem c (divisors (a * b)%Z)) -> (co_prime b c) -> mem c (divisors a).

Axiom euclid_lemma_co_prime :
  forall (a:Z) (b:Z) (c:Z), (0%Z < a)%Z -> (0%Z < b)%Z -> (0%Z < c)%Z ->
  (co_prime b c) -> (co_prime a c) -> co_prime (a * b)%Z c.
...
Axiom co_primes_spec :
  forall (i:Z), (0%Z < i)%Z ->
  ((1%Z < i)%Z -> mem 1%Z (co_primes i)) /\
  (((1%Z < i)%Z -> mem (cardinal (co_primes i)) (to_fset 1%Z i)) /\
...
Axiom co_prime_iproduct :
  forall (s:set Z) (f:Z -> Z) (bound:Z), (0%Z < bound)%Z ->
  (forall (e:Z), (mem e s) -> (0%Z < (f e))%Z) ->
  (forall (e:Z), (mem e s) -> co_prime (f e) bound) ->
  co_prime (iproduct s f) bound.
...
Axiom euler_phi_spec :
  forall (i:Z), (0%Z < i)%Z -> (1%Z < i)%Z ->
  mem (euler_phi i) (to_fset 1%Z i).

Axiom injec_mult_mod_pre :
  forall (a:Z) (i:Z) (i':Z) (bound:Z), (co_prime a bound) ->
  ((0%Z <= i)%Z /\ ((i < i')%Z /\ (i' < bound)%Z)) ->
...
Axiom co_prime_mod_mult :
  forall (a:Z) (e:Z) (bound:Z), (0%Z < a)%Z -> (0%Z < e)%Z ->
  (1%Z < bound)%Z -> (co_prime a bound) -> (co_prime e bound) ->
  co_prime (int.EuclideanDivision.mod1 (a * e)%Z bound) bound.

Axiom set_injec_mult_mod :
  forall (a:Z) (bound:Z), (1%Z < bound)%Z -> (co_prime a bound) ->
  (p_bijective (fun (i:Z) => (int.EuclideanDivision.mod1 (a * i)%Z bound))
   (co_primes bound) (co_primes bound)) /\
  ((map (fun (i:Z) => (int.EuclideanDivision.mod1 (a * i)%Z bound))
    (co_primes bound))
   = (co_primes bound)).

Axiom injec_mult_mod_rev :
  forall (a:Z) (i:Z) (i':Z) (bound:Z), (1%Z < bound)%Z ->
  (co_prime a bound) -> ((0%Z <= i)%Z /\ (i < bound)%Z) ->
  ((0%Z <= i')%Z /\ (i' < bound)%Z) ->
  ((int.EuclideanDivision.mod1 (i * a)%Z bound) =
   (int.EuclideanDivision.mod1 (i' * a)%Z bound)) ->
  (i = i').
...
Axiom bezout_set_spec :
  ...
  ((mem (min_set (bezout_set pick bound)) (divisors bound)) /\
   ((0%Z < (cardinal (bezout_set pick bound)))%Z /\
    (((0%Z <= (min_set (bezout_set pick bound)))%Z /\
      ((min_set (bezout_set pick bound)) <= pick)%Z) /\
     ((0%Z <= (min_set (bezout_set pick bound)))%Z /\
      ((min_set (bezout_set pick bound)) < bound)%Z)))).

Axiom euler_theorem :
  forall (pick:Z) (bound:Z), ((0%Z < pick)%Z /\ (pick < bound)%Z) ->
  (co_prime pick bound) ->
  ((int.EuclideanDivision.mod1 (power_ pick (euler_phi bound)) bound) = 1%Z).

Parameter modular_inverse: Z -> Z -> Z.

Parameter result31: Z -> Z -> Z -> bool.

Axiom result_def31 :
  forall (pick:Z) (bound:Z) (i:Z),
  (((result31 pick bound) i) = true) <->
...
Axiom modular_inverse_def :
  ...
  ((modular_inverse pick bound) =
   (min_filter (to_fset 0%Z bound) (result31 pick bound))).
...
Parameter result32: Z -> Z -> Z -> bool.

Axiom result_def32 :
  forall (pick:Z) (bound:Z) (i:Z),
  (((result32 pick bound) i) = true) <->
  ((int.EuclideanDivision.mod1 (power_ pick i) bound) = 1%Z).

Axiom multi_order_def :
  forall (pick:Z) (bound:Z), (co_prime pick bound) ->
  ((0%Z < pick)%Z /\ (pick < bound)%Z) ->
  ((multi_order pick bound) =
   (min_filter (to_fset 1%Z bound) (result32 pick bound))).
...
Axiom modular_expo :
  forall (a:Z) (k:Z) (bound:Z) (i:Z), (0%Z <= i)%Z ->
  ((0%Z < a)%Z /\ (a < bound)%Z) -> (0%Z <= k)%Z -> (co_prime a bound) ->
  (2%Z <= bound)%Z ->
...
Axiom modular_expo_gen :
  forall (a:Z) (bound:Z), ((0%Z < a)%Z /\ (a < bound)%Z) ->
  (co_prime a bound) -> forall (i:Z) (k:Z), (0%Z <= i)%Z -> (0%Z <= k)%Z ->
  ((int.EuclideanDivision.mod1 (power_ a i) bound) =
   (int.EuclideanDivision.mod1
    (power_ a ((k * (multi_order a bound))%Z + i)%Z) bound)).

Axiom modular_expo_rev :
  forall (a:Z) (k:Z) (bound:Z) (i:Z), ((0%Z < a)%Z /\ (a < bound)%Z) ->
  (0%Z <= i)%Z -> (0%Z <= k)%Z -> (co_prime a bound) ->
  ((int.EuclideanDivision.mod1
    (power_ a ((k * (multi_order a bound))%Z + i)%Z) bound)
   = (int.EuclideanDivision.mod1 (power_ a i) bound)).
...
Axiom injec_mod_prod_multi_order_pre :
  forall (pick:Z) (bound:Z) (i:Z) (i':Z), (co_prime pick bound) ->
  ((0%Z < pick)%Z /\ (pick < bound)%Z) ->
  (mem i (to_fset 0%Z (multi_order pick bound))) ->
  (mem i' (to_fset 0%Z (multi_order pick bound))) -> (i < i')%Z ->
  ~ ((int.EuclideanDivision.mod1 (power_ pick i') bound) =
     (int.EuclideanDivision.mod1 (power_ pick i) bound)).
...
Axiom injec_mod_prod_multi_order :
  ...
  ((0%Z < pick)%Z /\ (pick < bound)%Z) ->
  (mem i (to_fset 0%Z (multi_order pick bound))) ->
  (mem i' (to_fset 0%Z (multi_order pick bound))) -> ~ (i = i') ->
  ~ ((int.EuclideanDivision.mod1 (power_ pick i') bound) =
     (int.EuclideanDivision.mod1 (power_ pick i) bound)).
...
Axiom multiplier_pre_spec :
  ...
  (((ancillas (multiplier_pre pick bound n)) = 0%Z) /\
   ((forall (b:Z) (i:Z), ((0%Z <= b)%Z /\ (b < bound)%Z) ->
     ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
     sem (multiplier_pre pick bound n)
     (kronecker (ket n i)
      (kronecker (apply_qft (n + 1%Z)%Z b) (ket 1%Z 0%Z)))
     (kronecker (ket n i)
      (kronecker
...
Axiom multiplier_qft_pre_def :
  ...
  ((multiplier_qft_pre pick bound n b i) =
   (apply_function_in_qft_basis (multiplier_pre pick bound n) (n + 1%Z)%Z n
    ((2%Z * n)%Z + 2%Z)%Z
    (fun (b1:Z) => (int.EuclideanDivision.mod1 (b1 + (pick * i)%Z)%Z bound)))).
...
Axiom multiplier_qft_pre_spec :
  ...
  ((size (multiplier_qft_pre pick bound n b i)) <=
   (polysquare (n + 1%Z)%Z (2%Z * cont_size)%Z
  ...
  (((ancillas (multiplier_qft_pre pick bound n b i)) = 0%Z) /\
   (((width (multiplier_qft_pre pick bound n b i)) = ((2%Z * n)%Z + 2%Z)%Z) /\
    ((sem (multiplier_qft_pre pick bound n b i)
     ...
     ((sem (multiplier_qft_pre pick bound n b i)
      ...
      forall (i':Z), ((0%Z <= i')%Z /\ (i' < (power_ 2%Z n))%Z) ->
      ((multiplier_qft_pre pick bound n b i) =
       (apply_function_in_qft_basis (multiplier_pre pick bound n) (n + 1%Z)%Z
        n ((2%Z * n)%Z + 2%Z)%Z
        (fun (b1:Z) =>
         (int.EuclideanDivision.mod1 (b1 + (pick * i')%Z)%Z bound)))))))).
...
Axiom multiplier_qft_swap_spec :
  ...
  (((ancillas (multiplier_qft_swap pick bound n i)) = 0%Z) /\
   (((width (multiplier_qft_swap pick bound n i)) = ((2%Z * n)%Z + 2%Z)%Z) /\
    ((sem (multiplier_qft_swap pick bound n i)
...
Parameter restricted_modular_multiplier: Z -> Z -> Z -> Z -> circuit.

Axiom restricted_modular_multiplier_def :
  forall (pick:Z) (bound:Z) (n:Z) (i:Z), (0%Z < n)%Z ->
  ((0%Z <= pick)%Z /\ (pick < bound)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) < bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((0%Z <= i)%Z /\ (i < bound)%Z) -> (co_prime pick bound) ->
  ((restricted_modular_multiplier pick bound n i) =
...
Axiom restricted_modular_multiplier_spec :
  forall (pick:Z) (bound:Z) (n:Z) (i:Z), (0%Z < n)%Z ->
  ((0%Z <= pick)%Z /\ (pick < bound)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) < bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((0%Z <= i)%Z /\ (i < bound)%Z) -> (co_prime pick bound) ->
  ((size (restricted_modular_multiplier pick bound n i)) <=
   (polysquare (n + 1%Z)%Z (4%Z * cont_size)%Z
    (cont_size * (2%Z * (adder_gate_bound n))%Z)%Z 0%Z))%Z /\
  (((ancillas (restricted_modular_multiplier pick bound n i)) = 0%Z) /\
   (((width (restricted_modular_multiplier pick bound n i)) =
     ((2%Z * n)%Z + 2%Z)%Z) /\
    ((sem (restricted_modular_multiplier pick bound n i)
      (kronecker (ket n i) (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z)))
      (kronecker (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))
       (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z)))) /\
     ((sem (restricted_modular_multiplier pick bound n i)
       (kronecker (ket n i) (ket (n + 2%Z)%Z 0%Z))
       (kronecker (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))
        (ket (n + 2%Z)%Z 0%Z))) /\
...
Parameter check_first_bit_is_one_for_multiplier: Z -> circuit.

Axiom check_first_bit_is_one_for_multiplier_def :
  forall (n:Z), (0%Z < n)%Z ->
  ((check_first_bit_is_one_for_multiplier n) =
   (insert_qbits (check_first_bit_is_one n) (n + 1%Z)%Z (n + 2%Z)%Z
    (n + 2%Z)%Z)).

Axiom check_first_bit_is_one_for_multiplier_spec :
  forall (n:Z), (0%Z < n)%Z ->
  ((size (check_first_bit_is_one_for_multiplier n)) <= (cont_size * 3%Z)%Z)%Z /\
  (((ancillas (check_first_bit_is_one_for_multiplier n)) = 0%Z) /\
   (((width (check_first_bit_is_one_for_multiplier n)) =
     ((2%Z * n)%Z + 4%Z)%Z) /\
    ((forall (g:Z), ((0%Z <= g)%Z /\ (g < (power_ 2%Z n))%Z) ->
      sem (check_first_bit_is_one_for_multiplier n)
      (kronecker (ket (n + 1%Z)%Z g)
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))
      (kronecker (ket (n + 1%Z)%Z g)
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))) /\
     forall (g:Z),
     (((power_ 2%Z n) <= g)%Z /\ (g < (power_ 2%Z (n + 1%Z)%Z))%Z) ->
     ...
     (kronecker (ket (n + 1%Z)%Z g)
      (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))
     (kronecker (ket (n + 1%Z)%Z g)
      (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 1%Z)))))).

Parameter check_order_pre: Z -> Z -> Z -> circuit.

Axiom check_order_pre_def :
  forall (n:Z) (bound:Z) (i:Z), (0%Z < n)%Z ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((check_order_pre n bound i) =
   (sequence (place_substract_in_comput_basis bound n ((2%Z * n)%Z + 4%Z)%Z)
    (check_first_bit_is_one_for_multiplier n))).

Axiom check_order_pre_spec :
  forall (n:Z) (bound:Z) (i:Z), (0%Z < n)%Z ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((size (check_order_pre n bound i)) <=
   (polysquare (n + 1%Z)%Z ((cont_size * 2%Z)%Z + 1%Z)%Z 0%Z
    (cont_size * 3%Z)%Z))%Z /\
  (((ancillas (check_order_pre n bound i)) = 0%Z) /\
   (((width (check_order_pre n bound i)) = ((2%Z * n)%Z + 4%Z)%Z) /\
    (((bound <= i)%Z ->
      sem (check_order_pre n bound i)
      (kronecker (ket (n + 1%Z)%Z i)
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))
      (kronecker (ket (n + 1%Z)%Z (i - bound)%Z)
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))) /\
     ((i < bound)%Z ->
      sem (check_order_pre n bound i)
      (kronecker (ket (n + 1%Z)%Z i)
      ...
      (kronecker
       (ket (n + 1%Z)%Z
        (int.EuclideanDivision.mod1 (i - bound)%Z (power_ 2%Z (n + 1%Z)%Z)))
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 1%Z))))))).

Parameter check_order: Z -> Z -> Z -> circuit.

Axiom check_order_def :
  forall (n:Z) (bound:Z) (i:Z), (0%Z < n)%Z ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((check_order n bound i) =
   (sequence (check_order_pre n bound i)
    (place_add_in_comput_basis bound n ((2%Z * n)%Z + 4%Z)%Z))).

Axiom check_order_spec :
  forall (n:Z) (bound:Z) (i:Z), (0%Z < n)%Z ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((size (check_order n bound i)) <=
   (polysquare (n + 1%Z)%Z ((cont_size * 4%Z)%Z + 2%Z)%Z 0%Z
    (cont_size * 3%Z)%Z))%Z /\
  (((ancillas (check_order n bound i)) = 0%Z) /\
   (((width (check_order n bound i)) = ((2%Z * n)%Z + 4%Z)%Z) /\
    (((bound <= i)%Z ->
      sem (check_order n bound i)
      (kronecker (ket (n + 1%Z)%Z i)
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))
      (kronecker (ket (n + 1%Z)%Z i)
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))) /\
...
Parameter uncheck_order: Z -> Z -> Z -> circuit.

Axiom uncheck_order_def :
  forall (n:Z) (bound:Z) (i:Z), (0%Z < n)%Z ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((uncheck_order n bound i) = (reverse (check_order n bound i))).

Axiom uncheck_order_spec :
  forall (n:Z) (bound:Z) (i:Z), (0%Z < n)%Z ->
  (((power_ 2%Z (n - 1%Z)%Z) <= bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((size (uncheck_order n bound i)) <=
   (polysquare (n + 1%Z)%Z ((cont_size * 4%Z)%Z + 2%Z)%Z 0%Z
    (cont_size * 3%Z)%Z))%Z /\
  (((ancillas (uncheck_order n bound i)) = 0%Z) /\
   (((width (uncheck_order n bound i)) = ((2%Z * n)%Z + 4%Z)%Z) /\
    (((bound <= i)%Z ->
      sem (uncheck_order n bound i)
      (kronecker (ket (n + 1%Z)%Z i)
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))
      (kronecker (ket (n + 1%Z)%Z i)
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))) /\
...
Parameter cont_restricted_modular_multiplier: Z -> Z -> Z -> Z -> circuit.

Axiom cont_restricted_modular_multiplier_spec :
  forall (pick:Z) (bound:Z) (n:Z) (i:Z), (0%Z < n)%Z ->
  ((0%Z <= pick)%Z /\ (pick < bound)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) < bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) -> (co_prime pick bound) ->
  ((size (cont_restricted_modular_multiplier pick bound n i)) <=
   (polysquare (n + 1%Z)%Z ((power_ cont_size 2%Z) * 4%Z)%Z
    ((power_ cont_size 2%Z) * (2%Z * (adder_gate_bound n))%Z)%Z 0%Z))%Z /\
  (((ancillas (cont_restricted_modular_multiplier pick bound n i)) = 0%Z) /\
   (((width (cont_restricted_modular_multiplier pick bound n i)) =
     ((2%Z * n)%Z + 4%Z)%Z) /\
    (((i < bound)%Z ->
      sem (cont_restricted_modular_multiplier pick bound n i)
      (kronecker (ket (n + 1%Z)%Z i)
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 1%Z)))
      (kronecker
       (ket (n + 1%Z)%Z (int.EuclideanDivision.mod1 (pick * i)%Z bound))
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 1%Z)))) /\
     (((bound <= i)%Z ->
       sem (cont_restricted_modular_multiplier pick bound n i)
       (kronecker (ket (n + 1%Z)%Z i)
       ...
       (kronecker (ket (n + 1%Z)%Z i)
        (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))) /\
      forall (i':Z), ((0%Z <= i')%Z /\ (i' < (power_ 2%Z n))%Z) ->
      ((cont_restricted_modular_multiplier pick bound n i) =
       (place
        (cont_last_qbit
         (restricted_modular_multiplier pick bound n
...
Axiom modular_multiplier_with_ancillas_spec :
  ...
  (((width (modular_multiplier_with_ancillas pick bound n i)) =
   ...
   (((size (modular_multiplier_with_ancillas pick bound n i)) <=
     (polysquare (n + 1%Z)%Z
      ((((power_ cont_size 2%Z) * 4%Z)%Z + (8%Z * cont_size)%Z)%Z + 4%Z)%Z
      ((power_ cont_size 2%Z) * (2%Z * (adder_gate_bound n))%Z)%Z
      (cont_size * 6%Z)%Z))%Z /\
    (((i < bound)%Z ->
      sem (modular_multiplier_with_ancillas pick bound n i)
      (kronecker (ket (n + 1%Z)%Z i)
       (kronecker (ket (n + 2%Z)%Z 0%Z) (ket 1%Z 0%Z)))
      (kronecker
       (ket (n + 1%Z)%Z (int.EuclideanDivision.mod1 (pick * i)%Z bound))
     ...
     (((bound <= i)%Z ->
      ...
      (((i < bound)%Z ->
        sem (modular_multiplier_with_ancillas pick bound n i)
        (kronecker (ket 1%Z 0%Z) (kronecker (ket n i) (ket (n + 3%Z)%Z 0%Z)))
        (kronecker (ket 1%Z 0%Z)
         (kronecker (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))
          (ket (n + 3%Z)%Z 0%Z)))) /\
       (((bound <= i)%Z ->
         sem (modular_multiplier_with_ancillas pick bound n i)
         (kronecker (ket 1%Z 0%Z)
          (kronecker (ket n i) (ket (n + 3%Z)%Z 0%Z)))
         (kronecker (ket 1%Z 0%Z)
          (kronecker (ket n i) (ket (n + 3%Z)%Z 0%Z)))) /\
        (((modular_multiplier_with_ancillas pick bound n i) =
          (sequence
           (sequence (check_order n bound i)
            (cont_restricted_modular_multiplier pick bound n i))
           (uncheck_order n bound
            (int.EuclideanDivision.mod1 (pick * i)%Z bound)))) /\
         forall (i':Z), ((0%Z <= i')%Z /\ (i' < (power_ 2%Z n))%Z) ->
         ((modular_multiplier_with_ancillas pick bound n i) =
          (sequence
           (sequence (check_order n bound i')
...
Parameter permut_modular_multiplier: Z -> Z -> Z -> circuit.

Parameter result33: Z -> Z -> Z.

Axiom result_def33 :
  forall (n:Z) (i:Z),
  ((i < 1%Z)%Z ->
   (((result33 n) i) = ((i + ((2%Z * n)%Z + 4%Z)%Z)%Z - 1%Z)%Z)) /\
  (~ (i < 1%Z)%Z -> (((result33 n) i) = (i - 1%Z)%Z)).

Axiom permut_modular_multiplier_def :
  forall (pick:Z) (bound:Z) (n:Z), (0%Z < n)%Z ->
  ((0%Z <= pick)%Z /\ (pick < bound)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) < bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  (co_prime pick bound) ->
  ((permut_modular_multiplier pick bound n) =
   (with_permutation (modular_multiplier_with_ancillas pick bound n 0%Z)
    (result33 n))).

Axiom permut_modular_multiplier_spec :
  forall (pick:Z) (bound:Z) (n:Z), (0%Z < n)%Z ->
  ((0%Z <= pick)%Z /\ (pick < bound)%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) < bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  (co_prime pick bound) ->
  ((ancillas (permut_modular_multiplier pick bound n)) = 0%Z) /\
  (((width (permut_modular_multiplier pick bound n)) = ((2%Z * n)%Z + 4%Z)%Z) /\
   (((size (permut_modular_multiplier pick bound n)) <=
     (polysquare (n + 1%Z)%Z
      ((((power_ cont_size 2%Z) * 4%Z)%Z + (8%Z * cont_size)%Z)%Z + 4%Z)%Z
      ((power_ cont_size 2%Z) * (2%Z * (adder_gate_bound n))%Z)%Z
      (cont_size * 6%Z)%Z))%Z /\
    ((forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
      sem (permut_modular_multiplier pick bound n)
      (kronecker (ket n i) (ket (n + 4%Z)%Z 0%Z))
      (kronecker (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))
       (ket (n + 4%Z)%Z 0%Z))) /\
     forall (i:Z), ((bound <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
     sem (permut_modular_multiplier pick bound n)
     (kronecker (ket n i) (ket (n + 4%Z)%Z 0%Z))
     (kronecker (ket n i) (ket (n + 4%Z)%Z 0%Z))))).
...
Axiom modular_multiplier_def :
  ...
  (((power_ 2%Z (n - 1%Z)%Z) < bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  (co_prime pick bound) ->
  ((modular_multiplier pick bound n) =
   (ancilla_ket
    (permut_modular_multiplier (int.EuclideanDivision.mod1 pick bound) bound
     n)
    (n + 4%Z)%Z ((2%Z * n)%Z + 4%Z)%Z)).

Axiom modular_multiplier_spec :
  forall (pick:Z) (bound:Z) (n:Z), (0%Z < n)%Z ->
  (((power_ 2%Z (n - 1%Z)%Z) < bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  (co_prime pick bound) ->
  ((ancillas (modular_multiplier pick bound n)) = (n + 4%Z)%Z) /\
  (((width (modular_multiplier pick bound n)) = n) /\
   (((size (modular_multiplier pick bound n)) <=
     (polysquare (n + 1%Z)%Z
      ((((power_ cont_size 2%Z) * 4%Z)%Z + (8%Z * cont_size)%Z)%Z + 4%Z)%Z
      ((power_ cont_size 2%Z) * (2%Z * (adder_gate_bound n))%Z)%Z
      (cont_size * 6%Z)%Z))%Z /\
    ((forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
      sem (modular_multiplier pick bound n) (ket n i)
      (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))) /\
     forall (i:Z), ((bound <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
     sem (modular_multiplier pick bound n) (ket n i) (ket n i)))).
...
Axiom proba_measure_first_bits_but_one_def :
  ...
  ((proba_measure_first_bits_but_one x i n) =
   (proba_measure_first_bits x i (n - 1%Z)%Z n)).
...
Parameter result34: (matrix complex) -> Z -> Z -> complex.

Axiom result_def34 :
  forall (x:matrix complex) (n:Z) (k:Z),
  (((0%Z <= k)%Z /\ (k < (power_ 2%Z n))%Z) ->
   (((result34 x n) k) = (proba_measure x k n))) /\
  (~ ((0%Z <= k)%Z /\ (k < (power_ 2%Z n))%Z) ->
   (((result34 x n) k) = c_zero)).

Axiom proba_measure_sat_p_def :
  forall (x:matrix complex) (n:Z) (f:Z -> bool), (is_a_ket_l x n) ->
  ((proba_measure_sat_p x n f) =
   (sum (my_filter (to_fset 0%Z (power_ 2%Z n)) f) (result34 x n))).
...
Axiom proba_measure_from_scal_sum_sum_fun_spec :
  ...
  ((proba_measure_from_scal_sum_sum_fun x i y k n n1 n2 n' f g g' scal) =
   (infix_asdt scal
    (cpower (modulus (ind_sum (fun (i1:Z) => ((f (g i1)) y)) 0%Z k)) 2%Z))).
...
Axiom proba_measure_sum_of_conds :
  forall (s:set Z) (x:matrix complex) (n:Z) (p:Z -> Z -> bool) (p':Z -> bool)
    (scal:complex),
  (is_a_ket_l x n) ->
  (forall (j:Z), (mem j s) ->
   infix_lseqdt scal (proba_measure_cond x n (p j))) ->
  (forall (j:Z) (i:Z), (mem j s) -> (mem i (to_fset 0%Z (power_ 2%Z n))) ->
   (((p j) i) = true) -> ((p' i) = true)) ->
  infix_lseqdt (proba_measure_cond x n p')
  (infix_asdt scal (i_to_c (cardinal s))).

(* Why3 assumption *)
Definition eigen (c:circuit) (x:matrix complex) (o:angle) : Prop :=
  sem c x (infix_asdtdt (ang_exp o) x).

Axiom eigen_spec :
  forall (c:circuit) (x:matrix complex) (o:angle),
  ((eigen c x o) -> is_a_ket_l x (width c)) /\
  ((eigen c x o) -> ((path_sem c x) = (infix_asdtdt (ang_exp o) x))).

Axiom eigen_ket_l :
  forall (c:circuit) (x:matrix complex) (o:angle), (eigen c x o) ->
  is_a_ket_l x (width c).

Axiom set_eigen :
  forall (c:circuit) (x:matrix complex) (o:angle), (eigen c x o) ->
  ((path_sem c x) = (infix_asdtdt (ang_exp o) x)).

Axiom get_eigen :
  forall (c:circuit) (x:matrix complex) (o:angle),
  (is_a_ket_l x (width c)) ->
  ((path_sem c x) = (infix_asdtdt (ang_exp o) x)) -> eigen c x o.

Axiom is_a_ket_l_eigen :
  forall (c:circuit) (x:matrix complex), (exists o:angle, eigen c x o) ->
  is_a_ket_l x (width c).

Axiom eigen_scal :
  forall (c:circuit) (a:angle) (x:matrix complex) (o:angle), (eigen c x o) ->
  eigen c (infix_asdtdt (ang_exp a) x) o.

Parameter eigen_comp:
  circuit -> circuit -> (matrix complex) -> angle -> angle -> circuit.

Axiom eigen_comp_def :
  forall (c:circuit) (c':circuit) (x:matrix complex) (o:angle) (o':angle),
...
Parameter eigen_square: circuit -> (matrix complex) -> angle -> circuit.
...
Parameter pow_pow_2: circuit -> Z -> (matrix complex) -> angle -> circuit.

Axiom pow_pow_2_def :
  forall (c:circuit) (p:Z) (x:matrix complex) (o:angle), (0%Z <= p)%Z ->
  (eigen c x o) ->
...
Parameter control_eigen:
  circuit -> (matrix complex) -> angle -> Z -> Z -> Z -> circuit.

Axiom control_eigen_def :
  forall (circ:circuit) (y:matrix complex) (o:angle) (c:Z) (ft:Z) (n:Z),
...
Axiom control_eigen_spec :
  ...
  ((forall (x:matrix complex), (is_a_ket_l x ft) -> (is_a_ket_basis_elt x) ->
    (((value (ket_to_bv x)) c) = 0%Z) ->
    ((path_sem (control_eigen circ y o c ft n) (kronecker x y)) =
     (kronecker x y))) /\
   ((forall (x:matrix complex), (is_a_ket_l x ft) ->
     (is_a_ket_basis_elt x) -> (((value (ket_to_bv x)) c) = 1%Z) ->
     ((path_sem (control_eigen circ y o c ft n) (kronecker x y)) =
      (kronecker x (infix_asdtdt (ang_exp o) y)))) /\
    forall (x:bitvec), ((length x) = ft) ->
    ((path_sem (control_eigen circ y o c ft n) (kronecker (bv_to_ket x) y)) =
     (kronecker (bv_to_ket x)
      (infix_asdtdt (ang_exp (ang_mult_int o ((value x) c))) y))))).

Parameter control_eigen_scal:
  circuit -> (matrix complex) -> Z -> Z -> Z -> angle -> angle -> circuit.

Axiom control_eigen_scal_def :
  forall (circ:circuit) (y:matrix complex) (c:Z) (ft:Z) (n:Z) (o:angle)
    (o':angle),
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (width circ))%Z) ->
...
Axiom control_eigen_scal_spec :
  ...
  (((control_eigen_scal circ y c ft n o o') = (cont circ c ft n)) /\
   forall (x:bitvec), ((length x) = ft) ->
   ((path_sem (control_eigen_scal circ y c ft n o o')
...
Axiom control_eigen_seq_test_def :
  forall (fcirc:Z -> circuit) (fc42:Z -> Z) (ft:Z) (bound:Z) (s:Z) (n:Z),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc42 i))%Z /\ ((fc42 i) < ft)%Z) ->
  ((0%Z < bound)%Z /\ (bound <= ft)%Z) -> (0%Z <= s)%Z -> (n = (ft + s)%Z) ->
  (0%Z <= n)%Z -> (forall (i:Z), ((width (fcirc i)) = s)) ->
  ((bound = 1%Z) ->
   ((control_eigen_seq_test fcirc fc42 ft bound s n) =
    (cont (fcirc 0%Z) (fc42 0%Z) ft (ft + s)%Z))) /\
  (~ (bound = 1%Z) ->
   ((control_eigen_seq_test fcirc fc42 ft bound s n) =
    (sequence (control_eigen_seq_test fcirc fc42 ft (bound - 1%Z)%Z s n)
     (cont (fcirc (bound - 1%Z)%Z) (fc42 (bound - 1%Z)%Z) ft n)))).
...
Axiom control_eigen_seq_test_spec :
  ...
  ((0%Z < bound)%Z /\ (bound <= ft)%Z) -> (0%Z <= s)%Z -> (n = (ft + s)%Z) ->
  (0%Z <= n)%Z -> (forall (i:Z), ((width (fcirc i)) = s)) ->
  ((width (control_eigen_seq_test fcirc fc42 ft bound s n)) = (ft + s)%Z).

Parameter control_eigen_seq_pre:
  (Z -> circuit) -> (matrix complex) -> (Z -> angle) -> (Z -> Z) -> Z -> 
  Z -> Z -> Z -> bitvec -> circuit.

Axiom control_eigen_seq_pre_def :
  forall (fcirc:Z -> circuit) (y:matrix complex) (fk:Z -> angle)
    (fc42:Z -> Z) (ft:Z) (bound:Z) (s:Z) (n:Z) (x:bitvec),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc42 i))%Z /\ ((fc42 i) < ft)%Z) ->
  ((0%Z < bound)%Z /\ (bound <= ft)%Z) -> (0%Z <= s)%Z -> (n = (ft + s)%Z) ->
  (0%Z <= n)%Z ->
  ...
  ((length x) = ft) ->
  ((bound = 1%Z) ->
   ((control_eigen_seq_pre fcirc y fk fc42 ft bound s n x) =
    (control_eigen (fcirc 0%Z) y (fk 0%Z) (fc42 0%Z) ft (ft + s)%Z))) /\
  (~ (bound = 1%Z) ->
   ((control_eigen_seq_pre fcirc y fk fc42 ft bound s n x) =
    (sequence
     (control_eigen_seq_pre fcirc y fk fc42 ft (bound - 1%Z)%Z s n x)
     (control_eigen_scal (fcirc (bound - 1%Z)%Z) y (fc42 (bound - 1%Z)%Z) ft
      n
      (ang_sum (fun (i:Z) => (ang_mult_int (fk i) ((value x) (fc42 i)))) 0%Z
       (bound - 1%Z)%Z)
      (fk (bound - 1%Z)%Z))))).
...
Axiom control_eigen_seq_pre_spec :
  ...
  (forall (i:Z), ((width (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((length x) = ft) ->
  ((width (control_eigen_seq_pre fcirc y fk fc42 ft bound s n x)) =
   (ft + s)%Z) /\
  (((path_sem (control_eigen_seq_pre fcirc y fk fc42 ft bound s n x)
     (kronecker (bv_to_ket x) y))
    =
    (kronecker
     (infix_asdtdt
...
Axiom control_eigen_seq_def :
  ...
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) -> eigen (fcirc i) y (fk i)) ->
  (forall (i:Z), ((width (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((control_eigen_seq fcirc y fk fc42 ft bound s n) =
   (control_eigen_seq_test fcirc fc42 ft bound s n)).
...
Axiom control_eigen_seq_spec :
  ...
  (forall (x:bitvec), ((length x) = ft) ->
   ((control_eigen_seq fcirc y fk fc42 ft bound s n) =
    (control_eigen_seq_pre fcirc y fk fc42 ft bound s n x))) /\
  (((width (control_eigen_seq fcirc y fk fc42 ft bound s n)) = (ft + s)%Z) /\
   forall (x:bitvec), ((length x) = ft) ->
   ((path_sem (control_eigen_seq fcirc y fk fc42 ft bound s n)
     (kronecker (bv_to_ket x) y))
    =
    (kronecker
     (infix_asdtdt
...
Parameter control_eigen_seq_real:
  (Z -> circuit) -> (matrix complex) -> (Z -> complex) -> (Z -> Z) -> 
  Z -> Z -> Z -> Z -> circuit.

Parameter result35: (Z -> complex) -> Z -> angle.

Axiom result_def35 :
  forall (fk:Z -> complex) (k:Z),
  ((real_ (fk k)) -> (((result35 fk) k) = (real_to_ang (fk k)))) /\
  (~ (real_ (fk k)) -> (((result35 fk) k) = ang_zero)).

Axiom control_eigen_seq_real_def :
  forall (fcirc:Z -> circuit) (y:matrix complex) (fk:Z -> complex)
    (fc42:Z -> Z) (ft:Z) (bound:Z) (s:Z) (n:Z),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc42 i))%Z /\ ((fc42 i) < ft)%Z) ->
  ((0%Z < bound)%Z /\ (bound <= ft)%Z) -> (0%Z <= s)%Z -> (n = (ft + s)%Z) ->
  ...
  (forall (i:Z), ((width (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((control_eigen_seq_real fcirc y fk fc42 ft bound s n) =
   (control_eigen_seq fcirc y (result35 fk) fc42 ft bound s n)).
...
Axiom control_eigen_seq_real_spec :
  ...
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   eigen (fcirc i) y (real_to_ang (fk i))) ->
  (forall (i:Z), ((width (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((width (control_eigen_seq_real fcirc y fk fc42 ft bound s n)) =
   (ft + s)%Z) /\
  forall (x:bitvec), ((length x) = ft) ->
  ((path_sem (control_eigen_seq_real fcirc y fk fc42 ft bound s n)
    (kronecker (bv_to_ket x) y))
   =
   (kronecker
    (infix_asdtdt
     (ang_exp
      (ang_sum
       (fun (i:Z) =>
        (real_to_ang (infix_asdt (fk i) (i_to_c ((value x) (fc42 i))))))
       0%Z bound))
     (bv_to_ket x))
    y)).

Parameter black_box_coeff: complex -> bitvec -> complex.

Axiom black_box_coeff_def :
  forall (theta:complex) (y:bitvec), (real_ theta) ->
  ((black_box_coeff theta y) =
   (ang_exp (real_to_ang (infix_asdt theta (i_to_c (bv_to_int y)))))).

Axiom black_box_coeff_spec :
  forall (theta:complex) (y:bitvec), (real_ theta) -> forall (x:bitvec),
  forall (k:Z), (0%Z < k)%Z -> ((length x) = k) -> ((length y) = k) ->
  ((infix_asdt (black_box_coeff theta y)
    (int_qft_coeff (bv_to_int y) (-(bv_to_int x))%Z k))
   =
   (cpower
    (ang_exp
     (real_to_ang
      (infix_mndt theta (infix_asdt (i_to_c (bv_to_int x)) (pow_inv_2 k)))))
    (bv_to_int y))).

Parameter cascade_cont_pow:
  circuit -> Z -> (matrix complex) -> complex -> circuit.

Parameter result36:
  circuit -> Z -> (matrix complex) -> complex -> Z -> circuit.

Axiom result_def36 :
  forall (circ:circuit) (ft:Z) (y:matrix complex) (theta:complex) (i:Z),
  ((0%Z <= ((ft - i)%Z - 1%Z)%Z)%Z ->
   (((result36 circ ft y theta) i) =
...
Axiom cascade_cont_pow_def :
  forall (circ:circuit) (ft:Z) (y:matrix complex) (theta:complex),
  (1%Z <= ft)%Z -> (real_ theta) -> (eigen circ y (real_to_ang theta)) ->
  (is_a_ket_l y (width circ)) ->
  ((cascade_cont_pow circ ft y theta) =
   (control_eigen_seq_real (result36 circ ft y theta) y
    (fun (i:Z) =>
     (infix_asdt theta (i_to_c (power_ 2%Z ((ft - i)%Z - 1%Z)%Z))))
...
Axiom cascade_cont_pow_spec :
  ...
  ((forall (x:bitvec), ((length x) = ft) ->
    ((path_sem (cascade_cont_pow circ ft y theta)
      (kronecker (bv_to_ket x) y))
...
Parameter apply_black_box:
  circuit -> Z -> Z -> (matrix complex) -> complex -> circuit.

Axiom apply_black_box_def :
  forall (circ:circuit) (k:Z) (n:Z) (y:matrix complex) (theta:complex),
...
Axiom apply_black_box_spec :
  ...
  ((path_sem (apply_black_box circ k n y theta) (kronecker (ket k 0%Z) y)) =
   (kronecker
...
Axiom phase_estimation_def :
  ...
  ((phase_estimation circ k n y theta) =
   (sequence (apply_black_box circ k n y theta) (place (qft_rev_ k) 0%Z n))).
...
Axiom phase_estimation_spec :
  ...
  ((0%Z < k)%Z /\ (k < n)%Z) -> (is_a_ket_l y (n - k)%Z) ->
  (eigen circ y (real_to_ang theta)) ->
  ((path_sem (phase_estimation circ k n y theta) (kronecker (ket k 0%Z) y)) =
   (kronecker
     ...
     (ket_sum_l (n_bvs k)
      (fun (y1:bitvec) =>
       (ket_sum_l (n_bvs k)
        (fun (x:bitvec) =>
         (infix_asdtdt
          (infix_asdt (black_box_coeff theta y1)
           (int_qft_coeff (bv_to_int y1) (-(bv_to_int x))%Z k))
          (bv_to_ket x)))
        k))
      k))
    y)) /\
...
Parameter pe_measure:
  circuit -> Z -> Z -> Z -> (matrix complex) -> complex -> complex.

Axiom pe_measure_def :
  forall (circ:circuit) (k:Z) (i:Z) (n:Z) (y:matrix complex) (theta:complex),
  (n = (k + (width circ))%Z) -> (real_ theta) ->
      ...
      (ind_sum
       (fun (y1:Z) =>
        (cpower
         (ang_exp
          (real_to_ang
           (infix_mndt theta (infix_asdt (i_to_c i) (pow_inv_2 k)))))
         y1))
       0%Z (power_ 2%Z k)))
     2%Z))) /\
  ((pe_measure circ k i n y theta) =
...
Parameter best_appr: complex -> Z -> Z.

Parameter result37: complex -> Z -> Z -> bool.

Axiom result_def37 :
  forall (theta:complex) (k:Z) (x:Z),
  (((result37 theta k) x) = true) <->
  (infix_lseqdt
   (modulus (infix_mndt theta (infix_asdt (i_to_c x) (pow_inv_2 k))))
   (pow_inv_2 (k + 1%Z)%Z)).

Axiom best_appr_def :
  forall (theta:complex) (k:Z), (0%Z <= k)%Z -> (real_ theta) ->
  ((infix_lseqdt c_zero theta) /\ (infix_lseqdt theta c_one)) ->
  ((best_appr theta k) =
   (choose_filter (to_fset 0%Z ((power_ 2%Z k) + 1%Z)%Z) (result37 theta k))).
...
Axiom best_appr_spec :
  ...
  ((mem (best_appr theta k) (to_fset 0%Z ((power_ 2%Z k) + 1%Z)%Z)) /\
   (infix_lseqdt
    (modulus
     (infix_mndt theta
      (infix_asdt (i_to_c (best_appr theta k)) (pow_inv_2 k))))
    (pow_inv_2 (k + 1%Z)%Z))).

Parameter delta: complex -> Z -> complex.

Axiom delta_def :
  forall (theta:complex) (k:Z), (0%Z < k)%Z -> (real_ theta) ->
  ((infix_lsdt c_zero theta) /\ (infix_lseqdt theta c_one)) ->
  ((delta theta k) =
   (infix_mndt theta (infix_asdt (i_to_c (best_appr theta k)) (pow_inv_2 k)))).
...
Axiom delta_spec :
  ...
  ((real_ (delta theta k)) /\
   ((infix_lseqdt (modulus (delta theta k)) (pow_inv_2 (k + 1%Z)%Z)) /\
    (infix_lsdt (delta theta k) c_one))).

Axiom geom_sum_rewrite :
  forall (psi:complex) (b:Z), (1%Z <= b)%Z -> (real_ psi) ->
  ((infix_lsdt c_zero (modulus psi)) /\ (infix_lsdt (modulus psi) c_one)) ->
  ((cpower
    (modulus
   ...
   =
   (infix_sldt
    (cpower (modulus (sin (infix_asdt (infix_asdt pi psi) (i_to_c b)))) 2%Z)
    (cpower (modulus (sin (infix_asdt pi psi))) 2%Z))).

Axiom geom_sum_bound :
  forall (psi:complex) (b:Z), (1%Z <= b)%Z -> (real_ psi) ->
  ((infix_lseqdt c_zero (modulus psi)) /\
   (infix_lseqdt (modulus psi)
    (infix_sldt c_one (infix_asdt (infix_pldt c_one c_one) (i_to_c b))))) ->
  (infix_lseqdt
   (infix_asdt (cpower (i_to_c b) 2%Z)
    (infix_sldt (i_to_c 4%Z) (cpower pi 2%Z)))
   (cpower
    (modulus
     (ind_sum (fun (y:Z) => (cpower (ang_exp (real_to_ang psi)) y)) 0%Z b))
    2%Z)) /\
  (infix_lseqdt (infix_sldt (i_to_c 4%Z) (cpower pi 2%Z))
   (infix_asdt (infix_sldt c_one (cpower (i_to_c b) 2%Z))
    (cpower
     (modulus
      (ind_sum (fun (y:Z) => (cpower (ang_exp (real_to_ang psi)) y)) 0%Z b))
     2%Z))).
...
Parameter qpe_meas:
  circuit -> Z -> Z -> (matrix complex) -> complex -> complex.
...
Axiom qpe_meas_def :
  ...
  ((1%Z <= k)%Z /\ (k < n)%Z) -> (is_a_ket_l y (n - k)%Z) ->
  (eigen circ y (real_to_ang theta)) ->
  ((infix_lsdt c_zero theta) /\ (infix_lsdt theta c_one)) ->
...
Axiom qpe_meas_spec :
  ...
  (eigen circ y (real_to_ang theta)) ->
  ((infix_lsdt c_zero theta) /\ (infix_lsdt theta c_one)) ->
  (((delta theta k) = c_zero) -> ((qpe_meas circ k n y theta) = c_one)) /\
  ((infix_lsdt c_zero (delta theta k)) ->
   infix_lseqdt (infix_sldt (i_to_c 4%Z) (cpower pi 2%Z))
   (qpe_meas circ k n y theta)).

Parameter create_superposition: Z -> Z -> (matrix complex) -> circuit.

Axiom create_superposition_def :
  forall (k:Z) (n:Z) (y:matrix complex), ((0%Z < k)%Z /\ (k < n)%Z) ->
  (is_a_ket_l y (n - k)%Z) ->
...
Axiom create_superposition_spec :
  ...
  (((ancillas (create_superposition k n y)) = 0%Z) /\
   (((size (create_superposition k n y)) = k) /\
    ((path_sem (create_superposition k n y) (kronecker (ket k 0%Z) y)) =
     (kronecker
      (infix_asdtdt (pow_inv_sqrt_2 k)
...
Parameter shor_ket: Z -> Z -> Z -> Z -> Z -> matrix complex.
...
Axiom shor_ket_def :
  ...
  ((shor_ket a bound n i j) =
   (kronecker
    (infix_asdtdt (int_qft_coeff (-i)%Z j (2%Z * n)%Z) (ket (2%Z * n)%Z j))
...
Axiom shor_ket_spec :
  ...
  ((shor_ket a bound n i j) =
   (kronecker
    (infix_asdtdt (int_qft_coeff i (-j)%Z (2%Z * n)%Z) (ket (2%Z * n)%Z j))
    (ket n (int.EuclideanDivision.mod1 (power_ a i) bound)))).
...
Axiom shor_circ_spec :
  ...
  (((ancillas (shor_circ a bound n)) = (n + 4%Z)%Z) /\
   (((size (shor_circ a bound n)) <=
     ((((((multiplier_gate_bound n) * 2%Z)%Z * cont_size)%Z + 2%Z)%Z * n)%Z +
      (polysquare (2%Z * n)%Z cont_size 0%Z 0%Z))%Z)%Z /\
    ((path_sem (shor_circ a bound n)
      (kronecker (ket (2%Z * n)%Z 0%Z) (ket n 1%Z)))
     =
...
Axiom k_bound :
  forall (k:Z) (a:Z) (bound:Z) (n:Z) (i:Z), (0%Z < n)%Z ->
  ((0%Z <= a)%Z /\ (a < (power_ 2%Z n))%Z) ->
  (((power_ 2%Z (n - 1%Z)%Z) < bound)%Z /\ (bound < (power_ 2%Z n))%Z) ->
  (a < bound)%Z -> (co_prime a bound) ->
  ((0%Z <= k)%Z /\
  ...
  (infix_lseqdt
   (infix_asdt
    (infix_pldt (infix_asdt (i_to_c k) (i_to_c (multi_order a bound)))
     (i_to_c i))
    (pow_inv_2 (2%Z * n)%Z))
   c_one) /\
  ((infix_lseqdt
    (infix_pldt (infix_asdt (i_to_c k) (i_to_c (multi_order a bound)))
     (i_to_c i))
    (i_to_c (power_ 2%Z (2%Z * n)%Z))) /\
   ((infix_lseqdt
     (infix_asdt (i_to_c ((k * (multi_order a bound))%Z + i)%Z)
      (pow_inv_2 (2%Z * n)%Z))
     c_one) /\
    (infix_lseqdt (i_to_c ((k * (multi_order a bound))%Z + i)%Z)
     (i_to_c (power_ 2%Z (2%Z * n)%Z))))).
...
Axiom H8 : (k < (multi_order a bound))%Z.

Axiom H9 : (1%Z <= (multi_order a bound))%Z.

Axiom H10 : ((multi_order a bound) < bound)%Z.

Axiom H11 :
  ((int.EuclideanDivision.mod1 (power_ a (multi_order a bound)) bound) = 1%Z).

Axiom H12 : real_ (i_to_c (multi_order a bound)).

Axiom H13 : real_ (i_to_c (power_ 2%Z ((2%Z * n)%Z + 1%Z)%Z)).

Axiom H14 :
  ((infix_sldt c_one (i_to_c (power_ 2%Z ((2%Z * n)%Z + 1%Z)%Z))) =
   (infix_asdt c_one (inv (i_to_c (power_ 2%Z ((2%Z * n)%Z + 1%Z)%Z))))).

Axiom H15 : (1%Z <= (multi_order a bound))%Z.

Axiom H16 : ((multi_order a bound) < bound)%Z.

Axiom H17 :
  ((int.EuclideanDivision.mod1 (power_ a (multi_order a bound)) bound) = 1%Z).

Axiom H18 : real_ (i_to_c (multi_order a bound)).

Axiom H19 : real_ (i_to_c k).

Axiom H20 :
  ((infix_sldt (i_to_c k) (i_to_c (multi_order a bound))) =
   (infix_asdt (i_to_c k) (inv (i_to_c (multi_order a bound))))).
...
Axiom H24 : real_ (i_to_c (multi_order a bound)).

Axiom H25 : real_ (i_to_c k).
...
Axiom H27 :
  (0%Z <=
   (best_appr (infix_sldt (i_to_c k) (i_to_c (multi_order a bound)))
    (2%Z * n)%Z))%Z.

Axiom H28 :
  ((best_appr (infix_sldt (i_to_c k) (i_to_c (multi_order a bound)))
    (2%Z * n)%Z)
   <= (power_ 2%Z (2%Z * n)%Z))%Z.

Axiom H29 :
  mem
  (best_appr (infix_sldt (i_to_c k) (i_to_c (multi_order a bound)))
   (2%Z * n)%Z)
  (to_fset 0%Z ((power_ 2%Z (2%Z * n)%Z) + 1%Z)%Z).

Axiom H30 :
  infix_lseqdt
  (modulus
   (infix_mndt (infix_sldt (i_to_c k) (i_to_c (multi_order a bound)))
    (infix_asdt
     (i_to_c
      (best_appr (infix_sldt (i_to_c k) (i_to_c (multi_order a bound)))
       (2%Z * n)%Z))
     (pow_inv_2 (2%Z * n)%Z))))
  (pow_inv_2 ((2%Z * n)%Z + 1%Z)%Z).
...
Axiom H32 : real_ (pow_inv_2 (2%Z * n)%Z).

Axiom H33 : infix_gtdt (pow_inv_2 (2%Z * n)%Z) c_zero.

Axiom H34 :
  ((pow_inv_2 (2%Z * n)%Z) = (pow_inv_sqrt_2 (2%Z * (2%Z * n)%Z)%Z)).

Axiom H35 :
  ((pow_inv_2 (2%Z * n)%Z) =
   (infix_asdt (pow_inv_sqrt_2 (2%Z * n)%Z) (pow_inv_sqrt_2 (2%Z * n)%Z))).
...
Axiom H36 :
  ...
  (infix_asdt (infix_sldt c_one (i_to_c (power_ 2%Z ((2%Z * n)%Z + 1%Z)%Z)))
   (i_to_c (multi_order a bound))).

Axiom H37 : (1%Z <= (multi_order a bound))%Z.

Axiom H38 : ((multi_order a bound) < bound)%Z.

Axiom H39 :
  ((int.EuclideanDivision.mod1 (power_ a (multi_order a bound)) bound) = 1%Z).

Axiom H40 : real_ (i_to_c (multi_order a bound)).

Axiom H41 : real_ (i_to_c k).
     ...
     (infix_asdt (pow_inv_2 (2%Z * n)%Z)
      (i_to_c
       ((best_appr (infix_sldt (i_to_c k) (i_to_c (multi_order a bound)))
         (2%Z * n)%Z)
        * (multi_order a bound))%Z))))
   (infix_asdt (i_to_c (multi_order a bound))
    (pow_inv_2 ((2%Z * n)%Z + 1%Z)%Z))) ->
  (infix_lseqdt
   (infix_asdt (i_to_c (multi_order a bound))
    (pow_inv_2 ((2%Z * n)%Z + 1%Z)%Z))
...
Theorem G :
  infix_lseqdt
  (infix_asdt (infix_pldt c_one c_one)
   (infix_asdt (i_to_c b) (i_to_c (multi_order a bound))))
  (infix_asdt (infix_pldt c_one c_one) (i_to_c (power_ 2%Z (2%Z * n)%Z))).
Proof.
