...
Parameter fc2: (Z -> complex) -> complex -> Z -> Z -> Z -> complex.

Axiom fc_def2 :
  forall (f:Z -> complex) (g:complex) (i:Z) (j:Z) (k:Z),
  (((i <= k)%Z /\ (k < j)%Z) -> (((fc2 f g i j) k) = (f k))) /\
  (~ ((i <= k)%Z /\ (k < j)%Z) -> (((fc2 f g i j) k) = g)).

Axiom ind_sum_eq_del_bound :
  forall (f:Z -> complex) (g:complex) (i:Z) (j:Z),
  ((ind_sum (fc2 f g i j) i j) = (ind_sum f i j)).
...
Axiom ind_sum_eq_del_bound_rev :
  forall (f:Z -> complex) (g:complex) (i:Z) (j:Z),
  ((ind_sum f i j) = (ind_sum (fc3 f g i j) i j)).
...
Parameter result12: Z -> Z -> (Z* Z)%type -> matrix complex.
...
Axiom result_def12 :
  ...
  | (i, j) =>
      ((((0%Z <= i)%Z /\ (i < r)%Z) /\ ((0%Z <= j)%Z /\ (j < c)%Z)) ->
       (((result12 r c) o) = (ind_basis_mat i j r c))) /\
      (~ (((0%Z <= i)%Z /\ (i < r)%Z) /\ ((0%Z <= j)%Z /\ (j < c)%Z)) ->
       (((result12 r c) o) = (make r c c_zero)))
  end.

Axiom basis_mat_def :
  forall (r:Z) (c:Z), (0%Z < r)%Z -> (0%Z < c)%Z ->
  ((basis_mat r c) =
   (map (result12 r c) (cartesian_product (to_fset 0%Z r) (to_fset 0%Z c)))).
...
Parameter result13: (matrix complex) -> (Z* Z)%type -> bool.
...
Axiom basis_mat_indexes_def :
  ...
  ((basis_mat_indexes m) =
   (element (my_filter (mat_indices m) (result13 m)))).
...
Parameter result14: (matrix complex) -> (Z* Z)%type -> matrix complex.

Axiom result_def14 :
  forall (m:matrix complex) (o:(Z* Z)%type),
  ((valid_index m (fir o) (sec o)) ->
   (((result14 m) o) = (basis_projection m (fir o) (sec o)))) /\
  (~ (valid_index m (fir o) (sec o)) -> (((result14 m) o) = m)).

(* Why3 assumption *)
Definition basis_projections (m:matrix complex) : set (matrix complex) :=
  map (result14 m) (to_indexes m).
...
Axiom result_def15 :
  ...
  (~ (mem o (to_indexes m)) -> (((result15 m) o) = m)).

(* Why3 assumption *)
Definition indexes_decomp (m:matrix complex) : matrix complex :=
  mat_sum (to_indexes m) (result15 m).
...
Parameter result16: bitvec -> bitvec -> Z -> Z.

Axiom result_def16 :
  forall (bv1:bitvec) (bv2:bitvec) (i:Z),
  ((((length bv1) <= i)%Z /\ (i < ((length bv1) + (length bv2))%Z)%Z) ->
   (((result16 bv1 bv2) i) = ((value bv2) (i - (length bv1))%Z))) /\
  (~ (((length bv1) <= i)%Z /\ (i < ((length bv1) + (length bv2))%Z)%Z) ->
   (((result16 bv1 bv2) i) = ((value bv1) i))).

(* Why3 assumption *)
Definition concat (bv1:bitvec) (bv2:bitvec) : bitvec :=
  make_bv (result16 bv1 bv2) ((length bv1) + (length bv2))%Z.
...
Parameter fc20: (Z -> Z) -> (Z -> Z) -> Z -> angle.

Axiom fc_def20 :
  forall (x:Z -> Z) (y:Z -> Z) (i:Z),
  ((((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc20 x y) i) = (int_to_ang 1%Z 1%Z))) /\
  (~ (((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc20 x y) i) = (int_to_ang 0%Z 1%Z))).
...
Axiom repeat_pps_had_spec :
  ...
  (((h_range (repeat_pps_had n)) = n) /\
   ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
    ...
    forall (x:Z -> Z) (y:Z -> Z),
    ((((h_angle (repeat_pps_had n)) x) y) = (ang_sum (fc20 x y) 0%Z n)))).
...
Definition sem (c:circuit) (x:matrix complex) (y:matrix complex) : Prop :=
  (is_a_ket_l x (width c)) /\ (infix_eqeq1 y (path_sem c x)).
...
Parameter fc30: bitvec -> Z -> Z.

Axiom fc_def30 :
  forall (x:bitvec) (i:Z),
  ((i = 0%Z) -> (((fc30 x) i) = ((value x) i))) /\
  (~ (i = 0%Z) ->
   (((fc30 x) i) =
    (int.EuclideanDivision.mod1 (((value x) 0%Z) + ((value x) i))%Z 2%Z))).

Axiom flat_cnot_spec :
  flat cnot (fun (x:bitvec) => (make_bv (fc30 x) 2%Z))
...
Axiom flat_sequence_def :
  ...
  (forall (x:bitvec), ((a3 x) = (ang_add (a1 x) (a2 (k1 x))))) ->
  (forall (x:bitvec), ((k3 x) = (k2 (k1 x)))) ->
...
Parameter fc31: Z -> bitvec -> Z -> Z.

Axiom fc_def31 :
  forall (c:Z) (x:bitvec) (i:Z),
  ((i = c) -> (((fc31 c x) i) = (1%Z - ((value x) c))%Z)) /\
  (~ (i = c) -> (((fc31 c x) i) = ((value x) i))).

Axiom place_xx_spec :
  forall (c:Z) (n:Z), ((0%Z <= c)%Z /\ (c < n)%Z) ->
  (flat (place_xx c n) (fun (x:bitvec) => (make_bv (fc31 c x) n))
   (fun (us:bitvec) => ang_zero)) /\
...
Parameter fc32: (Z -> Z) -> (Z -> Z) -> Z -> angle.

Axiom fc_def32 :
  forall (x:Z -> Z) (y:Z -> Z) (i:Z),
  ((((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc32 x y) i) = (int_to_ang 1%Z 1%Z))) /\
  (~ (((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc32 x y) i) = (int_to_ang 0%Z 1%Z))).
   ...
   (((size (repeat_had n)) = n) /\
    (((ancillas (repeat_had n)) = 0%Z) /\
     ((forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
      ...
      ((forall (x:Z -> Z) (y:Z -> Z),
        ((ang_ind (repeat_had n) x y) = (ang_sum (fc32 x y) 0%Z n))) /\
...
Parameter result24: Z -> bitvec -> Z -> Z.

Parameter result25: Z -> Z -> Z -> bitvec -> bitvec.

Axiom result_def24 :
  forall (k:Z) (x:bitvec) (i:Z),
  ((i = k) -> (((result24 k x) i) = (1%Z - ((value x) i))%Z)) /\
  (~ (i = k) -> (((result24 k x) i) = ((value x) i))).

Axiom result_def25 :
  forall (c:Z) (k:Z) (n:Z) (x:bitvec),
  ((((value x) c) = 0%Z) -> (((result25 c k n) x) = x)) /\
  (~ (((value x) c) = 0%Z) ->
   (((result25 c k n) x) = (make_bv (result24 k x) n))).
...
Axiom ind_cnot_def :
  ...
  ((ind_cnot c k n) =
   (flat_cont (sequence (sequence hadamard (rz 1%Z)) hadamard) c k n
    ...
    (result25 c k n) (fun (us:bitvec) => ang_zero)
    (fun (us:bitvec) => ang_zero))).

Parameter fc33: Z -> bitvec -> Z -> Z.

Parameter fc34: Z -> Z -> Z -> bitvec -> bitvec.

Parameter fc35: Z -> (matrix complex) -> Z -> Z.

Axiom fc_def33 :
  forall (k:Z) (x:bitvec) (i:Z),
  ((i = k) -> (((fc33 k x) i) = (1%Z - ((value x) i))%Z)) /\
  (~ (i = k) -> (((fc33 k x) i) = ((value x) i))).

Axiom fc_def34 :
  forall (c:Z) (k:Z) (n:Z) (x:bitvec),
  ((((value x) c) = 0%Z) -> (((fc34 c k n) x) = x)) /\
  (~ (((value x) c) = 0%Z) -> (((fc34 c k n) x) = (make_bv (fc33 k x) n))).

Axiom fc_def35 :
  forall (k:Z) (ket1:matrix complex) (i:Z),
  ((i = k) -> (((fc35 k ket1) i) = (1%Z - ((value (ket_to_bv ket1)) i))%Z)) /\
  (~ (i = k) -> (((fc35 k ket1) i) = ((value (ket_to_bv ket1)) i))).
...
Axiom ind_cnot_spec :
  ...
  (((ancillas (ind_cnot c k n)) = 0%Z) /\
   ((flat (ind_cnot c k n) (fc34 c k n) (fun (us:bitvec) => ang_zero)) /\
    ((forall (ket1:matrix complex), (is_a_ket_l ket1 n) ->
     ...
     ((forall (ket1:matrix complex), (is_a_ket_l ket1 n) ->
       ...
       ((path_sem (ind_cnot c k n) ket1) =
        (bv_to_ket (make_bv (fc35 k ket1) n)))) /\
...
Parameter fc37: Z -> bitvec -> Z -> Z.

Parameter fc38: Z -> Z -> Z -> bitvec -> bitvec.

Axiom fc_def37 :
  forall (k:Z) (x:bitvec) (i:Z),
  ((i = k) -> (((fc37 k x) i) = (1%Z - ((value x) i))%Z)) /\
  (~ (i = k) -> (((fc37 k x) i) = ((value x) i))).

Axiom fc_def38 :
  forall (c:Z) (k:Z) (n:Z) (x:bitvec),
  ((((value x) c) = 0%Z) -> (((fc38 c k n) x) = (make_bv (fc37 k x) n))) /\
  (~ (((value x) c) = 0%Z) -> (((fc38 c k n) x) = x)).
...
Axiom ind_neg_cnot_spec :
  ...
  (((size (ind_neg_cnot c k n)) <= ((cont_size * 3%Z)%Z + 6%Z)%Z)%Z /\
   ((flat (ind_neg_cnot c k n) (fc38 c k n) (fun (us:bitvec) => ang_zero)) /\
    ((width (ind_neg_cnot c k n)) = n))).

Parameter fc39: Z -> (matrix complex) -> Z -> Z.

Axiom fc_def39 :
  forall (k:Z) (ket1:matrix complex) (i:Z),
  ((i = k) -> (((fc39 k ket1) i) = (1%Z - ((value (ket_to_bv ket1)) i))%Z)) /\
  (~ (i = k) -> (((fc39 k ket1) i) = ((value (ket_to_bv ket1)) i))).
  ...
  ((forall (i:Z),
   ...
   ((forall (ket1:matrix complex), (is_a_ket_l ket1 n) ->
    ...
    ((path_sem (ind_neg_cnot c k n) ket1) =
     (bv_to_ket (make_bv (fc39 k ket1) n))))).

Parameter swap_lists: Z -> Z -> Z -> Z -> circuit.

Parameter result26: Z -> Z -> Z -> Z -> Z.

Axiom result_def26 :
  forall (c1:Z) (c2:Z) (l:Z) (i:Z),
  (((c1 <= i)%Z /\ (i < (c1 + l)%Z)%Z) ->
   (((result26 c1 c2 l) i) = ((c2 + i)%Z - c1)%Z)) /\
  (~ ((c1 <= i)%Z /\ (i < (c1 + l)%Z)%Z) ->
   (((c2 <= i)%Z /\ (i < (c2 + l)%Z)%Z) ->
    (((result26 c1 c2 l) i) = ((c1 + i)%Z - c2)%Z)) /\
   (~ ((c2 <= i)%Z /\ (i < (c2 + l)%Z)%Z) -> (((result26 c1 c2 l) i) = i))).

Axiom swap_lists_def :
  forall (c1:Z) (c2:Z) (l:Z) (n:Z), ((0%Z <= c1)%Z /\ (c1 < n)%Z) ->
  (0%Z < l)%Z -> ((0%Z <= (c2 + l)%Z)%Z /\ ((c2 + l)%Z <= n)%Z) ->
  ((c1 + l)%Z <= c2)%Z ->
  ((swap_lists c1 c2 l n) = (flat_permutation n (result26 c1 c2 l))).

Parameter fc40: Z -> Z -> Z -> bitvec -> Z -> Z.

Axiom fc_def40 :
  forall (c1:Z) (c2:Z) (l:Z) (x:bitvec) (i:Z),
  (((c1 <= i)%Z /\ (i < (c1 + l)%Z)%Z) ->
   (((fc40 c1 c2 l x) i) = ((value x) ((c2 + i)%Z - c1)%Z))) /\
  (~ ((c1 <= i)%Z /\ (i < (c1 + l)%Z)%Z) ->
   (((c2 <= i)%Z /\ (i < (c2 + l)%Z)%Z) ->
    (((fc40 c1 c2 l x) i) = ((value x) ((c1 + i)%Z - c2)%Z))) /\
   (~ ((c2 <= i)%Z /\ (i < (c2 + l)%Z)%Z) ->
    (((fc40 c1 c2 l x) i) = ((value x) i)))).
  ...
  (((ancillas (swap_lists c1 c2 l n)) = 0%Z) /\
   (((width (swap_lists c1 c2 l n)) = n) /\
    (flat (swap_lists c1 c2 l n)
     (fun (x:bitvec) => (make_bv (fc40 c1 c2 l x) n))
     (fun (us:bitvec) => ang_zero)))).
...
(* Why3 assumption *)
Definition constant_bin (f:bitvec -> Z) (n:Z) : Prop :=
  (1%Z <= n)%Z /\
  ((forall (x:bitvec), ((length x) = n) ->
    (0%Z <= (f x))%Z /\ ((f x) < 2%Z)%Z) /\
   forall (x:bitvec) (y:bitvec),
   (((length x) = (length y)) /\ ((length y) = n)) -> ((f x) = (f y))).

Parameter fc41: (bitvec -> Z) -> bitvec -> bool.

Parameter fc42: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def41 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc41 f) x) = true) <-> ((f x) = 0%Z).

Axiom fc_def42 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc42 f) x) = true) <-> ((f x) = 1%Z).

(* Why3 assumption *)
Definition balanced_bin (f:bitvec -> Z) (n:Z) : Prop :=
  (1%Z <= n)%Z /\
  ((forall (x:bitvec), ((length x) = n) ->
    (0%Z <= (f x))%Z /\ ((f x) < 2%Z)%Z) /\
   (((cardinal (my_filter (n_bvs n) (fc41 f))) = (power_ 2%Z (n - 1%Z)%Z)) /\
    ((cardinal (my_filter (n_bvs n) (fc42 f))) = (power_ 2%Z (n - 1%Z)%Z)))).

Parameter fc43: (bitvec -> Z) -> bitvec -> bool.

Parameter fc44: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def43 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc43 f) x) = true) <-> ((f x) = 0%Z).

Axiom fc_def44 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc44 f) x) = true) <-> ((f x) = 1%Z).

Axiom get_balanced_bin_cardeq :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) ->
  ((cardinal (my_filter (n_bvs n) (fc43 f))) =
   (cardinal (my_filter (n_bvs n) (fc44 f)))).

Parameter fc45: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def45 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc45 f) x) = true) <-> ((f x) = 0%Z).

Axiom get_balanced_bin_zero :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) ->
  ((cardinal (my_filter (n_bvs n) (fc45 f))) = (power_ 2%Z (n - 1%Z)%Z)).

Parameter fc46: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def46 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc46 f) x) = true) <-> ((f x) = 1%Z).

Axiom get_balanced_bin_one :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) ->
  ((cardinal (my_filter (n_bvs n) (fc46 f))) = (power_ 2%Z (n - 1%Z)%Z)).

Parameter fc47: (bitvec -> Z) -> bitvec -> bool.

Parameter fc48: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def47 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc47 f) x) = true) <-> ((f x) = 0%Z).

Axiom fc_def48 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc48 f) x) = true) <-> ((f x) = 1%Z).

Axiom get_balanced_bin :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) ->
  ((cardinal (my_filter (n_bvs n) (fc47 f))) = (power_ 2%Z (n - 1%Z)%Z)) /\
  ((cardinal (my_filter (n_bvs n) (fc48 f))) = (power_ 2%Z (n - 1%Z)%Z)).

Parameter fc49: (bitvec -> Z) -> bitvec -> bool.

Parameter fc50: (bitvec -> Z) -> bitvec -> bool.

Parameter fc51: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def49 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc49 f) x) = true) <-> ((f x) = 0%Z).

Axiom fc_def50 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc50 f) x) = true) <-> ((f x) = 1%Z).

Axiom fc_def51 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc51 f) x) = true) <-> ((f x) = 1%Z).

Axiom set_balanced_bin :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z ->
  (forall (x:bitvec), ((length x) = n) ->
   (0%Z <= (f x))%Z /\ ((f x) < 2%Z)%Z) ->
  (((cardinal (my_filter (n_bvs n) (fc49 f))) =
    (cardinal (my_filter (n_bvs n) (fc50 f)))) /\
   ((cardinal (my_filter (n_bvs n) (fc51 f))) = (power_ 2%Z (n - 1%Z)%Z))) ->
  balanced_bin f n.

Axiom get_constant_bin :
  forall (f:bitvec -> Z) (n:Z), (constant_bin f n) ->
  forall (x:bitvec) (y:bitvec),
  (((length x) = (length y)) /\ ((length y) = n)) -> ((f x) = (f y)).

Axiom set_constant_bin :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z ->
  (forall (x:bitvec), ((length x) = n) ->
   (0%Z <= (f x))%Z /\ ((f x) < 2%Z)%Z) ->
  (forall (x:bitvec) (y:bitvec),
...
Axiom exclu_constant_balanced :
  forall (f:bitvec -> Z) (n:Z),
  ((constant_bin f n) -> ~ (balanced_bin f n)) /\
  ((balanced_bin f n) -> ~ (constant_bin f n)).

Parameter fc52: (bitvec -> Z) -> bitvec -> bool.

Parameter fc53: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def52 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc52 f) x) = true) <-> ((f x) = 0%Z).

Axiom fc_def53 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc53 f) x) = true) <-> ((f x) = 1%Z).

Axiom balanced_sum :
  forall (f:bitvec -> Z) (n:Z), (0%Z <= n)%Z -> (balanced_bin f n) ->
  ((cardinal (my_filter (n_bvs n) (fc52 f))) =
   (cardinal (my_filter (n_bvs n) (fc53 f)))) /\
  (((sum (n_bvs n) (fun (x:bitvec) => (cpower (prefix_mndt c_one) (f x)))) =
    c_zero) /\
   (((modulus
      (sum (n_bvs n) (fun (x:bitvec) => (cpower (prefix_mndt c_one) (f x)))))
     = c_zero) /\
...
Axiom constant_sum :
  forall (f:bitvec -> Z) (n:Z), (0%Z <= n)%Z -> (constant_bin f n) ->
  (forall (x:bitvec) (y:bitvec),
   (((length x) = (length y)) /\ ((length y) = n)) -> ((f x) = (f y))) /\
  (((sum (n_bvs n) (fun (x:bitvec) => (cpower (prefix_mndt c_one) (f x)))) =
    (infix_asdt (i_to_c (power_ 2%Z n))
     (cpower (prefix_mndt c_one) (f (choose (n_bvs n)))))) /\
   (((modulus
      (sum (n_bvs n) (fun (x:bitvec) => (cpower (prefix_mndt c_one) (f x)))))
     = (i_to_c (power_ 2%Z n))) /\
    ((cpower
      (modulus
       (infix_asdt (pow_inv_2 n)
        (sum (n_bvs n)
         (fun (x:bitvec) => (cpower (prefix_mndt c_one) (f x))))))
      2%Z)
     = c_one))).

Axiom ind_balanced_sum :
  forall (f:bitvec -> Z) (n:Z), (0%Z <= n)%Z -> (balanced_bin f n) ->
  ((ind_sum (fun (x:Z) => (cpower (prefix_mndt c_one) (f (int_to_bv x n))))
    0%Z (power_ 2%Z n))
   = c_zero) /\
  (((modulus
     (ind_sum (fun (x:Z) => (cpower (prefix_mndt c_one) (f (int_to_bv x n))))
   ...
   ((cpower
     (modulus
      (ind_sum
       (fun (x:Z) => (cpower (prefix_mndt c_one) (f (int_to_bv x n)))) 0%Z
       (power_ 2%Z n)))
     2%Z)
    = c_zero)).

Axiom ind_constant_sum :
  forall (f:bitvec -> Z) (n:Z), (0%Z <= n)%Z -> (constant_bin f n) ->
  (forall (x:bitvec) (y:bitvec),
   (((length x) = (length y)) /\ ((length y) = n)) -> ((f x) = (f y))) /\
  (((ind_sum (fun (x:Z) => (cpower (prefix_mndt c_one) (f (int_to_bv x n))))
   ...
   (((modulus
     ...
     = (i_to_c (power_ 2%Z n))) /\
    ((modulus
      (infix_asdt (pow_inv_sqrt_2 ((2%Z * n)%Z + 1%Z)%Z)
       (ind_sum
        (fun (x:Z) => (cpower (prefix_mndt c_one) (f (int_to_bv x n)))) 0%Z
        (power_ 2%Z n))))
     = (pow_inv_sqrt_2 1%Z)))).
...
Parameter result27: (matrix complex) -> Z -> Z -> complex.

Axiom result_def27 :
  forall (x:matrix complex) (n:Z) (k:Z),
  (((0%Z <= k)%Z /\ (k < (power_ 2%Z n))%Z) ->
   (((result27 x n) k) = (proba_measure x k n))) /\
  (~ ((0%Z <= k)%Z /\ (k < (power_ 2%Z n))%Z) ->
   (((result27 x n) k) = c_zero)).

Axiom proba_measure_sat_p_def :
  forall (x:matrix complex) (n:Z) (f:Z -> bool), (is_a_ket_l x n) ->
  ((proba_measure_sat_p x n f) =
   (sum (my_filter (to_fset 0%Z (power_ 2%Z n)) f) (result27 x n))).
...
Parameter deutsch_oracle: (bitvec -> Z) -> Z -> circuit.

Axiom deutsch_oracle_spec :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z ->
  (~ (constant_bin f n) -> balanced_bin f n) ->
  ((width (deutsch_oracle f n)) = (n + 1%Z)%Z) /\
  forall (x:bitvec), forall (y:matrix complex), (is_a_ket_l y 1%Z) ->
  ((path_sem (deutsch_oracle f n) (kronecker (bv_to_ket x) y)) =
   (kronecker (bv_to_ket x) (xor_qbits (ket 1%Z (f x)) y))).

Parameter dj_pre: (bitvec -> Z) -> Z -> circuit.

Axiom dj_pre_def :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z ->
  (~ (constant_bin f n) -> balanced_bin f n) ->
  ((dj_pre f n) = (sequence (repeat_had (n + 1%Z)%Z) (deutsch_oracle f n))).

Axiom dj_pre_spec :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z ->
  (~ (constant_bin f n) -> balanced_bin f n) ->
  ((size (dj_pre f n)) = ((n + 1%Z)%Z + (size (deutsch_oracle f n)))%Z) /\
  (((ancillas (dj_pre f n)) = (ancillas (deutsch_oracle f n))) /\
   (((width (dj_pre f n)) = (n + 1%Z)%Z) /\
    ((path_sem (dj_pre f n) (kronecker (ket n 0%Z) (ket 1%Z 1%Z))) =
     (kronecker
      (infix_asdtdt (pow_inv_sqrt_2 n)
       (ket_sum_l (n_bvs n)
        (fun (x:bitvec) =>
...
Parameter dj_output: (bitvec -> Z) -> Z -> matrix complex.
...
Axiom dj_output_spec :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z ->
  (~ (constant_bin f n) -> balanced_bin f n) ->
  (is_a_ket_l (dj_output f n) n) /\
  (((dj_output f n) =
    (ket_sum_l (n_bvs n)
     (fun (y:bitvec) =>
      (infix_asdtdt
       ...
       (bv_to_ket y)))
     n)) /\
   (((get (dj_output f n) 0%Z 0%Z) =
     (sum (n_bvs n) (fun (x:bitvec) => (cpower (prefix_mndt c_one) (f x))))) /\
    (((constant_bin f n) ->
      ((proba_measure (infix_asdtdt (pow_inv_2 n) (dj_output f n)) 0%Z n) =
       c_one)) /\
     ((balanced_bin f n) ->
      ((proba_measure (infix_asdtdt (pow_inv_2 n) (dj_output f n)) 0%Z n) =
       c_zero))))).

Parameter f: bitvec -> Z.

Parameter n: Z.

Axiom H : (1%Z <= n)%Z.

Axiom H1 : ~ (constant_bin f n) -> balanced_bin f n.

Axiom H2 : ((path_sem (repeat_had n) (superposition_state n)) = (ket n 0%Z)).
...
Axiom H4 : is_a_ket_l (pps_apply pps_hadamard (ket 1%Z 1%Z)) 1%Z.

Axiom H5 : ((rows (pps_apply pps_hadamard (ket 1%Z 1%Z))) = 2%Z).

Axiom H6 : ((columns (pps_apply pps_hadamard (ket 1%Z 1%Z))) = 1%Z).
...
Axiom H9 : is_a_ket_l (dj_output f n) n.
...
Axiom H14 : real_ (pow_inv_2 n).

Axiom H15 : infix_gtdt (pow_inv_2 n) c_zero.

Axiom H16 : ((pow_inv_2 n) = (pow_inv_sqrt_2 (2%Z * n)%Z)).

Axiom H17 :
  ((pow_inv_2 n) = (infix_asdt (pow_inv_sqrt_2 n) (pow_inv_sqrt_2 n))).

Axiom H18 :
  ((columns (infix_asdtdt (pow_inv_2 n) (dj_output f n))) =
   (columns (dj_output f n))).

Axiom H19 :
  ((rows (infix_asdtdt (pow_inv_2 n) (dj_output f n))) =
   (rows (dj_output f n))).

Axiom H20 :
  forall (i:Z) (j:Z),
  (valid_index (infix_asdtdt (pow_inv_2 n) (dj_output f n)) i j) ->
  ((get (infix_asdtdt (pow_inv_2 n) (dj_output f n)) i j) =
   (infix_asdt (pow_inv_2 n) (get (dj_output f n) i j))).

Axiom H21 :
  forall (i:Z) (j:Z),
  (valid_index (infix_asdtdt (pow_inv_2 n) (dj_output f n)) i j) <->
  (valid_index (dj_output f n) i j).

Axiom H22 :
  (1%Z <= n)%Z -> forall (s:set bitvec),
  (forall (f1:bitvec), (mem f1 s) <-> ((length f1) = (n - 1%Z)%Z)) ->
  ((n_bvs n) = (union (mapz_pre n s) (mapo_pre n s))).

Axiom H23 : forall (f1:bitvec), (mem f1 (n_bvs n)) -> ((length f1) = n).

Axiom H24 : forall (f1:bitvec), (mem f1 (n_bvs n)) <-> ((length f1) = n).

Axiom H25 : (0%Z < (cardinal (n_bvs n)))%Z.
...
Axiom H32 : real_ (pow_inv_sqrt_2 n).

Axiom H33 :
  ((pow_inv_sqrt_2 n) =
   (infix_sldt c_one (square_rt (i_to_c (power 2%Z n))))).
...
Axiom H38 : ((width (repeat_had n)) = n).

Axiom H39 : ((range (repeat_had n)) = n).

Axiom H40 : ((size (repeat_had n)) = n).

Axiom H41 : ((ancillas (repeat_had n)) = 0%Z).

Axiom H42 :
  forall (x:Z -> Z) (y:Z -> Z), forall (i:Z), ((0%Z <= i)%Z /\ (i < n)%Z) ->
  ((basis_ket (repeat_had n) x y i) = (y i)).

Parameter fc54: (Z -> Z) -> (Z -> Z) -> Z -> angle.

Axiom fc_def54 :
  forall (x:Z -> Z) (y:Z -> Z) (i:Z),
  ((((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc54 x y) i) = (int_to_ang 1%Z 1%Z))) /\
  (~ (((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc54 x y) i) = (int_to_ang 0%Z 1%Z))).

Axiom H43 :
  forall (x:Z -> Z) (y:Z -> Z),
  ((ang_ind (repeat_had n) x y) = (ang_sum (fc54 x y) 0%Z n)).

Axiom H44 : ((circ_to_pps (repeat_had n)) = (repeat_pps_had n)).

Axiom H45 :
  ((path_sem (place (repeat_had n) 0%Z (n + 1%Z)%Z)
    (kronecker
     (infix_asdtdt (pow_inv_sqrt_2 n)
      (ket_sum_l (n_bvs n)
       (fun (x:bitvec) =>
     ...
     (pps_apply pps_hadamard (ket 1%Z 1%Z))))
   =
   (kronecker (infix_asdtdt (pow_inv_2 n) (dj_output f n))
    (pps_apply pps_hadamard (ket 1%Z 1%Z)))).
...
Axiom H47 : is_a_ket_l (pps_apply pps_hadamard (ket 1%Z 1%Z)) 1%Z.

Axiom H48 : ((rows (pps_apply pps_hadamard (ket 1%Z 1%Z))) = 2%Z).

Axiom H49 : ((columns (pps_apply pps_hadamard (ket 1%Z 1%Z))) = 1%Z).
...
Axiom H52 : is_a_ket_l (dj_output f n) n.
...
Axiom H57 : real_ (pow_inv_2 n).

Axiom H58 : infix_gtdt (pow_inv_2 n) c_zero.

Axiom H59 : ((pow_inv_2 n) = (pow_inv_sqrt_2 (2%Z * n)%Z)).
...
Axiom H65 :
  ((rows
   ...
   =
   ((rows (infix_asdtdt (pow_inv_2 n) (dj_output f n))) *
    (rows (pps_apply pps_hadamard (ket 1%Z 1%Z))))%Z).
...
Axiom H66 :
  ((columns
   ...
   =
   ((columns (infix_asdtdt (pow_inv_2 n) (dj_output f n))) *
    (columns (pps_apply pps_hadamard (ket 1%Z 1%Z))))%Z).
...
Axiom H67 :
  ...
  ((get
   ...
   =
   (infix_asdt
    (get (infix_asdtdt (pow_inv_2 n) (dj_output f n))
     (int.EuclideanDivision.div i
      (rows (pps_apply pps_hadamard (ket 1%Z 1%Z))))
     (int.EuclideanDivision.div j
      (columns (pps_apply pps_hadamard (ket 1%Z 1%Z)))))
    (get (pps_apply pps_hadamard (ket 1%Z 1%Z))
...
Axiom H69 : is_a_ket_l (pps_apply pps_hadamard (ket 1%Z 1%Z)) 1%Z.

Axiom H70 : ((rows (pps_apply pps_hadamard (ket 1%Z 1%Z))) = 2%Z).

Axiom H71 : ((columns (pps_apply pps_hadamard (ket 1%Z 1%Z))) = 1%Z).
...
Axiom H75 : forall (f1:bitvec), (mem f1 (n_bvs n)) -> ((length f1) = n).

Axiom H76 : forall (f1:bitvec), (mem f1 (n_bvs n)) <-> ((length f1) = n).

Axiom H77 : (0%Z < (cardinal (n_bvs n)))%Z.
...
Axiom H84 : real_ (pow_inv_sqrt_2 n).
...
Axiom H93 : ((get (ket 1%Z 1%Z) 0%Z 0%Z) = c_zero).

Axiom H94 : ((get (ket 1%Z 1%Z) 1%Z 0%Z) = c_one).

Axiom H95 : is_a_ket_l (ket 1%Z 1%Z) 1%Z.

Axiom H96 : ((rows (ket 1%Z 1%Z)) = 2%Z).

Axiom H97 : ((columns (ket 1%Z 1%Z)) = 1%Z).

Axiom H98 : ((get (ket 1%Z 1%Z) 0%Z 0%Z) = c_zero).

Axiom H99 : ((get (ket 1%Z 1%Z) 1%Z 0%Z) = c_one).

Axiom H100 : is_a_ket_basis_elt (ket 1%Z 1%Z).

Axiom H101 : is_a_ket (ket n 0%Z).

Axiom H102 : ((ket_length (ket n 0%Z)) = n).

Axiom H103 : ((columns (ket n 0%Z)) = 1%Z).

Axiom H104 : ((rows (ket n 0%Z)) = (power 2%Z n)).
...
Axiom H108 :
  ((rows (kronecker (ket n 0%Z) (ket 1%Z 1%Z))) =
   ((rows (ket n 0%Z)) * (rows (ket 1%Z 1%Z)))%Z).

Axiom H109 :
  ((columns (kronecker (ket n 0%Z) (ket 1%Z 1%Z))) =
   ((columns (ket n 0%Z)) * (columns (ket 1%Z 1%Z)))%Z).

Axiom H110 :
  forall (i:Z) (j:Z),
  (valid_index (kronecker (ket n 0%Z) (ket 1%Z 1%Z)) i j) ->
  ((get (kronecker (ket n 0%Z) (ket 1%Z 1%Z)) i j) =
   (infix_asdt
    (get (ket n 0%Z) (int.EuclideanDivision.div i (rows (ket 1%Z 1%Z)))
...
Axiom H111 : ((width (repeat_had n)) = n).

Axiom H112 : ((range (repeat_had n)) = n).

Axiom H113 : ((size (repeat_had n)) = n).

Axiom H114 : ((ancillas (repeat_had n)) = 0%Z).

Axiom H115 :
  forall (x:Z -> Z) (y:Z -> Z), forall (i:Z), ((0%Z <= i)%Z /\ (i < n)%Z) ->
  ((basis_ket (repeat_had n) x y i) = (y i)).

Parameter fc55: (Z -> Z) -> (Z -> Z) -> Z -> angle.

Axiom fc_def55 :
  forall (x:Z -> Z) (y:Z -> Z) (i:Z),
  ((((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc55 x y) i) = (int_to_ang 1%Z 1%Z))) /\
  (~ (((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc55 x y) i) = (int_to_ang 0%Z 1%Z))).

Axiom H116 :
  forall (x:Z -> Z) (y:Z -> Z),
  ((ang_ind (repeat_had n) x y) = (ang_sum (fc55 x y) 0%Z n)).

Axiom H117 : ((circ_to_pps (repeat_had n)) = (repeat_pps_had n)).

Axiom H118 :
  ((ancillas (place (repeat_had n) 0%Z (n + 1%Z)%Z)) =
   (ancillas (repeat_had n))).

Axiom H119 :
  ((size (place (repeat_had n) 0%Z (n + 1%Z)%Z)) = (size (repeat_had n))).

Axiom H120 :
  ((range (place (repeat_had n) 0%Z (n + 1%Z)%Z)) = (range (repeat_had n))).

Axiom H121 : ((width (place (repeat_had n) 0%Z (n + 1%Z)%Z)) = (n + 1%Z)%Z).

Axiom H122 :
  forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (n + 1%Z)%Z)%Z) ->
  (((0%Z <= i)%Z /\ (i < (0%Z + (width (repeat_had n)))%Z)%Z) ->
   ((basis_ket (place (repeat_had n) 0%Z (n + 1%Z)%Z) x y i) =
    (basis_ket (repeat_had n) (fun (j:Z) => (x (j + 0%Z)%Z)) y (i - 0%Z)%Z))) /\
  (~ ((0%Z <= i)%Z /\ (i < (0%Z + (width (repeat_had n)))%Z)%Z) ->
   ((basis_ket (place (repeat_had n) 0%Z (n + 1%Z)%Z) x y i) = (x i))).

Axiom H123 :
  forall (x:Z -> Z) (y:Z -> Z),
  ((ang_ind (place (repeat_had n) 0%Z (n + 1%Z)%Z) x y) =
   (ang_ind (repeat_had n) (fun (j:Z) => (x (j + 0%Z)%Z)) y)).

Axiom H124 :
  (((n + 1%Z)%Z = (0%Z + (width (repeat_had n)))%Z) ->
   ((place (repeat_had n) 0%Z (n + 1%Z)%Z) = (repeat_had n))) /\
  (~ ((n + 1%Z)%Z = (0%Z + (width (repeat_had n)))%Z) ->
   ((place (repeat_had n) 0%Z (n + 1%Z)%Z) =
    (parallel (repeat_had n)
     (ids (((n + 1%Z)%Z - 0%Z)%Z - (width (repeat_had n)))%Z)))).

Axiom H125 :
  ((size (dj_pre f n)) = ((n + 1%Z)%Z + (size (deutsch_oracle f n)))%Z).

Axiom H126 : ((ancillas (dj_pre f n)) = (ancillas (deutsch_oracle f n))).

Axiom H127 : ((width (dj_pre f n)) = (n + 1%Z)%Z).
...
Axiom H129 :
  ((path_sem (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z))
    (kronecker (ket n 0%Z) (ket 1%Z 1%Z)))
   =
   (kronecker (infix_asdtdt (pow_inv_2 n) (dj_output f n))
    (pps_apply pps_hadamard (ket 1%Z 1%Z)))).

Axiom H130 : ((width (repeat_had n)) = n).

Axiom H131 : ((range (repeat_had n)) = n).

Axiom H132 : ((size (repeat_had n)) = n).

Axiom H133 : ((ancillas (repeat_had n)) = 0%Z).

Axiom H134 :
  forall (x:Z -> Z) (y:Z -> Z), forall (i:Z), ((0%Z <= i)%Z /\ (i < n)%Z) ->
  ((basis_ket (repeat_had n) x y i) = (y i)).

Parameter fc56: (Z -> Z) -> (Z -> Z) -> Z -> angle.

Axiom fc_def56 :
  forall (x:Z -> Z) (y:Z -> Z) (i:Z),
  ((((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc56 x y) i) = (int_to_ang 1%Z 1%Z))) /\
  (~ (((x i) = (y i)) /\ ((y i) = 1%Z)) ->
   (((fc56 x y) i) = (int_to_ang 0%Z 1%Z))).

Axiom H135 :
  forall (x:Z -> Z) (y:Z -> Z),
  ((ang_ind (repeat_had n) x y) = (ang_sum (fc56 x y) 0%Z n)).

Axiom H136 : ((circ_to_pps (repeat_had n)) = (repeat_pps_had n)).
...
Axiom H140 : ((width (place (repeat_had n) 0%Z (n + 1%Z)%Z)) = (n + 1%Z)%Z).
...
Axiom H145 : ((ancillas (dj_pre f n)) = (ancillas (deutsch_oracle f n))).

Axiom H146 : ((width (dj_pre f n)) = (n + 1%Z)%Z).
...
Axiom H148 :
  ((circ_to_pps
    (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z)))
   =
   (pps_seq (circ_to_pps (dj_pre f n))
    (circ_to_pps (place (repeat_had n) 0%Z (n + 1%Z)%Z)))).

Axiom H149 :
  ((ancillas (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z)))
   =
   (ZArith.BinInt.Z.max (ancillas (dj_pre f n))
    (ancillas (place (repeat_had n) 0%Z (n + 1%Z)%Z)))).

Axiom H150 :
  ((size (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z))) =
   ((size (dj_pre f n)) + (size (place (repeat_had n) 0%Z (n + 1%Z)%Z)))%Z).

Axiom H151 :
  ((width (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z))) =
   (width (dj_pre f n))).

Axiom H152 :
  ((range (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z))) =
   ((range (dj_pre f n)) + (range (place (repeat_had n) 0%Z (n + 1%Z)%Z)))%Z).

Axiom H153 :
  forall (x:Z -> Z) (y:Z -> Z),
  ((ang_ind (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z)) x
    y)
   =
   (ang_add (ang_ind (dj_pre f n) x y)
    (ang_ind (place (repeat_had n) 0%Z (n + 1%Z)%Z)
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
         (basis_ket y0 y1 y2 y3))
        (dj_pre f n))
       x)
      y)
     (fun (k:Z) => (y (k + (range (dj_pre f n)))%Z))))).

Axiom H154 :
  forall (x:Z -> Z) (y:Z -> Z), forall (i:Z),
  ((basis_ket (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z))
    x y i)
   =
   (basis_ket (place (repeat_had n) 0%Z (n + 1%Z)%Z)
    ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
        (basis_ket y0 y1 y2 y3))
       (dj_pre f n))
      x)
     y)
    (fun (k:Z) => (y (k + (range (dj_pre f n)))%Z)) i)).

Axiom H155 :
  ((size (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z))) =
   (((2%Z * n)%Z + 1%Z)%Z + (size (deutsch_oracle f n)))%Z).

(* Why3 goal *)
Theorem VC_dj :
  ((ancillas (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z)))
   = (ancillas (deutsch_oracle f n))).
Proof.
