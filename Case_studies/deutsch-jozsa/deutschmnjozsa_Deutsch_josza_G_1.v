...
Axiom op_neutral_left_def :
  ...
  forall (op1:im -> im -> im) (neutral:im), (op_neutral_left op1 neutral) ->
  forall (e:im), (((op1 neutral) e) = e).

Axiom op_neutral_left_def1 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (neutral:im),
  (forall (e:im), (((op1 neutral) e) = e)) -> op_neutral_left op1 neutral.
...
Axiom op_neutral_right_def :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (neutral:im), (op_neutral_right op1 neutral) ->
  forall (e:im), (((op1 e) neutral) = e).

Axiom op_neutral_right_def1 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (neutral:im),
  (forall (e:im), (((op1 e) neutral) = e)) -> op_neutral_right op1 neutral.
...
Axiom op_assoc_def :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im), (op_assoc op1) -> forall (a:im) (b:im) (c:im),
...
Axiom op_neutral_left_comm_def :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (neutral:im),
  (op_neutral_left_comm op1 neutral) -> forall (a:im),
  (forall (b:im), (((op1 a) b) = b)) -> (a = neutral).
...
Axiom commut_def :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im), (commut op1) -> forall (a:im) (b:im),
  (((op1 a) b) = ((op1 b) a)).

Axiom commut_def1 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im),
  (forall (a:im) (b:im), (((op1 a) b) = ((op1 b) a))) -> commut op1.
...
Axiom assoc_def :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im), (assoc op1) -> forall (a:im) (b:im) (c:im),
  (((op1 ((op1 a) b)) c) = ((op1 a) ((op1 b) c))).
...
Axiom opposite_n_def1 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (po1:im -> im -> im) (neutral:im),
  (forall (a:im), (((po1 a) a) = neutral)) -> opposite_n op1 po1 neutral.
...
Axiom inverse_def :
  ...
  (inverse op1 po1 inver1) -> forall (a:im) (b:im),
...
Axiom opposite_def :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (po1:im -> im -> im), (opposite op1 po1) ->
  forall (a:im) (b:im), (((op1 ((po1 a) b)) b) = a).

Axiom opposite_def1 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (po1:im -> im -> im),
  (forall (a:im) (b:im), (((op1 ((po1 a) b)) b) = a)) -> opposite op1 po1.
...
Axiom opposite_com_def :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (po1:im -> im -> im), (opposite_com op1 po1) ->
  forall (a:im) (b:im), (((po1 ((op1 a) b)) b) = a).

Axiom opposite_com_def1 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (po1:im -> im -> im),
  (forall (a:im) (b:im), (((po1 ((op1 a) b)) b) = a)) -> opposite_com op1 po1.
...
Axiom neutral_def :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (neut:im), (neutral op1 neut) ->
...
Axiom neutral_def2 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (neut:im), (neutral op1 neut) -> op_assoc op1.

Axiom neutral_def3 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (neut:im),
  ((op_neutral_left op1 neut) /\
...
Axiom has_neutral_def :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im), (has_neutral op1) ->
  exists e:im, neutral op1 e.

Axiom has_neutral_def1 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im), (exists e:im, neutral op1 e) ->
  has_neutral op1.
...
Axiom iterates_def :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (neutral1:im), (iterates op1 neutral1) ->
...
Axiom iterable_def1 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im), (exists e:im, iterates op1 e) -> iterable op1.
...
Axiom neutral_elt_spec :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im), forall (e:im), (neutral op1 e) ->
  ((neutral_elt op1) = e).

Axiom neutral_elt_spec1 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im), forall (e:im), ((neutral_elt op1) = e) ->
  neutral op1 e.
...
Axiom inverse_tuple_def1 :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (po1:im -> im -> im) (neutral1:im),
  (inverse_tuple op1 po1 neutral1) -> opposite op1 po1.
...
Axiom substract_comm :
  forall {im:Type} {im_WT:WhyType im},
  forall (op1:im -> im -> im) (po1:im -> im -> im) (a:im) (b:im),
...
Axiom opposite1 : forall (a:t), ((infix_mndt a a) = tzero).
...
Axiom real__def : forall (x:t), (real_ x) -> ((im_part x) = 0%R).

Axiom real__def1 : forall (x:t), ((im_part x) = 0%R) -> real_ x.

Parameter pure_im_: t -> Prop.

Axiom pure_im__def : forall (x:t), (pure_im_ x) -> ((real_part x) = 0%R).

Axiom pure_im__def1 : forall (x:t), ((real_part x) = 0%R) -> pure_im_ x.
...
Axiom tone_modulus_def1 :
  forall (x:t), ((modulus x) = tone) -> tone_modulus x.
...
Axiom eq_t_def1 : forall (a:t) (a':t), (a = a') -> eq_t a a'.
...
Axiom constant_size_def :
  ...
  (mem e s) -> ((rows (f e)) = (rows (f (choose s)))).

Axiom constant_size_def1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t), (constant_size s f) -> forall (e:a),
  (mem e s) -> ((columns (f e)) = (columns (f (choose s)))).
...
Axiom mat_sum_spec2 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t), (constant_size s f) ->
  ((cardinal s) > 0%Z)%Z -> forall (e:a), (mem e s) ->
  ((rows (f e)) = (s_rows s f)).
...
Axiom mat_sum_null_but_maybe_one_elt :
  forall {a:Type} {a_WT:WhyType a},
  forall (f:a -> matrix t) (s:set a) (e:a), ((cardinal s) > 1%Z)%Z ->
...
Axiom nonn_mat_sum :
  ...
  (c > 0%Z)%Z -> (forall (e:a), (mem e s) -> ((rows (f e)) = r)) ->
  (forall (e:a), (mem e s) -> ((columns (f e)) = c)) ->
  ((mat_sum_dim s f r c) = (mat_sum_dim (nonn_mat_subset f s) f r c)).
...
Axiom setbv_def :
  ...
  let result8 := setbv bv i j in
  forall (k:Z),
  ((k = i) -> ((result8 k) = j)) /\ (~ (k = i) -> ((result8 k) = (bv k))).
...
Axiom setbv_int_def :
  ...
  let result8 := setbv_int bv1 bv2 i j in
  forall (k:Z),
  (((i < k)%Z /\ (k <= j)%Z) -> ((result8 k) = (bv2 (k - i)%Z))) /\
  (~ ((i < k)%Z /\ (k <= j)%Z) -> ((result8 k) = (bv1 k))).
...
Axiom result_def9 :
  ...
  (~ (k = 0%Z) -> (((result9 bv i) k) = ((getbv bv) (k - 1%Z)%Z))).
...
Axiom bv_to_int_def :
  forall (bv:bitvec),
  ((bv_to_int bv) = (ind_isum (result10 bv) 0%Z (length bv))).
...
Axiom ang_minus_one_from_real :
  (ang_minus_one = (real_to_ang (prefix_mndt tone))).
...
Axiom K_int_to_ang :
  forall (k:Z), (k >= 0%Z)%Z -> ((k_int_to_ang k) = (int_to_ang 1%Z k)).
...
Axiom multiple_control_as_ang_sum :
  ...
  ((forall (j:Z), ((0%Z <= j)%Z /\ (j < n)%Z) -> (((getbv x) j) = 1%Z)) ->
   (o = (ang_mult_int o (ind_iproduct (getbv x) 0%Z n)))) /\
  (~ (forall (j:Z), ((0%Z <= j)%Z /\ (j < n)%Z) -> (((getbv x) j) = 1%Z)) ->
   (ang_zero = (ang_mult_int o (ind_iproduct (getbv x) 0%Z n)))).

Axiom multiple_control_as_ang_sum_rev :
  forall (n:Z) (o:angle), (0%Z <= n)%Z -> forall (x:bitvec),
  ((length x) = n) ->
  ((forall (j:Z), ((0%Z <= j)%Z /\ (j < n)%Z) -> (((getbv x) j) = 1%Z)) ->
   ((ang_mult_int o (ind_iproduct (getbv x) 0%Z n)) = o)) /\
  (~ (forall (j:Z), ((0%Z <= j)%Z /\ (j < n)%Z) -> (((getbv x) j) = 1%Z)) ->
   ((ang_mult_int o (ind_iproduct (getbv x) 0%Z n)) = ang_zero)).

Axiom multiple_control_neg_as_ang_sum :
  forall (n:Z), (0%Z <= n)%Z -> forall (x:bitvec), ((length x) = n) ->
  ((forall (j:Z), ((0%Z <= j)%Z /\ (j < n)%Z) -> (((getbv x) j) = 0%Z)) ->
   ((ang_mult_int ang_minus_one
     (ind_iproduct (fun (j:Z) => (1%Z - ((getbv x) j))%Z) 0%Z n))
    = ang_minus_one)) /\
  (~ (forall (j:Z), ((0%Z <= j)%Z /\ (j < n)%Z) -> (((getbv x) j) = 0%Z)) ->
   ((ang_mult_int ang_minus_one
     (ind_iproduct (fun (j:Z) => (1%Z - ((getbv x) j))%Z) 0%Z n))
...
Axiom min_filter_def1 :
  ...
  ~ ((p (min_set s)) = true) ->
  ((min_filter s p) = (min_filter (remove (choose s) s) p)).
...
Axiom max_filter_def1 :
  ...
  (exists e1:Z, (mem e1 s) /\ ((p e1) = true)) ->
  ~ ((p (max_set s)) = true) ->
  ((max_filter s p) = (max_filter (remove (choose s) s) p)).
...
Axiom is_a_ket_l_def :
  forall (m:matrix t) (l:Z), (is_a_ket_l m l) -> (l >= 0%Z)%Z.

Axiom is_a_ket_l_def1 :
  forall (m:matrix t) (l:Z), (is_a_ket_l m l) -> ((columns m) = 1%Z).
...
Axiom ket_valid_index_def1 :
  forall (m:matrix t) (i:Z), (valid_index m i 0%Z) -> ket_valid_index m i.
...
Axiom size_spec : forall (c:gate), ((size c) >= 0%Z)%Z.

Parameter range: gate -> Z.

Axiom range_spec : forall (c:gate), ((range c) >= 0%Z)%Z.
...
Parameter basis_ket_i: gate -> bitvec -> bitvec -> Z -> Z.

Axiom basis_ket_i_def :
  forall (c:gate) (x:bitvec) (y:bitvec) (i:Z),
...
Parameter ang_ind: gate -> bitvec -> bitvec -> angle.

Axiom ang_ind_def :
  forall (c:gate) (x:bitvec) (y:bitvec),
  ((ang_ind c x y) =
   (ang_sum
...
Parameter ang_ind_exp: gate -> bitvec -> bitvec -> t.
...
Axiom parallel_spec2 :
  forall (d:gate) (e1:gate), forall (x:bitvec) (y:bitvec),
  ((length x) = (size (parallel d e1))) ->
  ((length y) = (range (parallel d e1))) ->
  ((basis_ket (parallel d e1) x y) =
   (concat (basis_ket d (hpart x (size d)) (hpart y (range d)))
    (basis_ket e1 (tpart x (size d)) (tpart y (range d))))).

Axiom parallel_spec3 :
  forall (d:gate) (e1:gate), forall (x:bitvec) (y:bitvec), forall (i:Z),
  ((length x) = (size (parallel d e1))) ->
  ((length y) = (range (parallel d e1))) ->
  ((0%Z <= i)%Z /\ (i < ((size d) + (size e1))%Z)%Z) ->
  ((i < (size d))%Z ->
   ((basis_ket_i (parallel d e1) x y i) =
    (basis_ket_i d (hpart x (size d)) (hpart y (range d)) i))) /\
  (~ (i < (size d))%Z ->
   ((basis_ket_i (parallel d e1) x y i) =
    (basis_ket_i e1 (tpart x (size d)) (tpart y (range d)) (i - (size d))%Z))).
...
Axiom parallel_spec5 :
  ...
  (~ (i < (ang_ind_bound d))%Z ->
   ((ang_ind_i (parallel d e1) x y i) =
    (ang_ind_i e1 (tpart x (size d)) (tpart y (range d)) (i - (range d))%Z))).
...
Axiom parallel_spec6 :
  ...
  ((ang_ind (parallel d e1) x y) =
   (ang_add (ang_ind d (hpart x (size d)) (hpart y (range d)))
    (ang_ind e1 (tpart x (size d)) (tpart y (range d))))).

Parameter sequence: gate -> gate -> gate.

Axiom sequence_spec :
  forall (d:gate) (e1:gate), ((size d) = (size e1)) ->
  ((range (sequence d e1)) = ((range d) + (range e1))%Z).

Axiom sequence_spec1 :
  forall (d:gate) (e1:gate), ((size d) = (size e1)) ->
  ((size (sequence d e1)) = (size d)).

Axiom sequence_spec2 :
  forall (d:gate) (e1:gate), ((size d) = (size e1)) ->
  forall (x:bitvec) (y:bitvec), ((length x) = (size (sequence d e1))) ->
...
Axiom path_sum_scheme_basis :
  ...
  forall (x:matrix t), (is_a_ket_l x size1) -> (range1 >= 0%Z)%Z ->
  (forall (x1:bitvec) (y:bitvec), ((length x1) = size1) ->
   ((length y) = range1) -> ((length ((k x1) y)) = size1)) ->
  (is_a_ket_basis_elt x) ->
  ((path_sum_scheme a k size1 range1 x) =
...
Axiom set_path_sum_basis :
  forall (a:bitvec -> bitvec -> angle) (k:bitvec -> bitvec -> bitvec)
    (size1:Z) (range1:Z) (x:matrix t),
  (is_a_ket_l x size1) -> (is_a_ket_basis_elt x) -> (range1 >= 0%Z)%Z ->
  (forall (x1:bitvec) (y:bitvec), ((length x1) = size1) ->
   ((length y) = range1) -> ((length ((k x1) y)) = size1)) ->
  ((path_sum_scheme a k size1 range1 x) =
   (path_sum_scheme_unit a k size1 range1 (ket_to_bv x))).
...
Axiom correct_path_sum_unit_def :
  ...
  (correct_path_sum_unit c a k range1 x) -> forall (x1:bitvec) (y:bitvec),
  ((length x1) = (size c)) -> ((length y) = range1) ->
  ((length ((k x1) y)) = (size c)).

Axiom correct_path_sum_unit_def1 :
  forall (c:gate) (a:bitvec -> bitvec -> angle)
    (k:bitvec -> bitvec -> bitvec) (range1:Z) (x:bitvec),
  (correct_path_sum_unit c a k range1 x) -> (range1 >= 0%Z)%Z.

Axiom correct_path_sum_unit_def2 :
  forall (c:gate) (a:bitvec -> bitvec -> angle)
    (k:bitvec -> bitvec -> bitvec) (range1:Z) (x:bitvec),
  (correct_path_sum_unit c a k range1 x) -> ((length x) = (size c)).

Axiom correct_path_sum_unit_def3 :
  forall (c:gate) (a:bitvec -> bitvec -> angle)
    (k:bitvec -> bitvec -> bitvec) (range1:Z) (x:bitvec),
...
Axiom correct_path_sum_unit_def4 :
  forall (c:gate) (a:bitvec -> bitvec -> angle)
    (k:bitvec -> bitvec -> bitvec) (range1:Z) (x:bitvec),
...
Axiom correct_path_sum_def1 :
  forall (c:gate), forall (a:bitvec -> bitvec -> angle),
  forall (k:bitvec -> bitvec -> bitvec), forall (range1:Z),
  (correct_path_sum c a k range1) -> (range1 >= 0%Z)%Z.
...
Axiom sum_sem_gen :
  ...
  ((cardinal s) >= 1%Z)%Z ->
  (forall (e1:a), (mem e1 s) -> sem c (f e1) (g e1)) -> (l1 = (size c)) ->
...
Axiom sum_scal_sem :
  ...
  sem c (ket_sum_l s (fun (e1:a) => (infix_asdtdt (g e1) (f e1))) (size c))
  (ket_sum_l s (fun (e1:a) => (infix_asdtdt (g e1) (h e1))) (size c)).
...
Axiom comp_sem_sum :
  ...
  ((cardinal s) > 0%Z)%Z -> ((size c) = (size c')) ->
  (forall (e1:a), (mem e1 s) -> sem c (f e1) (g e1)) ->
...
Axiom sequence_spec_i_l_def :
  ...
  (forall (x:bitvec) (y:bitvec) (i:Z), ((length x) = (size c)) ->
   ((length y) = rse) -> ((0%Z <= i)%Z /\ (i < (size c))%Z) ->
   ((((bse x) y) i) =
    ((getbv ((b' (make_bv ((b x) (hpart y r)) (size c))) (tpart y r))) i))) ->
  (forall (x:bitvec) (y:bitvec) (i:Z), ((length x) = (size c)) ->
...
Axiom place_spec :
  forall (c:gate) (k:Z) (n:Z), (k >= 0%Z)%Z -> (n >= ((size c) + k)%Z)%Z ->
...
Axiom place_spec_i_def :
  forall (c:gate) (k:Z) (n:Z) (ase:bitvec -> bitvec -> Z -> angle)
    ...
    (r:Z),
  (k >= 0%Z)%Z -> (n >= ((size c) + k)%Z)%Z -> (l < h)%Z -> (rse = r) ->
  (forall (x:bitvec) (y:bitvec), forall (i:Z), ((length x) = n) ->
...
Axiom fc_def13 :
  forall (c:gate) (k:Z) (b:bitvec -> bitvec -> bitvec) (x:bitvec) (y:bitvec)
    (i:Z),
  (((k <= i)%Z /\ (i < (k + (size c))%Z)%Z) ->
   (((fc13 c k b x y) i) = ((getbv ((b (htpart x k (size c))) y)) (i - k)%Z))) /\
  (~ ((k <= i)%Z /\ (i < (k + (size c))%Z)%Z) ->
...
Axiom place_comp_scheme :
  forall (c:gate) (k:Z) (n:Z) (a:bitvec -> bitvec -> angle)
    (b:bitvec -> bitvec -> bitvec) (r:Z),
  (k >= 0%Z)%Z -> (n >= ((size c) + k)%Z)%Z -> (correct_path_sum c a b r) ->
...
Axiom place_kron :
  forall (c:gate) (k:Z) (n:Z) (x:matrix t) (y:matrix t) (y':matrix t)
    (z:matrix t),
  (k >= 0%Z)%Z -> (n >= ((size c) + k)%Z)%Z -> (is_a_ket_l x k) ->
...
Axiom cont_kron_left_contz :
  ...
  (((getbv (ket_to_bv y)) (co - (size c))%Z) = 0%Z) ->
...
Axiom cont_kron_left_conto :
  ...
  (((size c) <= co)%Z /\ (co < n)%Z) -> (is_a_ket_l x (size c)) ->
  (is_a_ket_l y (n - (size c))%Z) -> (is_a_ket_basis_elt y) ->
  (((getbv (ket_to_bv y)) (co - (size c))%Z) = 1%Z) ->
...
Axiom gen_ket_def1 : forall (a:angle_func), ((range_a a) = 0%Z) -> gen_ket a.
...
Axiom d_sequence_eq :
  forall (d:gate) (d':gate) (e1:gate) (e':gate), (diag d) -> (diag e1) ->
  ((size d) = (size e1)) -> (d = d') -> (e1 = e') ->
...
Axiom d_parallel_eq :
  forall (d:gate) (d':gate) (e1:gate) (e':gate), (diag d) -> (diag e1) ->
  (d = d') -> (e1 = e') -> ((d_parallel d e1) = (d_parallel d' e')).
...
Axiom rzp_spec : forall (n:Z), (n >= 0%Z)%Z -> ((size (rzp n)) = 1%Z).

Axiom rzp_spec1 : forall (n:Z), (n >= 0%Z)%Z -> diag (rzp n).
...
Axiom rzp_neg_spec :
  forall (n:Z), (n >= 0%Z)%Z -> ((size (rzp_neg n)) = 1%Z).
...
Axiom dcont_spec2 :
  ...
  (((diag_ang (dcont c co ft n)) x) =
   (ang_mult_int ((diag_ang c) (htpart x ft (size c))) ((getbv x) co))).
...
Axiom c_rzp_def :
  ...
  ~ (ft <= co)%Z -> ((c_rzp k co ft n) = (dcont (rzp k) co ft n)).
...
Axiom xx_spec1 : forall (us:unit), ((size (xx us)) = 1%Z).
...
Parameter correct_flat:
  gate -> (bitvec -> angle) -> (bitvec -> bitvec) -> Prop.
...
Axiom choose_filter_def :
  ...
  (exists e1:a, (mem e1 s) /\ ((p e1) = true)) -> ((p (choose s)) = true) ->
...
Axiom choose_filter_spec1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (p:a -> bool),
  (exists e1:a, (mem e1 s) /\ ((p e1) = true)) -> mem (choose_filter s p) s.
...
Axiom my_filter_spec :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (p:a -> bool), forall (e1:a), (mem e1 s) ->
  ((p e1) = true) -> mem e1 (my_filter s p).

Axiom my_filter_spec1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (p:a -> bool), forall (e1:a), (mem e1 s) ->
  (mem e1 (my_filter s p)) -> ((p e1) = true).

Axiom my_filter_spec2 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (p:a -> bool), forall (e1:a), (mem e1 (my_filter s p)) ->
  mem e1 s.
...
Parameter cascade_cont_rz: Z -> Z -> Z -> Z -> gate.

Parameter result21: Z -> Z -> Z -> gate.

Axiom result_def21 :
  forall (t1:Z) (n:Z) (k:Z),
  ((((t1 + 1%Z)%Z <= k)%Z /\ (k < n)%Z) ->
   (((result21 t1 n) k) = (c_rzp_neg ((k - t1)%Z + 1%Z)%Z k t1 n))) /\
  (~ (((t1 + 1%Z)%Z <= k)%Z /\ (k < n)%Z) ->
   (((result21 t1 n) k) = (rzp 1%Z))).

Axiom cascade_cont_rz_def :
  forall (first_c:Z) (t1:Z) (l:Z) (n:Z), (0%Z < l)%Z ->
  ((0%Z <= first_c)%Z /\ (first_c < n)%Z) ->
  ((0%Z <= t1)%Z /\ (t1 < (n - 1%Z)%Z)%Z) ->
  (((first_c + l)%Z - 1%Z)%Z < n)%Z ->
  ~ (t1 <= ((first_c + l)%Z - 1%Z)%Z)%Z ->
  ((cascade_cont_rz first_c t1 l n) =
   (d_seq_iter (result21 t1 n) n (t1 + 1%Z)%Z n)).

Parameter result22: Z -> Z -> Z -> gate.

Axiom result_def22 :
  forall (t1:Z) (n:Z) (k:Z),
  ((((t1 + 1%Z)%Z <= k)%Z /\ (k < n)%Z) ->
   (((result22 t1 n) k) = (c_rzp_neg ((k - t1)%Z + 1%Z)%Z k t1 n))) /\
  (~ (((t1 + 1%Z)%Z <= k)%Z /\ (k < n)%Z) ->
   (((result22 t1 n) k) = (rzp 1%Z))).

Axiom cascade_cont_rz_def1 :
  forall (first_c:Z) (t1:Z) (l:Z) (n:Z), (0%Z < l)%Z ->
  ((0%Z <= first_c)%Z /\ (first_c < n)%Z) ->
  ((0%Z <= t1)%Z /\ (t1 < (n - 1%Z)%Z)%Z) ->
  (((first_c + l)%Z - 1%Z)%Z < n)%Z -> (t1 < first_c)%Z ->
  ((cascade_cont_rz first_c t1 l n) =
   (d_seq_iter (result22 t1 n) n (t1 + 1%Z)%Z n)).
...
Axiom cascade_cont_rz_spec :
  ...
  (((first_c + l)%Z - 1%Z)%Z < n)%Z ->
  ~ (t1 <= ((first_c + l)%Z - 1%Z)%Z)%Z ->
  ((size (cascade_cont_rz first_c t1 l n)) = n).
...
Axiom cascade_cont_rz_spec1 :
  ...
  (((first_c + l)%Z - 1%Z)%Z < n)%Z ->
  ~ (t1 <= ((first_c + l)%Z - 1%Z)%Z)%Z ->
  diag (cascade_cont_rz first_c t1 l n).
...
Axiom cascade_cont_rz_spec2 :
  ...
  ~ (t1 <= ((first_c + l)%Z - 1%Z)%Z)%Z ->
  ((cascade_cont_rz first_c t1 l n) =
   (d_seq_iter (fun (k:Z) => (c_rzp_neg ((k - t1)%Z + 1%Z)%Z k t1 n)) n
    (t1 + 1%Z)%Z n)).
...
Axiom cascade_cont_rz_spec3 :
  ...
  ((0%Z <= t1)%Z /\ (t1 < (n - 1%Z)%Z)%Z) ->
  (((first_c + l)%Z - 1%Z)%Z < n)%Z ->
  ~ (t1 <= ((first_c + l)%Z - 1%Z)%Z)%Z -> forall (x:bitvec),
  ((length x) = n) ->
  (((diag_ang (cascade_cont_rz first_c t1 l n)) x) =
   (ang_sum
    (fun (k:Z) =>
     (int_to_ang
      (((-((getbv x) k))%Z * ((getbv x) t1))%Z *
...
Axiom cascade_cont_rz_spec4 :
  ...
  (((first_c + l)%Z - 1%Z)%Z < n)%Z ->
  ~ (t1 <= ((first_c + l)%Z - 1%Z)%Z)%Z ->
  correct_path_sum_i (cascade_cont_rz first_c t1 l n)
  (fun (x:bitvec) (us:bitvec) (k:Z) =>
   (int_to_ang
    (((-((getbv x) k))%Z * ((getbv x) t1))%Z *
     (power_ 2%Z (((n - k)%Z - 1%Z)%Z + t1)%Z))%Z
    n))
  (t1 + 1%Z)%Z n (fun (x:bitvec) (us:bitvec) (i:Z) => ((getbv x) i)) 0%Z.
...
Axiom cascade_cont_rz_spec8 :
  ...
  ((0%Z <= first_c)%Z /\ (first_c < n)%Z) ->
  ((0%Z <= t1)%Z /\ (t1 < (n - 1%Z)%Z)%Z) ->
  (((first_c + l)%Z - 1%Z)%Z < n)%Z -> (t1 < first_c)%Z -> forall (x:bitvec),
  ((length x) = n) ->
  (((diag_ang (cascade_cont_rz first_c t1 l n)) x) =
   (ang_sum
    (fun (k:Z) =>
...
Parameter qft_rev_line: Z -> Z -> gate.

Axiom qft_rev_line_def :
  forall (t1:Z) (n:Z), ((0%Z <= t1)%Z /\ (t1 < n)%Z) -> (t1 = (n - 1%Z)%Z) ->
  ((qft_rev_line t1 n) = (place_hadamard t1 n)).

Parameter result23: Z -> bitvec -> bitvec -> Z -> Z.

Parameter result24: Z -> bitvec -> bitvec -> Z -> Z.

Axiom result_def23 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((((result23 t1) x) y) i) = ((getbv y) 0%Z))) /\
  (~ (i = t1) -> (((((result23 t1) x) y) i) = ((getbv x) i))).

Axiom result_def24 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((result24 t1 x y) i) = ((getbv y) 0%Z))) /\
  (~ (i = t1) -> (((result24 t1 x y) i) = ((getbv x) i))).

Axiom qft_rev_line_def1 :
  forall (t1:Z) (n:Z), ((0%Z <= t1)%Z /\ (t1 < n)%Z) ->
  ~ (t1 = (n - 1%Z)%Z) ->
  ((qft_rev_line t1 n) =
   (sequence_spec_i_r (place_hadamard t1 n)
    (cascade_cont_rz (t1 + 1%Z)%Z t1 (n - (t1 + 1%Z)%Z)%Z n)
    (fun (x:bitvec) (y:bitvec) (k:Z) =>
     (int_to_ang
      (((-((getbv x) k))%Z * ((getbv y) 0%Z))%Z *
       (power_ 2%Z (((n - k)%Z - 1%Z)%Z + t1)%Z))%Z
      n))
    (fun (x:bitvec) (us:bitvec) (k:Z) =>
     (int_to_ang
    ...
    (fun (x:bitvec) (y:bitvec) =>
     (int_to_ang
      (((-((getbv x) t1))%Z * ((getbv y) 0%Z))%Z *
       (power_ 2%Z (n - 1%Z)%Z))%Z
      n))
    t1 n (result23 t1) (fun (x:bitvec) (us:bitvec) (i:Z) => ((getbv x) i))
    (fun (x:bitvec) (y:bitvec) => (make_bv (result24 t1 x y) n)) 1%Z 1%Z 0%Z)).

Axiom qft_rev_line_spec :
  forall (t1:Z) (n:Z), ((0%Z <= t1)%Z /\ (t1 < n)%Z) ->
  ((size (qft_rev_line t1 n)) = n).

Parameter fc15: Z -> bitvec -> bitvec -> Z -> Z.

Axiom fc_def15 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((((fc15 t1) x) y) i) = ((getbv y) 0%Z))) /\
  (~ (i = t1) -> (((((fc15 t1) x) y) i) = ((getbv x) i))).

Axiom qft_rev_line_spec1 :
  forall (t1:Z) (n:Z), ((0%Z <= t1)%Z /\ (t1 < n)%Z) ->
  correct_path_sum_i (qft_rev_line t1 n)
  (fun (x:bitvec) (y:bitvec) (i:Z) =>
   (int_to_ang
    (((-((getbv x) i))%Z * ((getbv y) 0%Z))%Z *
     (power_ 2%Z (((n - i)%Z - 1%Z)%Z + t1)%Z))%Z
    n))
  t1 n (fc15 t1) 1%Z.
...
Axiom fc_def16 :
  forall (t1:Z) (x:bitvec) (y:bitvec) (i:Z),
  ((i = t1) -> (((fc16 t1 x y) i) = ((getbv y) 0%Z))) /\
  (~ (i = t1) -> (((fc16 t1 x y) i) = ((getbv x) i))).

Axiom rewrite_rev_qft_line :
  forall (t1:Z) (n:Z), ((0%Z <= t1)%Z /\ (t1 < n)%Z) ->
  correct_path_sum (qft_rev_line t1 n)
  (fun (x:bitvec) (y:bitvec) =>
   (ang_sum
    (fun (i:Z) =>
     (int_to_ang
      ...
      n))
    t1 n))
  (fun (x:bitvec) (y:bitvec) => (make_bv (fc16 t1 x y) n)) 1%Z.

Parameter qft_rev: Z -> gate.

Axiom qft_rev_spec : forall (n:Z), (0%Z < n)%Z -> ((size (qft_rev n)) = n).

Axiom qft_rev_spec1 :
  forall (n:Z), (0%Z < n)%Z ->
  correct_path_sum_i (qft_rev n)
  (fun (x:bitvec) (y:bitvec) (j:Z) =>
   (ang_sum
    (fun (i:Z) =>
     (int_to_ang
      (((-((getbv x) i))%Z * ((getbv y) j))%Z *
      ...
      n))
    j n))
  0%Z n (fun (us:bitvec) (y:bitvec) (i:Z) => ((getbv y) i)) n.

Parameter eigen: gate -> (matrix t) -> angle -> Prop.

Axiom eigen_def :
  forall (c:gate) (x:matrix t) (o:angle), (eigen c x o) ->
  sem c x (infix_asdtdt (ang_exp o) x).

Axiom eigen_def1 :
  forall (c:gate) (x:matrix t) (o:angle),
  (sem c x (infix_asdtdt (ang_exp o) x)) -> eigen c x o.
...
Axiom eigen_scal :
  forall (c:gate) (a:angle) (x:matrix t) (o:angle), (eigen c x o) ->
  eigen c (infix_asdtdt (ang_exp a) x) o.

Parameter eigen_comp: gate -> gate -> (matrix t) -> angle -> angle -> gate.

Axiom eigen_comp_def :
  forall (c:gate) (c':gate) (x:matrix t) (o:angle) (o':angle),
  ((size c) = (size c')) -> (eigen c x o) -> (eigen c' x o') ->
  ((eigen_comp c c' x o o') = (sequence c c')).

Axiom eigen_comp_spec :
  forall (c:gate) (c':gate) (x:matrix t) (o:angle) (o':angle),
  ((size c) = (size c')) -> (eigen c x o) -> (eigen c' x o') ->
  ((size (eigen_comp c c' x o o')) = (size c)).

Axiom eigen_comp_spec1 :
  forall (c:gate) (c':gate) (x:matrix t) (o:angle) (o':angle),
  ((size c) = (size c')) -> (eigen c x o) -> (eigen c' x o') ->
  eigen (eigen_comp c c' x o o') x (ang_add o o').

Parameter eigen_square: gate -> (matrix t) -> angle -> gate.
...
Axiom eigen_square_spec :
  forall (c:gate) (x:matrix t) (o:angle), (eigen c x o) ->
  ((size (eigen_square c x o)) = (size c)).

Axiom eigen_square_spec1 :
  forall (c:gate) (x:matrix t) (o:angle), (eigen c x o) ->
  eigen (eigen_square c x o) x (ang_add o o).

Axiom eigen_square_spec2 :
  forall (c:gate) (x:matrix t) (o:angle), (eigen c x o) ->
  ((eigen_square c x o) = (sequence c c)).

Parameter pow_pow_2: gate -> Z -> (matrix t) -> angle -> gate.

Axiom pow_pow_2_def :
  forall (c:gate) (p:Z) (x:matrix t) (o:angle), (0%Z <= p)%Z ->
  (eigen c x o) -> (p = 0%Z) -> ((pow_pow_2 c p x o) = c).

Axiom pow_pow_2_def1 :
  forall (c:gate) (p:Z) (x:matrix t) (o:angle), (0%Z <= p)%Z ->
  (eigen c x o) -> ~ (p = 0%Z) ->
  ((pow_pow_2 c p x o) =
...
Axiom pow_pow_2_spec :
  forall (c:gate) (p:Z) (x:matrix t) (o:angle), (0%Z <= p)%Z ->
  (eigen c x o) -> ((size (pow_pow_2 c p x o)) = (size c)).

Axiom pow_pow_2_spec1 :
  forall (c:gate) (p:Z) (x:matrix t) (o:angle), (0%Z <= p)%Z ->
  (eigen c x o) -> eigen (pow_pow_2 c p x o) x (ang_mult_int o (power 2%Z p)).

Parameter control_eigen: gate -> (matrix t) -> angle -> Z -> Z -> Z -> gate.

Axiom control_eigen_def :
  forall (circ:gate) (y:matrix t) (o:angle) (c:Z) (ft:Z) (n:Z),
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (size circ))%Z) ->
...
Axiom control_eigen_spec :
  forall (circ:gate) (y:matrix t) (o:angle) (c:Z) (ft:Z) (n:Z),
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (size circ))%Z) ->
  (eigen circ y o) -> ((size (control_eigen circ y o c ft n)) = n).

Axiom control_eigen_spec1 :
  forall (circ:gate) (y:matrix t) (o:angle) (c:Z) (ft:Z) (n:Z),
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (size circ))%Z) ->
  (eigen circ y o) -> forall (x:matrix t), (is_a_ket_l x ft) ->
  (is_a_ket_basis_elt x) -> (((getbv (ket_to_bv x)) c) = 0%Z) ->
  sem (control_eigen circ y o c ft n) (kronecker x y) (kronecker x y).

Axiom control_eigen_spec2 :
  forall (circ:gate) (y:matrix t) (o:angle) (c:Z) (ft:Z) (n:Z),
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (size circ))%Z) ->
  (eigen circ y o) -> forall (x:matrix t), (is_a_ket_l x ft) ->
  (is_a_ket_basis_elt x) -> (((getbv (ket_to_bv x)) c) = 1%Z) ->
  sem (control_eigen circ y o c ft n) (kronecker x y)
  (kronecker x (infix_asdtdt (ang_exp o) y)).

Axiom control_eigen_spec3 :
  forall (circ:gate) (y:matrix t) (o:angle) (c:Z) (ft:Z) (n:Z),
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (size circ))%Z) ->
  (eigen circ y o) -> forall (x:bitvec), ((length x) = ft) ->
...
Parameter control_eigen_scal:
  gate -> (matrix t) -> Z -> Z -> Z -> angle -> angle -> gate.

Axiom control_eigen_scal_def :
  forall (circ:gate) (y:matrix t) (c:Z) (ft:Z) (n:Z) (o:angle) (o':angle),
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (size circ))%Z) ->
...
Axiom control_eigen_scal_spec :
  ...
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (size circ))%Z) ->
  (n >= 0%Z)%Z -> (eigen circ y o') ->
  ((size (control_eigen_scal circ y c ft n o o')) = (ft + (size circ))%Z).

Axiom control_eigen_scal_spec1 :
  forall (circ:gate) (y:matrix t) (c:Z) (ft:Z) (n:Z) (o:angle) (o':angle),
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (size circ))%Z) ->
  (n >= 0%Z)%Z -> (eigen circ y o') ->
  ((control_eigen_scal circ y c ft n o o') = (cont circ c ft n)).

Axiom control_eigen_scal_spec2 :
  forall (circ:gate) (y:matrix t) (c:Z) (ft:Z) (n:Z) (o:angle) (o':angle),
  ((0%Z <= c)%Z /\ (c < ft)%Z) -> (n = (ft + (size circ))%Z) ->
  (n >= 0%Z)%Z -> (eigen circ y o') -> forall (x:bitvec),
  ((length x) = ft) ->
...
Parameter control_eigen_seq_test:
  (Z -> gate) -> (Z -> Z) -> Z -> Z -> Z -> Z -> gate.

Axiom control_eigen_seq_test_def :
  forall (fcirc:Z -> gate) (fc17:Z -> Z) (ft:Z) (bound:Z) (s:Z) (n:Z),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc17 i))%Z /\ ((fc17 i) < ft)%Z) ->
  ((0%Z < bound)%Z /\ (bound <= ft)%Z) -> (s >= 0%Z)%Z -> (n = (ft + s)%Z) ->
  (0%Z <= n)%Z -> (forall (i:Z), ((size (fcirc i)) = s)) -> (bound = 1%Z) ->
  ((control_eigen_seq_test fcirc fc17 ft bound s n) =
   (cont (fcirc 0%Z) (fc17 0%Z) ft (ft + s)%Z)).

Axiom control_eigen_seq_test_def1 :
  forall (fcirc:Z -> gate) (fc17:Z -> Z) (ft:Z) (bound:Z) (s:Z) (n:Z),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc17 i))%Z /\ ((fc17 i) < ft)%Z) ->
  ((0%Z < bound)%Z /\ (bound <= ft)%Z) -> (s >= 0%Z)%Z -> (n = (ft + s)%Z) ->
  (0%Z <= n)%Z -> (forall (i:Z), ((size (fcirc i)) = s)) ->
  ~ (bound = 1%Z) ->
  ((control_eigen_seq_test fcirc fc17 ft bound s n) =
   (sequence (control_eigen_seq_test fcirc fc17 ft (bound - 1%Z)%Z s n)
    (cont (fcirc (bound - 1%Z)%Z) (fc17 (bound - 1%Z)%Z) ft n))).
...
Axiom control_eigen_seq_test_spec :
  ...
  ((0%Z < bound)%Z /\ (bound <= ft)%Z) -> (s >= 0%Z)%Z -> (n = (ft + s)%Z) ->
  (0%Z <= n)%Z -> (forall (i:Z), ((size (fcirc i)) = s)) ->
  ((size (control_eigen_seq_test fcirc fc17 ft bound s n)) = (ft + s)%Z).

Parameter control_eigen_seq_pre:
  (Z -> gate) -> (matrix t) -> (Z -> angle) -> (Z -> Z) -> Z -> Z -> 
  Z -> Z -> bitvec -> gate.

Axiom control_eigen_seq_pre_def :
  forall (fcirc:Z -> gate) (y:matrix t) (fk:Z -> angle) (fc17:Z -> Z) 
  ...
  (forall (i:Z), ((size (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((length x) = ft) -> (bound = 1%Z) ->
  ((control_eigen_seq_pre fcirc y fk fc17 ft bound s n x) =
   (control_eigen (fcirc 0%Z) y (fk 0%Z) (fc17 0%Z) ft (ft + s)%Z)).

Axiom control_eigen_seq_pre_def1 :
  forall (fcirc:Z -> gate) (y:matrix t) (fk:Z -> angle) (fc17:Z -> Z) 
    (ft:Z) (bound:Z) (s:Z) (n:Z) (x:bitvec),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc17 i))%Z /\ ((fc17 i) < ft)%Z) ->
  ...
  ((length x) = ft) -> ~ (bound = 1%Z) ->
  ((control_eigen_seq_pre fcirc y fk fc17 ft bound s n x) =
   (sequence (control_eigen_seq_pre fcirc y fk fc17 ft (bound - 1%Z)%Z s n x)
    (control_eigen_scal (fcirc (bound - 1%Z)%Z) y (fc17 (bound - 1%Z)%Z) ft n
     (ang_sum (fun (i:Z) => (ang_mult_int (fk i) ((getbv x) (fc17 i)))) 0%Z
      (bound - 1%Z)%Z)
     (fk (bound - 1%Z)%Z)))).
...
Axiom control_eigen_seq_pre_spec :
  ...
  (forall (i:Z), ((size (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((length x) = ft) ->
  ((size (control_eigen_seq_pre fcirc y fk fc17 ft bound s n x)) =
   (ft + s)%Z).

Axiom control_eigen_seq_pre_spec1 :
  forall (fcirc:Z -> gate) (y:matrix t) (fk:Z -> angle) (fc17:Z -> Z) 
    (ft:Z) (bound:Z) (s:Z) (n:Z) (x:bitvec),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc17 i))%Z /\ ((fc17 i) < ft)%Z) ->
  ...
  (forall (i:Z), ((size (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((length x) = ft) ->
  sem (control_eigen_seq_pre fcirc y fk fc17 ft bound s n x)
...
Axiom control_eigen_seq_pre_spec2 :
  forall (fcirc:Z -> gate) (y:matrix t) (fk:Z -> angle) (fc17:Z -> Z) 
    (ft:Z) (bound:Z) (s:Z) (n:Z) (x:bitvec),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc17 i))%Z /\ ((fc17 i) < ft)%Z) ->
...
Axiom control_eigen_seq_def :
  ...
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) -> eigen (fcirc i) y (fk i)) ->
  (forall (i:Z), ((size (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((control_eigen_seq fcirc y fk fc17 ft bound s n) =
   (control_eigen_seq_test fcirc fc17 ft bound s n)).
...
Axiom control_eigen_seq_spec1 :
  ...
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) -> eigen (fcirc i) y (fk i)) ->
  (forall (i:Z), ((size (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((size (control_eigen_seq fcirc y fk fc17 ft bound s n)) = (ft + s)%Z).

Axiom control_eigen_seq_spec2 :
  forall (fcirc:Z -> gate) (y:matrix t) (fk:Z -> angle) (fc17:Z -> Z) 
    (ft:Z) (bound:Z) (s:Z) (n:Z),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc17 i))%Z /\ ((fc17 i) < ft)%Z) ->
  ...
  (forall (i:Z), ((size (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  forall (x:bitvec), ((length x) = ft) ->
  sem (control_eigen_seq fcirc y fk fc17 ft bound s n)
  (kronecker (bv_to_ket x) y)
  (kronecker
   (infix_asdtdt
    (ang_exp
...
Parameter control_eigen_seq_real:
  (Z -> gate) -> (matrix t) -> (Z -> t) -> (Z -> Z) -> Z -> Z -> Z -> 
  Z -> gate.

Parameter result25: (Z -> t) -> Z -> angle.

Axiom result_def25 :
  forall (fk:Z -> t) (k:Z),
  ((real_ (fk k)) -> (((result25 fk) k) = (real_to_ang (fk k)))) /\
  (~ (real_ (fk k)) -> (((result25 fk) k) = ang_zero)).

Axiom control_eigen_seq_real_def :
  forall (fcirc:Z -> gate) (y:matrix t) (fk:Z -> t) (fc17:Z -> Z) (ft:Z)
    (bound:Z) (s:Z) (n:Z),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc17 i))%Z /\ ((fc17 i) < ft)%Z) ->
  ((0%Z < bound)%Z /\ (bound <= ft)%Z) -> (s >= 0%Z)%Z -> (n = (ft + s)%Z) ->
  ...
  (forall (i:Z), ((size (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((control_eigen_seq_real fcirc y fk fc17 ft bound s n) =
   (control_eigen_seq fcirc y (result25 fk) fc17 ft bound s n)).
...
Axiom control_eigen_seq_real_spec :
  ...
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   eigen (fcirc i) y (real_to_ang (fk i))) ->
  (forall (i:Z), ((size (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  ((size (control_eigen_seq_real fcirc y fk fc17 ft bound s n)) = (ft + s)%Z).

Axiom control_eigen_seq_real_spec1 :
  forall (fcirc:Z -> gate) (y:matrix t) (fk:Z -> t) (fc17:Z -> Z) (ft:Z)
    (bound:Z) (s:Z) (n:Z),
  (forall (i:Z), ((0%Z <= i)%Z /\ (i < bound)%Z) ->
   (0%Z <= (fc17 i))%Z /\ ((fc17 i) < ft)%Z) ->
  ...
  (forall (i:Z), ((size (fcirc i)) = s)) -> (is_a_ket_l y s) ->
  forall (x:bitvec), ((length x) = ft) ->
  sem (control_eigen_seq_real fcirc y fk fc17 ft bound s n)
  (kronecker (bv_to_ket x) y)
  (kronecker
   (infix_asdtdt
    (ang_exp
     (ang_sum
      (fun (i:Z) =>
       (real_to_ang (infix_asdt (fk i) (i_to_t ((getbv x) (fc17 i))))))
      0%Z bound))
    (bv_to_ket x))
   y).

Parameter cascade_cont_pow: gate -> Z -> (matrix t) -> t -> gate.

Parameter result26: gate -> Z -> (matrix t) -> t -> Z -> gate.

Axiom result_def26 :
  forall (circ:gate) (ft:Z) (y:matrix t) (theta:t) (i:Z),
  ((((ft - i)%Z - 1%Z)%Z >= 0%Z)%Z ->
   (((result26 circ ft y theta) i) =
...
Axiom cascade_cont_pow_def :
  forall (circ:gate) (ft:Z) (y:matrix t) (theta:t), (1%Z <= ft)%Z ->
  (real_ theta) -> (eigen circ y (real_to_ang theta)) ->
  ((cascade_cont_pow circ ft y theta) =
   (control_eigen_seq_real (result26 circ ft y theta) y
    (fun (i:Z) =>
     (infix_asdt theta (i_to_t (power_ 2%Z ((ft - i)%Z - 1%Z)%Z))))
    (fun (i:Z) => i) ft ft (size circ) (ft + (size circ))%Z)).

Axiom cascade_cont_pow_spec :
  forall (circ:gate) (ft:Z) (y:matrix t) (theta:t), (1%Z <= ft)%Z ->
  (real_ theta) -> (eigen circ y (real_to_ang theta)) ->
  ((size (cascade_cont_pow circ ft y theta)) = (ft + (size circ))%Z).

Axiom cascade_cont_pow_spec1 :
  forall (circ:gate) (ft:Z) (y:matrix t) (theta:t), (1%Z <= ft)%Z ->
  (real_ theta) -> (eigen circ y (real_to_ang theta)) -> forall (x:bitvec),
  ((length x) = ft) ->
  sem (cascade_cont_pow circ ft y theta) (kronecker (bv_to_ket x) y)
  (kronecker
   (infix_asdtdt
...
Parameter repeat_had: Z -> gate.

Axiom repeat_had_def :
  forall (n:Z), (n >= 1%Z)%Z -> (n = 1%Z) -> ((repeat_had n) = hadamard).
...
Axiom repeat_had_spec :
  forall (n:Z), (n >= 1%Z)%Z -> ((size (repeat_had n)) = n).

Axiom repeat_had_spec1 :
  forall (n:Z), (n >= 1%Z)%Z -> ((range (repeat_had n)) = n).

Axiom repeat_had_spec2 :
  forall (n:Z), (n >= 1%Z)%Z -> forall (x:bitvec) (y:bitvec), forall (i:Z),
  ((length x) = n) -> ((length y) = n) -> ((0%Z <= i)%Z /\ (i < n)%Z) ->
  ((basis_ket_i (repeat_had n) x y i) = ((getbv y) i)).

Axiom repeat_had_spec3 :
  forall (n:Z), (n >= 1%Z)%Z -> ((ang_ind_bound (repeat_had n)) = n).
...
Parameter cc_rz: Z -> gate.

Axiom cc_rz_def :
  forall (n:Z), (n >= 2%Z)%Z -> (n = 2%Z) ->
  ((cc_rz n) = (c_rzp 1%Z 0%Z 1%Z n)).

Axiom cc_rz_def1 :
  forall (n:Z), (n >= 2%Z)%Z -> ~ (n = 2%Z) ->
  ((cc_rz n) = (d_cont (cc_rz (n - 1%Z)%Z) 0%Z 1%Z n)).

Axiom cc_rz_spec : forall (n:Z), (n >= 2%Z)%Z -> ((size (cc_rz n)) = n).

Axiom cc_rz_spec1 : forall (n:Z), (n >= 2%Z)%Z -> diag (cc_rz n).

Axiom cc_rz_spec2 :
  forall (n:Z), (n >= 2%Z)%Z -> forall (x:bitvec), ((length x) = n) ->
  ((forall (j:Z), ((0%Z <= j)%Z /\ (j < n)%Z) -> (((getbv x) j) = 1%Z)) ->
   (((diag_ang (cc_rz n)) x) = ang_minus_one)) /\
  (~ (forall (j:Z), ((0%Z <= j)%Z /\ (j < n)%Z) -> (((getbv x) j) = 1%Z)) ->
   (((diag_ang (cc_rz n)) x) = ang_zero)).
...
Parameter x_cc_rz: Z -> gate.

Axiom x_cc_rz_def :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((x_cc_rz n) =
   (flat_sequ (x_kron n) (cc_rz n)
    (fun (x:bitvec) =>
     (ang_mult_int ang_minus_one
      (ind_iproduct (fun (i:Z) => (1%Z - ((getbv x) i))%Z) 0%Z n)))
    (flat_ang (x_kron n)) (diag_ang (cc_rz n))
    (fun (x:bitvec) => (make_bv (fun (i:Z) => (1%Z - ((getbv x) i))%Z) n))
    (flat_ket (x_kron n)) (fun (x:bitvec) => x) n)).

Axiom x_cc_rz_spec : forall (n:Z), (n >= 2%Z)%Z -> ((size (x_cc_rz n)) = n).

Axiom x_cc_rz_spec1 : forall (n:Z), (n >= 2%Z)%Z -> flat (x_cc_rz n).

Axiom x_cc_rz_spec2 :
  forall (n:Z), (n >= 2%Z)%Z ->
  correct_flat (x_cc_rz n)
  (fun (x:bitvec) =>
   (ang_mult_int ang_minus_one
    (ind_iproduct (fun (i:Z) => (1%Z - ((getbv x) i))%Z) 0%Z n)))
  (fun (x:bitvec) => (make_bv (fun (i:Z) => (1%Z - ((getbv x) i))%Z) n)).

Parameter diff_pre: Z -> gate.

Axiom diff_pre_def :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((diff_pre n) =
   (flat_sequ (x_cc_rz n) (x_kron n)
    (fun (x:bitvec) =>
     (ang_mult_int ang_minus_one
      (ind_iproduct (fun (j:Z) => (1%Z - ((getbv x) j))%Z) 0%Z n)))
    (fun (x:bitvec) =>
     (ang_mult_int ang_minus_one
      (ind_iproduct (fun (i:Z) => (1%Z - ((getbv x) i))%Z) 0%Z n)))
    (flat_ang (x_kron n)) (fun (x:bitvec) => x)
    (fun (x:bitvec) => (make_bv (fun (i:Z) => (1%Z - ((getbv x) i))%Z) n))
    (flat_ket (x_kron n)) n)).

Axiom diff_pre_spec :
  forall (n:Z), (n >= 2%Z)%Z -> ((size (diff_pre n)) = n).

Axiom diff_pre_spec1 : forall (n:Z), (n >= 2%Z)%Z -> diag (diff_pre n).

Axiom diff_pre_spec2 :
  forall (n:Z), (n >= 2%Z)%Z ->
  correct_flat (diff_pre n)
  (fun (x:bitvec) =>
   (ang_mult_int ang_minus_one
    (ind_iproduct (fun (j:Z) => (1%Z - ((getbv x) j))%Z) 0%Z n)))
  (fun (x:bitvec) => x).
...
Axiom adjoint_spec : forall (m:matrix t), ((rows (adjoint m)) = (columns m)).

Axiom adjoint_spec1 :
  forall (m:matrix t), ((columns (adjoint m)) = (rows m)).

Axiom adjoint_spec2 :
  forall (m:matrix t), forall (i:Z) (j:Z), (valid_index (adjoint m) i j) ->
  valid_index m j i.

Axiom adjoint_spec3 :
  forall (m:matrix t), forall (i:Z) (j:Z), (valid_index m j i) ->
  valid_index (adjoint m) i j.
...
Axiom is_a_bra_def : forall (m:matrix t), (is_a_bra m) -> ((rows m) = 1%Z).
...
Axiom is_a_bra_l_def :
  forall (m:matrix t) (l:Z), (is_a_bra_l m l) -> (l >= 0%Z)%Z.

Axiom is_a_bra_l_def1 :
  forall (m:matrix t) (l:Z), (is_a_bra_l m l) -> ((rows m) = 1%Z).

Axiom is_a_bra_l_def2 :
  forall (m:matrix t) (l:Z), (is_a_bra_l m l) ->
  ((columns m) = (power 2%Z l)).

Axiom is_a_bra_l_def3 :
  forall (m:matrix t) (l:Z),
...
Axiom bra_length_spec :
  forall (m:matrix t), (is_a_bra m) -> ((bra_length m) >= 0%Z)%Z.

Axiom bra_length_spec1 :
  forall (m:matrix t), (is_a_bra m) ->
  ((columns m) = (power 2%Z (bra_length m))).

Axiom bra_length_spec2 :
  forall (m:matrix t), (is_a_bra m) -> is_a_bra_l m (bra_length m).
...
Axiom get_is_a_bra : forall (m:matrix t), (is_a_bra m) -> ((rows m) = 1%Z).
...
Axiom bra_to_ket_spec :
  forall (m:matrix t), (is_a_bra m) -> ((rows (bra_to_ket m)) = (columns m)).

Axiom bra_to_ket_spec1 :
  forall (m:matrix t), (is_a_bra m) -> ((columns (bra_to_ket m)) = 1%Z).

Axiom bra_to_ket_spec2 :
  forall (m:matrix t), (is_a_bra m) -> ((bra_to_ket m) = (bra_to_ket_pre m)).

Axiom bra_to_ket_spec3 :
  forall (m:matrix t), (is_a_bra m) -> is_a_ket (bra_to_ket m).

Axiom bra_to_ket_spec4 :
  forall (m:matrix t), (is_a_bra m) ->
  ((ket_length (bra_to_ket m)) = (bra_length m)).

Axiom bra_to_ket_spec5 :
  forall (m:matrix t), (is_a_bra m) -> forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power 2%Z (bra_length m)))%Z) ->
...
Axiom is_a_bra_basis_elt_def :
  forall (m:matrix t), (is_a_bra_basis_elt m) -> is_a_bra m.

Axiom is_a_bra_basis_elt_def1 :
  forall (m:matrix t), (is_a_bra_basis_elt m) ->
  is_a_ket_basis_elt (bra_to_ket m).

Axiom is_a_bra_basis_elt_def2 :
  forall (m:matrix t),
...
Axiom bra_spec : forall (n:Z) (i:Z), (0%Z <= n)%Z -> is_a_bra (bra n i).
...
Axiom bra_spec4 :
  forall (n:Z) (i:Z), (0%Z <= n)%Z -> ((rows (bra n i)) = 1%Z).

Axiom bra_spec5 :
  forall (n:Z) (i:Z), (0%Z <= n)%Z -> forall (j:Z),
  (valid_index (bra n i) 0%Z j) -> ((get (bra n i) 0%Z j) = (indic j i)).
...
Axiom bra_spec8 :
  forall (n:Z) (i:Z), (0%Z <= n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) -> ((get_bra (bra n i) i) = tone).
...
Axiom bra_spec10 :
  forall (n:Z) (i:Z), (0%Z <= n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) -> is_a_bra_basis_elt (bra n i).
...
Axiom bra_valid_index_def :
  forall (m:matrix t) (j:Z), (bra_valid_index m j) -> is_a_bra m.

Axiom bra_valid_index_def1 :
  forall (m:matrix t) (j:Z), (bra_valid_index m j) -> (0%Z <= j)%Z.

Axiom bra_valid_index_def2 :
  forall (m:matrix t) (j:Z), (bra_valid_index m j) ->
  (j < (power 2%Z (bra_length m)))%Z.

Axiom bra_valid_index_def3 :
  forall (m:matrix t) (j:Z),
...
Axiom get_bra_valid_index1 :
  forall (m:matrix t) (j:Z), (bra_valid_index m j) -> (0%Z <= j)%Z.

Axiom get_bra_valid_index2 :
  forall (m:matrix t) (j:Z), (bra_valid_index m j) ->
  (j < (power 2%Z (bra_length m)))%Z.
...
Axiom ket_to_bra_spec1 :
  forall (m:matrix t), (is_a_ket m) ->
  ((bra_length (ket_to_bra m)) = (ket_length m)).

Axiom ket_to_bra_spec2 :
  forall (m:matrix t), (is_a_ket m) -> ((rows (ket_to_bra m)) = 1%Z).

Axiom ket_to_bra_spec3 :
  forall (m:matrix t), (is_a_ket m) -> ((columns (ket_to_bra m)) = (rows m)).

Axiom ket_to_bra_spec4 :
  forall (m:matrix t), (is_a_ket m) -> forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power 2%Z (ket_length m)))%Z) ->
...
Axiom bra_sum_l_spec1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (l:Z), (l >= 0%Z)%Z ->
  ((cardinal s) > 0%Z)%Z ->
  (forall (e1:a), (mem e1 s) -> is_a_bra_l (f e1) l) -> forall (i:Z),
  (bra_valid_index (bra_sum_l s f l) i) ->
  ((get_bra (bra_sum_l s f l) i) =
   (sum s (fun (e1:a) => (get_bra (f e1) i)))).

Axiom bra_sum_l_spec2 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (l:Z), (l >= 0%Z)%Z ->
  ((cardinal s) > 0%Z)%Z ->
  (forall (e1:a), (mem e1 s) -> is_a_bra_l (f e1) l) ->
...
Axiom bra_sum_l_spec3 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (l:Z), (l >= 0%Z)%Z ->
  ((cardinal s) > 0%Z)%Z ->
  (forall (e1:a), (mem e1 s) -> is_a_bra_l (f e1) l) ->
  ((bra_length (bra_sum_l s f l)) = l).
...
Axiom add_bra_spec :
  forall (m:matrix t) (n:matrix t), (is_a_bra m) -> (is_a_bra n) ->
  ((bra_length m) = (bra_length n)) -> is_a_bra (add_bra m n).
...
Axiom add_bra_spec2 :
  forall (m:matrix t) (n:matrix t), (is_a_bra m) -> (is_a_bra n) ->
  ((bra_length m) = (bra_length n)) -> forall (i:Z),
  (bra_valid_index (add_bra m n) i) ->
...
Axiom add_bra_l_spec :
  forall (m:matrix t) (n:matrix t) (l:Z), (is_a_bra_l m l) ->
  (is_a_bra_l n l) -> is_a_bra_l (add_bra_l m n l) l.

Axiom add_bra_l_spec1 :
  forall (m:matrix t) (n:matrix t) (l:Z), (is_a_bra_l m l) ->
  (is_a_bra_l n l) -> ((bra_length (add_bra_l m n l)) = l).

Axiom add_bra_l_spec2 :
  forall (m:matrix t) (n:matrix t) (l:Z), (is_a_bra_l m l) ->
  (is_a_bra_l n l) -> forall (i:Z),
  ((0%Z <= i)%Z /\ (i < (power 2%Z (bra_length (add_bra_l m n l))))%Z) ->
  ((get_bra (add_bra_l m n l) i) = (infix_pldt (get_bra m i) (get_bra n i))).

Axiom add_bra_l_spec3 :
  forall (m:matrix t) (n:matrix t) (l:Z), (is_a_bra_l m l) ->
  (is_a_bra_l n l) -> ((add_bra_l m n l) = (add_bra m n)).
...
Axiom is_a_ketbra_n_def1 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_n m n) ->
  ((columns m) = (power 2%Z n)).

Axiom is_a_ketbra_n_def2 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_n m n) ->
  ((rows m) = (power 2%Z n)).

Axiom is_a_ketbra_n_def3 :
...
Axiom is_a_ketbra_def :
  ...
  exists s:Z, (s >= 0%Z)%Z /\ (is_a_ketbra_n m s).

Axiom is_a_ketbra_def1 :
  forall (m:matrix t), (exists s:Z, (s >= 0%Z)%Z /\ (is_a_ketbra_n m s)) ->
  is_a_ketbra m.
...
Axiom ketbra_size_spec1 :
  forall (m:matrix t), (is_a_ketbra m) -> ((ketbra_size m) >= 0%Z)%Z.

Axiom ketbra_size_spec2 :
  forall (m:matrix t), (is_a_ketbra m) ->
  ((columns m) = (power 2%Z (ketbra_size m))).

Axiom ketbra_size_spec3 :
  forall (m:matrix t), (is_a_ketbra m) ->
  ((rows m) = (power 2%Z (ketbra_size m))).

Axiom ketbra_size_spec4 :
  forall (m:matrix t), (is_a_ketbra m) -> is_a_ketbra_n m (ketbra_size m).

Axiom get_ketbra_size :
  forall (m:matrix t) (n:Z), (is_a_ketbra m) -> (n >= 0%Z)%Z ->
  ((ketbra_size m) = n) -> ((columns m) = (power 2%Z n)).

Axiom get_ketbra_size1 :
  forall (m:matrix t) (n:Z), (is_a_ketbra m) -> (n >= 0%Z)%Z ->
  ((ketbra_size m) = n) -> ((rows m) = (power 2%Z n)).
...
Axiom is_a_ketbra_basis_elt_n_def1 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) ->
  exists i:Z, exists j:Z,
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) /\
  (((0%Z <= j)%Z /\ (j < (power 2%Z n))%Z) /\
...
Axiom is_a_ketbra_basis_elt_n_def2 :
  forall (m:matrix t) (n:Z),
  ((is_a_ketbra_n m n) /\
   exists i:Z, exists j:Z,
   ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) /\
...
Axiom is_a_ketbra_basis_elt_def1 :
  forall (m:matrix t), (exists n:Z, is_a_ketbra_basis_elt_n m n) ->
  is_a_ketbra_basis_elt m.

Axiom get_ketbra_basis_elt_n :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) -> (n >= 0%Z)%Z.

Axiom get_ketbra_basis_elt_n1 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) ->
  exists i:Z, exists j:Z,
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) /\
  (((0%Z <= j)%Z /\ (j < (power 2%Z n))%Z) /\
...
Axiom get_ketbra_basis_elt_n2 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) ->
  ((rows m) = (power 2%Z n)).

Axiom get_ketbra_basis_elt_n3 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) ->
  ((columns m) = (power 2%Z n)).

Axiom get_ketbra_basis_elt_n4 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) ->
  is_a_ketbra_n m n.

Axiom get_ketbra_basis_elt_n5 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) -> is_a_ketbra m.

Axiom get_ketbra_basis_elt_n6 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) ->
  is_a_ketbra_basis_elt m.

Axiom get_ketbra_basis_elt_n7 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) ->
  ((ketbra_size m) = n).
...
Axiom ketbra_basis_elt_n_is_a_ketbra_basis_element1 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) ->
  (n = (ketbra_size m)).
...
Axiom ketbra_basis_element_has_decomp1 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) ->
  (is_a_ketbra_n m n) ->
...
Axiom ketbra_basis_element_has_decomp2 :
  forall (m:matrix t) (n:Z), (is_a_ketbra_basis_elt_n m n) ->
  (is_a_ketbra_n m n) ->
  exists o:(Z* Z)%type,
  (mem o
...
Axiom ketbra_pre_spec2 :
  forall (n:Z) (i:Z) (j:Z), (n > 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  ((0%Z <= j)%Z /\ (j < (power 2%Z n))%Z) ->
  ((ketbra_pre n i j) = (ind_basis_mat i j (power 2%Z n) (power 2%Z n))).

Axiom ketbra_pre_spec3 :
  forall (n:Z) (i:Z) (j:Z), (n > 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  ((0%Z <= j)%Z /\ (j < (power 2%Z n))%Z) -> forall (y:matrix t),
  (is_a_ket_l y n) ->
  ((mat_mult (ketbra_pre n i j) y) = (infix_asdtdt (get_ket y j) (ket n i))).

Axiom ketbra_pre_spec4 :
  forall (n:Z) (i:Z) (j:Z), (n > 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z n))%Z) ->
  ((0%Z <= j)%Z /\ (j < (power 2%Z n))%Z) ->
...
Parameter result27: (matrix t) -> (Z* Z)%type -> bool.
...
Axiom ketbra_to_int_couple_spec1 :
  forall (m:matrix t), (is_a_ketbra_basis_elt m) ->
  (0%Z <= (fir (ketbra_to_int_couple m)))%Z.

Axiom ketbra_to_int_couple_spec2 :
  forall (m:matrix t), (is_a_ketbra_basis_elt m) ->
  ((fir (ketbra_to_int_couple m)) < (power 2%Z (ketbra_size m)))%Z.

Axiom ketbra_to_int_couple_spec3 :
  forall (m:matrix t), (is_a_ketbra_basis_elt m) ->
  (0%Z <= (sec (ketbra_to_int_couple m)))%Z.

Axiom ketbra_to_int_couple_spec4 :
  forall (m:matrix t), (is_a_ketbra_basis_elt m) ->
...
Axiom ketbra_to_int_rows_spec1 :
  forall (m:matrix t), (is_a_ketbra_basis_elt m) ->
  ((ketbra_to_int_rows m) < (power 2%Z (ketbra_size m)))%Z.

Axiom ketbra_to_int_rows_spec2 :
  forall (m:matrix t), (is_a_ketbra_basis_elt m) ->
  exists j:Z,
  ((0%Z <= j)%Z /\ (j < (power 2%Z (ketbra_size m)))%Z) /\
  (m =
...
Axiom ketbra_to_int_col_spec1 :
  forall (m:matrix t), (is_a_ketbra_basis_elt m) ->
  ((ketbra_to_int_col m) < (power 2%Z (ketbra_size m)))%Z.

Axiom ketbra_to_int_col_spec2 :
  forall (m:matrix t), (is_a_ketbra_basis_elt m) ->
  (m =
   (kronecker (ket (ketbra_size m) (ketbra_to_int_rows m))
...
Axiom projection_spec1 :
  forall (m:matrix t), (is_a_ket m) -> forall (i:Z) (j:Z),
  ((0%Z <= i)%Z /\ (i < (power 2%Z (ket_length m)))%Z) ->
  ((0%Z <= j)%Z /\ (j < (power 2%Z (ket_length m)))%Z) ->
  ((get (projection m) i j) =
   (infix_asdt (get_ket m i) (conjugate (get_ket m j)))).

Axiom projection_spec2 :
  forall (m:matrix t), (is_a_ket m) ->
  ((rows (projection m)) = (power 2%Z (ket_length m))).

Axiom projection_spec3 :
  forall (m:matrix t), (is_a_ket m) ->
...
Axiom projection_basis_spec1 :
  forall (m:matrix t), (is_a_ket_basis_elt m) ->
  ((projection_basis m) =
   (ketbra (ket_length m) (ket_to_int m) (ket_to_int m))).

Axiom projection_basis_spec2 :
  forall (m:matrix t), (is_a_ket_basis_elt m) ->
  is_a_ketbra_n (projection_basis m) (ket_length m).

Axiom projection_basis_spec3 :
  forall (m:matrix t), (is_a_ket_basis_elt m) ->
  is_a_ketbra_basis_elt (projection_basis m).

Axiom projection_basis_spec4 :
  forall (m:matrix t), (is_a_ket_basis_elt m) -> forall (i:Z) (j:Z),
  (valid_index (projection_basis m) i j) ->
  (((i = (ket_to_int m)) /\ (j = (ket_to_int m))) ->
   ((get (projection_basis m) i j) = tone)) /\
  (~ ((i = (ket_to_int m)) /\ (j = (ket_to_int m))) ->
   ((get (projection_basis m) i j) = tzero)).

Axiom projection_basis_spec5 :
  forall (m:matrix t), (is_a_ket_basis_elt m) -> forall (y:matrix t),
  (is_a_ket_l y (ket_length m)) ->
...
Axiom is_diagonal_def :
  forall (m:matrix t), (is_diagonal m) ->
  exists f:Z -> t, (m = (make_f (rows m) (rows m) (fc17 f))).

Parameter fc18: (Z -> t) -> Z -> Z -> t.

Axiom fc_def18 :
  forall (f:Z -> t) (i:Z) (j:Z),
  ((i = j) -> ((((fc18 f) i) j) = (f i))) /\
  (~ (i = j) -> ((((fc18 f) i) j) = tzero)).

Axiom is_diagonal_def1 :
  forall (m:matrix t),
  (exists f:Z -> t, (m = (make_f (rows m) (rows m) (fc18 f)))) ->
  is_diagonal m.

Parameter diag_mat1: (Z -> t) -> Z -> matrix t.

Parameter result28: (Z -> t) -> Z -> Z -> t.

Axiom result_def28 :
  forall (f:Z -> t) (i:Z) (j:Z),
  ((i = j) -> ((((result28 f) i) j) = (f i))) /\
  (~ (i = j) -> ((((result28 f) i) j) = tzero)).

Axiom diag_mat_def1 :
  forall (f:Z -> t) (s:Z), (0%Z < s)%Z ->
  ((diag_mat1 f s) = (make_f s s (result28 f))).

Axiom diag_mat_spec2 :
  forall (f:Z -> t) (s:Z), (0%Z < s)%Z -> is_diagonal (diag_mat1 f s).

Axiom diag_mat_spec3 :
  forall (f:Z -> t) (s:Z), (0%Z < s)%Z -> ((rows (diag_mat1 f s)) = s).

Axiom diag_mat_spec4 :
  forall (f:Z -> t) (s:Z), (0%Z < s)%Z -> ((columns (diag_mat1 f s)) = s).
...
Axiom projection_basis_l_spec :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) -> ((projection_basis_l m i l) = (projection_basis m)).

Axiom projection_basis_l_spec1 :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) ->
  ((projection_basis_l m i l) = (ketbra l (ket_to_int m) (ket_to_int m))).

Axiom projection_basis_l_spec2 :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) ->
  ((projection_basis_l m i l) = (kronecker m (adjoint m))).

Axiom projection_basis_l_spec3 :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) ->
  ((projection_basis_l m i l) = (kronecker (ket l i) (bra l i))).

Axiom projection_basis_l_spec4 :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) -> ((projection_basis_l m i l) = (projection_n m l)).

Axiom projection_basis_l_spec5 :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) -> ((projection_basis_l m i l) = (projection_basis m)).

Axiom projection_basis_l_spec6 :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) -> is_a_ketbra_basis_elt (projection_basis_l m i l).

Axiom projection_basis_l_spec7 :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) -> ((projection_basis_l m i l) = (ketbra l i i)).

Axiom projection_basis_l_spec8 :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) -> forall (i1:Z) (j:Z),
...
Axiom projection_basis_l_spec9 :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) -> forall (y:matrix t), (is_a_ket_l y l) ->
...
Axiom projection_basis_l_spec10 :
  forall (m:matrix t) (i:Z) (l:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> (m = (ket l i)) ->
  (is_a_ket_l m l) ->
  ((projection_basis_l m i l) = (diag_mat1 (fc19 i) (power 2%Z l))).
...
Axiom ket_projection_basis_spec1 :
  forall (l:Z) (i:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) ->
  ((ket_projection_basis l i) = (kronecker (ket l i) (bra l i))).

Axiom ket_projection_basis_spec2 :
  forall (l:Z) (i:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) ->
  is_a_ketbra_basis_elt (ket_projection_basis l i).

Axiom ket_projection_basis_spec3 :
  forall (l:Z) (i:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) ->
  ((ket_projection_basis l i) = (ketbra l i i)).

Axiom ket_projection_basis_spec4 :
  forall (l:Z) (i:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) ->
  ((ket_projection_basis l i) = (projection (ket l i))).

Axiom ket_projection_basis_spec5 :
  forall (l:Z) (i:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) ->
  ((rows (ket_projection_basis l i)) = (power 2%Z l)).

Axiom ket_projection_basis_spec6 :
  forall (l:Z) (i:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) ->
  ((columns (ket_projection_basis l i)) = (power 2%Z l)).

Axiom ket_projection_basis_spec7 :
  forall (l:Z) (i:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) -> forall (y:matrix t),
  (is_a_ket_l y l) ->
  ((mat_mult (ket_projection_basis l i) y) =
   (infix_asdtdt (get_ket y i) (ket l i))).

Parameter fc20: Z -> Z -> t.

Axiom fc_def20 :
  forall (i:Z) (j:Z),
  ((j = i) -> (((fc20 i) j) = tone)) /\ (~ (j = i) -> (((fc20 i) j) = tzero)).

Axiom ket_projection_basis_spec8 :
  forall (l:Z) (i:Z), (l >= 0%Z)%Z ->
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) ->
  ((ket_projection_basis l i) = (diag_mat1 (fc20 i) (power 2%Z l))).
...
Axiom add_ketbra_spec :
  forall (m:matrix t) (n:matrix t), (is_a_ketbra m) -> (is_a_ketbra n) ->
  ((ketbra_size m) = (ketbra_size n)) -> is_a_ketbra (add_ketbra m n).

Axiom add_ketbra_spec1 :
  forall (m:matrix t) (n:matrix t), (is_a_ketbra m) -> (is_a_ketbra n) ->
  ((ketbra_size m) = (ketbra_size n)) ->
  ((ketbra_size (add_ketbra m n)) = (ketbra_size m)).

Axiom add_ketbra_spec2 :
  forall (m:matrix t) (n:matrix t), (is_a_ketbra m) -> (is_a_ketbra n) ->
  ((ketbra_size m) = (ketbra_size n)) -> forall (i:Z) (j:Z),
  (valid_index (add_ketbra m n) i j) ->
...
Axiom add_ketbra_l_spec :
  forall (m:matrix t) (n:matrix t) (l:Z), (is_a_ketbra_n m l) ->
  (is_a_ketbra_n n l) -> ((add_ketbra_l m n l) = (add_ketbra m n)).

Axiom add_ketbra_l_spec1 :
  forall (m:matrix t) (n:matrix t) (l:Z), (is_a_ketbra_n m l) ->
  (is_a_ketbra_n n l) -> is_a_ketbra_n (add_ketbra_l m n l) l.

Axiom add_ketbra_l_spec2 :
  forall (m:matrix t) (n:matrix t) (l:Z), (is_a_ketbra_n m l) ->
  (is_a_ketbra_n n l) -> ((ketbra_size (add_ketbra_l m n l)) = l).

Axiom add_ketbra_l_spec3 :
  forall (m:matrix t) (n:matrix t) (l:Z), (is_a_ketbra_n m l) ->
  (is_a_ketbra_n n l) -> forall (i:Z) (j:Z),
  ((0%Z <= i)%Z /\ (i < (power 2%Z l))%Z) ->
  ((0%Z <= j)%Z /\ (j < (power 2%Z l))%Z) ->
...
Axiom mat_sum_d_spec3 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (r:Z) (c:Z), (r > 0%Z)%Z ->
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  forall (i:Z) (j:Z), (valid_index (mat_sum_d s f r c) i j) -> (0%Z <= i)%Z.

Axiom mat_sum_d_spec4 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (r:Z) (c:Z), (r > 0%Z)%Z ->
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  forall (i:Z) (j:Z), (valid_index (mat_sum_d s f r c) i j) -> (i < r)%Z.

Axiom mat_sum_d_spec5 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (r:Z) (c:Z), (r > 0%Z)%Z ->
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  forall (i:Z) (j:Z), (valid_index (mat_sum_d s f r c) i j) -> (0%Z <= j)%Z.

Axiom mat_sum_d_spec6 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (r:Z) (c:Z), (r > 0%Z)%Z ->
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  forall (i:Z) (j:Z), (valid_index (mat_sum_d s f r c) i j) -> (j < c)%Z.

Axiom mat_sum_d_spec7 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (r:Z) (c:Z), (r > 0%Z)%Z ->
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
...
Axiom mat_sum_d_valid_index :
  ...
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  (valid_index (mat_sum_d s f r c) i j) -> (0%Z <= i)%Z.

Axiom mat_sum_d_valid_index1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (r:Z) (c:Z) (i:Z) (j:Z), (r > 0%Z)%Z ->
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  (valid_index (mat_sum_d s f r c) i j) -> (i < r)%Z.

Axiom mat_sum_d_valid_index2 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (r:Z) (c:Z) (i:Z) (j:Z), (r > 0%Z)%Z ->
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  (valid_index (mat_sum_d s f r c) i j) -> (0%Z <= j)%Z.

Axiom mat_sum_d_valid_index3 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (r:Z) (c:Z) (i:Z) (j:Z), (r > 0%Z)%Z ->
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  (valid_index (mat_sum_d s f r c) i j) -> (j < c)%Z.
...
Axiom mat_sum_d_valid_i :
  ...
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  (exists j:Z, valid_index (mat_sum_d s f r c) i j) -> (0%Z <= i)%Z.

Axiom mat_sum_d_valid_i1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (r:Z) (c:Z) (i:Z), (r > 0%Z)%Z ->
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  (exists j:Z, valid_index (mat_sum_d s f r c) i j) ->
  (i < (rows (mat_sum_d s f r c)))%Z.
...
Axiom mat_sum_d_valid_j :
  ...
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  (exists i:Z, valid_index (mat_sum_d s f r c) i j) -> (0%Z <= j)%Z.

Axiom mat_sum_d_valid_j1 :
  forall {a:Type} {a_WT:WhyType a},
  forall (s:set a) (f:a -> matrix t) (r:Z) (c:Z) (j:Z), (r > 0%Z)%Z ->
  (c > 0%Z)%Z -> (forall (e1:a), (mem e1 s) -> ((rows (f e1)) = r)) ->
  (forall (e1:a), (mem e1 s) -> ((columns (f e1)) = c)) ->
  (exists i:Z, valid_index (mat_sum_d s f r c) i j) ->
  (j < (columns (mat_sum_d s f r c)))%Z.
...
Axiom result_def29 :
  ...
  ((mem a1 sa) -> (((result29 sa sb f r c) a1) = (mat_sum_d sb (f a1) r c))) /\
  (~ (mem a1 sa) -> (((result29 sa sb f r c) a1) = (make r c tzero))).
...
Axiom mat_sum_sum_d_def :
  ...
  (forall (a1:a), forall (b1:b), (mem a1 sa) -> (mem b1 sb) ->
   ((columns ((f a1) b1)) = c)) ->
  ((mat_sum_sum_d sa sb f r c) = (mat_sum_d sa (result29 sa sb f r c) r c)).
...
Axiom pre_reqs_of_size_range :
  ...
  (mem y (n_bvs range1)) ->
  is_a_ket_l (infix_asdtdt (ang_exp ((a e1) y)) (bv_to_ket ((k e1) y))) size1.

Axiom pre_reqs_of_size_range1 :
  forall (a:bitvec -> bitvec -> angle) (k:bitvec -> bitvec -> bitvec)
    (size1:Z) (range1:Z) (x:matrix t),
  (is_a_ket_l x size1) -> (range1 >= 0%Z)%Z ->
  (forall (x1:bitvec) (y:bitvec), ((length x1) = size1) ->
...
Axiom result_def30 :
  ...
  (((length y) = range1) ->
   (((result30 a k size1 range1 z) y) =
    (infix_asdtdt (ang_exp ((a z) y))
     (ketbra size1 (bv_to_int ((k z) y)) (bv_to_int z))))) /\
  (~ ((length y) = range1) ->
   (((result30 a k size1 range1 z) y) = (ket size1 0%Z))).

Axiom result_def31 :
  forall (a:bitvec -> bitvec -> angle) (k:bitvec -> bitvec -> bitvec)
    (size1:Z) (range1:Z) (z:bitvec),
  (((length z) = size1) ->
   (((result31 a k size1 range1) z) =
    (ketbra_sum_l (n_bvs range1) (result30 a k size1 range1 z) size1))) /\
  (~ ((length z) = size1) ->
   (((result31 a k size1 range1) z) = (ket size1 0%Z))).
...
Axiom ketbra_sop_def :
  ...
  ((ketbra_sop a k size1 range1) =
   (infix_asdtdt (pow_inv_sqrt_2 range1)
    (ketbra_sum_l (n_bvs size1) (result31 a k size1 range1) size1))).
...
Axiom result_def32 :
  ...
  (((length z) = size1) ->
   (((result32 a k size1 y) z) =
    (infix_asdtdt (ang_exp ((a z) y))
     (ketbra size1 (bv_to_int ((k z) y)) (bv_to_int z))))) /\
  (~ ((length z) = size1) -> (((result32 a k size1 y) z) = (ket size1 0%Z))).

Axiom result_def33 :
  forall (a:bitvec -> bitvec -> angle) (k:bitvec -> bitvec -> bitvec)
    (size1:Z) (range1:Z) (y:bitvec),
  (((length y) = range1) ->
   (((result33 a k size1 range1) y) =
    (ketbra_sum_l (n_bvs size1) (result32 a k size1 y) size1))) /\
  (~ ((length y) = range1) ->
   (((result33 a k size1 range1) y) = (ket size1 0%Z))).
...
Axiom ketbra_sop_rs_def :
  ...
  ((ketbra_sop_rs a k size1 range1) =
   (infix_asdtdt (pow_inv_sqrt_2 range1)
    (ketbra_sum_l (n_bvs range1) (result33 a k size1 range1) size1))).
...
Axiom correct_ketbra_sop :
  ...
  (is_a_ket_l x (size c)) -> (correct_path_sum c a k range1) ->
  sem c x (mat_mult (ketbra_sop a k (size c) range1) x).

Axiom correct_ketbra_sop_rs :
  forall (c:gate) (a:bitvec -> bitvec -> angle)
    (k:bitvec -> bitvec -> bitvec) (range1:Z) (x:matrix t),
  (is_a_ket_l x (size c)) -> (correct_path_sum c a k range1) ->
  sem c x (mat_mult (ketbra_sop_rs a k (size c) range1) x).
...
Axiom real_mat_def :
  forall (m:matrix t), (real_mat m) -> forall (i:Z) (j:Z),
  (valid_index m i j) -> real_ (get m i j).
...
Axiom reverse_spec1 :
  forall (c:gate), forall (x:matrix t) (y:matrix t), (sem (reverse c) y x) ->
  sem c x y.

Axiom reverse_spec2 :
  forall (c:gate), ((mat_sem (reverse c)) = (adjoint (mat_sem c))).

Axiom are_different :
  forall (a:matrix t) (b:matrix t) (i:Z) (j:Z) (c:Z) (n:Z), (0%Z <= n)%Z ->
  (((rows a) = (rows b)) /\ ((rows b) = c)) ->
  (((columns a) = (columns b)) /\ ((columns b) = (power 2%Z n))) ->
  ((0%Z <= i)%Z /\ (i < c)%Z) -> ((0%Z <= j)%Z /\ (j < (power 2%Z n))%Z) ->
  ~ ((get a i j) = (get b i j)) ->
  exists x:matrix t,
  (is_a_ket_l x n) /\
  ((is_a_ket_basis_elt x) /\ ~ ((mat_mult a x) = (mat_mult b x))).

Axiom mat_to_ket_eq_pre :
  forall (m:matrix t) (n:matrix t) (c:Z) (size1:Z), (0%Z <= size1)%Z ->
  ((rows m) = c) -> ((rows n) = c) -> ((columns m) = (power 2%Z size1)) ->
  ((columns n) = (power 2%Z size1)) ->
  (forall (x:matrix t), (is_a_ket_l x size1) -> (is_a_ket_basis_elt x) ->
   ((mat_mult m x) = (mat_mult n x))) ->
  forall (i:Z) (j:Z), ((0%Z <= i)%Z /\ (i < c)%Z) ->
  ((0%Z <= j)%Z /\ (j < (power 2%Z size1))%Z) -> ((get m i j) = (get n i j)).
...
Axiom path_sum_scheme_to_mat :
  forall (c:gate) (a:bitvec -> bitvec -> angle)
    (b:bitvec -> bitvec -> bitvec) (r:Z),
  (correct_path_sum c a b r) -> ((mat_sem c) = (ketbra_sop a b (size c) r)).

Axiom path_sum_scheme_to_mat1 :
  forall (c:gate) (a:bitvec -> bitvec -> angle)
    (b:bitvec -> bitvec -> bitvec) (r:Z),
  (correct_path_sum c a b r) ->
  ((mat_sem c) = (ketbra_sop_rs a b (size c) r)).

Axiom mat_to_path_sum_scheme :
  forall (c:gate) (a:bitvec -> bitvec -> angle)
    (b:bitvec -> bitvec -> bitvec) (r:Z),
  (correct_path_sum c a b r) -> ((ketbra_sop a b (size c) r) = (mat_sem c)).

Axiom mat_to_path_sum_scheme_rev :
  forall (c:gate) (a:bitvec -> bitvec -> angle)
    (b:bitvec -> bitvec -> bitvec) (r:Z),
  ((ketbra_sop a b (size c) r) = (mat_sem c)) -> correct_path_sum c a b r.

Axiom diag_circ_to_mat :
  forall (c:gate), (diag c) ->
  ((mat_sem c) =
   (diag_mat1 (fun (i:Z) => (ang_exp ((diag_ang c) (int_to_bv i (size c)))))
    (power 2%Z (size c)))).

Parameter conj_ang_func:
  (bitvec -> bitvec -> angle) -> bitvec -> bitvec -> angle.

Axiom conj_ang_func_def :
  forall (a:bitvec -> bitvec -> angle) (x:bitvec) (y:bitvec),
  ((conj_ang_func a x y) = (ang_inv ((a x) y))).

Parameter conj_func_i:
  (bitvec -> bitvec -> Z -> angle) -> bitvec -> bitvec -> Z -> angle.

Axiom conj_func_i_def :
  forall (a:bitvec -> bitvec -> Z -> angle) (x:bitvec) (y:bitvec) (i:Z),
  ((conj_func_i a x y i) = (ang_inv (((a x) y) i))).

Axiom set_correct_path_sum_reverse :
  forall (c:gate) (a':bitvec -> bitvec -> angle)
    (a:bitvec -> bitvec -> angle) (b:bitvec -> bitvec -> bitvec) (r:Z),
  (correct_path_sum c a b r) ->
  (forall (x:bitvec) (y:bitvec), ((length x) = (size c)) ->
   ((length y) = r) -> (((a' x) y) = (ang_inv ((a x) y)))) ->
  (forall (x:bitvec) (y:bitvec), ((length x) = (size c)) ->
   ((length y) = r) -> (((a x) y) = ((a y) x))) ->
  (forall (x:bitvec) (y:bitvec), ((length x) = (size c)) ->
   ((length y) = r) -> (((b x) y) = y)) ->
  correct_path_sum (reverse c) a' b r.

Axiom set_correct_path_sum_i_reverse :
  forall (c:gate) (a:bitvec -> bitvec -> Z -> angle)
    (a':bitvec -> bitvec -> Z -> angle) (l:Z) (h:Z)
    (b:bitvec -> bitvec -> Z -> Z) (r:Z),
  (correct_path_sum_i c a l h b r) ->
  (forall (x:bitvec) (y:bitvec), forall (i:Z), ((length x) = (size c)) ->
   ((length y) = r) -> ((0%Z <= i)%Z /\ (i < (size c))%Z) ->
   ((((a' x) y) i) = (ang_inv (((a x) y) i)))) ->
  correct_path_sum_i (reverse c) a' l h b r.

Parameter diff_pre_to_mat: Z -> matrix t.

Axiom diff_pre_to_mat_def :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((diff_pre_to_mat n) = (mat_sem (diff_pre n))).

Axiom diff_pre_to_mat_spec :
  forall (n:Z), (n >= 2%Z)%Z -> ((rows (diff_pre_to_mat n)) = (power 2%Z n)).

Axiom diff_pre_to_mat_spec1 :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((columns (diff_pre_to_mat n)) = (power 2%Z n)).

Axiom diff_pre_to_mat_spec2 :
  forall (n:Z), (n >= 2%Z)%Z -> is_diagonal (diff_pre_to_mat n).

Axiom diff_pre_to_mat_spec3 :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((diff_pre_to_mat n) =
   (diag_mat1
    (fun (x:Z) =>
     (ang_exp
      (ang_mult_int ang_minus_one
       (ind_iproduct (fun (j:Z) => (1%Z - ((getbv (int_to_bv x n)) j))%Z) 0%Z
        n))))
    (power 2%Z n))).

Axiom diff_pre_to_mat_spec4 :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((diff_pre_to_mat n) =
   (mat_substr (infix_asdtdt ttwo (ket_projection_basis n 0%Z))
    (id_mat (power 2%Z n)))).

Parameter superposition: Z -> gate.

Axiom superposition_def :
  forall (n:Z), (n >= 1%Z)%Z -> (n = 1%Z) -> ((superposition n) = hadamard).

Axiom superposition_def1 :
  forall (n:Z), (n >= 1%Z)%Z -> ~ (n = 1%Z) ->
  ((superposition n) = (parallel (superposition (n - 1%Z)%Z) hadamard)).

Axiom superposition_spec :
  forall (n:Z), (n >= 1%Z)%Z -> ((superposition n) = (repeat_had n)).

Axiom superposition_spec1 :
  forall (n:Z), (n >= 1%Z)%Z ->
  ((pat_sem (superposition n) (ket n 0%Z)) =
   (infix_asdtdt (pow_inv_sqrt_2 n)
    (ket_sum_l (n_bvs n) (fun (y0:bitvec) => (bv_to_ket y0)) n))).

Axiom superposition_spec2 :
  forall (n:Z), (n >= 1%Z)%Z -> ((size (superposition n)) = n).

Axiom superposition_spec3 :
  forall (n:Z), (n >= 1%Z)%Z ->
  ((adjoint (mat_sem (superposition n))) = (mat_sem (superposition n))).

Parameter superposition_state: Z -> matrix t.

Axiom superposition_state_def :
  forall (n:Z), (n >= 1%Z)%Z ->
  ((superposition_state n) = (pat_sem (superposition n) (ket n 0%Z))).

Axiom superposition_state_spec :
  forall (n:Z), (n >= 1%Z)%Z ->
  ((superposition_state n) =
   (mat_mult (mat_sem (superposition n)) (ket n 0%Z))).
...
Axiom superposition_state_spec3 :
...
Parameter diff_pre_had: Z -> gate.

Axiom diff_pre_had_def :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((diff_pre_had n) = (sequence (diff_pre n) (superposition n))).

Axiom diff_pre_had_spec :
  forall (n:Z), (n >= 2%Z)%Z -> ((size (diff_pre_had n)) = n).

Axiom diff_pre_had_spec1 :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((mat_sem (diff_pre_had n)) =
   (mat_mult (mat_sem (superposition n))
    (mat_substr (infix_asdtdt ttwo (ket_projection_basis n 0%Z))
     (id_mat (power 2%Z n))))).

Axiom diff_pre_had_spec2 :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((mat_sem (diff_pre_had n)) =
   (mat_substr
    (mat_mult (mat_sem (superposition n))
     (infix_asdtdt ttwo (ket_projection_basis n 0%Z)))
    (mat_mult (mat_sem (superposition n)) (id_mat (power 2%Z n))))).

Axiom diff_pre_had_spec3 :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((mat_sem (diff_pre_had n)) =
   (mat_substr
    (mat_mult (mat_sem (superposition n))
     (infix_asdtdt ttwo (ket_projection_basis n 0%Z)))
    (mat_sem (superposition n)))).

Parameter diff1: Z -> gate.

Axiom diff_def :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((diff1 n) = (sequence (superposition n) (diff_pre_had n))).

Axiom diff_spec3 : forall (n:Z), (n >= 2%Z)%Z -> ((size (diff1 n)) = n).

Axiom diff_spec4 :
  forall (n:Z), (n >= 2%Z)%Z -> ((rows (mat_sem (diff1 n))) = (power 2%Z n)).

Axiom diff_spec5 :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((columns (mat_sem (diff1 n))) = (power 2%Z n)).
   ...
   (mat_substr
    (mat_mult
     (mat_mult (mat_sem (superposition n))
      (infix_asdtdt ttwo (ket_projection_basis n 0%Z)))
     (mat_sem (superposition n)))
    (mat_mult (mat_sem (superposition n)) (mat_sem (superposition n))))).
...
Axiom diff_spec8 :
  ...
  ((mat_sem (diff1 n)) =
   (mat_substr
    (infix_asdtdt ttwo
     (mat_mult
      (mat_mult (mat_sem (superposition n)) (ket_projection_basis n 0%Z))
      (mat_sem (superposition n))))
    (id_mat (power 2%Z n)))).
...
Axiom diff_rewrite :
  forall (n:Z), (n >= 2%Z)%Z ->
  ((mat_sem (diff1 n)) =
   (mat_substr (infix_asdtdt ttwo (projection (superposition_state n)))
    (id_mat (power 2%Z n)))).
...
Parameter result34: (matrix t) -> Z -> Z -> t.
...
Axiom qbit_zero_spec : forall (us:unit), is_a_ket_l (qbit_zero us) 1%Z.

Axiom qbit_zero_spec1 : forall (us:unit), ((rows (qbit_zero us)) = 2%Z).

Axiom qbit_zero_spec2 : forall (us:unit), ((columns (qbit_zero us)) = 1%Z).

Axiom qbit_zero_spec3 :
  forall (us:unit), ((get (qbit_zero us) 0%Z 0%Z) = tone).

Axiom qbit_zero_spec4 :
  forall (us:unit), ((get (qbit_zero us) 1%Z 0%Z) = tzero).

Parameter qbit_one: unit -> matrix t.

Axiom qbit_one_def : forall (us:unit), ((qbit_one us) = (ket 1%Z 1%Z)).

Axiom qbit_one_spec : forall (us:unit), is_a_ket_l (qbit_one us) 1%Z.

Axiom qbit_one_spec1 : forall (us:unit), ((rows (qbit_one us)) = 2%Z).

Axiom qbit_one_spec2 : forall (us:unit), ((columns (qbit_one us)) = 1%Z).

Axiom qbit_one_spec3 :
  forall (us:unit), ((get (qbit_one us) 0%Z 0%Z) = tzero).

Axiom qbit_one_spec4 :
  forall (us:unit), ((get (qbit_one us) 1%Z 0%Z) = tone).
...
Axiom qbit_plus_spec : forall (us:unit), is_a_ket_l (qbit_plus us) 1%Z.

Axiom qbit_plus_spec1 : forall (us:unit), ((rows (qbit_plus us)) = 2%Z).

Axiom qbit_plus_spec2 : forall (us:unit), ((columns (qbit_plus us)) = 1%Z).
...
Axiom qbit_minus_spec : forall (us:unit), is_a_ket_l (qbit_minus us) 1%Z.

Axiom qbit_minus_spec1 : forall (us:unit), ((rows (qbit_minus us)) = 2%Z).

Axiom qbit_minus_spec2 : forall (us:unit), ((columns (qbit_minus us)) = 1%Z).
...
Parameter result35: (matrix t) -> (matrix t) -> Z -> t.
...
Axiom xor_qbits_def :
  ...
  (is_a_ket_l y 1%Z) -> ((xor_qbits x y) = (make_ket 1%Z (result35 x y))).
...
Axiom repeat_had_hops1 :
  forall (n:Z), (n >= 1%Z)%Z -> ((range (repeat_had n)) = n).

Axiom repeat_had_hops2 :
  forall (n:Z), (n >= 1%Z)%Z -> forall (x:bitvec) (y:bitvec),
  ((length x) = n) -> ((length y) = n) ->
  ((basis_ket (repeat_had n) x y) = y).

Axiom repeat_had_hops3 :
  forall (n:Z), (n >= 1%Z)%Z -> forall (x:bitvec) (y:bitvec),
  ((length x) = n) -> ((length y) = n) ->
...
Parameter constant_bin: (bitvec -> Z) -> Z -> Prop.

Axiom constant_bin_def :
  forall (f:bitvec -> Z) (n:Z), (constant_bin f n) -> (1%Z <= n)%Z.

Axiom constant_bin_def1 :
  forall (f:bitvec -> Z) (n:Z), (constant_bin f n) -> forall (x:bitvec),
  ((length x) = n) -> (0%Z <= (f x))%Z.

Axiom constant_bin_def2 :
  forall (f:bitvec -> Z) (n:Z), (constant_bin f n) -> forall (x:bitvec),
  ((length x) = n) -> ((f x) < 2%Z)%Z.

Axiom constant_bin_def3 :
  forall (f:bitvec -> Z) (n:Z), (constant_bin f n) -> forall (x:bitvec),
  ((length x) = n) -> forall (x1:bitvec) (y:bitvec),
  (((length x1) = (length y)) /\ ((length y) = n)) -> ((f x1) = (f y)).

Axiom constant_bin_def4 :
...
Parameter balanced_bin: (bitvec -> Z) -> Z -> Prop.

Axiom balanced_bin_def :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) -> (1%Z <= n)%Z.

Axiom balanced_bin_def1 :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) -> forall (x:bitvec),
  ((length x) = n) -> (0%Z <= (f x))%Z.

Axiom balanced_bin_def2 :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) -> forall (x:bitvec),
  ((length x) = n) -> ((f x) < 2%Z)%Z.

Parameter fc21: (bitvec -> Z) -> bitvec -> bool.

Parameter fc22: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def21 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc21 f) x) = true) <-> ((f x) = 0%Z).

Axiom fc_def22 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc22 f) x) = true) <-> ((f x) = 1%Z).

Axiom balanced_bin_def3 :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) -> forall (x:bitvec),
  ((length x) = n) ->
  ((cardinal (my_filter (n_bvs n) (fc21 f))) =
   (cardinal (my_filter (n_bvs n) (fc22 f)))).

Parameter fc23: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def23 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc23 f) x) = true) <-> ((f x) = 1%Z).

Axiom balanced_bin_def4 :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) -> forall (x:bitvec),
  ((length x) = n) ->
  ((cardinal (my_filter (n_bvs n) (fc23 f))) = (power 2%Z (n - 1%Z)%Z)).

Parameter fc24: (bitvec -> Z) -> bitvec -> bool.

Parameter fc25: (bitvec -> Z) -> bitvec -> bool.

Parameter fc26: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def24 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc24 f) x) = true) <-> ((f x) = 0%Z).

Axiom fc_def25 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc25 f) x) = true) <-> ((f x) = 1%Z).

Axiom fc_def26 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc26 f) x) = true) <-> ((f x) = 1%Z).

Axiom balanced_bin_def5 :
  forall (f:bitvec -> Z) (n:Z),
  ((1%Z <= n)%Z /\
   forall (x:bitvec), ((length x) = n) ->
   ((0%Z <= (f x))%Z /\ ((f x) < 2%Z)%Z) /\
   (((cardinal (my_filter (n_bvs n) (fc24 f))) =
     (cardinal (my_filter (n_bvs n) (fc25 f)))) /\
    ((cardinal (my_filter (n_bvs n) (fc26 f))) = (power 2%Z (n - 1%Z)%Z)))) ->
  balanced_bin f n.

Parameter fc27: (bitvec -> Z) -> bitvec -> bool.

Parameter fc28: (bitvec -> Z) -> bitvec -> bool.

Axiom fc_def27 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc27 f) x) = true) <-> ((f x) = 0%Z).

Axiom fc_def28 :
  forall (f:bitvec -> Z) (x:bitvec), (((fc28 f) x) = true) <-> ((f x) = 1%Z).

Axiom balanced_sum :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) ->
  ((cardinal (my_filter (n_bvs n) (fc27 f))) =
   (cardinal (my_filter (n_bvs n) (fc28 f)))).

Axiom balanced_sum1 :
  forall (f:bitvec -> Z) (n:Z), (balanced_bin f n) ->
  ((sum (n_bvs n) (fun (x:bitvec) => (cpower (prefix_mndt tone) (f x)))) =
   tzero).
...
Axiom constant_sum1 :
  forall (f:bitvec -> Z) (n:Z), (constant_bin f n) ->
  ((sum (n_bvs n) (fun (x:bitvec) => (cpower (prefix_mndt tone) (f x)))) =
   (infix_asdt (i_to_t (power 2%Z n))
    (cpower (prefix_mndt tone) (f (choose (n_bvs n)))))).
...
Axiom constant_sum4 :
  ...
  ((cpower
    (modulus
     (sum (n_bvs n) (fun (x:bitvec) => (cpower (prefix_mndt tone) (f x)))))
    2%Z)
   = (i_to_t (power 2%Z (n * 2%Z)%Z))).

Parameter deutsch_oracle: (bitvec -> Z) -> Z -> gate.

Axiom deutsch_oracle_spec :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z -> (constant_bin f n) ->
  ((size (deutsch_oracle f n)) = (n + 1%Z)%Z).

Axiom deutsch_oracle_spec1 :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z -> (constant_bin f n) ->
  forall (x:bitvec), forall (y:matrix t), (is_a_ket_l y 1%Z) ->
  sem (deutsch_oracle f n) (kronecker (bv_to_ket x) y)
  (kronecker (bv_to_ket x) (xor_qbits (ket 1%Z (f x)) y)).

Axiom deutsch_oracle_spec2 :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z -> (balanced_bin f n) ->
  ((size (deutsch_oracle f n)) = (n + 1%Z)%Z).

Axiom deutsch_oracle_spec3 :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z -> (balanced_bin f n) ->
  forall (x:bitvec), forall (y:matrix t), (is_a_ket_l y 1%Z) ->
  sem (deutsch_oracle f n) (kronecker (bv_to_ket x) y)
  (kronecker (bv_to_ket x) (xor_qbits (ket 1%Z (f x)) y)).

Parameter dj_pre: (bitvec -> Z) -> Z -> gate.
...
Axiom dj_pre_spec :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z -> (constant_bin f n) ->
  ((size (dj_pre f n)) = (n + 1%Z)%Z).

Axiom dj_pre_spec1 :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z -> (constant_bin f n) ->
  sem (dj_pre f n) (kronecker (ket n 0%Z) (qbit_one tt))
  (kronecker
   (infix_asdtdt (pow_inv_sqrt_2 n)
    (ket_sum_l (n_bvs n)
     (fun (x:bitvec) =>
...
Parameter dj_output: (bitvec -> Z) -> Z -> matrix t.
...
Axiom dj_output_spec :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z -> is_a_ket_l (dj_output f n) n.

Axiom dj_output_spec1 :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z ->
  ((dj_output f n) =
   (ket_sum_l (n_bvs n)
    (fun (y:bitvec) =>
...
Axiom dj_output_spec2 :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z ->
  ((get_ket (dj_output f n) 0%Z) =
   (sum (n_bvs n) (fun (x:bitvec) => (cpower (prefix_mndt tone) (f x))))).

Parameter dj: (bitvec -> Z) -> Z -> gate.

Axiom dj_def :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z -> (constant_bin f n) ->
  ((dj f n) = (sequence (dj_pre f n) (place (repeat_had n) 0%Z (n + 1%Z)%Z))).
...
Axiom dj_spec :
  forall (f:bitvec -> Z) (n:Z), (1%Z <= n)%Z -> (constant_bin f n) ->
  sem (dj f n) (kronecker (ket n 0%Z) (qbit_one tt))
  (kronecker (infix_asdtdt (pow_inv_2 n) (dj_output f n)) (qbit_minus tt)).
...
Axiom H2 : is_a_ket_l (dj_output f n) n.
...
Parameter result36: t.

Axiom result_def36 : (result36 = (proba_measure (dj_output f n) 0%Z n)).

Axiom H5 : (result36 = (cpower (modulus (get_ket (dj_output f n) 0%Z)) 2%Z)).

Axiom H6 : (constant_bin f n) -> (result36 = tone).

Axiom H7 : balanced_bin f n.

(* Why3 goal *)
Theorem G : balanced_bin f n.
Proof.
