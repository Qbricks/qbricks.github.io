...
Axiom ancilla_ket_spec :
  ...
  (exists f:(matrix complex) -> matrix complex,
   ...
   (is_a_ket_basis_elt x) ->
   ((path_sem c (kronecker x (ket 0%Z k))) = (kronecker (f x) (ket 0%Z k)))) ->
...
Axiom get_path_sem_rev_qft_ket :
  forall (i:Z) (j:Z) (n:Z), (0%Z < n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
...
Axiom path_sem_rev_qft_ket_ind :
  forall (i:Z) (n:Z), (0%Z < n)%Z ->
  ((0%Z <= i)%Z /\ (i < (power_ 2%Z n))%Z) ->
  ((path_sem (qft_rev_be n) (ket n i)) =
   (infix_asdtdt (pow_inv_sqrt_2 n)
  ...
  (((ancillas (multiplier_qft_swap pick bound n i)) = 0%Z) /\
   (((width (multiplier_qft_swap pick bound n i)) = ((2%Z * n)%Z + 2%Z)%Z) /\
    ((sem (multiplier_qft_swap pick bound n i)
      (kronecker (ket n i) (ket (n + 1%Z)%Z 0%Z))
...
Axiom H7 : co_prime pick bound.

Axiom H8 : (0%Z <= (modular_inverse pick bound))%Z.

Axiom H9 : ((modular_inverse pick bound) < bound)%Z.
...
Axiom H14 :
  sem
  (multiplier_qft_pre
   (int.EuclideanDivision.mod1 (-(modular_inverse pick bound))%Z bound) bound
   n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))
  (kronecker (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))
   ...
   (kronecker
    (ket (n + 1%Z)%Z
     (int.EuclideanDivision.mod1
      (i +
       ((int.EuclideanDivision.mod1 (-(modular_inverse pick bound))%Z bound)
        * (int.EuclideanDivision.mod1 (pick * i)%Z bound))%Z)%Z
      bound))
    (ket 1%Z 0%Z))).
...
Axiom H18 : ((ancillas (multiplier_qft_swap pick bound n i)) = 0%Z).
  ...
  ((circ_to_pps
    (sequence (multiplier_qft_swap pick bound n i)
     (multiplier_qft_pre
      ...
      bound n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))))
   =
   (pps_seq (circ_to_pps (multiplier_qft_swap pick bound n i))
    (circ_to_pps
     (multiplier_qft_pre
      (int.EuclideanDivision.mod1 (-(modular_inverse pick bound))%Z bound)
      bound n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))))).
  ...
  ((ancillas
    (sequence (multiplier_qft_swap pick bound n i)
     (multiplier_qft_pre
      ...
      bound n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))))
   =
   (ZArith.BinInt.Z.max (ancillas (multiplier_qft_swap pick bound n i))
    (ancillas
     (multiplier_qft_pre
      (int.EuclideanDivision.mod1 (-(modular_inverse pick bound))%Z bound)
      bound n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))))).
  ...
  ((size
   ...
   ((size (multiplier_qft_swap pick bound n i)) +
    (size
     (multiplier_qft_pre
      (int.EuclideanDivision.mod1 (-(modular_inverse pick bound))%Z bound)
      bound n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))))%Z).
  ...
  ((width
    (sequence (multiplier_qft_swap pick bound n i)
     (multiplier_qft_pre
      (int.EuclideanDivision.mod1 (-(modular_inverse pick bound))%Z bound)
      bound n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))))
   = (width (multiplier_qft_swap pick bound n i))).
  ...
  ((range
    (sequence (multiplier_qft_swap pick bound n i)
     (multiplier_qft_pre
      ...
      bound n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))))
   =
   ((range (multiplier_qft_swap pick bound n i)) +
    (range
     (multiplier_qft_pre
      (int.EuclideanDivision.mod1 (-(modular_inverse pick bound))%Z bound)
      bound n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))))%Z).
...
Axiom H27 :
  ...
  ((ang_ind
    ...
    x y)
   =
   (ang_add (ang_ind (multiplier_qft_swap pick bound n i) x y)
    (ang_ind
     (multiplier_qft_pre
      (int.EuclideanDivision.mod1 (-(modular_inverse pick bound))%Z bound)
      bound n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))
     ((((fun (y0:circuit) (y1:Z -> Z) (y2:Z -> Z) (y3:Z) =>
       ...
       x)
      y)
     (fun (k:Z) => (y (k + (range (multiplier_qft_swap pick bound n i)))%Z))))).

Axiom H28 :
  forall (x:Z -> Z) (y:Z -> Z), forall (i1:Z),
  ((basis_ket
    (sequence (multiplier_qft_swap pick bound n i)
     (multiplier_qft_pre
      (int.EuclideanDivision.mod1 (-(modular_inverse pick bound))%Z bound)
...
Axiom H30 : (0%Z <= (modular_inverse pick bound))%Z.

Axiom H31 : ((modular_inverse pick bound) < bound)%Z.
...
Axiom H41 : ((ancillas (multiplier_qft_swap pick bound n i)) = 0%Z).
...
Axiom H45 : (0%Z <= (size (multiplier_qft_swap pick bound n i)))%Z.

Axiom H46 : (0%Z <= (adder_gate_bound n))%Z.

Axiom H47 :
  forall (added:Z) (bound1:Z),
  (((power_ 2%Z (n - 1%Z)%Z) < bound1)%Z /\ (bound1 < (power_ 2%Z n))%Z) ->
  ((0%Z <= added)%Z /\ (added < bound1)%Z) ->
  ((size (modular_adder added bound1 n)) <= (adder_gate_bound n))%Z.

Axiom H48 : (0%Z <= (adder_gate_bound n))%Z.
  ...
  ((size
    (sequence (multiplier_qft_swap pick bound n i)
     (multiplier_qft_pre
      ...
      bound n i (int.EuclideanDivision.mod1 (pick * i)%Z bound))))
   <=
   (polysquare (n + 1%Z)%Z ((2%Z * cont_size)%Z + (2%Z * cont_size)%Z)%Z
    ((cont_size * (adder_gate_bound n))%Z +
     (cont_size * (adder_gate_bound n))%Z)%Z
    (0%Z + 0%Z)%Z))%Z.

Axiom H51 : is_a_ket (ket 1%Z 0%Z).

Axiom H52 : ((ket_length (ket 1%Z 0%Z)) = 1%Z).

Axiom H53 : ((columns (ket 1%Z 0%Z)) = 1%Z).

Axiom H54 : ((rows (ket 1%Z 0%Z)) = (power 2%Z 1%Z)).
...
Axiom H56 :
  ...
  ((get (ket 1%Z 0%Z) j 0%Z) = c_zero).

Axiom H57 :
  ((0%Z <= 0%Z)%Z /\ (0%Z < (power 2%Z 1%Z))%Z) ->
  ((get (ket 1%Z 0%Z) 0%Z 0%Z) = c_one).

Axiom H58 : is_a_ket (ket n 0%Z).

Axiom H59 : ((ket_length (ket n 0%Z)) = n).

Axiom H60 : ((columns (ket n 0%Z)) = 1%Z).

Axiom H61 : ((rows (ket n 0%Z)) = (power 2%Z n)).

Axiom H62 :
  ((0%Z <= 0%Z)%Z /\ (0%Z < (power 2%Z n))%Z) -> forall (j:Z),
  (valid_index (ket n 0%Z) j 0%Z) ->
  ((get (ket n 0%Z) j 0%Z) = (indic j 0%Z)).

Axiom H63 :
  forall (j:Z), (valid_index (ket n 0%Z) j 0%Z) -> ~ (0%Z = j) ->
  ((get (ket n 0%Z) j 0%Z) = c_zero).

Axiom H64 :
  ((0%Z <= 0%Z)%Z /\ (0%Z < (power 2%Z n))%Z) ->
  ((get (ket n 0%Z) 0%Z 0%Z) = c_one).

Axiom H65 : is_a_ket (ket 1%Z 0%Z).

Axiom H66 : ((ket_length (ket 1%Z 0%Z)) = 1%Z).

Axiom H67 : ((columns (ket 1%Z 0%Z)) = 1%Z).

Axiom H68 : ((rows (ket 1%Z 0%Z)) = (power 2%Z 1%Z)).
...
Axiom H72 :
  ((rows (kronecker (ket 1%Z 0%Z) (ket n 0%Z))) =
   ((rows (ket 1%Z 0%Z)) * (rows (ket n 0%Z)))%Z).

Axiom H73 :
  ((columns (kronecker (ket 1%Z 0%Z) (ket n 0%Z))) =
   ((columns (ket 1%Z 0%Z)) * (columns (ket n 0%Z)))%Z).

Axiom H74 :
  forall (i1:Z) (j:Z),
  (valid_index (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) i1 j) ->
  ((get (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) i1 j) =
   (infix_asdt
    (get (ket 1%Z 0%Z) (int.EuclideanDivision.div i1 (rows (ket n 0%Z)))
     (int.EuclideanDivision.div j (columns (ket n 0%Z))))
    (get (ket n 0%Z) (int.EuclideanDivision.mod1 i1 (rows (ket n 0%Z)))
     (int.EuclideanDivision.mod1 j (columns (ket n 0%Z)))))).

Axiom H75 :
  ((rows (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z))) =
   ((rows (kronecker (ket 1%Z 0%Z) (ket n 0%Z))) * (rows (ket 1%Z 0%Z)))%Z).

Axiom H76 :
  ((columns (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z)))
   =
   ((columns (kronecker (ket 1%Z 0%Z) (ket n 0%Z))) *
...
Axiom H77 :
  forall (i1:Z) (j:Z),
  (valid_index
   (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z)) i1 j) ->
  ((get (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z)) i1 j)
   =
   (infix_asdt
    (get (kronecker (ket 1%Z 0%Z) (ket n 0%Z))
     (int.EuclideanDivision.div i1 (rows (ket 1%Z 0%Z)))
     (int.EuclideanDivision.div j (columns (ket 1%Z 0%Z))))
    (get (ket 1%Z 0%Z) (int.EuclideanDivision.mod1 i1 (rows (ket 1%Z 0%Z)))
     (int.EuclideanDivision.mod1 j (columns (ket 1%Z 0%Z)))))).

Axiom H78 : is_a_ket (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound)).

Axiom H79 :
  ((ket_length (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))) = n).

Axiom H80 :
  ((columns (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))) = 1%Z).

Axiom H81 :
  ((rows (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))) =
   (power 2%Z n)).

Axiom H82 :
  ((0%Z <= (int.EuclideanDivision.mod1 (pick * i)%Z bound))%Z /\
   ((int.EuclideanDivision.mod1 (pick * i)%Z bound) < (power 2%Z n))%Z) ->
  forall (j:Z),
  (valid_index (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound)) j 0%Z) ->
  ((get (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound)) j 0%Z) =
   (indic j (int.EuclideanDivision.mod1 (pick * i)%Z bound))).

Axiom H83 :
  forall (j:Z),
  (valid_index (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound)) j 0%Z) ->
  ~ ((int.EuclideanDivision.mod1 (pick * i)%Z bound) = j) ->
  ((get (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound)) j 0%Z) =
   c_zero).
...
Axiom H84 :
  ((0%Z <= (int.EuclideanDivision.mod1 (pick * i)%Z bound))%Z /\
   ((int.EuclideanDivision.mod1 (pick * i)%Z bound) < (power 2%Z n))%Z) ->
  ((get (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))
    (int.EuclideanDivision.mod1 (pick * i)%Z bound) 0%Z)
   = c_one).
...
Axiom H85 :
  ((rows
   ...
   =
   ((rows (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))) *
    (rows (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z))))%Z).
...
Axiom H86 :
  ((columns
    (kronecker (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))
     (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z))))
   =
   ((columns (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))) *
    (columns (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z))))%Z).
   ...
   (infix_asdt
    (get (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))
     ...
     (int.EuclideanDivision.div j
      (columns
       (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z)))))
    (get (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z))
     (int.EuclideanDivision.mod1 i1
      (rows (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z))))
     (int.EuclideanDivision.mod1 j
      (columns
       (kronecker (kronecker (ket 1%Z 0%Z) (ket n 0%Z)) (ket 1%Z 0%Z))))))).

Axiom H88 : is_a_ket (ket 1%Z 0%Z).

Axiom H89 : ((ket_length (ket 1%Z 0%Z)) = 1%Z).

Axiom H90 : ((columns (ket 1%Z 0%Z)) = 1%Z).

Axiom H91 : ((rows (ket 1%Z 0%Z)) = (power 2%Z 1%Z)).
...
Axiom H95 : is_a_ket (ket n i).

Axiom H96 : ((ket_length (ket n i)) = n).

Axiom H97 : ((columns (ket n i)) = 1%Z).

Axiom H98 : ((rows (ket n i)) = (power 2%Z n)).
...
Axiom H102 : is_a_ket (ket 1%Z 0%Z).

Axiom H103 : ((ket_length (ket 1%Z 0%Z)) = 1%Z).

Axiom H104 : ((columns (ket 1%Z 0%Z)) = 1%Z).

Axiom H105 : ((rows (ket 1%Z 0%Z)) = (power 2%Z 1%Z)).
...
Axiom H109 :
  ((rows (kronecker (ket 1%Z 0%Z) (ket n i))) =
   ((rows (ket 1%Z 0%Z)) * (rows (ket n i)))%Z).

Axiom H110 :
  ((columns (kronecker (ket 1%Z 0%Z) (ket n i))) =
   ((columns (ket 1%Z 0%Z)) * (columns (ket n i)))%Z).

Axiom H111 :
  forall (i1:Z) (j:Z),
  (valid_index (kronecker (ket 1%Z 0%Z) (ket n i)) i1 j) ->
  ((get (kronecker (ket 1%Z 0%Z) (ket n i)) i1 j) =
   (infix_asdt
    (get (ket 1%Z 0%Z) (int.EuclideanDivision.div i1 (rows (ket n i)))
     (int.EuclideanDivision.div j (columns (ket n i))))
    (get (ket n i) (int.EuclideanDivision.mod1 i1 (rows (ket n i)))
     (int.EuclideanDivision.mod1 j (columns (ket n i)))))).

Axiom H112 :
  ((rows (kronecker (kronecker (ket 1%Z 0%Z) (ket n i)) (ket 1%Z 0%Z))) =
   ((rows (kronecker (ket 1%Z 0%Z) (ket n i))) * (rows (ket 1%Z 0%Z)))%Z).

Axiom H113 :
  ((columns (kronecker (kronecker (ket 1%Z 0%Z) (ket n i)) (ket 1%Z 0%Z))) =
   ((columns (kronecker (ket 1%Z 0%Z) (ket n i))) *
    (columns (ket 1%Z 0%Z)))%Z).

Axiom H114 :
  forall (i1:Z) (j:Z),
  (valid_index (kronecker (kronecker (ket 1%Z 0%Z) (ket n i)) (ket 1%Z 0%Z))
   i1 j) ->
  ((get (kronecker (kronecker (ket 1%Z 0%Z) (ket n i)) (ket 1%Z 0%Z)) i1 j) =
   (infix_asdt
    (get (kronecker (ket 1%Z 0%Z) (ket n i))
     (int.EuclideanDivision.div i1 (rows (ket 1%Z 0%Z)))
     (int.EuclideanDivision.div j (columns (ket 1%Z 0%Z))))
    (get (ket 1%Z 0%Z) (int.EuclideanDivision.mod1 i1 (rows (ket 1%Z 0%Z)))
     (int.EuclideanDivision.mod1 j (columns (ket 1%Z 0%Z)))))).
...
Axiom H115 :
  is_a_ket (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound)).
...
Axiom H122 :
  ((rows
   ...
   =
   ((rows (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))) *
    (rows (kronecker (kronecker (ket 1%Z 0%Z) (ket n i)) (ket 1%Z 0%Z))))%Z).
...
Axiom H123 :
  ((columns
   ...
   =
   ((columns (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))) *
    (columns (kronecker (kronecker (ket 1%Z 0%Z) (ket n i)) (ket 1%Z 0%Z))))%Z).
  ...
  ((get
   ...
   (infix_asdt
    (get (ket n (int.EuclideanDivision.mod1 (pick * i)%Z bound))
     ...
     (int.EuclideanDivision.div j
      (columns (kronecker (kronecker (ket 1%Z 0%Z) (ket n i)) (ket 1%Z 0%Z)))))
    (get (kronecker (kronecker (ket 1%Z 0%Z) (ket n i)) (ket 1%Z 0%Z))
     (int.EuclideanDivision.mod1 i1
      (rows (kronecker (kronecker (ket 1%Z 0%Z) (ket n i)) (ket 1%Z 0%Z))))
     (int.EuclideanDivision.mod1 j
      (columns (kronecker (kronecker (ket 1%Z 0%Z) (ket n i)) (ket 1%Z 0%Z))))))).

Axiom H125 : is_a_ket (ket 1%Z 0%Z).

Axiom H126 : ((ket_length (ket 1%Z 0%Z)) = 1%Z).

Axiom H127 : ((columns (ket 1%Z 0%Z)) = 1%Z).

Axiom H128 : ((rows (ket 1%Z 0%Z)) = (power 2%Z 1%Z)).
...
Axiom H132 : is_a_ket (ket (n + 1%Z)%Z 0%Z).

Axiom H133 : ((ket_length (ket (n + 1%Z)%Z 0%Z)) = (n + 1%Z)%Z).

Axiom H134 : ((columns (ket (n + 1%Z)%Z 0%Z)) = 1%Z).

Axiom H135 : ((rows (ket (n + 1%Z)%Z 0%Z)) = (power 2%Z (n + 1%Z)%Z)).

Axiom H136 :
  ((0%Z <= 0%Z)%Z /\ (0%Z < (power 2%Z (n + 1%Z)%Z))%Z) -> forall (j:Z),
  (valid_index (ket (n + 1%Z)%Z 0%Z) j 0%Z) ->
  ((get (ket (n + 1%Z)%Z 0%Z) j 0%Z) = (indic j 0%Z)).

Axiom H137 :
  forall (j:Z), (valid_index (ket (n + 1%Z)%Z 0%Z) j 0%Z) -> ~ (0%Z = j) ->
  ((get (ket (n + 1%Z)%Z 0%Z) j 0%Z) = c_zero).

Axiom H138 :
  ((0%Z <= 0%Z)%Z /\ (0%Z < (power 2%Z (n + 1%Z)%Z))%Z) ->
  ((get (ket (n + 1%Z)%Z 0%Z) 0%Z 0%Z) = c_one).

Axiom H139 :
  ((rows (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z))) =
   ((rows (ket (n + 1%Z)%Z 0%Z)) * (rows (ket 1%Z 0%Z)))%Z).

Axiom H140 :
  ((columns (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z))) =
   ((columns (ket (n + 1%Z)%Z 0%Z)) * (columns (ket 1%Z 0%Z)))%Z).

Axiom H141 :
  forall (i1:Z) (j:Z),
  (valid_index (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z)) i1 j) ->
  ((get (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z)) i1 j) =
   (infix_asdt
    (get (ket (n + 1%Z)%Z 0%Z)
     (int.EuclideanDivision.div i1 (rows (ket 1%Z 0%Z)))
     (int.EuclideanDivision.div j (columns (ket 1%Z 0%Z))))
...
Axiom H142 : is_a_ket (ket n i).

Axiom H143 : ((ket_length (ket n i)) = n).

Axiom H144 : ((columns (ket n i)) = 1%Z).

Axiom H145 : ((rows (ket n i)) = (power 2%Z n)).
...
Axiom H149 :
  ((rows
   ...
   =
   ((rows (ket n i)) *
    (rows (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z))))%Z).
...
Axiom H150 :
  ((columns
   ...
   =
   ((columns (ket n i)) *
    (columns (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z))))%Z).

Axiom H151 :
  forall (i1:Z) (j:Z),
  (valid_index
   (kronecker (ket n i) (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z))) i1
   j) ->
  ((get (kronecker (ket n i) (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z)))
    i1 j)
   =
   (infix_asdt
    (get (ket n i)
     ...
     (int.EuclideanDivision.div j
      (columns (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z)))))
    (get (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z))
     (int.EuclideanDivision.mod1 i1
      (rows (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z))))
     (int.EuclideanDivision.mod1 j
      (columns (kronecker (ket (n + 1%Z)%Z 0%Z) (ket 1%Z 0%Z))))))).

Axiom H152 : (0%Z <= (modular_inverse pick bound))%Z.

Axiom H153 : ((modular_inverse pick bound) < bound)%Z.
...
Axiom H162 : ((ancillas (multiplier_qft_swap pick bound n i)) = 0%Z).
...
(* Why3 goal *)
Theorem G :
  ((int.EuclideanDivision.mod1 ((-(modular_inverse pick bound))%Z * pick)%Z
    bound)
   = (int.EuclideanDivision.mod1 (-1%Z)%Z bound)).
Proof.
